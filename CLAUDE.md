...
`HAMMER_HIT_TICK_OFFSET`이며 실측 스윙에 맞춘 30틱(1.0초)이다. 이 배치는 현재 protocol 84를 쓰므로
...
사용하려면 gameplay bootstrap v26과 현재 protocol v84의 Server/Client를 함께 빌드·배포해야 한다.
