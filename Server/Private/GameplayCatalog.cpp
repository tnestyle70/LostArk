...
namespace
{
	...
	{
		/* Catalog loads are one-shot, while this helper nests under the already
		large contract-test frame. Reuse one heap buffer instead of reserving two
		64 KiB path arrays on every caller's stack. */
