...
VertexShader EffectRectPreviewVS = compile vs_5_0 VS_MAIN();
PixelShader EffectRectPreviewPS = compile ps_5_0 PS_MAIN();
...
technique11 DefaultTechnique
{
    pass OpaqueBackDepthWrite
    {
        ...
        VertexShader = EffectRectPreviewVS;
        GeometryShader = NULL;
        PixelShader = EffectRectPreviewPS;
    }
