// Original Kouku material programs 4416..4479; native IDs and expressions are unchanged.
...
float4 ArtistNative4416(ARTIST_NATIVE_INPUT input)
{
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// bfx_g_me_sy_squ_01_ad: b6e16486151293479a105a38cdc89b88; selected map c2d3d90ac9b7f89048d6830e9aa4c715777d3d6f22d0cfca21f18feefecf21e2.
float4 ArtistNative4417(ARTIST_NATIVE_INPUT input)
{
    ...
    source[3] = ArtistNativeAppend(cos((g_ArtistSourceMaterialParameters[1u].wwww*float4(6.2831831, 0.0, 0.0, 0.0))),(float4(-1.0, 0.0, 0.0, 0.0)*sin((g_ArtistSourceMaterialParameters[1u].wwww*float4(6.2831831, 0.0, 0.0, 0.0)))),1u);
    source[4] = ArtistNativeAppend(sin((g_ArtistSourceMaterialParameters[1u].wwww*float4(6.2831831, 0.0, 0.0, 0.0))),cos((g_ArtistSourceMaterialParameters[1u].wwww*float4(6.2831831, 0.0, 0.0, 0.0))),1u);
    source[5] = ArtistNativeAppend(cos((g_ArtistSourceMaterialTime.xxxx*float4(1.0, 0.0, 0.0, 0.0))),(float4(-1.0, 0.0, 0.0, 0.0)*sin((g_ArtistSourceMaterialTime.xxxx*float4(1.0, 0.0, 0.0, 0.0)))),1u);
    source[6] = ArtistNativeAppend(sin((g_ArtistSourceMaterialTime.xxxx*float4(1.0, 0.0, 0.0, 0.0))),cos((g_ArtistSourceMaterialTime.xxxx*float4(1.0, 0.0, 0.0, 0.0))),1u);
    ...
    source[8].w = ((g_ArtistSourceMaterialParameters[1u].wwww*float4(6.2831831, 0.0, 0.0, 0.0))).x;
    source[9].x = ((g_ArtistSourceMaterialTime.xxxx*g_ArtistSourceMaterialParameters[0u].yyyy)).x;
    source[9].y = ((g_ArtistSourceMaterialTime.xxxx*float4(1.0, 0.0, 0.0, 0.0))).x;
    source[9].z = (sin((g_ArtistSourceMaterialTime.xxxx*float4(1.0, 0.0, 0.0, 0.0)))).x;
    source[9].w = ((float4(-1.0, 0.0, 0.0, 0.0)*sin((g_ArtistSourceMaterialTime.xxxx*float4(1.0, 0.0, 0.0, 0.0))))).x;
    source[10].x = (cos((g_ArtistSourceMaterialTime.xxxx*float4(1.0, 0.0, 0.0, 0.0)))).x;
    ...
    // 1: add r0.xy, v4.xyxx, l(-0.500000, -0.700000, 0.000000, 0.000000)
    r0.xy = ((v4.xyxx)+(float4(-0.500000,-0.700000,0.000000,0.000000))).xy;
    ...
    // 5: sample_b_indexable(texture2d)(float,float,float,float) r0.xyz, r0.xyxx, t3.xyzw, s3, l(0.000000)
    r0.xyz = (ArtistNativeSample3((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 6: add r1.xyzw, v4.xyxy, l(-0.500000, -0.500000, -0.300000, -0.500000)
    r1.xyzw = ((v4.xyxy)+(float4(-0.500000,-0.500000,-0.300000,-0.500000))).xyzw;
    // 7: dp2 r2.x, cb0[5].xyxx, r1.zwzz
    r2.x = (dot((source[5].xyxx).xy,(r1.zwzz).xy).xxxx).x;
    // 8: dp2 r2.y, cb0[6].xyxx, r1.zwzz
    r2.y = (dot((source[6].xyxx).xy,(r1.zwzz).xy).xxxx).y;
    // 9: add r1.zw, r2.xxxy, l(0.000000, 0.000000, 0.500000, 0.500000)
    r1.zw = ((r2.xxxy)+(float4(0.000000,0.000000,0.500000,0.500000))).zw;
    // 10: sample_b_indexable(texture2d)(float,float,float,float) r2.xyz, r1.zwzz, t3.xyzw, s3, l(0.000000)
    r2.xyz = (ArtistNativeSample3((r1.zwzz).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 11: add r0.xyz, r0.xyzx, r2.xyzx
    r0.xyz = ((r0.xyzx)+(r2.xyzx)).xyz;
    // 12: dp2 r0.w, cb0[4].xyxx, r1.xyxx
    r0.w = (dot((source[4].xyxx).xy,(r1.xyxx).xy).xxxx).w;
    // 13: add r0.w, r0.w, cb0[9].x
    r0.w = ((r0.wwww)+(source[9].xxxx)).w;
    // 14: add r2.z, r0.w, l(0.500000)
    r2.z = ((r0.wwww)+(float4(0.500000,0.500000,0.500000,0.500000))).z;
    // 15: dp2 r0.w, cb0[3].xyxx, r1.xyxx
    r0.w = (dot((source[3].xyxx).xy,(r1.xyxx).xy).xxxx).w;
    // 16: add r2.x, r0.w, l(0.500000)
    r2.x = ((r0.wwww)+(float4(0.500000,0.500000,0.500000,0.500000))).x;
    // 17: sample_b_indexable(texture2d)(float,float,float,float) r2.xyz, r2.xzxx, t2.xyzw, s2, l(0.000000)
    r2.xyz = (ArtistNativeSample2((r2.xzxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 18: add r0.xyz, r0.xyzx, r2.xyzx
    r0.xyz = ((r0.xyzx)+(r2.xyzx)).xyz;
    // 19: mul r0.xyz, r0.xyzx, cb0[10].yyyy
    r0.xyz = ((r0.xyzx)*(source[10].yyyy)).xyz;
    // 20: mul r1.zw, v4.xxxy, cb0[8].xxxx
    r1.zw = ((v4.xxxy)*(source[8].xxxx)).zw;
    // 21: mad r2.x, cb0[7].w, cb0[7].z, r1.z
    r2.x = ((source[7].wwww)*(source[7].zzzz)+(r1.zzzz)).x;
    // 22: mad r2.y, cb0[7].w, cb0[8].y, r1.w
    r2.y = ((source[7].wwww)*(source[8].yyyy)+(r1.wwww)).y;
    // 23: sample_b_indexable(texture2d)(float,float,float,float) r1.zw, r2.xyxx, t0.zwxy, s1, l(0.000000)
    r1.zw = (ArtistNativeSample1((r2.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).zwxy).zw;
    // 24: div r0.w, l(1.000000, 1.000000, 1.000000, 1.000000), cb0[7].x
    r0.w = ((float4(1.000000,1.000000,1.000000,1.000000))/(source[7].xxxx)).w;
    // 25: mad r1.xy, r0.wwww, r1.xyxx, l(1.000000, 1.000000, 0.000000, 0.000000)
    r1.xy = ((r0.wwww)*(r1.xyxx)+(float4(1.000000,1.000000,0.000000,0.000000))).xy;
    // 26: mad r1.xy, cb0[7].yyyy, r1.zwzz, r1.xyxx
    r1.xy = ((source[7].yyyy)*(r1.zwzz)+(r1.xyxx)).xy;
    // 27: mul r1.zw, r1.zzzw, cb0[7].yyyy
    r1.zw = ((r1.zzzw)*(source[7].yyyy)).zw;
    // 28: sample_b_indexable(texture2d)(float,float,float,float) r2.xyz, r1.xyxx, t1.xyzw, s0, l(0.000000)
    r2.xyz = (ArtistNativeSample0((r1.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 29: add r3.xyzw, -v4.xyxy, l(1.000000, 1.000000, 0.500000, 0.500000)
    r3.xyzw = ((-(v4.xyxy))+(float4(1.000000,1.000000,0.500000,0.500000))).xyzw;
    // 30: mad r1.xy, r0.wwww, r3.zwzz, r1.zwzz
    r1.xy = ((r0.wwww)*(r3.zwzz)+(r1.zwzz)).xy;
    // 31: mul r0.w, r0.w, l(0.500000)
    r0.w = ((r0.wwww)*(float4(0.500000,0.500000,0.500000,0.500000))).w;
    // 32: add r3.xy, r3.xyxx, r3.xyxx
    r3.xy = ((r3.xyxx)+(r3.xyxx)).xy;
    // 33: round_ni r3.xy, r3.xyxx
    r3.xy = (floor(r3.xyxx)).xy;
    // 34: add r1.xy, r1.xyxx, l(1.000000, 1.000000, 0.000000, 0.000000)
    r1.xy = ((r1.xyxx)+(float4(1.000000,1.000000,0.000000,0.000000))).xy;
    // 35: sample_b_indexable(texture2d)(float,float,float,float) r4.xyz, r1.xyxx, t1.xyzw, s0, l(0.000000)
    r4.xyz = (ArtistNativeSample0((r1.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 36: add r1.xy, v4.xyxx, v4.xyxx
    r1.xy = ((v4.xyxx)+(v4.xyxx)).xy;
    // 37: round_ni r1.xy, r1.yxyy
    r1.xy = (floor(r1.yxyy)).xy;
    // 38: mul r2.w, r1.x, r1.y
    r2.w = ((r1.xxxx)*(r1.yyyy)).w;
    // 39: mul r1.xy, r1.xyxx, r3.xyxx
    r1.xy = ((r1.xyxx)*(r3.xyxx)).xy;
    // 40: mul r3.x, r3.y, r3.x
    r3.x = ((r3.yyyy)*(r3.xxxx)).x;
    // 41: mul r4.xyzw, r4.xxyz, r2.wwww
    r4.xyzw = ((r4.xxyz)*(r2.wwww)).xyzw;
    // 42: mad r2.xyzw, r3.xxxx, r2.xxyz, r4.xyzw
    r2.xyzw = ((r3.xxxx)*(r2.xxyz)+(r4.xyzw)).xyzw;
    // 43: mad r3.xyzw, v4.xyxy, l(2.000000, 2.000000, 2.000000, 2.000000), l(-0.500000, -1.500000, -1.500000, -0.500000)
    r3.xyzw = ((v4.xyxy)*(float4(2.000000,2.000000,2.000000,2.000000))+(float4(-0.500000,-1.500000,-1.500000,-0.500000))).xyzw;
    // 44: dp2 r4.x, l(0.000796, 1.000000, 0.000000, 0.000000), r3.zwzz
    r4.x = (dot((float4(0.000796,1.000000,0.000000,0.000000)).xy,(r3.zwzz).xy).xxxx).x;
    // 45: dp2 r4.y, l(-1.000000, 0.000796, 0.000000, 0.000000), r3.zwzz
    r4.y = (dot((float4(-1.000000,0.000796,0.000000,0.000000)).xy,(r3.zwzz).xy).xxxx).y;
    // 46: add r3.zw, r4.xxxy, l(0.000000, 0.000000, -0.500000, -0.500000)
    r3.zw = ((r4.xxxy)+(float4(0.000000,0.000000,-0.500000,-0.500000))).zw;
    // 47: mad r3.zw, r0.wwww, r3.zzzw, r1.zzzw
    r3.zw = ((r0.wwww)*(r3.zzzw)+(r1.zzzw)).zw;
    // 48: add r3.zw, r3.zzzw, l(0.000000, 0.000000, 1.000000, 1.000000)
    r3.zw = ((r3.zzzw)+(float4(0.000000,0.000000,1.000000,1.000000))).zw;
    // 49: sample_b_indexable(texture2d)(float,float,float,float) r4.xyz, r3.zwzz, t1.xyzw, s0, l(0.000000)
    r4.xyz = (ArtistNativeSample0((r3.zwzz).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 50: mul r4.xyzw, r1.yyyy, r4.xxyz
    r4.xyzw = ((r1.yyyy)*(r4.xxyz)).xyzw;
    // 51: dp2 r5.x, l(0.000796, -1.000000, 0.000000, 0.000000), r3.xyxx
    r5.x = (dot((float4(0.000796,-1.000000,0.000000,0.000000)).xy,(r3.xyxx).xy).xxxx).x;
    // 52: dp2 r5.y, l(1.000000, 0.000796, 0.000000, 0.000000), r3.xyxx
    r5.y = (dot((float4(1.000000,0.000796,0.000000,0.000000)).xy,(r3.xyxx).xy).xxxx).y;
    // 53: add r3.xy, r5.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)
    r3.xy = ((r5.xyxx)+(float4(-0.500000,-0.500000,0.000000,0.000000))).xy;
    // 54: mad r1.yz, r0.wwww, r3.xxyx, r1.zzwz
    r1.yz = ((r0.wwww)*(r3.xxyx)+(r1.zzwz)).yz;
    // 55: add r1.yz, r1.yyzy, l(0.000000, 1.000000, 1.000000, 0.000000)
    r1.yz = ((r1.yyzy)+(float4(0.000000,1.000000,1.000000,0.000000))).yz;
    // 56: sample_b_indexable(texture2d)(float,float,float,float) r1.yzw, r1.yzyy, t1.wxyz, s0, l(0.000000)
    r1.yzw = (ArtistNativeSample0((r1.yzyy).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).wxyz).yzw;
    // 57: mad r1.xyzw, r1.xxxx, r1.yyzw, r4.xyzw
    r1.xyzw = ((r1.xxxx)*(r1.yyzw)+(r4.xyzw)).xyzw;
    // 58: add r1.xyzw, r1.xyzw, r2.xyzw
    r1.xyzw = ((r1.xyzw)+(r2.xyzw)).xyzw;
    // 59: mad r0.xyz, r1.yzwy, r0.xyzx, r1.yzwy
    r0.xyz = ((r1.yzwy)*(r0.xyzx)+(r1.yzwy)).xyz;
    // 60: mul_sat r0.w, r1.x, l(15.000000)
    r0.w = (saturate((r1.xxxx)*(float4(15.000000,15.000000,15.000000,15.000000)))).w;
    ...
    // 64: mul r0.xyz, r0.xyzx, v5.wwww
    r0.xyz = ((r0.xyzx)*(v5.wwww)).xyz;
    // 65: mul o0.xyz, r0.wwww, r0.xyzx
...
float4 ArtistNative4418(ARTIST_NATIVE_INPUT input)
{
    float4 source[11]; [unroll] for (uint i=0u; i<11u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative4419(ARTIST_NATIVE_INPUT input)
{
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_g_pa_colorring_01_ad: d2f98fa3ff9867468d6951becfbcf7e7; selected map 5651218fc865f2d1162a0637698d7183bb98441305f2a03f0e35e99d2ff77bfb.
float4 ArtistNative4420(ARTIST_NATIVE_INPUT input)
{
...
float4 ArtistNative4420Distortion(ARTIST_NATIVE_INPUT input)
{
    ...
    source[3].x = ((g_ArtistSourceMaterialParameters[4u].zzzz*g_ArtistSourceMaterialTime.xxxx)).x;
    source[3].y = (g_ArtistSourceMaterialParameters[2u].wwww).x;
    source[3].z = (g_ArtistSourceMaterialParameters[5u].zzzz).x;
    source[3].w = (g_ArtistSourceMaterialParameters[5u].wwww).x;
    ...
    source[4].w = ((g_ArtistSourceMaterialParameters[0u].xxxx*g_ArtistSourceMaterialTime.xxxx)).x;
    source[5].x = (((g_ArtistSourceMaterialParameters[0u].xxxx*g_ArtistSourceMaterialTime.xxxx)*g_ArtistSourceMaterialParameters[5u].zzzz)).x;
    source[5].y = (g_ArtistSourceMaterialParameters[7u].yyyy).x;
    source[5].z = (g_ArtistSourceMaterialParameters[7u].zzzz).x;
    source[5].w = (g_ArtistSourceMaterialParameters[6u].zzzz).x;
    source[6].x = ((g_ArtistSourceMaterialParameters[6u].zzzz*g_ArtistSourceMaterialTime.xxxx)).x;
    source[6].y = (((g_ArtistSourceMaterialParameters[6u].zzzz*g_ArtistSourceMaterialTime.xxxx)*g_ArtistSourceMaterialParameters[5u].zzzz)).x;
    ...
    source[8].y = ((g_ArtistSourceMaterialParameters[2u].zzzz*g_ArtistSourceMaterialTime.xxxx)).x;
    ...
    source[10].y = (g_ArtistSourceMaterialParameters[6u].xxxx).x;
    ...
    source[11].z = ((float4(0.0, 0.0, 0.0, 0.0)*g_ArtistSourceMaterialParameters[3u].xxxx)).x;
    float4 passValues[4]; [unroll] for(uint passIndex=0u;passIndex<4u;++passIndex) passValues[passIndex]=0.f;
    passValues[0]=float4(.5f,-.5f,.5f,.5f);
    float4 v0 = float4(input.sourceBasisX,0.f); // native texcoord10
    ...
    // 33: mul r3.x, r1.x, cb0[5].y
    r3.x = ((r1.xxxx)*(source[5].yyyy)).x;
    // 34: add r0.y, r0.x, r0.x
    r0.y = ((r0.xxxx)+(r0.xxxx)).y;
    // 35: lt r0.x, r0.x, l(0.000000)
    r0.x = (asfloat((uint4)((r0.xxxx)<(float4(0.000000,0.000000,0.000000,0.000000))) * 0xffffffffu)).x;
    // 36: log r0.y, r0.y
    r0.y = (log2(r0.yyyy)).y;
    // 37: mul r0.y, r0.y, cb0[3].y
    r0.y = ((r0.yyyy)*(source[3].yyyy)).y;
    // 38: exp r0.y, r0.y
    r0.y = (exp2(r0.yyyy)).y;
    // 39: mul r0.y, r0.y, cb0[3].z
    r0.y = ((r0.yyyy)*(source[3].zzzz)).y;
    // 40: movc r0.x, r0.x, l(0), r0.y
    r0.x = ((asuint(r0.xxxx) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.yyyy)).x;
    // 41: add r0.y, v3.x, cb0[3].w
    r0.y = ((v3.xxxx)+(source[3].wwww)).y;
    // 42: mad r1.y, r0.y, l(-0.400000), r0.x
    r1.y = ((r0.yyyy)*(float4(-0.400000,-0.400000,-0.400000,-0.400000))+(r0.xxxx)).y;
    // 43: mad r3.y, r1.y, cb0[5].z, cb0[6].y
    r3.y = ((r1.yyyy)*(source[5].zzzz)+(source[6].yyyy)).y;
    ...
    // 46: log r0.xy, r0.xyxx
    r0.xy = (log2(r0.xyxx)).xy;
    // 47: mul r0.xy, r0.xyxx, cb0[6].zzzz
    r0.xy = ((r0.xyxx)*(source[6].zzzz)).xy;
    // 48: exp r0.xy, r0.xyxx
    r0.xy = (exp2(r0.xyxx)).xy;
    // 49: mad r2.y, r1.y, cb0[7].w, cb0[8].y
    r2.y = ((r1.yyyy)*(source[7].wwww)+(source[8].yyyy)).y;
    // 50: mad r0.zw, cb0[6].wwww, r0.xxxy, r2.xxxy
    r0.zw = ((source[6].wwww)*(r0.xxxy)+(r2.xxxy)).zw;
    ...
    // 56: log r2.xyz, r2.xyzx
    r2.xyz = (log2(r2.xyzx)).xyz;
    // 57: mul r2.xyz, r2.xyzx, cb0[8].zzzz
    r2.xyz = ((r2.xyzx)*(source[8].zzzz)).xyz;
    // 58: exp r2.xyz, r2.xyzx
    r2.xyz = (exp2(r2.xyzx)).xyz;
    // 59: mul r3.xyz, r2.xyzx, cb0[8].wwww
    r3.xyz = ((r2.xyzx)*(source[8].wwww)).xyz;
    // 60: dp3 r0.z, r3.xyzx, l(0.300000, 0.590000, 0.110000, 0.000000)
    r0.z = (dot((r3.xyzx).xyz,(float4(0.300000,0.590000,0.110000,0.000000)).xyz).xxxx).z;
    // 61: mad r2.xyzw, -cb0[8].wwww, r2.xyxy, r0.zzzz
    r2.xyzw = ((-(source[8].wwww))*(r2.xyxy)+(r0.zzzz)).xyzw;
    // 62: mad r2.xyzw, cb0[9].xxxx, r2.xyzw, r3.xyxy
    r2.xyzw = ((source[9].xxxx)*(r2.xyzw)+(r3.xyxy)).xyzw;
    // 63: mul r2.xyzw, r2.xyzw, cb0[0].xyxy
    r2.xyzw = ((r2.xyzw)*(source[0].xyxy)).xyzw;
    // 64: mad r0.zw, r1.xxxy, l(0.000000, 0.000000, 1.000000, 0.800000), cb0[1].xxxy
    r0.zw = ((r1.xxxy)*(float4(0.000000,0.000000,1.000000,0.800000))+(source[1].xxxy)).zw;
    // 65: mul r3.x, r1.x, cb0[4].x
    r3.x = ((r1.xxxx)*(source[4].xxxx)).x;
    // 66: mad r3.y, r1.y, cb0[4].y, cb0[5].x
    r3.y = ((r1.yyyy)*(source[4].yyyy)+(source[5].xxxx)).y;
    // 67: mad r1.xy, cb0[6].wwww, r0.xyxx, r3.xyxx
    r1.xy = ((source[6].wwww)*(r0.xyxx)+(r3.xyxx)).xy;
    // 68: mad r0.xy, cb0[6].wwww, r0.xyxx, r0.zwzz
    r0.xy = ((source[6].wwww)*(r0.xyxx)+(r0.zwzz)).xy;
    ...
    // 71: mul r1.xy, r1.xyxx, l(1.500000, 0.250000, 0.000000, 0.000000)
    r1.xy = ((r1.xyxx)*(float4(1.500000,0.250000,0.000000,0.000000))).xy;
    // 72: sample_l_indexable(texture2d)(float,float,float,float) r1.x, r1.xyxx, t1.xyzw, s1, l(-1.000000)
    r1.x = (ArtistNativeSample0((r1.xyxx).xy, (float4(-1.000000,-1.000000,-1.000000,-1.000000)).x, true).xyzw).x;
    // 73: mul r2.xyzw, r0.xyzw, cb0[9].wwww
    r2.xyzw = ((r0.xyzw)*(source[9].wwww)).xyzw;
    // 74: max r2.xyzw, |r2.xyzw|, l(0.000001, 0.000001, 0.000001, 0.000001)
    r2.xyzw = (max(abs(r2.xyzw),float4(0.000001,0.000001,0.000001,0.000001))).xyzw;
    // 75: log r2.xyzw, r2.xyzw
    r2.xyzw = (log2(r2.xyzw)).xyzw;
    // 76: mul r2.xyzw, r2.xyzw, cb0[10].xxxx
    r2.xyzw = ((r2.xyzw)*(source[10].xxxx)).xyzw;
    // 77: exp r2.xyzw, r2.xyzw
    r2.xyzw = (exp2(r2.xyzw)).xyzw;
    // 78: log r0.x, |r1.x|
    r0.x = (log2(abs(r1.xxxx))).x;
    // 79: lt r0.y, |r1.x|, l(0.000001)
    r0.y = (asfloat((uint4)((abs(r1.xxxx))<(float4(0.000001,0.000001,0.000001,0.000001))) * 0xffffffffu)).y;
    // 80: mul r0.x, r0.x, cb0[7].x
    r0.x = ((r0.xxxx)*(source[7].xxxx)).x;
    // 81: exp r0.x, r0.x
    r0.x = (exp2(r0.xxxx)).x;
    // 82: mul r0.x, r0.x, cb0[7].y
    r0.x = ((r0.xxxx)*(source[7].yyyy)).x;
    // 83: movc r0.x, r0.y, l(0), r0.x
    r0.x = ((asuint(r0.yyyy) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.xxxx)).x;
    // 84: mad r0.xyzw, r0.xxxx, r0.zwzw, r2.xyzw
    r0.xyzw = ((r0.xxxx)*(r0.zwzw)+(r2.xyzw)).xyzw;
    // 85: mul r0.xyzw, r0.xyzw, cb0[11].zzzz
    r0.xyzw = ((r0.xyzw)*(source[11].zzzz)).xyzw;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_d_pa_ring_07_54_ad: cf380577169fb14db0da86d4d69ce3f2; selected map ea0671cec64f66c53447f820e434bb8f540086657125a6daee1c5f23268c0a37.
float4 ArtistNative4421(ARTIST_NATIVE_INPUT input)
{
    float4 source[5]; [unroll] for (uint i=0u; i<5u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    // 38: sample_l_indexable(texture2d)(float,float,float,float) r0.x, r1.xyxx, t0.xyzw, s0, cb0[2].y
    r0.x = (ArtistNativeSample0((r1.xyxx).xy, (source[2].yyyy).x, true).xyzw).x;
    // 39: mul_sat r0.x, r0.x, cb0[3].w
    r0.x = (saturate((r0.xxxx)*(source[3].wwww))).x;
    // 40: mov_sat r0.y, v4.y
    r0.y = (saturate(v4.yyyy)).y;
    // 41: add r0.y, -r0.y, l(1.000000)
    r0.y = ((-(r0.yyyy))+(float4(1.000000,1.000000,1.000000,1.000000))).y;
    // 42: add r0.x, -r0.y, r0.x
    r0.x = ((-(r0.yyyy))+(r0.xxxx)).x;
    // 43: max r0.x, r0.x, l(0.000000)
    r0.x = (max(r0.xxxx,float4(0.000000,0.000000,0.000000,0.000000))).x;
    // 44: sample_b_indexable(texture2d)(float,float,float,float) r0.y, v2.xyxx, t1.yxzw, s1, l(0.000000)
    r0.y = (ArtistNativeSample1((v2.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yxzw).y;
    // 45: mul_sat r0.x, r0.y, r0.x
    r0.x = (saturate((r0.yyyy)*(r0.xxxx))).x;
    // 46: log r0.y, r0.x
    r0.y = (log2(r0.xxxx)).y;
    // 47: lt r0.x, r0.x, l(0.000001)
    r0.x = (asfloat((uint4)((r0.xxxx)<(float4(0.000001,0.000001,0.000001,0.000001))) * 0xffffffffu)).x;
    // 48: mul r0.y, r0.y, cb0[4].x
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative4421Distortion(ARTIST_NATIVE_INPUT input)
{
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_g_pa_circle_01_ad: dd388502d511d14a8a6d49d5b330347c; selected map 810dda8d1835714271c00f0ad51a82aba07c84bdcf66e2e613d8f430674017e4.
float4 ArtistNative4422(ARTIST_NATIVE_INPUT input)
{
    float4 source[8]; [unroll] for (uint i=0u; i<8u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    source[1] = g_ArtistSourceMaterialParameters[0u];
    source[2] = ArtistNativeAppend(cos((g_ArtistSourceMaterialTime.xxxx*float4(0.100000001, 0.0, 0.0, 0.0))),(float4(-1.0, 0.0, 0.0, 0.0)*sin((g_ArtistSourceMaterialTime.xxxx*float4(0.100000001, 0.0, 0.0, 0.0)))),1u);
    source[3] = ArtistNativeAppend(sin((g_ArtistSourceMaterialTime.xxxx*float4(0.100000001, 0.0, 0.0, 0.0))),cos((g_ArtistSourceMaterialTime.xxxx*float4(0.100000001, 0.0, 0.0, 0.0))),1u);
    source[4] = ArtistNativeAppend(ArtistNativePeriodic((g_ArtistSourceMaterialTime.xxxx*float4(0.200000003, 0.0, 0.0, 0.0))),ArtistNativePeriodic((g_ArtistSourceMaterialTime.xxxx*float4(-0.100000001, 0.0, 0.0, 0.0))),1u);
    source[5] = ArtistNativeAppend(ArtistNativePeriodic((g_ArtistSourceMaterialTime.xxxx*float4(-0.100000001, 0.0, 0.0, 0.0))),ArtistNativePeriodic((g_ArtistSourceMaterialTime.xxxx*float4(0.150000006, 0.0, 0.0, 0.0))),1u);
    source[6] = ArtistNativeAppend(cos((g_ArtistSourceMaterialTime.xxxx*float4(-0.100000001, 0.0, 0.0, 0.0))),(float4(-1.0, 0.0, 0.0, 0.0)*sin((g_ArtistSourceMaterialTime.xxxx*float4(-0.100000001, 0.0, 0.0, 0.0)))),1u);
    source[7] = ArtistNativeAppend(sin((g_ArtistSourceMaterialTime.xxxx*float4(-0.100000001, 0.0, 0.0, 0.0))),cos((g_ArtistSourceMaterialTime.xxxx*float4(-0.100000001, 0.0, 0.0, 0.0))),1u);
    float4 passValues[4]; [unroll] for(uint passIndex=0u;passIndex<4u;++passIndex) passValues[passIndex]=0.f;
    passValues[0]=float4(.5f,-.5f,.5f,.5f);
    float4 v0 = float4(input.sourceBasisX,0.f); // native texcoord10
    float4 v1 = float4(input.sourceBasisZ,input.handedness); // native texcoord11
    ...
    r0.zw = ((r1.xxxy)+(float4(0.000000,0.000000,0.500000,0.500000))).zw;
    // 5: sample_b_indexable(texture2d)(float,float,float,float) r0.z, r0.zwzz, t1.yzxw, s0, l(0.000000)
    r0.z = (ArtistNativeSample0((r0.zwzz).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yzxw).z;
    // 6: add r1.xy, r0.zzzz, v2.xyxx
    r1.xy = ((r0.zzzz)+(v2.xyxx)).xy;
    // 7: mad r0.zw, v2.xxxy, l(0.000000, 0.000000, 2.000000, 2.000000), r0.zzzz
    r0.zw = ((v2.xxxy)*(float4(0.000000,0.000000,2.000000,2.000000))+(r0.zzzz)).zw;
    // 8: add r0.zw, r0.zzzw, cb0[5].xxxy
    r0.zw = ((r0.zzzw)+(source[5].xxxy)).zw;
    // 9: sample_b_indexable(texture2d)(float,float,float,float) r2.xyz, r0.zwzz, t2.xyzw, s1, l(0.000000)
    r2.xyz = (ArtistNativeSample1((r0.zwzz).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 10: add r0.zw, r1.xxxy, cb0[4].xxxy
    r0.zw = ((r1.xxxy)+(source[4].xxxy)).zw;
    // 11: sample_b_indexable(texture2d)(float,float,float,float) r1.xyz, r0.zwzz, t2.xyzw, s1, l(0.000000)
    r1.xyz = (ArtistNativeSample1((r0.zwzz).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 12: mul r1.xyz, r2.xyzx, r1.xyzx
    r1.xyz = ((r2.xyzx)*(r1.xyzx)).xyz;
    // 13: mul r1.xyz, r1.xyzx, l(100.000000, 100.000000, 100.000000, 0.000000)
    r1.xyz = ((r1.xyzx)*(float4(100.000000,100.000000,100.000000,0.000000))).xyz;
    // 14: dp2 r2.x, cb0[6].xyxx, r0.xyxx
    r2.x = (dot((source[6].xyxx).xy,(r0.xyxx).xy).xxxx).x;
    // 15: dp2 r2.y, cb0[7].xyxx, r0.xyxx
    ...
    // 17: sample_b_indexable(texture2d)(float,float,float,float) r0.xyz, r0.xyxx, t3.xyzw, s2, l(0.000000)
    ...
    r0.xyz = ((r0.xyzx)*(v5.wwww)).xyz;
    // 21: sample_b_indexable(texture2d)(float,float,float,float) r0.w, v2.xyxx, t0.yzwx, s3, l(0.000000)
    r0.w = (ArtistNativeSample3((v2.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yzwx).w;
    // 22: mul r0.w, r0.w, v3.w
    r0.w = ((r0.wwww)*(v3.wwww)).w;
    // 23: mul r0.w, r0.w, cb0[0].x
    r0.w = ((r0.wwww)*(source[0].xxxx)).w;
...
float4 ArtistNative4423(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// bfx_d_pa_shine_01_01_ad: 1cf325c945d58f4f9233eee74ec122b8; selected map c9f206d2afeaac1e8f7a42fe692baaafcced9032a0de01d254e1d0ef4bab2cbc.
float4 ArtistNative4424(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_d_pa_ringmaster_01_18_ad: a659438589f1d6428dd34a39e16a067f; selected map af5f992c3175bd9bdb4fd922b487066f30756845a7e3d0ee66dbf17dda111725.
float4 ArtistNative4425(ARTIST_NATIVE_INPUT input)
{
    ...
    source[7].z = ((float4(-0.523599029, 0.0, 0.0, 0.0)*g_ArtistSourceMaterialParameters[1u].zzzz)).x;
    source[7].w = (((float4(-0.523599029, 0.0, 0.0, 0.0)*g_ArtistSourceMaterialParameters[1u].zzzz)*float4(1.0, 0.0, 0.0, 0.0))).x;
    source[8].x = (sin(((float4(-0.523599029, 0.0, 0.0, 0.0)*g_ArtistSourceMaterialParameters[1u].zzzz)*float4(1.0, 0.0, 0.0, 0.0)))).x;
    source[8].y = ((float4(-1.0, 0.0, 0.0, 0.0)*sin(((float4(-0.523599029, 0.0, 0.0, 0.0)*g_ArtistSourceMaterialParameters[1u].zzzz)*float4(1.0, 0.0, 0.0, 0.0))))).x;
    source[8].z = (cos(((float4(-0.523599029, 0.0, 0.0, 0.0)*g_ArtistSourceMaterialParameters[1u].zzzz)*float4(1.0, 0.0, 0.0, 0.0)))).x;
    ...
    // 40: sample_l_indexable(texture2d)(float,float,float,float) r1.xyz, r1.xyxx, t1.xyzw, s0, l(-1.000000)
    r1.xyz = (ArtistNativeSample0((r1.xyxx).xy, (float4(-1.000000,-1.000000,-1.000000,-1.000000)).x, true).xyzw).xyz;
    // 41: dp3 r0.z, r1.xyzx, l(0.300000, 0.590000, 0.110000, 0.000000)
    r0.z = (dot((r1.xyzx).xyz,(float4(0.300000,0.590000,0.110000,0.000000)).xyz).xxxx).z;
    // 42: add r2.xyz, -r1.xyzx, r0.zzzz
    r2.xyz = ((-(r1.xyzx))+(r0.zzzz)).xyz;
    // 43: mad r1.xyz, cb0[6].wwww, r2.xyzx, r1.xyzx
    r1.xyz = ((source[6].wwww)*(r2.xyzx)+(r1.xyzx)).xyz;
    // 44: max r1.xyz, |r1.xyzx|, l(0.000001, 0.000001, 0.000001, 0.000000)
    r1.xyz = (max(abs(r1.xyzx),float4(0.000001,0.000001,0.000001,0.000000))).xyz;
    // 45: log r1.xyz, r1.xyzx
    r1.xyz = (log2(r1.xyzx)).xyz;
    // 46: mul r1.xyz, r1.xyzx, cb0[7].xxxx
    ...
    // 49: mul r1.xyz, r1.xyzx, r2.xyzx
    r1.xyz = ((r1.xyzx)*(r2.xyzx)).xyz;
    // 50: mad r1.xyz, r1.xyzx, v3.xyzx, cb0[1].xyzx
    r1.xyz = ((r1.xyzx)*(v3.xyzx)+(source[1].xyzx)).xyz;
    // 51: mul r1.xyz, r1.xyzx, v5.wwww
    ...
    // 54: mad r0.xy, cb0[8].wwww, r2.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
    r0.xy = ((source[8].wwww)*(r2.xyxx)+(float4(0.500000,0.500000,0.000000,0.000000))).xy;
    // 55: sample_b_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t0.xyzw, s1, l(0.000000)
    r0.x = (ArtistNativeSample1((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).x;
    // 56: mul_sat r0.x, r0.x, cb0[9].x
    r0.x = (saturate((r0.xxxx)*(source[9].xxxx))).x;
    // 57: lt r0.y, r0.x, l(0.000001)
    r0.y = (asfloat((uint4)((r0.xxxx)<(float4(0.000001,0.000001,0.000001,0.000001))) * 0xffffffffu)).y;
    // 58: log r0.x, r0.x
    r0.x = (log2(r0.xxxx)).x;
    // 59: mul r0.x, r0.x, cb0[9].y
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative4425Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_PARTICLE_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_d_me_master_01_035_ma: 94c5369024a6da46ac7b68e818d45137; selected map 71d118a612f59d08a40bb47f960e0c4bc6dc71fb8da4ff7c447557f146cb011f.
float4 ArtistNative4426(ARTIST_NATIVE_INPUT input)
{
    float4 source[8]; [unroll] for (uint i=0u; i<8u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    // 20: mad r0.xyz, cb0[6].xxxx, r1.xyzx, r0.xyzx
    ...
    // 23: mul r0.xyz, r0.xyzx, cb0[6].yyyy
    ...
    r0.xyz = ((r0.xyzx)*(r1.xyzx)).xyz;
    // 27: mul r1.xy, r0.xyxx, cb0[6].zzzz
    r1.xy = ((r0.xyxx)*(source[6].zzzz)).xy;
    // 28: dp3 r0.w, v5.xyzx, v5.xyzx
    r0.w = (dot((v5.xyzx).xyz,(v5.xyzx).xyz).xxxx).w;
    // 29: rsq r0.w, r0.w
    r0.w = (rsqrt(r0.wwww)).w;
    // 30: mul r1.zw, r0.wwww, v5.xxxy
    r1.zw = ((r0.wwww)*(v5.xxxy)).zw;
    // 31: mad r1.xy, r1.zwzz, cb0[2].xyxx, r1.xyxx
    r1.xy = ((r1.zwzz)*(source[2].xyxx)+(r1.xyxx)).xy;
    // 32: sample_b_indexable(texture2d)(float,float,float,float) r1.xyz, r1.xyxx, t1.xyzw, s1, l(0.000000)
...
#if !defined(EFFECT_NATIVE_PARTICLE_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_d_me_master_01_036_ma: 94c5369024a6da46ac7b68e818d45137; selected map 71d118a612f59d08a40bb47f960e0c4bc6dc71fb8da4ff7c447557f146cb011f.
float4 ArtistNative4427(ARTIST_NATIVE_INPUT input)
{
    float4 source[8]; [unroll] for (uint i=0u; i<8u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative4428(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative4429(ARTIST_NATIVE_INPUT input)
{
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative4429Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
