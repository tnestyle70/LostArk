// Single source owner for ArtistNative profiles 832..895.
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_d_pa_shine_02_06d_ad: c44c02b570fb014493949efc412c9761; selected map c1d9b8c8a16cddbfa80478c2c1e08df07a0553fd99e16e5cc70d6689bc3d5c10.
float4 ArtistNative832(ARTIST_NATIVE_INPUT input)
{
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_m_de_flowergarden_grass_60_02_tr: fec22f6db20f63479d8c9b17f8407637; selected map 72a07621320d03e69af3ce99caadd8ac1b785789ac9376190bf6210141504023.
float4 ArtistNative833(ARTIST_NATIVE_INPUT input)
{
    ...
    source[3] = ArtistNativeAppend(g_ArtistSourceMaterialParameters[0u].yyyy,g_ArtistSourceMaterialParameters[0u].yyyy,1u);
    source[4] = ArtistNativeAppend(ArtistNativeAppend(g_ArtistSourceMaterialParameters[0u].zzzz,g_ArtistSourceMaterialParameters[0u].zzzz,1u),float4(1.0, 0.0, 0.0, 0.0),2u);
    ...
    // 1: mul r0.xy, v2.xyxx, cb0[5].zzzz
    r0.xy = ((v2.xyxx)*(source[5].zzzz)).xy;
    // 2: sample_b_indexable(texture2d)(float,float,float,float) r0.xyz, r0.xyxx, t4.xyzw, s2, l(0.000000)
    r0.xyz = (ArtistNativeSample2((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 3: add r0.x, r0.y, r0.x
    r0.x = ((r0.yyyy)+(r0.xxxx)).x;
    // 4: add r0.x, r0.z, r0.x
    r0.x = ((r0.zzzz)+(r0.xxxx)).x;
    // 5: mul r0.x, r0.x, l(0.333330)
    ...
    // 8: mul r0.y, r0.y, cb0[5].w
    r0.y = ((r0.yyyy)*(source[5].wwww)).y;
    // 9: exp r0.y, r0.y
    r0.y = (exp2(r0.yyyy)).y;
    // 10: mul_sat r0.y, r0.y, cb0[6].x
    ...
    // 12: mul r1.xyzw, v2.xyxy, cb0[5].xxyy
    r1.xyzw = ((v2.xyxy)*(source[5].xxyy)).xyzw;
    // 13: sample_b_indexable(texture2d)(float,float,float,float) r0.yzw, r1.zwzz, t3.wxyz, s1, l(0.000000)
    r0.yzw = (ArtistNativeSample1((r1.zwzz).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).wxyz).yzw;
    // 14: sample_b_indexable(texture2d)(float,float,float,float) r1.xyz, r1.xyxx, t2.xyzw, s0, l(0.000000)
    r1.xyz = (ArtistNativeSample0((r1.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 15: add r0.yzw, r0.yyzw, -r1.xxyz
    r0.yzw = ((r0.yyzw)+(-(r1.xxyz))).yzw;
    // 16: mad r0.xyz, r0.xxxx, r0.yzwy, r1.xyzx
    r0.xyz = ((r0.xxxx)*(r0.yzwy)+(r1.xyzx)).xyz;
    // 17: dp3 r0.w, r0.xyzx, l(0.300000, 0.590000, 0.110000, 0.000000)
    r0.w = (dot((r0.xyzx).xyz,(float4(0.300000,0.590000,0.110000,0.000000)).xyz).xxxx).w;
    // 18: add r1.xyz, -r0.xyzx, r0.wwww
    r1.xyz = ((-(r0.xyzx))+(r0.wwww)).xyz;
    // 19: mul r0.w, v4.x, cb0[6].y
    r0.w = ((v4.xxxx)*(source[6].yyyy)).w;
    // 20: mad r0.xyz, r0.wwww, r1.xyzx, r0.xyzx
    r0.xyz = ((r0.wwww)*(r1.xyzx)+(r0.xyzx)).xyz;
    // 21: mul r1.xyz, cb0[2].xyzx, cb0[2].wwww
    r1.xyz = ((source[2].xyzx)*(source[2].wwww)).xyz;
    // 22: mul r0.xyz, r0.xyzx, r1.xyzx
    r0.xyz = ((r0.xyzx)*(r1.xyzx)).xyz;
    // 23: mul r1.xy, v2.xyxx, cb0[3].xyxx
    r1.xy = ((v2.xyxx)*(source[3].xyxx)).xy;
    // 24: sample_b_indexable(texture2d)(float,float,float,float) r1.xy, r1.xyxx, t5.xyzw, s3, l(0.000000)
    ...
    // 38: mul r0.xyz, r0.xyzx, v3.xyzx
    r0.xyz = ((r0.xyzx)*(v3.xyzx)).xyz;
    // 39: mad r0.xyz, cb0[7].xxxx, r0.xyzx, cb0[1].xyzx
    r0.xyz = ((source[7].xxxx)*(r0.xyzx)+(source[1].xyzx)).xyz;
    // 40: mad o0.xyz, r0.xyzx, v5.wwww, v5.xyzx
    output.xyz = ((r0.xyzx)*(v5.wwww)+(v5.xyzx)).xyz;
    // 41: mov_sat r0.xy, v2.xyxx
    r0.xy = (saturate(v2.xyxx)).xy;
    // 42: sample_b_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t0.xyzw, s4, l(0.000000)
    r0.x = (ArtistNativeSample4((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).x;
    // 43: mul r0.x, r0.x, cb0[7].y
    r0.x = ((r0.xxxx)*(source[7].yyyy)).x;
    // 44: log r0.y, |r0.x|
    r0.y = (log2(abs(r0.xxxx))).y;
    // 45: lt r0.x, |r0.x|, l(0.000001)
    r0.x = (asfloat((uint4)((abs(r0.xxxx))<(float4(0.000001,0.000001,0.000001,0.000001))) * 0xffffffffu)).x;
    // 46: mul r0.y, r0.y, cb0[7].z
    r0.y = ((r0.yyyy)*(source[7].zzzz)).y;
    // 47: exp r0.y, r0.y
    r0.y = (exp2(r0.yyyy)).y;
    // 48: movc r0.x, r0.x, l(0), r0.y
    r0.x = ((asuint(r0.xxxx) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.yyyy)).x;
    // 49: mul r0.yz, v2.xxyx, cb0[7].wwww
    r0.yz = ((v2.xxyx)*(source[7].wwww)).yz;
    // 50: sample_b_indexable(texture2d)(float,float,float,float) r0.y, r0.yzyy, t1.yxzw, s5, l(0.000000)
    r0.y = (ArtistNativeSample5((r0.yzyy).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yxzw).y;
    // 51: mov_sat r0.z, v3.w
    r0.z = (saturate(v3.wwww)).z;
    // 52: add r0.z, -r0.z, l(1.000000)
    r0.z = ((-(r0.zzzz))+(float4(1.000000,1.000000,1.000000,1.000000))).z;
    // 53: mul r0.y, r0.y, r0.z
    r0.y = ((r0.yyyy)*(r0.zzzz)).y;
    // 54: mad r0.x, -r0.y, l(10.000000), r0.x
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_m_me_flowergarden_07_1_ad: 74762e15bb374d44a52ee9ddf59f268b; selected map af8c368a28be3af9d3c9c63f1e475941f864a3420ae0eb60728eeb480cafbd31.
float4 ArtistNative834(ARTIST_NATIVE_INPUT input)
{
    ...
    source[5] = ArtistNativeAppend(g_ArtistSourceMaterialParameters[3u].zzzz,g_ArtistSourceMaterialParameters[3u].wwww,1u);
    source[6].x = (g_ArtistSourceMaterialParameters[6u].xxxx).x;
    ...
    source[11].x = ((float4(-0.523599029, 0.0, 0.0, 0.0)*g_ArtistSourceMaterialParameters[4u].xxxx)).x;
    ...
    source[12].w = (g_ArtistSourceMaterialParameters[4u].wwww).x;
    float4 passValues[4]={float4(.5f,-.5f,.5f,.5f),float4(0.f,0.f,0.f,0.f),float4(0.f,0.f,0.f,0.f),float4(0.f,0.f,0.f,0.f)};
    float4 v0 = float4(input.sourceBasisX,0.f); // native texcoord10
    float4 v1 = float4(input.sourceBasisZ,input.handedness); // native texcoord11
    ...
    r0.y = (ArtistNativeSample3((r1.yzyy).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yxzw).y;
    ...
    r0.x = ((asuint(r0.yyyy) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.xxxx)).x;
    // 58: mul r0.y, r0.z, cb0[6].w
    r0.y = ((r0.zzzz)*(source[6].wwww)).y;
    // 59: mad r2.x, r1.x, cb0[6].z, r0.y
    r2.x = ((r1.xxxx)*(source[6].zzzz)+(r0.yyyy)).x;
    // 60: mul r0.y, r1.x, cb0[8].w
    r0.y = ((r1.xxxx)*(source[8].wwww)).y;
    // 61: mad r2.y, cb0[7].x, r0.w, r0.y
    r2.y = ((source[7].xxxx)*(r0.wwww)+(r0.yyyy)).y;
    // 62: sample_b_indexable(texture2d)(float,float,float,float) r0.yzw, r2.xyxx, t4.wxyz, s2, l(0.000000)
    ...
    // 65: mad r0.yzw, cb0[9].xxxx, r1.xxyz, r0.yyzw
    ...
    // 68: mul r0.yzw, r0.yyzw, cb0[9].yyyy
    ...
    r0.yzw = ((r0.yyzw)*(r1.xxyz)).yzw;
    // 72: mad r0.yzw, r0.yyzw, cb0[1].xxyz, cb0[2].xxyz
    r0.yzw = ((r0.yyzw)*(source[1].xxyz)+(source[2].xxyz)).yzw;
    // 73: mul r0.yzw, r0.yyzw, v5.wwww
    r0.yzw = ((r0.yyzw)*(v5.wwww)).yzw;
    // 74: mul o0.xyz, r0.xxxx, r0.yzwy
    output.xyz = ((r0.xxxx)*(r0.yzwy)).xyz;
    // 75: mov o0.w, l(0)
    output.w = (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))).w;
    return output;
...
float4 ArtistNative835(ARTIST_NATIVE_INPUT input)
{
    ...
    source[4].z = (g_ArtistSourceMaterialParameters[5u].yyyy).x;
    source[4].w = (g_ArtistSourceMaterialParameters[6u].yyyy).x;
    source[5].x = ((g_ArtistSourceMaterialParameters[4u].zzzz*g_ArtistSourceMaterialTime.xxxx)).x;
    source[5].y = (g_ArtistSourceMaterialParameters[2u].wwww).x;
    source[5].z = (g_ArtistSourceMaterialParameters[5u].zzzz).x;
    source[5].w = (g_ArtistSourceMaterialParameters[5u].wwww).x;
    ...
    source[6].w = ((g_ArtistSourceMaterialParameters[0u].xxxx*g_ArtistSourceMaterialTime.xxxx)).x;
    source[7].x = (((g_ArtistSourceMaterialParameters[0u].xxxx*g_ArtistSourceMaterialTime.xxxx)*g_ArtistSourceMaterialParameters[5u].zzzz)).x;
    source[7].y = (g_ArtistSourceMaterialParameters[7u].yyyy).x;
    source[7].z = (g_ArtistSourceMaterialParameters[7u].zzzz).x;
    source[7].w = (g_ArtistSourceMaterialParameters[6u].zzzz).x;
    source[8].x = ((g_ArtistSourceMaterialParameters[6u].zzzz*g_ArtistSourceMaterialTime.xxxx)).x;
    source[8].y = (((g_ArtistSourceMaterialParameters[6u].zzzz*g_ArtistSourceMaterialTime.xxxx)*g_ArtistSourceMaterialParameters[5u].zzzz)).x;
    ...
    source[10].y = ((g_ArtistSourceMaterialParameters[2u].zzzz*g_ArtistSourceMaterialTime.xxxx)).x;
    ...
    source[13].z = ((float4(0.0, 0.0, 0.0, 0.0)*g_ArtistSourceMaterialParameters[3u].xxxx)).x;
    float4 passValues[4]={float4(.5f,-.5f,.5f,.5f),float4(0.f,0.f,0.f,0.f),float4(0.f,0.f,0.f,0.f),float4(0.f,0.f,0.f,0.f)};
    float4 v0 = float4(input.sourceBasisX,0.f); // native texcoord10
    float4 v1 = float4(input.sourceBasisZ,input.handedness); // native texcoord11
    float4 v2 = float4(input.uv,float2(0.f,0.f)); // native texcoord0
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_j_pa_ring_07_18_tr: 25c27c3a88ca2a45bff45c24979ff787; selected map 455cb50dd9d1d62a6da216cc1d0f10f1f96aa1183b2df5e003aadbde33457951.
float4 ArtistNative836(ARTIST_NATIVE_INPUT input)
{
    float4 source[8]; [unroll] for (uint i=0u; i<8u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    // 57: mad o0.xyz, r1.xyzx, v5.wwww, v5.xyzx
    output.xyz = ((r1.xyzx)*(v5.wwww)+(v5.xyzx)).xyz;
    // 58: mad r1.x, cb0[3].z, cb0[6].y, r0.x
    r1.x = ((source[3].zzzz)*(source[6].yyyy)+(r0.xxxx)).x;
    // 59: mad r1.y, cb0[3].z, cb0[7].x, r0.z
    r1.y = ((source[3].zzzz)*(source[7].xxxx)+(r0.zzzz)).y;
    // 60: mad r0.xy, r0.yyyy, r0.wwww, r1.xyxx
    r0.xy = ((r0.yyyy)*(r0.wwww)+(r1.xyxx)).xy;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_m_me_flowergraden_1_ad: 4f28fc374f4fd94f8a32a1632fa2af10; selected map f552533451a95325eae54ca0431baed9b9472108d15bd484495b376d7ca99cea.
float4 ArtistNative837(ARTIST_NATIVE_INPUT input)
{
    float4 source[14]; [unroll] for (uint i=0u; i<14u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_m_flowergarden_ringmaster_02_01_tr: b7989ea7e673484daae628018492729f; selected map 71dc4b710bc9dc0d9d420dfdcdb1582bdd996ab5579390272ab9a6fe1902cd7e.
float4 ArtistNative838(ARTIST_NATIVE_INPUT input)
{
    float4 source[17]; [unroll] for (uint i=0u; i<17u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    source[1] = g_ArtistSourceMaterialParameters[11u];
    source[2] = ArtistNativeAppend(g_ArtistSourceMaterialParameters[2u].yyyy,g_ArtistSourceMaterialParameters[3u].xxxx,1u);
    ...
    source[6].x = ((float4(1.0, 0.0, 0.0, 0.0)/max(float4(9.99999975e-06, 0.0, 0.0, 0.0),g_ArtistSourceMaterialParameters[2u].wwww))).x;
    source[6].y = (g_ArtistSourceMaterialParameters[3u].zzzz).x;
    source[6].z = ((float4(1.0, 0.0, 0.0, 0.0)-g_ArtistSourceMaterialParameters[3u].zzzz)).x;
    source[6].w = (max((float4(1.0, 0.0, 0.0, 0.0)-g_ArtistSourceMaterialParameters[3u].zzzz),float4(9.99999975e-06, 0.0, 0.0, 0.0))).x;
    source[7].x = ((float4(1.0, 0.0, 0.0, 0.0)/max((float4(1.0, 0.0, 0.0, 0.0)-g_ArtistSourceMaterialParameters[3u].zzzz),float4(9.99999975e-06, 0.0, 0.0, 0.0)))).x;
    ...
    source[11].y = ((float4(1.0, 0.0, 0.0, 0.0)*g_ArtistSourceMaterialParameters[1u].wwww)).x;
    ...
    source[15].y = (g_ArtistSourceMaterialParameters[7u].yyyy).x;
    source[15].z = (g_ArtistSourceMaterialParameters[7u].zzzz).x;
    source[15].w = (g_ArtistSourceMaterialParameters[8u].yyyy).x;
    source[16].x = ((g_ArtistSourceMaterialParameters[8u].yyyy*float4(0.0, 0.0, 0.0, 0.0))).x;
    source[16].y = (g_ArtistSourceMaterialParameters[7u].wwww).x;
    source[16].z = (g_ArtistSourceMaterialParameters[8u].xxxx).x;
    float4 passValues[4]={float4(.5f,-.5f,.5f,.5f),float4(0.f,0.f,0.f,0.f),float4(0.f,0.f,0.f,0.f),float4(0.f,0.f,0.f,0.f)};
    float4 v0 = float4(input.sourceBasisX,0.f); // native texcoord10
    float4 v1 = float4(input.sourceBasisZ,input.handedness); // native texcoord11
    float4 v2 = float4(input.uv,float2(0.f,0.f)); // native texcoord0
    ...
    r1.x = ((r0.yyyy)*(float4(0.159155,0.159155,0.159155,0.159155))+(float4(0.500000,0.500000,0.500000,0.500000))).x;
    // 28: add r0.yz, v7.xxyx, cb0[0].xxyx
    r0.yz = ((v7.xxyx)+(source[0].xxyx)).yz;
    // 29: mul r0.yz, r0.yyzy, cb0[10].zzzz
    r0.yz = ((r0.yyzy)*(source[10].zzzz)).yz;
    // 30: mul r0.yz, r0.yyzy, cb0[10].xxyx
    r0.yz = ((r0.yyzy)*(source[10].xxyx)).yz;
    // 31: mad r2.x, cb0[9].w, cb0[9].z, r0.y
    r2.x = ((source[9].wwww)*(source[9].zzzz)+(r0.yyyy)).x;
    // 32: mad r2.y, cb0[9].w, cb0[10].w, r0.z
    r2.y = ((source[9].wwww)*(source[10].wwww)+(r0.zzzz)).y;
    ...
    // 34: mad r0.yz, r0.yyzy, l(0.000000, 2.000000, 2.000000, 0.000000), l(0.000000, -1.000000, -1.000000, 0.000000)
    r0.yz = ((r0.yyzy)*(float4(0.000000,2.000000,2.000000,0.000000))+(float4(0.000000,-1.000000,-1.000000,0.000000))).yz;
    // 35: add r0.w, r0.x, r0.x
    r0.w = ((r0.xxxx)+(r0.xxxx)).w;
    // 36: lt r0.x, r0.x, l(0.000000)
    r0.x = (asfloat((uint4)((r0.xxxx)<(float4(0.000000,0.000000,0.000000,0.000000))) * 0xffffffffu)).x;
    // 37: log r0.w, r0.w
    r0.w = (log2(r0.wwww)).w;
    // 38: mul r1.z, v3.y, cb0[9].y
    r1.z = ((v3.yyyy)*(source[9].yyyy)).z;
    // 39: mul r0.w, r0.w, r1.z
    r0.w = ((r0.wwww)*(r1.zzzz)).w;
    // 40: exp r0.w, r0.w
    r0.w = (exp2(r0.wwww)).w;
    // 41: movc r1.y, r0.x, l(0), r0.w
    r1.y = ((asuint(r0.xxxx) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.wwww)).y;
    // 42: mad r0.xy, cb0[11].yyyy, r0.yzyy, r1.xyxx
    r0.xy = ((source[11].yyyy)*(r0.yzyy)+(r1.xyxx)).xy;
    // 43: mul r1.y, r0.y, cb0[3].y
    r1.y = ((r0.yyyy)*(source[3].yyyy)).y;
    // 44: mad r2.x, r0.x, cb0[3].x, v3.x
    r2.x = ((r0.xxxx)*(source[3].xxxx)+(v3.xxxx)).x;
    // 45: mul r2.y, cb0[9].w, cb0[12].x
    r2.y = ((source[9].wwww)*(source[12].xxxx)).y;
    // 46: mov r1.z, l(-1.000000)
    r1.z = (float4(-1.000000,-1.000000,-1.000000,-1.000000)).z;
    // 47: add r0.zw, r1.zzzy, r2.xxxy
    r0.zw = ((r1.zzzy)+(r2.xxxy)).zw;
    // 48: sample_l_indexable(texture2d)(float,float,float,float) r0.z, r0.zwzz, t1.yzxw, s0, l(-1.000000)
    r0.z = (ArtistNativeSample0((r0.zwzz).xy, (float4(-1.000000,-1.000000,-1.000000,-1.000000)).x, true).yzxw).z;
    // 49: add r1.xy, v2.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)
    r1.xy = ((v2.xyxx)+(float4(-0.500000,-0.500000,0.000000,0.000000))).xy;
    // 50: dp2 r0.w, r1.xyxx, r1.xyxx
    r0.w = (dot((r1.xyxx).xy,(r1.xyxx).xy).xxxx).w;
    // 51: sqrt r0.w, r0.w
    r0.w = (sqrt(r0.wwww)).w;
    // 52: mad r1.x, -r0.w, cb0[6].x, l(1.000000)
    r1.x = ((-(r0.wwww))*(source[6].xxxx)+(float4(1.000000,1.000000,1.000000,1.000000))).x;
    // 53: mad r0.w, -r0.w, cb0[7].w, l(1.000000)
    r0.w = ((-(r0.wwww))*(source[7].wwww)+(float4(1.000000,1.000000,1.000000,1.000000))).w;
    // 54: mul_sat r0.w, r0.w, cb0[8].w
    r0.w = (saturate((r0.wwww)*(source[8].wwww))).w;
    // 55: mul_sat r1.x, r1.x, cb0[7].x
    ...
    r0.w = (asfloat((uint4)((r0.wwww)<(float4(0.000001,0.000001,0.000001,0.000001))) * 0xffffffffu)).w;
    // 60: mul r1.x, r1.x, cb0[9].x
    r1.x = ((r1.xxxx)*(source[9].xxxx)).x;
    // 61: exp r1.x, r1.x
    r1.x = (exp2(r1.xxxx)).x;
    // 62: movc r0.w, r0.w, l(0), r1.x
    r0.w = ((asuint(r0.wwww) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r1.xxxx)).w;
    // 63: mul r0.z, r0.z, r0.w
    r0.z = ((r0.zzzz)*(r0.wwww)).z;
    // 64: mul r1.xy, r0.xyxx, cb0[12].zwzz
    r1.xy = ((r0.xyxx)*(source[12].zwzz)).xy;
    // 65: mul r0.xy, r0.xyxx, cb0[13].zwzz
    r0.xy = ((r0.xyxx)*(source[13].zwzz)).xy;
    // 66: mad r2.x, cb0[12].y, cb0[9].w, r1.x
    r2.x = ((source[12].yyyy)*(source[9].wwww)+(r1.xxxx)).x;
    // 67: mad r2.y, cb0[9].w, cb0[13].x, r1.y
    r2.y = ((source[9].wwww)*(source[13].xxxx)+(r1.yyyy)).y;
    // 68: sample_l_indexable(texture2d)(float,float,float,float) r1.xyz, r2.xyxx, t2.xyzw, s2, l(-1.000000)
    r1.xyz = (ArtistNativeSample2((r2.xyxx).xy, (float4(-1.000000,-1.000000,-1.000000,-1.000000)).x, true).xyzw).xyz;
    // 69: mad r2.x, cb0[9].w, cb0[13].y, r0.x
    r2.x = ((source[9].wwww)*(source[13].yyyy)+(r0.xxxx)).x;
    // 70: mad r2.y, cb0[9].w, cb0[14].x, r0.y
    r2.y = ((source[9].wwww)*(source[14].xxxx)+(r0.yyyy)).y;
    // 71: sample_l_indexable(texture2d)(float,float,float,float) r0.xyw, r2.xyxx, t3.xywz, s3, l(-1.000000)
    r0.xyw = (ArtistNativeSample3((r2.xyxx).xy, (float4(-1.000000,-1.000000,-1.000000,-1.000000)).x, true).xywz).xyw;
    // 72: add r0.xyw, r0.xyxw, r1.xyxz
    r0.xyw = ((r0.xyxw)+(r1.xyxz)).xyw;
    // 73: add r1.x, r0.y, r0.x
    r1.x = ((r0.yyyy)+(r0.xxxx)).x;
    // 74: add r1.x, r0.w, r1.x
    r1.x = ((r0.wwww)+(r1.xxxx)).x;
    // 75: mad r1.x, r1.x, l(0.333330), -r0.z
    r1.x = ((r1.xxxx)*(float4(0.333330,0.333330,0.333330,0.333330))+(-(r0.zzzz))).x;
    // 76: mad r1.x, cb0[14].y, r1.x, r0.z
    r1.x = ((source[14].yyyy)*(r1.xxxx)+(r0.zzzz)).x;
    // 77: mul_sat r0.z, r0.z, cb0[16].y
    r0.z = (saturate((r0.zzzz)*(source[16].yyyy))).z;
    // 78: mul r1.x, r1.x, cb0[14].z
    r1.x = ((r1.xxxx)*(source[14].zzzz)).x;
    // 79: dp3 r1.y, v6.xyzx, v6.xyzx
    r1.y = (dot((v6.xyzx).xyz,(v6.xyzx).xyz).xxxx).y;
    // 80: rsq r1.y, r1.y
    r1.y = (rsqrt(r1.yyyy)).y;
    // 81: mul r1.yzw, r1.yyyy, v6.xxyz
    r1.yzw = ((r1.yyyy)*(v6.xxyz)).yzw;
    // 82: mad r1.yz, r1.yyzy, l(0.000000, -0.500000, -0.500000, 0.000000), l(0.000000, 0.500000, 0.500000, 0.000000)
    r1.yz = ((r1.yyzy)*(float4(0.000000,-0.500000,-0.500000,0.000000))+(float4(0.000000,0.500000,0.500000,0.000000))).yz;
    // 83: add r1.w, -|r1.w|, l(1.000000)
    r1.w = ((-(abs(r1.wwww)))+(float4(1.000000,1.000000,1.000000,1.000000))).w;
    // 84: mul r1.w, r1.w, r1.w
    r1.w = ((r1.wwww)*(r1.wwww)).w;
    // 85: mad r1.xy, r1.yzyy, cb0[2].xyxx, r1.xxxx
    r1.xy = ((r1.yzyy)*(source[2].xyxx)+(r1.xxxx)).xy;
    // 86: sample_b_indexable(texture2d)(float,float,float,float) r1.xyz, r1.xyxx, t4.xyzw, s4, l(0.000000)
    r1.xyz = (ArtistNativeSample4((r1.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 87: dp3 r2.x, r1.xyzx, l(0.300000, 0.590000, 0.110000, 0.000000)
    r2.x = (dot((r1.xyzx).xyz,(float4(0.300000,0.590000,0.110000,0.000000)).xyz).xxxx).x;
    // 88: add r2.xyz, -r1.xyzx, r2.xxxx
    r2.xyz = ((-(r1.xyzx))+(r2.xxxx)).xyz;
    // 89: mad r1.xyz, cb0[14].wwww, r2.xyzx, r1.xyzx
    r1.xyz = ((source[14].wwww)*(r2.xyzx)+(r1.xyzx)).xyz;
    // 90: max r1.xyz, |r1.xyzx|, l(0.000001, 0.000001, 0.000001, 0.000000)
    r1.xyz = (max(abs(r1.xyzx),float4(0.000001,0.000001,0.000001,0.000000))).xyz;
    // 91: log r1.xyz, r1.xyzx
    r1.xyz = (log2(r1.xyzx)).xyz;
    // 92: mul r1.xyz, r1.xyzx, cb0[15].xxxx
    r1.xyz = ((r1.xyzx)*(source[15].xxxx)).xyz;
    // 93: exp r1.xyz, r1.xyzx
    r1.xyz = (exp2(r1.xyzx)).xyz;
    // 94: mul r2.xyz, cb0[4].xyzx, cb0[4].wwww
    r2.xyz = ((source[4].xyzx)*(source[4].wwww)).xyz;
    // 95: mul r1.xyz, r1.xyzx, r2.xyzx
    r1.xyz = ((r1.xyzx)*(r2.xyzx)).xyz;
    // 96: dp3 r2.x, r0.xywx, l(0.300000, 0.590000, 0.110000, 0.000000)
    r2.x = (dot((r0.xywx).xyz,(float4(0.300000,0.590000,0.110000,0.000000)).xyz).xxxx).x;
    // 97: add r2.xyz, -r0.xywx, r2.xxxx
    r2.xyz = ((-(r0.xywx))+(r2.xxxx)).xyz;
    // 98: mad r0.xyw, cb0[15].yyyy, r2.xyxz, r0.xyxw
    r0.xyw = ((source[15].yyyy)*(r2.xyxz)+(r0.xyxw)).xyw;
    // 99: max r0.xyw, |r0.xyxw|, l(0.000001, 0.000001, 0.000000, 0.000001)
    r0.xyw = (max(abs(r0.xyxw),float4(0.000001,0.000001,0.000000,0.000001))).xyw;
    // 100: log r0.xyw, r0.xyxw
    r0.xyw = (log2(r0.xyxw)).xyw;
    // 101: mul r0.xyw, r0.xyxw, cb0[15].zzzz
    r0.xyw = ((r0.xyxw)*(source[15].zzzz)).xyw;
    // 102: exp r0.xyw, r0.xyxw
    r0.xyw = (exp2(r0.xyxw)).xyw;
    // 103: mul r2.xyz, cb0[5].xyzx, cb0[5].wwww
    r2.xyz = ((source[5].xyzx)*(source[5].wwww)).xyz;
    // 104: mul r0.xyw, r0.xyxw, r2.xyxz
    r0.xyw = ((r0.xyxw)*(r2.xyxz)).xyw;
    // 105: mad r0.xyw, r1.wwww, r1.xyxz, r0.xyxw
    r0.xyw = ((r1.wwww)*(r1.xyxz)+(r0.xyxw)).xyw;
    // 106: add r0.xyw, r0.xyxw, cb0[16].xxxx
    r0.xyw = ((r0.xyxw)+(source[16].xxxx)).xyw;
    // 107: add r0.xyw, r0.xyxw, cb0[1].xyxz
    r0.xyw = ((r0.xyxw)+(source[1].xyxz)).xyw;
    // 108: mad o0.xyz, r0.xywx, v5.wwww, v5.xyzx
    output.xyz = ((r0.xywx)*(v5.wwww)+(v5.xyzx)).xyz;
    // 109: log r0.x, r0.z
    r0.x = (log2(r0.zzzz)).x;
    // 110: lt r0.y, r0.z, l(0.000001)
    r0.y = (asfloat((uint4)((r0.zzzz)<(float4(0.000001,0.000001,0.000001,0.000001))) * 0xffffffffu)).y;
    // 111: mul r0.x, r0.x, cb0[16].z
    r0.x = ((r0.xxxx)*(source[16].zzzz)).x;
    // 112: exp r0.x, r0.x
    r0.x = (exp2(r0.xxxx)).x;
    // 113: min r0.x, r0.x, l(1.000000)
    r0.x = (min(r0.xxxx,float4(1.000000,1.000000,1.000000,1.000000))).x;
    // 114: movc r0.x, r0.y, l(0), r0.x
    r0.x = ((asuint(r0.yyyy) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.xxxx)).x;
    // 115: mov_sat r0.y, v3.z
    r0.y = (saturate(v3.zzzz)).y;
    // 116: add r0.y, -r0.y, l(1.000000)
    r0.y = ((-(r0.yyyy))+(float4(1.000000,1.000000,1.000000,1.000000))).y;
    // 117: add r0.x, -r0.y, r0.x
    r0.x = ((-(r0.yyyy))+(r0.xxxx)).x;
    // 118: max r0.x, r0.x, l(0.000000)
    r0.x = (max(r0.xxxx,float4(0.000000,0.000000,0.000000,0.000000))).x;
    // 119: mul_sat r0.x, r0.x, v3.w
    r0.x = (saturate((r0.xxxx)*(v3.wwww))).x;
    // 120: mul o0.w, r0.x, cb0[0].w
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_m_flowergarden_ringmaster_01_01_tr: b7989ea7e673484daae628018492729f; selected map 71dc4b710bc9dc0d9d420dfdcdb1582bdd996ab5579390272ab9a6fe1902cd7e.
float4 ArtistNative839(ARTIST_NATIVE_INPUT input)
{
    float4 source[17]; [unroll] for (uint i=0u; i<17u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative840(ARTIST_NATIVE_INPUT input)
{
...
float4 ArtistNative841(ARTIST_NATIVE_INPUT input)
{
    float4 source[11]; [unroll] for (uint i=0u; i<11u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_j_pa_litgrass_01_ma: 74c47eb56be67b46ad8739860ef3a6b8; selected map f5e9336763cea61c61e1a7d4ef9e70e3fe21f0ecb7eaf20ded2d381f31252ef8.
float4 ArtistNative842(ARTIST_NATIVE_INPUT input)
{
    ...
    // 9: mul r0.y, r0.y, l(0.150000)
    r0.y = ((r0.yyyy)*(float4(0.150000,0.150000,0.150000,0.150000))).y;
    // 10: mad r0.xy, r0.yyyy, r0.xxxx, v2.xyxx
    r0.xy = ((r0.yyyy)*(r0.xxxx)+(v2.xyxx)).xy;
    // 11: sample_b_indexable(texture2d)(float,float,float,float) r0.xyzw, r0.xyxx, t1.xyzw, s1, l(0.000000)
    r0.xyzw = (ArtistNativeSample1((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyzw;
    // 12: dp3 r1.x, r0.xyzx, l(0.300000, 0.590000, 0.110000, 0.000000)
    r1.x = (dot((r0.xyzx).xyz,(float4(0.300000,0.590000,0.110000,0.000000)).xyz).xxxx).x;
    // 13: add r1.xyz, -r0.xyzx, r1.xxxx
    r1.xyz = ((-(r0.xyzx))+(r1.xxxx)).xyz;
    // 14: mad r0.xyz, r1.xyzx, l(0.330000, 0.330000, 0.330000, 0.000000), r0.xyzx
    r0.xyz = ((r1.xyzx)*(float4(0.330000,0.330000,0.330000,0.000000))+(r0.xyzx)).xyz;
    // 15: mad r0.xyz, v3.xyzx, r0.xyzx, cb0[1].xyzx
    r0.xyz = ((v3.xyzx)*(r0.xyzx)+(source[1].xyzx)).xyz;
    // 16: mad o0.xyz, r0.xyzx, v5.wwww, v5.xyzx
    output.xyz = ((r0.xyzx)*(v5.wwww)+(v5.xyzx)).xyz;
    // 17: mul r0.xy, v2.xyxx, l(5.000000, 1.000000, 0.000000, 0.000000)
    r0.xy = ((v2.xyxx)*(float4(5.000000,1.000000,0.000000,0.000000))).xy;
    // 18: sample_b_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t2.xyzw, s2, l(0.000000)
    r0.x = (ArtistNativeSample2((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).x;
    // 19: add r0.x, r0.x, l(1.000000)
    r0.x = ((r0.xxxx)+(float4(1.000000,1.000000,1.000000,1.000000))).x;
    // 20: add r0.y, -v3.w, l(1.000000)
    r0.y = ((-(v3.wwww))+(float4(1.000000,1.000000,1.000000,1.000000))).y;
    // 21: add r0.x, -r0.y, r0.x
    r0.x = ((-(r0.yyyy))+(r0.xxxx)).x;
    // 22: round_ni r0.x, r0.x
    r0.x = (floor(r0.xxxx)).x;
    // 23: mul r0.x, r0.x, r0.w
    r0.x = ((r0.xxxx)*(r0.wwww)).x;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_m_flowergardenmesh_03_tr: 5d386692bc002444a8ed4c7b9428be25; selected map 2e6d6e85ad00f169d89740830715f0cf7e376d9f05f53faa04e5d3e47c212ff0.
float4 ArtistNative843(ARTIST_NATIVE_INPUT input)
{
    ...
    source[3] = ArtistNativeAppend(ArtistNativeAppend(g_ArtistSourceMaterialParameters[7u].xxxx,g_ArtistSourceMaterialParameters[7u].xxxx,1u),float4(1.0, 0.0, 0.0, 0.0),2u);
    source[4] = ArtistNativeAppend(g_ArtistSourceMaterialParameters[4u].yyyy,g_ArtistSourceMaterialParameters[5u].wwww,1u);
    ...
    source[10].x = (g_ArtistSourceMaterialParameters[4u].zzzz).x;
    source[10].y = ((g_ArtistSourceMaterialParameters[6u].wwww*float4(0.5, 0.0, 0.0, 0.0))).x;
    source[10].z = ((g_ArtistSourceMaterialParameters[2u].zzzz+float4(0.5, 0.0, 0.0, 0.0))).x;
    source[10].w = ((g_ArtistSourceMaterialParameters[7u].yyyy*float4(0.5, 0.0, 0.0, 0.0))).x;
    source[11].x = ((g_ArtistSourceMaterialParameters[4u].zzzz+float4(0.5, 0.0, 0.0, 0.0))).x;
    ...
    source[12].w = (g_ArtistSourceMaterialParameters[8u].wwww).x;
    source[13].x = (g_ArtistSourceMaterialParameters[3u].xxxx).x;
    source[13].y = (g_ArtistSourceMaterialParameters[5u].xxxx).x;
    source[13].z = (g_ArtistSourceMaterialParameters[8u].xxxx).x;
    ...
    source[16].w = (g_ArtistSourceMaterialParameters[4u].wwww).x;
    ...
    r0.x = (min(r0.xxxx,float4(1.000000,1.000000,1.000000,1.000000))).x;
    // 12: mad r0.y, cb0[2].z, cb0[8].y, cb0[8].z
    r0.y = ((source[2].zzzz)*(source[8].yyyy)+(source[8].zzzz)).y;
    // 13: mul r0.zw, v4.xxxy, cb0[9].xxxy
    r0.zw = ((v4.xxxy)*(source[9].xxxy)).zw;
    // 14: mad r0.z, cb0[7].y, cb0[8].w, r0.z
    r0.z = ((source[7].yyyy)*(source[8].wwww)+(r0.zzzz)).z;
    // 15: mad r0.w, cb0[7].y, cb0[9].z, r0.w
    r0.w = ((source[7].yyyy)*(source[9].zzzz)+(r0.wwww)).w;
    // 16: add r1.x, r0.z, r0.y
    r1.x = ((r0.zzzz)+(r0.yyyy)).x;
    // 17: mad r0.y, cb0[2].z, cb0[9].w, cb0[10].x
    r0.y = ((source[2].zzzz)*(source[9].wwww)+(source[10].xxxx)).y;
    // 18: add r1.y, r0.y, r0.w
    r1.y = ((r0.yyyy)+(r0.wwww)).y;
    ...
    // 20: mad r0.y, cb0[2].z, cb0[10].y, cb0[10].z
    r0.y = ((source[2].zzzz)*(source[10].yyyy)+(source[10].zzzz)).y;
    // 21: add r2.x, r0.z, r0.y
    r2.x = ((r0.zzzz)+(r0.yyyy)).x;
    // 22: mad r0.y, cb0[2].z, cb0[10].w, cb0[11].x
    r0.y = ((source[2].zzzz)*(source[10].wwww)+(source[11].xxxx)).y;
    // 23: add r2.y, r0.y, r0.w
    r2.y = ((r0.yyyy)+(r0.wwww)).y;
    // 24: sample_b_indexable(texture2d)(float,float,float,float) r0.yz, r2.xyxx, t0.zxyw, s0, l(0.000000)
    r0.yz = (ArtistNativeSample0((r2.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).zxyw).yz;
    // 25: add r0.yz, r0.yyzy, r1.xxyx
    r0.yz = ((r0.yyzy)+(r1.xxyx)).yz;
    // 26: sample_b_indexable(texture2d)(float,float,float,float) r0.w, v4.xyxx, t1.yzwx, s1, l(0.000000)
    r0.w = (ArtistNativeSample1((v4.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yzwx).w;
    // 27: mul r0.yz, r0.yyzy, r0.wwww
    r0.yz = ((r0.yyzy)*(r0.wwww)).yz;
    // 28: mul r0.yz, r0.yyzy, cb0[2].yyyy
    r0.yz = ((r0.yyzy)*(source[2].yyyy)).yz;
    // 29: mul r0.w, v4.x, cb0[15].w
    r0.w = ((v4.xxxx)*(source[15].wwww)).w;
    // 30: mad r0.w, cb0[7].y, cb0[15].z, r0.w
    r0.w = ((source[7].yyyy)*(source[15].zzzz)+(r0.wwww)).w;
    // 31: add r1.x, r0.w, cb0[16].z
    r1.x = ((r0.wwww)+(source[16].zzzz)).x;
    // 32: mul r0.w, v4.y, cb0[16].x
    r0.w = ((v4.yyyy)*(source[16].xxxx)).w;
    // 33: mad r0.w, cb0[7].y, cb0[16].y, r0.w
    r0.w = ((source[7].yyyy)*(source[16].yyyy)+(r0.wwww)).w;
    // 34: add r1.y, r0.w, cb0[16].w
    r1.y = ((r0.wwww)+(source[16].wwww)).y;
    // 35: mad r1.xy, cb0[15].yyyy, r0.yzyy, r1.xyxx
    r1.xy = ((source[15].yyyy)*(r0.yzyy)+(r1.xyxx)).xy;
    // 36: sample_b_indexable(texture2d)(float,float,float,float) r0.w, r1.xyxx, t3.yzwx, s5, l(0.000000)
    r0.w = (ArtistNativeSample5((r1.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yzwx).w;
    // 37: mul_sat r0.w, r0.w, cb0[17].x
    r0.w = (saturate((r0.wwww)*(source[17].xxxx))).w;
    // 38: max r0.w, r0.w, l(0.000001)
    r0.w = (max(r0.wwww,float4(0.000001,0.000001,0.000001,0.000001))).w;
    // 39: log r0.w, r0.w
    r0.w = (log2(r0.wwww)).w;
    // 40: mul r0.w, r0.w, cb0[17].y
    r0.w = ((r0.wwww)*(source[17].yyyy)).w;
    // 41: exp r0.w, r0.w
    r0.w = (exp2(r0.wwww)).w;
    // 42: mul r0.x, r0.w, r0.x
    r0.x = ((r0.wwww)*(r0.xxxx)).x;
    // 43: min r0.x, r0.x, l(1.000000)
    r0.x = (min(r0.xxxx,float4(1.000000,1.000000,1.000000,1.000000))).x;
    // 44: add r0.x, r0.x, l(-0.166000)
    r0.x = ((r0.xxxx)+(float4(-0.166000,-0.166000,-0.166000,-0.166000))).x;
    // 45: lt r0.x, r0.x, l(0.000000)
    r0.x = (asfloat((uint4)((r0.xxxx)<(float4(0.000000,0.000000,0.000000,0.000000))) * 0xffffffffu)).x;
    // 46: discard_nz r0.x
    if ((asuint(r0.xxxx)).x != 0u) clip(-1.f);
    // 47: mov oMask, vCoverage.x
    // Coverage is owned by the product rasterizer.
    // 48: mad r0.xw, cb0[12].wwww, r0.yyyz, v4.xxxy
    r0.xw = ((source[12].wwww)*(r0.yyyz)+(v4.xxxy)).xw;
    // 49: add r0.xw, r0.xxxw, cb0[13].xxxy
    r0.xw = ((r0.xxxw)+(source[13].xxxy)).xw;
    // 50: sample_b_indexable(texture2d)(float,float,float,float) r1.xyz, r0.xwxx, t4.xyzw, s3, l(0.000000)
    r1.xyz = (ArtistNativeSample3((r0.xwxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 51: dp3 r0.x, r1.xyzx, l(0.300000, 0.590000, 0.110000, 0.000000)
    r0.x = (dot((r1.xyzx).xyz,(float4(0.300000,0.590000,0.110000,0.000000)).xyz).xxxx).x;
    // 52: add r2.xyz, -r1.xyzx, r0.xxxx
    r2.xyz = ((-(r1.xyzx))+(r0.xxxx)).xyz;
    // 53: mad r1.xyz, cb0[13].zzzz, r2.xyzx, r1.xyzx
    ...
    r1.xyz = (log2(r1.xyzx)).xyz;
    // 56: mul r1.xyz, r1.xyzx, cb0[13].wwww
    r1.xyz = ((r1.xyzx)*(source[13].wwww)).xyz;
    // 57: exp r1.xyz, r1.xyzx
    r1.xyz = (exp2(r1.xyzx)).xyz;
    // 58: mul r0.xw, v4.xxxy, cb0[7].zzzw
    r0.xw = ((v4.xxxy)*(source[7].zzzw)).xw;
    // 59: mad r2.x, cb0[7].y, cb0[7].x, r0.x
    r2.x = ((source[7].yyyy)*(source[7].xxxx)+(r0.xxxx)).x;
    // 60: mad r2.y, cb0[7].y, cb0[8].x, r0.w
    r2.y = ((source[7].yyyy)*(source[8].xxxx)+(r0.wwww)).y;
    // 61: mad r0.xy, cb0[11].yyyy, r0.yzyy, r2.xyxx
    r0.xy = ((source[11].yyyy)*(r0.yzyy)+(r2.xyxx)).xy;
    // 62: add r0.xy, r0.xyxx, cb0[11].zwzz
    r0.xy = ((r0.xyxx)+(source[11].zwzz)).xy;
    // 63: sample_b_indexable(texture2d)(float,float,float,float) r0.xyz, r0.xyxx, t2.xyzw, s2, l(0.000000)
    r0.xyz = (ArtistNativeSample2((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 64: mul r0.xyz, r0.xyzx, cb0[3].xyzx
    r0.xyz = ((r0.xyzx)*(source[3].xyzx)).xyz;
    // 65: mul r2.xyz, cb0[5].xyzx, cb0[5].wwww
    r2.xyz = ((source[5].xyzx)*(source[5].wwww)).xyz;
    // 66: mad r3.xy, r1.xyxx, r2.xyxx, r0.xyxx
    r3.xy = ((r1.xyxx)*(r2.xyxx)+(r0.xyxx)).xy;
    // 67: mul r1.xyz, r1.xyzx, r2.xyzx
    r1.xyz = ((r1.xyzx)*(r2.xyzx)).xyz;
    // 68: mul r2.xy, r3.xyxx, cb0[14].xxxx
    r2.xy = ((r3.xyxx)*(source[14].xxxx)).xy;
    // 69: dp3 r0.w, v5.xyzx, v5.xyzx
    r0.w = (dot((v5.xyzx).xyz,(v5.xyzx).xyz).xxxx).w;
    // 70: rsq r0.w, r0.w
    r0.w = (rsqrt(r0.wwww)).w;
    // 71: mul r2.zw, r0.wwww, v5.xxxy
    r2.zw = ((r0.wwww)*(v5.xxxy)).zw;
    // 72: mad r2.xy, r2.zwzz, cb0[4].xyxx, r2.xyxx
    r2.xy = ((r2.zwzz)*(source[4].xyxx)+(r2.xyxx)).xy;
    // 73: sample_b_indexable(texture2d)(float,float,float,float) r2.xyz, r2.xyxx, t5.xyzw, s4, l(0.000000)
    r2.xyz = (ArtistNativeSample4((r2.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 74: dp3 r0.w, r2.xyzx, l(0.300000, 0.590000, 0.110000, 0.000000)
    r0.w = (dot((r2.xyzx).xyz,(float4(0.300000,0.590000,0.110000,0.000000)).xyz).xxxx).w;
    // 75: add r3.xyz, -r2.xyzx, r0.wwww
    r3.xyz = ((-(r2.xyzx))+(r0.wwww)).xyz;
    // 76: mad r2.xyz, cb0[14].yyyy, r3.xyzx, r2.xyzx
    r2.xyz = ((source[14].yyyy)*(r3.xyzx)+(r2.xyzx)).xyz;
    // 77: max r2.xyz, |r2.xyzx|, l(0.000001, 0.000001, 0.000001, 0.000000)
    r2.xyz = (max(abs(r2.xyzx),float4(0.000001,0.000001,0.000001,0.000000))).xyz;
    // 78: log r2.xyz, r2.xyzx
    r2.xyz = (log2(r2.xyzx)).xyz;
    // 79: mul r2.xyz, r2.xyzx, cb0[14].zzzz
    r2.xyz = ((r2.xyzx)*(source[14].zzzz)).xyz;
    // 80: exp r2.xyz, r2.xyzx
    r2.xyz = (exp2(r2.xyzx)).xyz;
    // 81: mul r2.xyz, r2.xyzx, cb0[6].xyzx
    r2.xyz = ((r2.xyzx)*(source[6].xyzx)).xyz;
    // 82: dp3 r0.w, v1.xyzx, v1.xyzx
    r0.w = (dot((v1.xyzx).xyz,(v1.xyzx).xyz).xxxx).w;
    // 83: rsq r0.w, r0.w
    r0.w = (rsqrt(r0.wwww)).w;
    // 84: mad r1.w, v1.z, r0.w, l(1.000000)
    r1.w = ((v1.zzzz)*(r0.wwww)+(float4(1.000000,1.000000,1.000000,1.000000))).w;
    // 85: mul r3.xyz, r0.wwww, v1.xyzx
    r3.xyz = ((r0.wwww)*(v1.xyzx)).xyz;
    // 86: mul_sat r0.w, r1.w, l(0.500000)
    r0.w = (saturate((r1.wwww)*(float4(0.500000,0.500000,0.500000,0.500000)))).w;
    // 87: mad r0.w, r0.w, l(0.950000), l(0.050000)
    r0.w = ((r0.wwww)*(float4(0.950000,0.950000,0.950000,0.950000))+(float4(0.050000,0.050000,0.050000,0.050000))).w;
    // 88: dp3 r0.w, r0.xyzx, r0.wwww
    r0.w = (dot((r0.xyzx).xyz,(r0.wwww).xyz).xxxx).w;
    // 89: log r1.w, |r0.w|
    r1.w = (log2(abs(r0.wwww))).w;
    // 90: lt r0.w, |r0.w|, l(0.000001)
    r0.w = (asfloat((uint4)((abs(r0.wwww))<(float4(0.000001,0.000001,0.000001,0.000001))) * 0xffffffffu)).w;
    // 91: mul r1.w, r1.w, cb0[14].w
    r1.w = ((r1.wwww)*(source[14].wwww)).w;
    // 92: exp r1.w, r1.w
    r1.w = (exp2(r1.wwww)).w;
    // 93: mul r1.w, r1.w, cb0[15].x
    r1.w = ((r1.wwww)*(source[15].xxxx)).w;
    // 94: movc r0.w, r0.w, l(0), r1.w
    r0.w = ((asuint(r0.wwww) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r1.wwww)).w;
    // 95: mad r1.xyz, r0.wwww, r2.xyzx, r1.xyzx
    r1.xyz = ((r0.wwww)*(r2.xyzx)+(r1.xyzx)).xyz;
    // 96: mul r1.xyz, r0.wwww, r1.xyzx
    r1.xyz = ((r0.wwww)*(r1.xyzx)).xyz;
    // 97: mad o0.xyz, r1.xyzx, cb0[0].xyzx, cb0[1].xyzx
    output.xyz = ((r1.xyzx)*(source[0].xyzx)+(source[1].xyzx)).xyz;
    // 98: mov o0.w, l(0)
    output.w = (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))).w;
    return output;
}
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_m_flowergardenmesh_02_tr: 5d386692bc002444a8ed4c7b9428be25; selected map 2e6d6e85ad00f169d89740830715f0cf7e376d9f05f53faa04e5d3e47c212ff0.
float4 ArtistNative844(ARTIST_NATIVE_INPUT input)
{
    float4 source[18]; [unroll] for (uint i=0u; i<18u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_m_flowergardenmesh_01_tr: 225d08ca81649a4c87a563652da10de0; selected map d85e1abe8c7dfb36a397b7361b7ab166260154d1db98ec49d2711b268c0e4484.
float4 ArtistNative845(ARTIST_NATIVE_INPUT input)
{
    float4 source[17]; [unroll] for (uint i=0u; i<17u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    source[2] = input.dynamicParameter;
    source[3] = ArtistNativeAppend(ArtistNativeAppend(g_ArtistSourceMaterialParameters[6u].zzzz,g_ArtistSourceMaterialParameters[6u].zzzz,1u),float4(1.0, 0.0, 0.0, 0.0),2u);
    source[4] = ArtistNativeAppend(g_ArtistSourceMaterialParameters[4u].xxxx,g_ArtistSourceMaterialParameters[5u].zzzz,1u);
    source[5] = g_ArtistSourceMaterialParameters[10u];
    ...
    source[8].y = (g_ArtistSourceMaterialParameters[6u].yyyy).x;
    source[8].z = (g_ArtistSourceMaterialParameters[2u].zzzz).x;
    source[8].w = (g_ArtistSourceMaterialParameters[0u].wwww).x;
    source[9].x = (g_ArtistSourceMaterialParameters[1u].xxxx).x;
    source[9].y = (g_ArtistSourceMaterialParameters[2u].xxxx).x;
    ...
    source[10].y = ((g_ArtistSourceMaterialParameters[6u].yyyy*float4(0.5, 0.0, 0.0, 0.0))).x;
    source[10].z = ((g_ArtistSourceMaterialParameters[2u].zzzz+float4(0.5, 0.0, 0.0, 0.0))).x;
    source[10].w = ((g_ArtistSourceMaterialParameters[6u].wwww*float4(0.5, 0.0, 0.0, 0.0))).x;
    source[11].x = ((g_ArtistSourceMaterialParameters[4u].yyyy+float4(0.5, 0.0, 0.0, 0.0))).x;
    ...
    source[16].w = (g_ArtistSourceMaterialParameters[7u].yyyy).x;
    float4 passValues[4]={float4(.5f,-.5f,.5f,.5f),float4(0.f,0.f,0.f,0.f),float4(0.f,0.f,0.f,0.f),float4(0.f,0.f,0.f,0.f)};
    float4 v0 = float4(input.sourceBasisX,0.f); // native texcoord10
    float4 v1 = float4(input.sourceBasisZ,input.handedness); // native texcoord11
    float4 v2 = input.vertexColor; // native color0
    ...
    // 28: mul r0.yz, r0.yyzy, cb0[2].yyyy
    r0.yz = ((r0.yyzy)*(source[2].yyyy)).yz;
    // 29: mul r1.xy, v4.xyxx, cb0[15].yzyy
    r1.xy = ((v4.xyxx)*(source[15].yzyy)).xy;
    // 30: mad r1.xy, cb0[7].yyyy, cb0[15].xwxx, r1.xyxx
    r1.xy = ((source[7].yyyy)*(source[15].xwxx)+(r1.xyxx)).xy;
    // 31: add r1.xy, r1.xyxx, cb0[16].xyxx
    r1.xy = ((r1.xyxx)+(source[16].xyxx)).xy;
    // 32: mad r1.xy, cb0[14].wwww, r0.yzyy, r1.xyxx
    r1.xy = ((source[14].wwww)*(r0.yzyy)+(r1.xyxx)).xy;
    // 33: sample_b_indexable(texture2d)(float,float,float,float) r0.w, r1.xyxx, t3.yzwx, s5, l(0.000000)
    r0.w = (ArtistNativeSample5((r1.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yzwx).w;
    // 34: mul_sat r0.w, r0.w, cb0[16].z
    r0.w = (saturate((r0.wwww)*(source[16].zzzz))).w;
    // 35: max r0.w, r0.w, l(0.000001)
    r0.w = (max(r0.wwww,float4(0.000001,0.000001,0.000001,0.000001))).w;
    // 36: log r0.w, r0.w
    r0.w = (log2(r0.wwww)).w;
    // 37: mul r0.w, r0.w, cb0[16].w
    r0.w = ((r0.wwww)*(source[16].wwww)).w;
    // 38: exp r0.w, r0.w
    r0.w = (exp2(r0.wwww)).w;
    // 39: mul r0.x, r0.w, r0.x
    r0.x = ((r0.wwww)*(r0.xxxx)).x;
    // 40: min r0.x, r0.x, l(1.000000)
    r0.x = (min(r0.xxxx,float4(1.000000,1.000000,1.000000,1.000000))).x;
    // 41: add r0.x, r0.x, l(-0.166000)
    r0.x = ((r0.xxxx)+(float4(-0.166000,-0.166000,-0.166000,-0.166000))).x;
    // 42: lt r0.x, r0.x, l(0.000000)
    r0.x = (asfloat((uint4)((r0.xxxx)<(float4(0.000000,0.000000,0.000000,0.000000))) * 0xffffffffu)).x;
    // 43: discard_nz r0.x
    if ((asuint(r0.xxxx)).x != 0u) clip(-1.f);
    // 44: mov oMask, vCoverage.x
    // Coverage is owned by the product rasterizer.
    // 45: mad r0.xw, cb0[12].wwww, r0.yyyz, v4.xxxy
    r0.xw = ((source[12].wwww)*(r0.yyyz)+(v4.xxxy)).xw;
    // 46: add r0.xw, r0.xxxw, cb0[13].xxxy
    r0.xw = ((r0.xxxw)+(source[13].xxxy)).xw;
    // 47: sample_b_indexable(texture2d)(float,float,float,float) r1.xyz, r0.xwxx, t4.xyzw, s3, l(0.000000)
    r1.xyz = (ArtistNativeSample3((r0.xwxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 48: dp3 r0.x, r1.xyzx, l(0.300000, 0.590000, 0.110000, 0.000000)
    r0.x = (dot((r1.xyzx).xyz,(float4(0.300000,0.590000,0.110000,0.000000)).xyz).xxxx).x;
    // 49: add r2.xyz, -r1.xyzx, r0.xxxx
    r2.xyz = ((-(r1.xyzx))+(r0.xxxx)).xyz;
    // 50: mad r1.xyz, cb0[13].zzzz, r2.xyzx, r1.xyzx
    r1.xyz = ((source[13].zzzz)*(r2.xyzx)+(r1.xyzx)).xyz;
    // 51: max r1.xyz, |r1.xyzx|, l(0.000001, 0.000001, 0.000001, 0.000000)
    r1.xyz = (max(abs(r1.xyzx),float4(0.000001,0.000001,0.000001,0.000000))).xyz;
    // 52: log r1.xyz, r1.xyzx
    r1.xyz = (log2(r1.xyzx)).xyz;
    // 53: mul r1.xyz, r1.xyzx, cb0[13].wwww
    r1.xyz = ((r1.xyzx)*(source[13].wwww)).xyz;
    ...
    r1.xyz = ((r1.xyzx)*(r2.xyzx)).xyz;
    // 57: mul r0.xw, v4.xxxy, cb0[7].zzzw
    r0.xw = ((v4.xxxy)*(source[7].zzzw)).xw;
    // 58: mad r2.x, cb0[7].y, cb0[7].x, r0.x
    r2.x = ((source[7].yyyy)*(source[7].xxxx)+(r0.xxxx)).x;
    // 59: mad r2.y, cb0[7].y, cb0[8].x, r0.w
    r2.y = ((source[7].yyyy)*(source[8].xxxx)+(r0.wwww)).y;
    // 60: mad r0.xy, cb0[11].yyyy, r0.yzyy, r2.xyxx
    r0.xy = ((source[11].yyyy)*(r0.yzyy)+(r2.xyxx)).xy;
    // 61: add r0.xy, r0.xyxx, cb0[11].zwzz
    r0.xy = ((r0.xyxx)+(source[11].zwzz)).xy;
    // 62: sample_b_indexable(texture2d)(float,float,float,float) r0.xyz, r0.xyxx, t2.xyzw, s2, l(0.000000)
    r0.xyz = (ArtistNativeSample2((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 63: mad r2.xy, r0.xyxx, cb0[3].xyxx, r1.xyxx
    r2.xy = ((r0.xyxx)*(source[3].xyxx)+(r1.xyxx)).xy;
    // 64: mul r0.xyz, r0.xyzx, cb0[3].xyzx
    r0.xyz = ((r0.xyzx)*(source[3].xyzx)).xyz;
    // 65: mul r2.xy, r2.xyxx, cb0[14].xxxx
    r2.xy = ((r2.xyxx)*(source[14].xxxx)).xy;
    // 66: dp3 r0.w, v5.xyzx, v5.xyzx
    r0.w = (dot((v5.xyzx).xyz,(v5.xyzx).xyz).xxxx).w;
    // 67: rsq r0.w, r0.w
    r0.w = (rsqrt(r0.wwww)).w;
    // 68: mul r2.zw, r0.wwww, v5.xxxy
    r2.zw = ((r0.wwww)*(v5.xxxy)).zw;
    // 69: mad r2.xy, r2.zwzz, cb0[4].xyxx, r2.xyxx
    r2.xy = ((r2.zwzz)*(source[4].xyxx)+(r2.xyxx)).xy;
    // 70: sample_b_indexable(texture2d)(float,float,float,float) r2.xyz, r2.xyxx, t5.xyzw, s4, l(0.000000)
    r2.xyz = (ArtistNativeSample4((r2.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 71: dp3 r0.w, r2.xyzx, l(0.300000, 0.590000, 0.110000, 0.000000)
    r0.w = (dot((r2.xyzx).xyz,(float4(0.300000,0.590000,0.110000,0.000000)).xyz).xxxx).w;
    // 72: add r3.xyz, -r2.xyzx, r0.wwww
    r3.xyz = ((-(r2.xyzx))+(r0.wwww)).xyz;
    // 73: mad r2.xyz, cb0[14].yyyy, r3.xyzx, r2.xyzx
    r2.xyz = ((source[14].yyyy)*(r3.xyzx)+(r2.xyzx)).xyz;
    // 74: max r2.xyz, |r2.xyzx|, l(0.000001, 0.000001, 0.000001, 0.000000)
    r2.xyz = (max(abs(r2.xyzx),float4(0.000001,0.000001,0.000001,0.000000))).xyz;
    // 75: log r2.xyz, r2.xyzx
    r2.xyz = (log2(r2.xyzx)).xyz;
    // 76: mul r2.xyz, r2.xyzx, cb0[14].zzzz
    r2.xyz = ((r2.xyzx)*(source[14].zzzz)).xyz;
    // 77: exp r2.xyz, r2.xyzx
    r2.xyz = (exp2(r2.xyzx)).xyz;
    // 78: mad r1.xyz, r2.xyzx, cb0[6].xyzx, r1.xyzx
    r1.xyz = ((r2.xyzx)*(source[6].xyzx)+(r1.xyzx)).xyz;
    // 79: mad o0.xyz, r1.xyzx, cb0[0].xyzx, cb0[1].xyzx
    output.xyz = ((r1.xyzx)*(source[0].xyzx)+(source[1].xyzx)).xyz;
    // 80: mov o0.w, l(0)
    output.w = (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))).w;
    return output;
...
float4 ArtistNative846(ARTIST_NATIVE_INPUT input)
{
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_m_me_flowergarden_shine_02_04_dt_ad: 7fb05a9ed54248449227988af84f9fe7; selected map 85c62aa2d1c26a6c42fbb3d795e7de6320171af328711625a273edd8f64f88f8.
float4 ArtistNative847(ARTIST_NATIVE_INPUT input)
{
    ...
    // 40: mul r1.x, r1.y, r1.x
    r1.x = ((r1.yyyy)*(r1.xxxx)).x;
    // 41: mul r1.yz, r0.zzwz, cb0[6].zzwz
    r1.yz = ((r0.zzwz)*(source[6].zzwz)).yz;
    // 42: mul r0.zw, r0.zzzw, cb0[8].xxxy
    r0.zw = ((r0.zzzw)*(source[8].xxxy)).zw;
    // 43: mad r2.x, cb0[6].y, cb0[6].x, r1.y
    r2.x = ((source[6].yyyy)*(source[6].xxxx)+(r1.yyyy)).x;
    // 44: mad r2.y, cb0[6].y, cb0[7].z, r1.z
    r2.y = ((source[6].yyyy)*(source[7].zzzz)+(r1.zzzz)).y;
    // 45: sample_b_indexable(texture2d)(float,float,float,float) r1.yzw, r2.xyxx, t0.wxyz, s1, l(0.000000)
    r1.yzw = (ArtistNativeSample0((r2.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).wxyz).yzw;
    // 46: mad r2.x, cb0[6].y, cb0[7].w, r0.z
    r2.x = ((source[6].yyyy)*(source[7].wwww)+(r0.zzzz)).x;
    // 47: mad r2.y, cb0[6].y, cb0[8].z, r0.w
    r2.y = ((source[6].yyyy)*(source[8].zzzz)+(r0.wwww)).y;
    // 48: sample_b_indexable(texture2d)(float,float,float,float) r2.xyz, r2.xyxx, t1.xyzw, s2, l(0.000000)
    r2.xyz = (ArtistNativeSample1((r2.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 49: add r2.xyzw, r1.yyzw, r2.xxyz
    r2.xyzw = ((r1.yyzw)+(r2.xxyz)).xyzw;
    // 50: mul r0.z, r2.x, l(0.500000)
    r0.z = ((r2.xxxx)*(float4(0.500000,0.500000,0.500000,0.500000))).z;
    // 51: log r0.w, |r0.z|
    r0.w = (log2(abs(r0.zzzz))).w;
    // 52: lt r0.yz, |r0.yyzy|, l(0.000000, 0.000001, 0.000001, 0.000000)
    r0.yz = (asfloat((uint4)((abs(r0.yyzy))<(float4(0.000000,0.000001,0.000001,0.000000))) * 0xffffffffu)).yz;
    // 53: mul r0.w, r0.w, cb0[10].x
    r0.w = ((r0.wwww)*(source[10].xxxx)).w;
    // 54: exp r0.w, r0.w
    r0.w = (exp2(r0.wwww)).w;
    // 55: mul r0.w, r0.w, cb0[10].y
    r0.w = ((r0.wwww)*(source[10].yyyy)).w;
    // 56: movc r0.z, r0.z, l(0), r0.w
    r0.z = ((asuint(r0.zzzz) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.wwww)).z;
    // 57: mul_sat r0.z, r0.z, r1.x
    ...
    r0.x = ((asuint(r0.yyyy) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.xxxx)).x;
    // 62: dp3 r0.y, r2.yzwy, l(0.300000, 0.590000, 0.110000, 0.000000)
    r0.y = (dot((r2.yzwy).xyz,(float4(0.300000,0.590000,0.110000,0.000000)).xyz).xxxx).y;
    // 63: add r0.yzw, -r2.yyzw, r0.yyyy
    r0.yzw = ((-(r2.yyzw))+(r0.yyyy)).yzw;
    // 64: mad r0.yzw, cb0[8].wwww, r0.yyzw, r2.yyzw
    r0.yzw = ((source[8].wwww)*(r0.yyzw)+(r2.yyzw)).yzw;
    // 65: mul r1.xyz, cb0[5].xyzx, cb0[5].wwww
    r1.xyz = ((source[5].xyzx)*(source[5].wwww)).xyz;
    // 66: mul r0.yzw, r0.yyzw, r1.xxyz
    r0.yzw = ((r0.yyzw)*(r1.xxyz)).yzw;
    // 67: mad r0.yzw, r0.yyzw, cb0[1].xxyz, cb0[2].xxyz
    r0.yzw = ((r0.yyzw)*(source[1].xxyz)+(source[2].xxyz)).yzw;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_m_flowergarden_01_tr: 054e38e2ddc27546b58e198e0a71a2d6; selected map 4d9076570f0d5e4062ddb0d788b54e5ecfea91a21fc14149b0f4c0174eaa0f3e.
float4 ArtistNative848(ARTIST_NATIVE_INPUT input)
{
    float4 source[17]; [unroll] for (uint i=0u; i<17u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    source[4].y = (g_ArtistSourceMaterialParameters[9u].zzzz).x;
    source[4].z = (g_ArtistSourceMaterialParameters[5u].xxxx).x;
    source[4].w = (g_ArtistSourceMaterialParameters[5u].wwww).x;
    source[5].x = (g_ArtistSourceMaterialTime.xxxx).x;
    source[5].y = ((g_ArtistSourceMaterialTime.xxxx*g_ArtistSourceMaterialParameters[5u].wwww)).x;
    ...
    source[6].w = ((g_ArtistSourceMaterialParameters[5u].zzzz*g_ArtistSourceMaterialTime.xxxx)).x;
    source[7].x = (g_ArtistSourceMaterialParameters[7u].zzzz).x;
    source[7].y = (g_ArtistSourceMaterialParameters[2u].wwww).x;
    source[7].z = (g_ArtistSourceMaterialParameters[9u].wwww).x;
    ...
    source[9].y = (g_ArtistSourceMaterialParameters[11u].xxxx).x;
    source[9].z = (g_ArtistSourceMaterialParameters[10u].zzzz).x;
    source[9].w = (g_ArtistSourceMaterialParameters[1u].zzzz).x;
    source[10].x = (g_ArtistSourceMaterialParameters[9u].xxxx).x;
    source[10].y = (g_ArtistSourceMaterialParameters[4u].zzzz).x;
    source[10].z = (g_ArtistSourceMaterialParameters[6u].xxxx).x;
    source[10].w = (g_ArtistSourceMaterialParameters[8u].xxxx).x;
    ...
    source[12].x = (g_ArtistSourceMaterialParameters[11u].yyyy).x;
    ...
    source[14].y = (g_ArtistSourceMaterialParameters[10u].yyyy).x;
    source[14].z = (g_ArtistSourceMaterialParameters[11u].zzzz).x;
    source[14].w = (g_ArtistSourceMaterialParameters[3u].zzzz).x;
    source[15].x = (g_ArtistSourceMaterialParameters[4u].yyyy).x;
    source[15].y = (g_ArtistSourceMaterialParameters[10u].wwww).x;
    ...
    // 10: mad r0.z, cb0[3].x, cb0[10].x, cb0[10].y
    r0.z = ((source[3].xxxx)*(source[10].xxxx)+(source[10].yyyy)).z;
    // 11: mad r0.z, v4.y, cb0[9].w, r0.z
    r0.z = ((v4.yyyy)*(source[9].wwww)+(r0.zzzz)).z;
    // 12: mad r0.w, cb0[3].x, cb0[10].w, cb0[11].x
    r0.w = ((source[3].xxxx)*(source[10].wwww)+(source[11].xxxx)).w;
    // 13: mad r0.w, cb0[11].y, v4.x, r0.w
    r0.w = ((source[11].yyyy)*(v4.xxxx)+(r0.wwww)).w;
    // 14: mad r1.x, cb0[10].z, r0.z, r0.w
    r1.x = ((source[10].zzzz)*(r0.zzzz)+(r0.wwww)).x;
    // 15: mad r1.y, r0.w, cb0[11].z, r0.z
    r1.y = ((r0.wwww)*(source[11].zzzz)+(r0.zzzz)).y;
    // 16: mad r0.zw, cb0[11].wwww, r0.xxxy, r1.xxxy
    r0.zw = ((source[11].wwww)*(r0.xxxy)+(r1.xxxy)).zw;
    // 17: sample_b_indexable(texture2d)(float,float,float,float) r1.xyz, r0.zwzz, t1.xyzw, s3, l(0.000000)
    r1.xyz = (ArtistNativeSample2((r0.zwzz).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 18: mul r1.xyzw, r1.xxyz, cb0[12].xxxx
    r1.xyzw = ((r1.xxyz)*(source[12].xxxx)).xyzw;
    // 19: mad r0.z, cb0[3].x, cb0[12].z, cb0[12].w
    r0.z = ((source[3].xxxx)*(source[12].zzzz)+(source[12].wwww)).z;
    // 20: mad r0.z, v4.y, cb0[12].y, r0.z
    r0.z = ((v4.yyyy)*(source[12].yyyy)+(r0.zzzz)).z;
    // 21: mad r0.w, cb0[3].x, cb0[13].y, cb0[13].z
    r0.w = ((source[3].xxxx)*(source[13].yyyy)+(source[13].zzzz)).w;
    // 22: mad r0.w, cb0[13].w, v4.x, r0.w
    r0.w = ((source[13].wwww)*(v4.xxxx)+(r0.wwww)).w;
    // 23: mad r2.x, cb0[13].x, r0.z, r0.w
    r2.x = ((source[13].xxxx)*(r0.zzzz)+(r0.wwww)).x;
    // 24: mad r2.y, r0.w, cb0[14].x, r0.z
    r2.y = ((r0.wwww)*(source[14].xxxx)+(r0.zzzz)).y;
    // 25: mad r0.zw, cb0[14].yyyy, r0.xxxy, r2.xxxy
    r0.zw = ((source[14].yyyy)*(r0.xxxy)+(r2.xxxy)).zw;
    // 26: sample_b_indexable(texture2d)(float,float,float,float) r2.xyz, r0.zwzz, t2.xyzw, s4, l(0.000000)
    r2.xyz = (ArtistNativeSample3((r0.zwzz).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 27: mul r2.xyzw, r2.xxyz, cb0[14].zzzz
    r2.xyzw = ((r2.xxyz)*(source[14].zzzz)).xyzw;
    // 28: mul r1.xyzw, r1.xyzw, r2.xyzw
    r1.xyzw = ((r1.xyzw)*(r2.xyzw)).xyzw;
    // 29: max r1.xyzw, |r1.xyzw|, l(0.000001, 0.000001, 0.000001, 0.000001)
    r1.xyzw = (max(abs(r1.xyzw),float4(0.000001,0.000001,0.000001,0.000001))).xyzw;
    // 30: log r1.xyzw, r1.xyzw
    r1.xyzw = (log2(r1.xyzw)).xyzw;
    // 31: mul r0.z, cb0[3].w, cb0[14].w
    r0.z = ((source[3].wwww)*(source[14].wwww)).z;
    // 32: mul r1.xyzw, r1.xyzw, r0.zzzz
    r1.xyzw = ((r1.xyzw)*(r0.zzzz)).xyzw;
    // 33: exp r1.xyzw, r1.xyzw
    r1.xyzw = (exp2(r1.xyzw)).xyzw;
    // 34: mul_sat r1.xyzw, r1.xyzw, cb0[15].xxxx
    r1.xyzw = (saturate((r1.xyzw)*(source[15].xxxx))).xyzw;
    // 35: mad r0.z, cb0[3].x, cb0[4].y, cb0[4].z
    r0.z = ((source[3].xxxx)*(source[4].yyyy)+(source[4].zzzz)).z;
    // 36: mad r0.z, v4.y, cb0[4].x, r0.z
    r0.z = ((v4.yyyy)*(source[4].xxxx)+(r0.zzzz)).z;
    // 37: add r0.z, r0.z, cb0[5].y
    r0.z = ((r0.zzzz)+(source[5].yyyy)).z;
    // 38: mad r0.w, cb0[3].x, cb0[6].x, cb0[6].y
    r0.w = ((source[3].xxxx)*(source[6].xxxx)+(source[6].yyyy)).w;
    // 39: mad r0.w, cb0[6].z, v4.x, r0.w
    r0.w = ((source[6].zzzz)*(v4.xxxx)+(r0.wwww)).w;
    // 40: add r0.w, r0.w, cb0[6].w
    r0.w = ((r0.wwww)+(source[6].wwww)).w;
    // 41: mad r2.x, cb0[5].z, r0.z, r0.w
    r2.x = ((source[5].zzzz)*(r0.zzzz)+(r0.wwww)).x;
    // 42: mad r2.y, r0.w, cb0[7].x, r0.z
    r2.y = ((r0.wwww)*(source[7].xxxx)+(r0.zzzz)).y;
    // 43: mad r0.xy, cb0[9].zzzz, r0.xyxx, r2.xyxx
    r0.xy = ((source[9].zzzz)*(r0.xyxx)+(r2.xyxx)).xy;
    // 44: sample_b_indexable(texture2d)(float,float,float,float) r0.xyz, r0.xyxx, t4.xyzw, s2, l(0.000000)
    r0.xyz = (ArtistNativeSample1((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 45: mul r2.xyz, r1.yzwy, r0.xyzx
    r2.xyz = ((r1.yzwy)*(r0.xyzx)).xyz;
    // 46: dp3 r0.w, r2.xyzx, l(0.300000, 0.590000, 0.110000, 0.000000)
    r0.w = (dot((r2.xyzx).xyz,(float4(0.300000,0.590000,0.110000,0.000000)).xyz).xxxx).w;
    // 47: mad r0.xyz, -r0.xyzx, r1.yzwy, r0.wwww
    r0.xyz = ((-(r0.xyzx))*(r1.yzwy)+(r0.wwww)).xyz;
    // 48: mad r0.xyz, cb0[15].yyyy, r0.xyzx, r2.xyzx
    r0.xyz = ((source[15].yyyy)*(r0.xyzx)+(r2.xyzx)).xyz;
    // 49: max r0.xyz, |r0.xyzx|, l(0.000001, 0.000001, 0.000001, 0.000000)
    r0.xyz = (max(abs(r0.xyzx),float4(0.000001,0.000001,0.000001,0.000000))).xyz;
    // 50: log r0.xyz, r0.xyzx
    r0.xyz = (log2(r0.xyzx)).xyz;
    // 51: mul r0.xyz, r0.xyzx, cb0[15].zzzz
    r0.xyz = ((r0.xyzx)*(source[15].zzzz)).xyz;
    // 52: exp r0.xyz, r0.xyzx
    r0.xyz = (exp2(r0.xyzx)).xyz;
    // 53: mad r0.xyz, cb0[15].wwww, r0.xyzx, cb0[16].xxxx
    r0.xyz = ((source[15].wwww)*(r0.xyzx)+(source[16].xxxx)).xyz;
    // 54: mad r0.xyz, r0.xyzx, cb0[1].xyzx, cb0[2].xyzx
    r0.xyz = ((r0.xyzx)*(source[1].xyzx)+(source[2].xyzx)).xyz;
    // 55: mad o0.xyz, r0.xyzx, v5.wwww, v5.xyzx
    output.xyz = ((r0.xyzx)*(v5.wwww)+(v5.xyzx)).xyz;
    // 56: div r0.xy, v7.xyxx, v7.wwww
    r0.xy = ((v7.xyxx)/(v7.wwww)).xy;
    // 57: mad r0.xy, r0.xyxx, cb2[0].xyxx, cb2[0].wzww
    r0.xy = ((r0.xyxx)*(passValues[0].xyxx)+(passValues[0].wzww)).xy;
    ...
    r0.x = r0.x;
    // 64: add r0.x, r0.x, -v7.w
    r0.x = ((r0.xxxx)+(-(v7.wwww))).x;
    // 65: add r0.y, -cb0[16].y, l(1.000000)
    r0.y = ((-(source[16].yyyy))+(float4(1.000000,1.000000,1.000000,1.000000))).y;
    // 66: max r0.y, r0.y, l(0.001000)
    r0.y = (max(r0.yyyy,float4(0.001000,0.001000,0.001000,0.001000))).y;
    // 67: div_sat r0.x, r0.x, r0.y
    r0.x = (saturate((r0.xxxx)/(r0.yyyy))).x;
    // 68: mul r0.x, r0.x, r1.x
    r0.x = ((r0.xxxx)*(r1.xxxx)).x;
    // 69: mul_sat r0.x, r0.x, cb0[1].w
    r0.x = (saturate((r0.xxxx)*(source[1].wwww))).x;
    // 70: mul o0.w, r0.x, cb0[0].x
    output.w = ((r0.xxxx)*(source[0].xxxx)).w;
    return output;
}
#endif
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_m_me_master_01_343_ts_dt_tr: 5ab408241d6bd8498deeae8fe104b344; selected map 4dfe9bde32a230cf36662f5a4d2050944e751f000e8db218b5f16f12e42e094a.
float4 ArtistNative849(ARTIST_NATIVE_INPUT input)
{
    float4 source[14]; [unroll] for (uint i=0u; i<14u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    source[8].y = ((float4(1.0, 0.0, 0.0, 0.0)*g_ArtistSourceMaterialParameters[1u].zzzz)).x;
    ...
    source[11].w = ((float4(-0.523599029, 0.0, 0.0, 0.0)*g_ArtistSourceMaterialParameters[5u].xxxx)).x;
    ...
    // 23: add r0.y, cb0[4].y, l(-1.000000)
    r0.y = ((source[4].yyyy)+(float4(-1.000000,-1.000000,-1.000000,-1.000000))).y;
    // 24: mad r0.z, cb0[6].y, cb0[11].z, cb0[11].w
    r0.z = ((source[6].yyyy)*(source[11].zzzz)+(source[11].wwww)).z;
    // 25: sincos r1.x, r2.x, r0.z
    r1.x = (sin(r0.zzzz)).x; r2.x = (cos(r0.zzzz)).x;
    // 26: mov r3.x, -r1.x
    r3.x = (-(r1.xxxx)).x;
    // 27: mul r0.zw, v4.xxxy, cb0[7].yyyz
    r0.zw = ((v4.xxxy)*(source[7].yyyz)).zw;
    // 28: mad r0.zw, cb0[6].yyyy, cb0[7].xxxw, r0.zzzw
    r0.zw = ((source[6].yyyy)*(source[7].xxxw)+(r0.zzzw)).zw;
    // 29: sample_b_indexable(texture2d)(float,float,float,float) r0.zw, r0.zwzz, t0.zwxy, s1, l(0.000000)
    r0.zw = (ArtistNativeSample0((r0.zwzz).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).zwxy).zw;
    // 30: mad r0.zw, cb0[8].yyyy, r0.zzzw, v4.xxxy
    r0.zw = ((source[8].yyyy)*(r0.zzzw)+(v4.xxxy)).zw;
    // 31: add r1.yz, r0.zzwz, l(0.000000, -0.500000, -0.500000, 0.000000)
    r1.yz = ((r0.zzwz)+(float4(0.000000,-0.500000,-0.500000,0.000000))).yz;
    // 32: mov r3.y, r2.x
    r3.y = (r2.xxxx).y;
    // 33: mov r3.z, r1.x
    r3.z = (r1.xxxx).z;
    // 34: dp2 r1.x, r3.zyzz, r1.yzyy
    r1.x = (dot((r3.zyzz).xy,(r1.yzyy).xy).xxxx).x;
    // 35: dp2 r1.y, r3.yxyy, r1.yzyy
    r1.y = (dot((r3.yxyy).xy,(r1.yzyy).xy).xxxx).y;
    // 36: mad r2.x, r1.y, cb0[5].x, r0.y
    r2.x = ((r1.yyyy)*(source[5].xxxx)+(r0.yyyy)).x;
    // 37: mul r2.z, r1.x, cb0[5].y
    r2.z = ((r1.xxxx)*(source[5].yyyy)).z;
    // 38: add r1.xy, r2.xzxx, l(0.500000, 0.500000, 0.000000, 0.000000)
    r1.xy = ((r2.xzxx)+(float4(0.500000,0.500000,0.000000,0.000000))).xy;
    // 39: sample_b_indexable(texture2d)(float,float,float,float) r1.xyz, r1.xyxx, t3.xyzw, s5, l(0.000000)
    r1.xyz = (ArtistNativeSample4((r1.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 40: mul r2.xy, r0.zwzz, cb0[10].zwzz
    r2.xy = ((r0.zwzz)*(source[10].zwzz)).xy;
    // 41: mad r3.x, cb0[6].y, cb0[10].y, r2.x
    r3.x = ((source[6].yyyy)*(source[10].yyyy)+(r2.xxxx)).x;
    // 42: mad r3.y, cb0[6].y, cb0[11].x, r2.y
    r3.y = ((source[6].yyyy)*(source[11].xxxx)+(r2.yyyy)).y;
    // 43: sample_b_indexable(texture2d)(float,float,float,float) r2.xyz, r3.xyxx, t2.xyzw, s4, l(0.000000)
    r2.xyz = (ArtistNativeSample3((r3.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 44: mul r1.xyz, r1.xyzx, r2.xyzx
    r1.xyz = ((r1.xyzx)*(r2.xyzx)).xyz;
    // 45: mul r2.xy, r0.zwzz, cb0[9].zwzz
    r2.xy = ((r0.zwzz)*(source[9].zwzz)).xy;
    // 46: mul r0.yz, r0.zzwz, cb0[6].zzwz
    r0.yz = ((r0.zzwz)*(source[6].zzwz)).yz;
    // 47: mad r3.x, cb0[6].y, cb0[9].y, r2.x
    r3.x = ((source[6].yyyy)*(source[9].yyyy)+(r2.xxxx)).x;
    // 48: mad r3.y, cb0[6].y, cb0[10].x, r2.y
    r3.y = ((source[6].yyyy)*(source[10].xxxx)+(r2.yyyy)).y;
    // 49: sample_b_indexable(texture2d)(float,float,float,float) r2.xyz, r3.xyxx, t1.xyzw, s3, l(0.000000)
    r2.xyz = (ArtistNativeSample2((r3.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 50: mul r1.xy, r1.xyxx, r2.xyxx
    r1.xy = ((r1.xyxx)*(r2.xyxx)).xy;
    // 51: add r0.w, r1.y, r1.x
    r0.w = ((r1.yyyy)+(r1.xxxx)).w;
    // 52: mad r0.w, r2.z, r1.z, r0.w
    r0.w = ((r2.zzzz)*(r1.zzzz)+(r0.wwww)).w;
    // 53: add r1.x, -cb0[4].x, l(1.000000)
    r1.x = ((-(source[4].xxxx))+(float4(1.000000,1.000000,1.000000,1.000000))).x;
    // 54: mad r0.w, r0.w, l(0.333330), -r1.x
    r0.w = ((r0.wwww)*(float4(0.333330,0.333330,0.333330,0.333330))+(-(r1.xxxx))).w;
    // 55: mul_sat r0.w, r0.w, cb0[12].z
    r0.w = (saturate((r0.wwww)*(source[12].zzzz))).w;
    // 56: log r1.x, r0.w
    r1.x = (log2(r0.wwww)).x;
    // 57: lt r0.w, r0.w, l(0.000001)
    r0.w = (asfloat((uint4)((r0.wwww)<(float4(0.000001,0.000001,0.000001,0.000001))) * 0xffffffffu)).w;
    // 58: mul r1.x, r1.x, cb0[12].w
    r1.x = ((r1.xxxx)*(source[12].wwww)).x;
    // 59: exp r1.x, r1.x
    r1.x = (exp2(r1.xxxx)).x;
    // 60: mul r0.x, r0.x, r1.x
    r0.x = ((r0.xxxx)*(r1.xxxx)).x;
    // 61: mul_sat r0.x, r0.x, cb0[1].w
    r0.x = (saturate((r0.xxxx)*(source[1].wwww))).x;
    // 62: mul r0.x, r0.x, cb0[0].x
    r0.x = ((r0.xxxx)*(source[0].xxxx)).x;
    // 63: movc o0.w, r0.w, l(0), r0.x
    output.w = ((asuint(r0.wwww) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.xxxx)).w;
    // 64: mad r0.x, cb0[6].y, cb0[6].x, r0.y
    r0.x = ((source[6].yyyy)*(source[6].xxxx)+(r0.yyyy)).x;
    // 65: mad r0.y, cb0[6].y, cb0[8].z, r0.z
    r0.y = ((source[6].yyyy)*(source[8].zzzz)+(r0.zzzz)).y;
    // 66: sample_b_indexable(texture2d)(float,float,float,float) r0.xyz, r0.xyxx, t5.xyzw, s2, l(0.000000)
    r0.xyz = (ArtistNativeSample1((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 67: dp3 r0.w, r0.xyzx, l(0.300000, 0.590000, 0.110000, 0.000000)
    r0.w = (dot((r0.xyzx).xyz,(float4(0.300000,0.590000,0.110000,0.000000)).xyz).xxxx).w;
    // 68: add r1.xyz, -r0.xyzx, r0.wwww
    r1.xyz = ((-(r0.xyzx))+(r0.wwww)).xyz;
    // 69: mad r0.xyz, cb0[8].wwww, r1.xyzx, r0.xyzx
    r0.xyz = ((source[8].wwww)*(r1.xyzx)+(r0.xyzx)).xyz;
    // 70: max r0.xyz, |r0.xyzx|, l(0.000001, 0.000001, 0.000001, 0.000000)
    r0.xyz = (max(abs(r0.xyzx),float4(0.000001,0.000001,0.000001,0.000000))).xyz;
    // 71: log r0.xyz, r0.xyzx
    r0.xyz = (log2(r0.xyzx)).xyz;
    // 72: mul r0.xyz, r0.xyzx, cb0[9].xxxx
    r0.xyz = ((r0.xyzx)*(source[9].xxxx)).xyz;
    ...
    r0.xyz = ((r0.xyzx)*(r1.xyzx)).xyz;
    // 76: mad r0.xyz, r0.xyzx, cb0[1].xyzx, cb0[2].xyzx
    r0.xyz = ((r0.xyzx)*(source[1].xyzx)+(source[2].xyzx)).xyz;
...
float4 ArtistNative850(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_d_pa_glow_02_02_tr: 8453d0e400932c45a58472c32a00128d; selected map dd4519ae31cd56bf7b4c6834a824cadf48d612f10cff3c989503a2d0c2e2fac5.
float4 ArtistNative851(ARTIST_NATIVE_INPUT input)
{
...
float4 ArtistNative852(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_m_pa_flowergarden_02_03_dt_ad: 7db81b6b37fb6b4fa40ad0b6873ce4d3; selected map 11f9d8b0e2025d60e283ef5a0c9aff75d4a98123d02233dcc981eaa776f872c5.
float4 ArtistNative853(ARTIST_NATIVE_INPUT input)
{
    float4 source[12]; [unroll] for (uint i=0u; i<12u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    source[8].w = (max(float4(9.99999975e-06, 0.0, 0.0, 0.0),g_ArtistSourceMaterialParameters[0u].yyyy)).x;
    source[9].x = ((float4(1.0, 0.0, 0.0, 0.0)/max(float4(9.99999975e-06, 0.0, 0.0, 0.0),g_ArtistSourceMaterialParameters[0u].yyyy))).x;
    source[9].y = (g_ArtistSourceMaterialParameters[0u].wwww).x;
    source[9].z = ((float4(1.0, 0.0, 0.0, 0.0)-g_ArtistSourceMaterialParameters[0u].wwww)).x;
    source[9].w = (max((float4(1.0, 0.0, 0.0, 0.0)-g_ArtistSourceMaterialParameters[0u].wwww),float4(9.99999975e-06, 0.0, 0.0, 0.0))).x;
    source[10].x = ((float4(1.0, 0.0, 0.0, 0.0)/max((float4(1.0, 0.0, 0.0, 0.0)-g_ArtistSourceMaterialParameters[0u].wwww),float4(9.99999975e-06, 0.0, 0.0, 0.0)))).x;
    source[10].y = (g_ArtistSourceMaterialParameters[5u].wwww).x;
    source[10].z = (g_ArtistSourceMaterialParameters[0u].zzzz).x;
    source[10].w = ((float4(100.0, 0.0, 0.0, 0.0)-g_ArtistSourceMaterialParameters[0u].zzzz)).x;
    source[11].x = ((float4(0.00999999978, 0.0, 0.0, 0.0)*(float4(100.0, 0.0, 0.0, 0.0)-g_ArtistSourceMaterialParameters[0u].zzzz))).x;
    float4 passValues[4]={float4(.5f,-.5f,.5f,.5f),float4(0.f,0.f,0.f,0.f),float4(0.f,0.f,0.f,0.f),float4(0.f,0.f,0.f,0.f)};
    float4 v0 = float4(input.sourceBasisX,0.f); // native texcoord10
    float4 v1 = float4(input.sourceBasisZ,input.handedness); // native texcoord11
    float4 v2 = float4(input.uv,float2(0.f,0.f)); // native texcoord0
    ...
    r1.yzw = (ArtistNativeSample2((r3.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, true).wxyz).yzw;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_a_pa_gl_01_4_ad: b0d551a53864c9408d2c03215f9ef88f; selected map 4dd93e1b4ffae10c2db3ed0c4c9132c6db631aa6aa2fdbffcc7ea3e1b5d89ab4.
float4 ArtistNative854(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative855(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative856(ARTIST_NATIVE_INPUT input)
{
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_r_pa_twirl_02_03_dt_ad: 7db81b6b37fb6b4fa40ad0b6873ce4d3; selected map 11f9d8b0e2025d60e283ef5a0c9aff75d4a98123d02233dcc981eaa776f872c5.
float4 ArtistNative857(ARTIST_NATIVE_INPUT input)
{
    float4 source[12]; [unroll] for (uint i=0u; i<12u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_k_pa_shockwave_06_ad: 9f7d04fd3c6b0e448fa52dafeb5d5d43; selected map 10da5aa7496658c84693cc64ba5144d47c39f3f9e298e1dca0ff00adbeb7516f.
float4 ArtistNative858(ARTIST_NATIVE_INPUT input)
{
...
float4 ArtistNative859(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative860(ARTIST_NATIVE_INPUT input)
{
    float4 source[7]; [unroll] for (uint i=0u; i<7u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_n_pa_flamepillar_01_5_tr: caac5e67fe16e54e88dd9c0ef352c199; selected map 00edafd7417fdd347bd3a73c2d384cdd3cc83063762bd92e8781c728d0ed9ece.
float4 ArtistNative861(ARTIST_NATIVE_INPUT input)
{
    float4 source[8]; [unroll] for (uint i=0u; i<8u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    // 17: mov r3.x, -r1.x
    r3.x = (-(r1.xxxx)).x;
    // 18: dp2 r0.w, r3.yxyy, r0.xyxx
    r0.w = (dot((r3.yxyy).xy,(r0.xyxx).xy).xxxx).w;
    // 19: dp2 r0.x, r3.zyzz, r0.xyxx
    r0.x = (dot((r3.zyzz).xy,(r0.xyxx).xy).xxxx).x;
    // 20: mul r1.x, r0.w, cb0[2].x
    r1.x = ((r0.wwww)*(source[2].xxxx)).x;
    // 21: add r0.y, v4.y, l(-1.000000)
    r0.y = ((v4.yyyy)+(float4(-1.000000,-1.000000,-1.000000,-1.000000))).y;
    // 22: mad r1.z, r0.x, cb0[2].y, r0.y
    r1.z = ((r0.xxxx)*(source[2].yyyy)+(r0.yyyy)).z;
...
float4 ArtistNative862(ARTIST_NATIVE_INPUT input)
{
    float4 source[8]; [unroll] for (uint i=0u; i<8u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_m_shine_depth_02_1_ad: c23e4ebaf28ad84aa6a005f5bcb0f3bd; selected map fa799dc74c967b4f632c7cfca7d72b89a58b34fb696433c2be015fcf5075b18d.
float4 ArtistNative863(ARTIST_NATIVE_INPUT input)
{
    float4 source[11]; [unroll] for (uint i=0u; i<11u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative864(ARTIST_NATIVE_INPUT input)
{
    float4 source[8]; [unroll] for (uint i=0u; i<8u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative865(ARTIST_NATIVE_INPUT input)
{
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_m_pa_flare_depth_02_02_dt_ad: 31a56416afc48b48975d5f75c4d52157; selected map 4d77068b2fd78f85fcdac963e7906195871e4e3e5ba7a45f5fe9ea5bb462c047.
float4 ArtistNative866(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative867(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_c_pa_flickline_01_ad: 13a7bccdac44374e9a842c018e20a73a; selected map 8f0f6176d7500e9a27eed031f7f5372bd1f6a55a529253b3b5d2cd2bbd900a67.
float4 ArtistNative868(ARTIST_NATIVE_INPUT input)
{
    ...
    // 2: frc r0.x, r0.x
    r0.x = (frac(r0.xxxx)).x;
    // 3: mul r0.x, r0.x, v4.x
    r0.x = ((r0.xxxx)*(v4.xxxx)).x;
    // 4: mul r0.x, r0.x, l(6.283185)
    r0.x = ((r0.xxxx)*(float4(6.283185,6.283185,6.283185,6.283185))).x;
    // 5: sincos r0.x, null, r0.x
    r0.x = (sin(r0.xxxx)).x;
    // 6: add r0.x, r0.x, l(1.000000)
    r0.x = ((r0.xxxx)+(float4(1.000000,1.000000,1.000000,1.000000))).x;
    // 7: sample_b_indexable(texture2d)(float,float,float,float) r1.xyzw, v2.xyxx, t0.xyzw, s0, l(0.000000)
    r1.xyzw = (ArtistNativeSample0((v2.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyzw;
    // 8: mul r0.x, r0.x, r1.w
    r0.x = ((r0.xxxx)*(r1.wwww)).x;
    // 9: mad r0.yzw, v3.xxyz, r1.xxyz, cb0[1].xxyz
    r0.yzw = ((v3.xxyz)*(r1.xxyz)+(source[1].xxyz)).yzw;
    // 10: mul r0.yzw, r0.yyzw, v5.wwww
    r0.yzw = ((r0.yyzw)*(v5.wwww)).yzw;
    // 11: mul r0.x, r0.x, l(0.500000)
    r0.x = ((r0.xxxx)*(float4(0.500000,0.500000,0.500000,0.500000))).x;
    // 12: mul r0.x, r0.x, cb0[0].x
    r0.x = ((r0.xxxx)*(source[0].xxxx)).x;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_m_me_spritewave_01_1_ad: 778d9d5539a274478ce69ba8c43069bf; selected map f12736698d565bab7661db555834d6abb23f00bd216f9d5dc64e4e6d276e986e.
float4 ArtistNative869(ARTIST_NATIVE_INPUT input)
{
    ...
    source[3] = input.dynamicParameter;
    source[4] = ArtistNativeAppend(cos(((float4(3.1400001, 0.0, 0.0, 0.0)*g_ArtistSourceMaterialParameters[5u].wwww)*float4(0.25, 0.0, 0.0, 0.0))),(float4(-1.0, 0.0, 0.0, 0.0)*sin(((float4(3.1400001, 0.0, 0.0, 0.0)*g_ArtistSourceMaterialParameters[5u].wwww)*float4(0.25, 0.0, 0.0, 0.0)))),1u);
    source[5] = ArtistNativeAppend(sin(((float4(3.1400001, 0.0, 0.0, 0.0)*g_ArtistSourceMaterialParameters[5u].wwww)*float4(0.25, 0.0, 0.0, 0.0))),cos(((float4(3.1400001, 0.0, 0.0, 0.0)*g_ArtistSourceMaterialParameters[5u].wwww)*float4(0.25, 0.0, 0.0, 0.0))),1u);
    source[6] = ArtistNativeAppend(g_ArtistSourceMaterialParameters[4u].wwww,g_ArtistSourceMaterialParameters[5u].xxxx,1u);
    source[7] = ArtistNativeAppend(cos(((g_ArtistSourceMaterialParameters[5u].wwww*float4(6.28000021, 0.0, 0.0, 0.0))*float4(0.25, 0.0, 0.0, 0.0))),(float4(-1.0, 0.0, 0.0, 0.0)*sin(((g_ArtistSourceMaterialParameters[5u].wwww*float4(6.28000021, 0.0, 0.0, 0.0))*float4(0.25, 0.0, 0.0, 0.0)))),1u);
    source[8] = ArtistNativeAppend(sin(((g_ArtistSourceMaterialParameters[5u].wwww*float4(6.28000021, 0.0, 0.0, 0.0))*float4(0.25, 0.0, 0.0, 0.0))),cos(((g_ArtistSourceMaterialParameters[5u].wwww*float4(6.28000021, 0.0, 0.0, 0.0))*float4(0.25, 0.0, 0.0, 0.0))),1u);
    ...
    source[12].x = ((float4(-1.0, 0.0, 0.0, 0.0)*sin(((g_ArtistSourceMaterialParameters[5u].wwww*float4(6.28000021, 0.0, 0.0, 0.0))*float4(0.25, 0.0, 0.0, 0.0))))).x;
    source[12].y = (cos(((g_ArtistSourceMaterialParameters[5u].wwww*float4(6.28000021, 0.0, 0.0, 0.0))*float4(0.25, 0.0, 0.0, 0.0)))).x;
    ...
    source[13].y = (g_ArtistSourceMaterialParameters[6u].yyyy).x;
    source[13].z = (g_ArtistSourceMaterialParameters[4u].yyyy).x;
    source[13].w = (g_ArtistSourceMaterialParameters[4u].zzzz).x;
    source[14].x = (cos(((float4(3.1400001, 0.0, 0.0, 0.0)*g_ArtistSourceMaterialParameters[5u].wwww)*float4(0.25, 0.0, 0.0, 0.0)))).x;
    source[14].y = (g_ArtistSourceMaterialParameters[5u].zzzz).x;
    source[14].z = (g_ArtistSourceMaterialParameters[8u].wwww).x;
    source[14].w = (g_ArtistSourceMaterialParameters[9u].yyyy).x;
    source[15].x = (g_ArtistSourceMaterialParameters[9u].zzzz).x;
    ...
    source[17].w = (g_ArtistSourceMaterialParameters[0u].zzzz).x;
    source[18].x = (g_ArtistSourceMaterialParameters[0u].wwww).x;
    source[18].y = (g_ArtistSourceMaterialParameters[2u].xxxx).x;
    source[18].z = ((g_ArtistSourceMaterialParameters[2u].xxxx*float4(0.25, 0.0, 0.0, 0.0))).x;
    source[18].w = (sin((g_ArtistSourceMaterialParameters[2u].xxxx*float4(0.25, 0.0, 0.0, 0.0)))).x;
    source[19].x = ((float4(-1.0, 0.0, 0.0, 0.0)*sin((g_ArtistSourceMaterialParameters[2u].xxxx*float4(0.25, 0.0, 0.0, 0.0))))).x;
    source[19].y = (cos((g_ArtistSourceMaterialParameters[2u].xxxx*float4(0.25, 0.0, 0.0, 0.0)))).x;
    source[19].z = (g_ArtistSourceMaterialParameters[6u].wwww).x;
    source[19].w = (g_ArtistSourceMaterialParameters[7u].yyyy).x;
    source[20].x = (g_ArtistSourceMaterialParameters[7u].zzzz).x;
    source[20].y = (g_ArtistSourceMaterialParameters[7u].xxxx).x;
    ...
    source[22].x = (g_ArtistSourceMaterialParameters[2u].wwww).x;
    source[22].y = (g_ArtistSourceMaterialParameters[3u].wwww).x;
    source[22].z = (g_ArtistSourceMaterialParameters[7u].wwww).x;
    source[22].w = (g_ArtistSourceMaterialParameters[8u].xxxx).x;
    source[23].x = (g_ArtistSourceMaterialParameters[8u].yyyy).x;
    source[23].y = (g_ArtistSourceMaterialParameters[4u].xxxx).x;
    float4 passValues[4]={float4(.5f,-.5f,.5f,.5f),float4(0.f,0.f,0.f,0.f),float4(0.f,0.f,0.f,0.f),float4(0.f,0.f,0.f,0.f)};
    float4 v0 = float4(input.sourceBasisX,0.f); // native texcoord10
    float4 v1 = float4(input.sourceBasisZ,input.handedness); // native texcoord11
    float4 v2 = input.vertexColor; // native color0
    ...
    r0.x = (ArtistNativeSample3((r0.xwxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).x;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_m_me_flowergarden_petal_01_245_ts_tr: 93c27ea3fa7f924c96a6ed71936b7b70; selected map ee8c3ed95987482adaad0bf024f3b5cded2467a37829520f5ff3cb5763bc5123.
float4 ArtistNative870(ARTIST_NATIVE_INPUT input)
{
    float4 source[8]; [unroll] for (uint i=0u; i<8u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    source[6].x = (g_ArtistSourceMaterialParameters[0u].wwww).x;
    source[6].y = ((float4(1.0, 0.0, 0.0, 0.0)*g_ArtistSourceMaterialParameters[0u].wwww)).x;
    source[6].z = (g_ArtistSourceMaterialParameters[1u].xxxx).x;
    ...
    // 5: lt r0.x, |r0.x|, l(0.000001)
    r0.x = (asfloat((uint4)((abs(r0.xxxx))<(float4(0.000001,0.000001,0.000001,0.000001))) * 0xffffffffu)).x;
    // 6: mul r0.y, r0.y, cb0[7].y
    r0.y = ((r0.yyyy)*(source[7].yyyy)).y;
    // 7: exp r0.y, r0.y
    r0.y = (exp2(r0.yyyy)).y;
    // 8: mul_sat r0.y, r0.y, cb0[7].z
    r0.y = (saturate((r0.yyyy)*(source[7].zzzz))).y;
    // 9: movc r0.x, r0.x, l(0), r0.y
    r0.x = ((asuint(r0.xxxx) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.yyyy)).x;
    // 10: mul r0.yz, v4.xxyx, cb0[5].yyzy
    r0.yz = ((v4.xxyx)*(source[5].yyzy)).yz;
    // 11: mad r0.yz, cb0[4].yyyy, cb0[5].xxwx, r0.yyzy
    r0.yz = ((source[4].yyyy)*(source[5].xxwx)+(r0.yyzy)).yz;
    // 12: sample_b_indexable(texture2d)(float,float,float,float) r0.yz, r0.yzyy, t0.zxyw, s0, l(0.000000)
    r0.yz = (ArtistNativeSample0((r0.yzyy).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).zxyw).yz;
    // 13: mad r0.yz, cb0[6].yyyy, r0.yyzy, v4.xxyx
    r0.yz = ((source[6].yyyy)*(r0.yyzy)+(v4.xxyx)).yz;
    // 14: mul r0.yz, r0.yyzy, cb0[4].zzwz
    r0.yz = ((r0.yyzy)*(source[4].zzwz)).yz;
    // 15: mad r1.x, cb0[4].y, cb0[4].x, r0.y
    r1.x = ((source[4].yyyy)*(source[4].xxxx)+(r0.yyyy)).x;
    // 16: mad r1.y, cb0[4].y, cb0[6].z, r0.z
    r1.y = ((source[4].yyyy)*(source[6].zzzz)+(r0.zzzz)).y;
    // 17: sample_b_indexable(texture2d)(float,float,float,float) r0.yzw, r1.xyxx, t1.wxyz, s1, l(0.000000)
    r0.yzw = (ArtistNativeSample1((r1.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).wxyz).yzw;
    // 18: add r0.y, r0.z, r0.y
    r0.y = ((r0.zzzz)+(r0.yyyy)).y;
    // 19: add r0.y, r0.w, r0.y
    r0.y = ((r0.wwww)+(r0.yyyy)).y;
    // 20: add r0.z, -cb0[3].x, l(1.000000)
    r0.z = ((-(source[3].xxxx))+(float4(1.000000,1.000000,1.000000,1.000000))).z;
    // 21: mad r0.y, r0.y, l(0.333330), -r0.z
    r0.y = ((r0.yyyy)*(float4(0.333330,0.333330,0.333330,0.333330))+(-(r0.zzzz))).y;
    // 22: mul_sat r0.y, r0.y, cb0[6].w
    r0.y = (saturate((r0.yyyy)*(source[6].wwww))).y;
    // 23: log r0.z, r0.y
    r0.z = (log2(r0.yyyy)).z;
    // 24: lt r0.y, r0.y, l(0.000001)
    r0.y = (asfloat((uint4)((r0.yyyy)<(float4(0.000001,0.000001,0.000001,0.000001))) * 0xffffffffu)).y;
    // 25: mul r0.z, r0.z, cb0[7].x
    ...
    output.w = ((asuint(r0.yyyy) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.xxxx)).w;
    // 31: add r0.xyz, cb0[1].xyzx, cb0[2].xyzx
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_m_me_flowergarden_petal_01_246_ts_tr: 93c27ea3fa7f924c96a6ed71936b7b70; selected map ee8c3ed95987482adaad0bf024f3b5cded2467a37829520f5ff3cb5763bc5123.
float4 ArtistNative871(ARTIST_NATIVE_INPUT input)
{
    float4 source[8]; [unroll] for (uint i=0u; i<8u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_d_pa_master_01_230_dt_ad: 14b14a2cf473a34996a369400d814d7a; selected map 9201de07ce3de7f8353bbc3c0743a9c167c6f370cdcc4eac4889a2c9e774a781.
float4 ArtistNative872(ARTIST_NATIVE_INPUT input)
{
    float4 source[7]; [unroll] for (uint i=0u; i<7u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    r0.y = ((-(r0.yyyy))+(float4(1.000000,1.000000,1.000000,1.000000))).y;
    // 15: mul_sat r0.y, r0.y, cb0[6].x
    r0.y = (saturate((r0.yyyy)*(source[6].xxxx))).y;
    // 16: log r0.z, r0.y
    r0.z = (log2(r0.yyyy)).z;
    // 17: lt r0.y, r0.y, l(0.000001)
    r0.y = (asfloat((uint4)((r0.yyyy)<(float4(0.000001,0.000001,0.000001,0.000001))) * 0xffffffffu)).y;
    // 18: mul r0.z, r0.z, cb0[6].y
    ...
    // 27: mul r0.yw, v2.yyyx, cb0[4].xxxw
    r0.yw = ((v2.yyyx)*(source[4].xxxw)).yw;
    // 28: mad r1.yz, r0.zzzz, cb0[4].yyzy, r0.yywy
    r1.yz = ((r0.zzzz)*(source[4].yyzy)+(r0.yywy)).yz;
    // 29: sample_b_indexable(texture2d)(float,float,float,float) r2.xyz, r1.xyxx, t1.xyzw, s1, l(0.000000)
    r2.xyz = (ArtistNativeSample0((r1.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 30: mul r0.y, v2.y, cb0[5].x
    r0.y = ((v2.yyyy)*(source[5].xxxx)).y;
    // 31: mad r1.w, r0.z, cb0[5].y, r0.y
    r1.w = ((r0.zzzz)*(source[5].yyyy)+(r0.yyyy)).w;
    // 32: sample_b_indexable(texture2d)(float,float,float,float) r0.yzw, r1.zwzz, t2.wxyz, s2, l(0.000000)
    r0.yzw = (ArtistNativeSample1((r1.zwzz).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).wxyz).yzw;
...
float4 ArtistNative873(ARTIST_NATIVE_INPUT input)
{
    float4 source[6]; [unroll] for (uint i=0u; i<6u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative874(ARTIST_NATIVE_INPUT input)
{
    float4 source[23]; [unroll] for (uint i=0u; i<23u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    source[1] = g_ArtistSourceMaterialParameters[12u];
    source[2] = ArtistNativeAppend(cos(((float4(3.1400001, 0.0, 0.0, 0.0)*g_ArtistSourceMaterialParameters[5u].zzzz)*float4(0.25, 0.0, 0.0, 0.0))),(float4(-1.0, 0.0, 0.0, 0.0)*sin(((float4(3.1400001, 0.0, 0.0, 0.0)*g_ArtistSourceMaterialParameters[5u].zzzz)*float4(0.25, 0.0, 0.0, 0.0)))),1u);
    source[3] = ArtistNativeAppend(sin(((float4(3.1400001, 0.0, 0.0, 0.0)*g_ArtistSourceMaterialParameters[5u].zzzz)*float4(0.25, 0.0, 0.0, 0.0))),cos(((float4(3.1400001, 0.0, 0.0, 0.0)*g_ArtistSourceMaterialParameters[5u].zzzz)*float4(0.25, 0.0, 0.0, 0.0))),1u);
    source[4] = ArtistNativeAppend(g_ArtistSourceMaterialParameters[4u].zzzz,g_ArtistSourceMaterialParameters[4u].wwww,1u);
    source[5] = ArtistNativeAppend(cos(((g_ArtistSourceMaterialParameters[5u].zzzz*float4(6.28000021, 0.0, 0.0, 0.0))*float4(0.25, 0.0, 0.0, 0.0))),(float4(-1.0, 0.0, 0.0, 0.0)*sin(((g_ArtistSourceMaterialParameters[5u].zzzz*float4(6.28000021, 0.0, 0.0, 0.0))*float4(0.25, 0.0, 0.0, 0.0)))),1u);
    source[6] = ArtistNativeAppend(sin(((g_ArtistSourceMaterialParameters[5u].zzzz*float4(6.28000021, 0.0, 0.0, 0.0))*float4(0.25, 0.0, 0.0, 0.0))),cos(((g_ArtistSourceMaterialParameters[5u].zzzz*float4(6.28000021, 0.0, 0.0, 0.0))*float4(0.25, 0.0, 0.0, 0.0))),1u);
    source[7] = ArtistNativeAppend(cos((g_ArtistSourceMaterialParameters[2u].xxxx*float4(0.25, 0.0, 0.0, 0.0))),(float4(-1.0, 0.0, 0.0, 0.0)*sin((g_ArtistSourceMaterialParameters[2u].xxxx*float4(0.25, 0.0, 0.0, 0.0)))),1u);
    source[8] = ArtistNativeAppend(sin((g_ArtistSourceMaterialParameters[2u].xxxx*float4(0.25, 0.0, 0.0, 0.0))),cos((g_ArtistSourceMaterialParameters[2u].xxxx*float4(0.25, 0.0, 0.0, 0.0))),1u);
    source[9] = g_ArtistSourceMaterialParameters[11u];
    source[10].x = ((float4(-1.0, 0.0, 0.0, 0.0)*sin(((g_ArtistSourceMaterialParameters[5u].zzzz*float4(6.28000021, 0.0, 0.0, 0.0))*float4(0.25, 0.0, 0.0, 0.0))))).x;
    source[10].y = (cos(((g_ArtistSourceMaterialParameters[5u].zzzz*float4(6.28000021, 0.0, 0.0, 0.0))*float4(0.25, 0.0, 0.0, 0.0)))).x;
    ...
    source[11].w = (g_ArtistSourceMaterialParameters[4u].yyyy).x;
    source[12].x = (cos(((float4(3.1400001, 0.0, 0.0, 0.0)*g_ArtistSourceMaterialParameters[5u].zzzz)*float4(0.25, 0.0, 0.0, 0.0)))).x;
    ...
    source[17].x = (g_ArtistSourceMaterialParameters[0u].zzzz).x;
    source[17].y = (g_ArtistSourceMaterialParameters[0u].wwww).x;
    source[17].z = (g_ArtistSourceMaterialParameters[2u].xxxx).x;
    source[17].w = ((g_ArtistSourceMaterialParameters[2u].xxxx*float4(0.25, 0.0, 0.0, 0.0))).x;
    source[18].x = (sin((g_ArtistSourceMaterialParameters[2u].xxxx*float4(0.25, 0.0, 0.0, 0.0)))).x;
    source[18].y = ((float4(-1.0, 0.0, 0.0, 0.0)*sin((g_ArtistSourceMaterialParameters[2u].xxxx*float4(0.25, 0.0, 0.0, 0.0))))).x;
    source[18].z = (cos((g_ArtistSourceMaterialParameters[2u].xxxx*float4(0.25, 0.0, 0.0, 0.0)))).x;
    ...
    source[19].z = (g_ArtistSourceMaterialParameters[6u].wwww).x;
    source[19].w = (g_ArtistSourceMaterialParameters[6u].yyyy).x;
    source[20].x = (g_ArtistSourceMaterialParameters[0u].yyyy).x;
    source[20].y = (g_ArtistSourceMaterialParameters[1u].yyyy).x;
    source[20].z = (g_ArtistSourceMaterialParameters[1u].zzzz).x;
    source[20].w = (g_ArtistSourceMaterialParameters[1u].wwww).x;
    source[21].x = (g_ArtistSourceMaterialParameters[1u].xxxx).x;
    source[21].y = (g_ArtistSourceMaterialParameters[2u].wwww).x;
    ...
    r0.w = (ArtistNativeSample1((r3.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yzwx).w;
...
float4 ArtistNative875(ARTIST_NATIVE_INPUT input)
{
    float4 source[8]; [unroll] for (uint i=0u; i<8u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative876(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_m_pa_flowergarden_splitline_addmask_02_ad: 5c4f93282d75074d82da3ed9457eb012; selected map fb912fc0f454094c6f416a301ed6c52253d9990889e2f89ff1fea63a5bee1e38.
float4 ArtistNative877(ARTIST_NATIVE_INPUT input)
{
    float4 source[5]; [unroll] for (uint i=0u; i<5u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    source[1] = g_ArtistSourceMaterialParameters[1u];
    source[2] = ArtistNativeAppend(ArtistNativePeriodic((g_ArtistSourceMaterialTime.xxxx*float4(0.0500000007, 0.0, 0.0, 0.0))),ArtistNativePeriodic((g_ArtistSourceMaterialTime.xxxx*float4(0.0, 0.0, 0.0, 0.0))),1u);
    source[3].x = (ArtistNativePeriodic((g_ArtistSourceMaterialTime.xxxx*float4(0.0500000007, 0.0, 0.0, 0.0)))).x;
    ...
    r0.w = ((r0.wwww)*(v3.wwww)).w;
    // 16: mad r1.x, cb0[3].y, v2.x, cb0[3].z
    r1.x = ((source[3].yyyy)*(v2.xxxx)+(source[3].zzzz)).x;
    // 17: mad r1.y, cb0[3].w, v2.y, cb0[4].x
    r1.y = ((source[3].wwww)*(v2.yyyy)+(source[4].xxxx)).y;
    // 18: sample_b_indexable(texture2d)(float,float,float,float) r1.x, r1.xyxx, t1.xyzw, s2, l(0.000000)
    r1.x = (ArtistNativeSample1((r1.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).x;
    // 19: mul r0.w, r0.w, r1.x
    r0.w = ((r0.wwww)*(r1.xxxx)).w;
    // 20: mul o0.w, r0.w, cb0[0].x
    output.w = ((r0.wwww)*(source[0].xxxx)).w;
    // 21: div r1.xy, v7.xyxx, v7.wwww
    r1.xy = ((v7.xyxx)/(v7.wwww)).xy;
    // 22: mad r1.xy, r1.xyxx, cb2[0].xyxx, cb2[0].wzww
    r1.xy = ((r1.xyxx)*(passValues[0].xyxx)+(passValues[0].wzww)).xy;
    // 23: add r0.w, v2.x, l(-0.500000)
    r0.w = ((v2.xxxx)+(float4(-0.500000,-0.500000,-0.500000,-0.500000))).w;
    // 24: add r1.w, |r0.w|, |r0.w|
    ...
    // 26: log r1.w, r1.w
    r1.w = (log2(r1.wwww)).w;
    // 27: mul r1.w, r1.w, l(10.000000)
    r1.w = ((r1.wwww)*(float4(10.000000,10.000000,10.000000,10.000000))).w;
    // 28: exp r1.w, r1.w
    r1.w = (exp2(r1.wwww)).w;
    // 29: movc r0.w, r0.w, l(0), r1.w
    r0.w = ((asuint(r0.wwww) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r1.wwww)).w;
    // 30: mul r2.xy, r0.wwww, l(0.350000, 0.035000, 0.000000, 0.000000)
    r2.xy = ((r0.wwww)*(float4(0.350000,0.035000,0.000000,0.000000))).xy;
    // 31: mad r2.zw, r0.wwww, l(0.000000, 0.000000, 0.017500, 0.017500), r1.xxxy
    r2.zw = ((r0.wwww)*(float4(0.000000,0.000000,0.017500,0.017500))+(r1.xxxy)).zw;
    // 32: mad r0.w, v4.x, l(0.010000), r2.y
    r0.w = ((v4.xxxx)*(float4(0.010000,0.010000,0.010000,0.010000))+(r2.yyyy)).w;
    // 33: sample_b_indexable(texture2d)(float,float,float,float) r3.xyz, r2.zwzz, t2.xyzw, s0, l(0.000000) (project resolved HDR SceneColor snapshot adapter)
    ...
    // 34: add r1.xy, r1.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)
    r1.xy = ((r1.xyxx)+(float4(-0.500000,-0.500000,0.000000,0.000000))).xy;
    // 35: mul r1.xy, r1.xyxx, l(0.000000, 1.000000, 0.000000, 0.000000)
    r1.xy = ((r1.xyxx)*(float4(0.000000,1.000000,0.000000,0.000000))).xy;
    // 36: mul r0.w, r0.w, l(0.100000)
    r0.w = ((r0.wwww)*(float4(0.100000,0.100000,0.100000,0.100000))).w;
    // 37: mov r4.xy, r2.wzww
    r4.xy = (r2.wzww).xy;
    // 38: mov r5.x, r3.x
    r5.x = (r3.xxxx).x;
    // 39: mov r5.y, l(0)
    ...
    // 40: loop
    [loop] while (true) {
    // 41: ge r1.w, r5.y, l(3.000000)
    r1.w = (asfloat((uint4)((r5.yyyy)>=(float4(3.000000,3.000000,3.000000,3.000000))) * 0xffffffffu)).w;
    // 42: breakc_nz r1.w
    if ((asuint(r1.wwww)).x != 0u) break;
    // 43: mad r4.xy, -r1.yxyy, r0.wwww, r4.xyxx
    r4.xy = ((-(r1.yxyy))*(r0.wwww)+(r4.xyxx)).xy;
    // 44: sample_b_indexable(texture2d)(float,float,float,float) r1.w, r4.yxyy, t2.yzwx, s0, l(0.000000) (project resolved HDR SceneColor snapshot adapter)
    ...
    // 45: add r5.x, r1.w, r5.x
    r5.x = ((r1.wwww)+(r5.xxxx)).x;
    // 46: add r5.y, r5.y, l(1.000000)
    ...
    // 52: loop
    [loop] while (true) {
    // 53: ge r1.w, r6.y, l(3.000000)
    r1.w = (asfloat((uint4)((r6.yyyy)>=(float4(3.000000,3.000000,3.000000,3.000000))) * 0xffffffffu)).w;
    // 54: breakc_nz r1.w
    if ((asuint(r1.wwww)).x != 0u) break;
    // 55: mad r2.yw, -r1.yyyx, r0.wwww, r2.yyyw
    r2.yw = ((-(r1.yyyx))*(r0.wwww)+(r2.yyyw)).yw;
    // 56: sample_b_indexable(texture2d)(float,float,float,float) r1.w, r2.wyww, t2.xzwy, s0, l(0.000000) (project resolved HDR SceneColor snapshot adapter)
    ...
    // 64: loop
    [loop] while (true) {
    // 65: ge r1.w, r4.y, l(3.000000)
    r1.w = (asfloat((uint4)((r4.yyyy)>=(float4(3.000000,3.000000,3.000000,3.000000))) * 0xffffffffu)).w;
    // 66: breakc_nz r1.w
    if ((asuint(r1.wwww)).x != 0u) break;
    // 67: mad r3.xy, -r1.xyxx, r0.wwww, r3.xyxx
    r3.xy = ((-(r1.xyxx))*(r0.wwww)+(r3.xyxx)).xy;
    // 68: sample_b_indexable(texture2d)(float,float,float,float) r1.w, r3.xyxx, t2.xywz, s0, l(0.000000) (project resolved HDR SceneColor snapshot adapter)
...
float4 ArtistNative878(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative879(ARTIST_NATIVE_INPUT input)
{
    float4 source[7]; [unroll] for (uint i=0u; i<7u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative880(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_m_pa_flowergarden_01_205_ts_dt_ad: 769d50cc54bd4e46b7dae36b27b358bb; selected map 6d128a5bf3c65db1689e2f86345cf367c3c925cb5369c131ab522c9d34ca1c00.
float4 ArtistNative881(ARTIST_NATIVE_INPUT input)
{
    float4 source[13]; [unroll] for (uint i=0u; i<13u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    source[7].z = (max(float4(9.99999975e-06, 0.0, 0.0, 0.0),g_ArtistSourceMaterialParameters[2u].xxxx)).x;
    source[7].w = ((float4(1.0, 0.0, 0.0, 0.0)/max(float4(9.99999975e-06, 0.0, 0.0, 0.0),g_ArtistSourceMaterialParameters[2u].xxxx))).x;
    source[8].x = (g_ArtistSourceMaterialParameters[2u].yyyy).x;
    source[8].y = ((float4(1.0, 0.0, 0.0, 0.0)-g_ArtistSourceMaterialParameters[2u].yyyy)).x;
    source[8].z = (max((float4(1.0, 0.0, 0.0, 0.0)-g_ArtistSourceMaterialParameters[2u].yyyy),float4(9.99999975e-06, 0.0, 0.0, 0.0))).x;
    source[8].w = ((float4(1.0, 0.0, 0.0, 0.0)/max((float4(1.0, 0.0, 0.0, 0.0)-g_ArtistSourceMaterialParameters[2u].yyyy),float4(9.99999975e-06, 0.0, 0.0, 0.0)))).x;
    source[9].x = (g_ArtistSourceMaterialParameters[0u].yyyy).x;
    ...
    source[11].x = ((float4(-1.0, 0.0, 0.0, 0.0)*sin(((float4(-0.523599029, 0.0, 0.0, 0.0)*g_ArtistSourceMaterialParameters[3u].yyyy)*float4(1.0, 0.0, 0.0, 0.0))))).x;
    source[11].y = (cos(((float4(-0.523599029, 0.0, 0.0, 0.0)*g_ArtistSourceMaterialParameters[3u].yyyy)*float4(1.0, 0.0, 0.0, 0.0)))).x;
    ...
    r0.z = ((asuint(r0.wwww) != 0u) ? (-(r0.zzzz)) : (r0.zzzz)).z;
    // 25: mad r0.z, r0.z, l(0.159155), l(0.500000)
    r0.z = ((r0.zzzz)*(float4(0.159155,0.159155,0.159155,0.159155))+(float4(0.500000,0.500000,0.500000,0.500000))).z;
    // 26: mul r0.z, r0.z, cb0[5].w
    r0.z = ((r0.zzzz)*(source[5].wwww)).z;
    // 27: mul r0.w, cb0[5].x, cb0[5].y
    r0.w = ((source[5].xxxx)*(source[5].yyyy)).w;
    // 28: mad r1.x, r0.w, cb0[5].z, r0.z
    r1.x = ((r0.wwww)*(source[5].zzzz)+(r0.zzzz)).x;
    // 29: mul r0.z, v4.z, cb0[6].y
    r0.z = ((v4.zzzz)*(source[6].yyyy)).z;
    // 30: dp2 r1.z, r0.xyxx, r0.xyxx
    r1.z = (dot((r0.xyxx).xy,(r0.xyxx).xy).xxxx).z;
    // 31: sqrt r1.z, r1.z
    r1.z = (sqrt(r1.zzzz)).z;
    // 32: add r1.w, r1.z, r1.z
    r1.w = ((r1.zzzz)+(r1.zzzz)).w;
    // 33: log r1.w, r1.w
    r1.w = (log2(r1.wwww)).w;
    // 34: mul r0.z, r0.z, r1.w
    r0.z = ((r0.zzzz)*(r1.wwww)).z;
    // 35: exp r0.z, r0.z
    r0.z = (exp2(r0.zzzz)).z;
    // 36: lt r1.w, r1.z, l(0.000000)
    r1.w = (asfloat((uint4)((r1.zzzz)<(float4(0.000000,0.000000,0.000000,0.000000))) * 0xffffffffu)).w;
    // 37: movc r0.z, r1.w, l(0), r0.z
    r0.z = ((asuint(r1.wwww) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.zzzz)).z;
    // 38: mul r0.z, r0.z, cb0[6].x
    r0.z = ((r0.zzzz)*(source[6].xxxx)).z;
    // 39: mad r1.y, r0.w, cb0[6].z, r0.z
    r1.y = ((r0.wwww)*(source[6].zzzz)+(r0.zzzz)).y;
    // 40: sample_l_indexable(texture2d)(float,float,float,float) r1.xyw, r1.xyxx, t2.xywz, s1, l(-1.000000)
    r1.xyw = (ArtistNativeSample0((r1.xyxx).xy, (float4(-1.000000,-1.000000,-1.000000,-1.000000)).x, true).xywz).xyw;
    // 41: dp3 r0.z, r1.xywx, l(0.300000, 0.590000, 0.110000, 0.000000)
    r0.z = (dot((r1.xywx).xyz,(float4(0.300000,0.590000,0.110000,0.000000)).xyz).xxxx).z;
    // 42: add r2.xyz, -r1.xywx, r0.zzzz
    r2.xyz = ((-(r1.xywx))+(r0.zzzz)).xyz;
    // 43: mad r1.xyw, cb0[6].wwww, r2.xyxz, r1.xyxw
    r1.xyw = ((source[6].wwww)*(r2.xyxz)+(r1.xyxw)).xyw;
    // 44: max r1.xyw, |r1.xyxw|, l(0.000001, 0.000001, 0.000000, 0.000001)
    r1.xyw = (max(abs(r1.xyxw),float4(0.000001,0.000001,0.000000,0.000001))).xyw;
    // 45: log r1.xyw, r1.xyxw
    r1.xyw = (log2(r1.xyxw)).xyw;
    // 46: mul r1.xyw, r1.xyxw, cb0[7].xxxx
    r1.xyw = ((r1.xyxw)*(source[7].xxxx)).xyw;
    // 47: exp r1.xyw, r1.xyxw
    r1.xyw = (exp2(r1.xyxw)).xyw;
    // 48: mul r2.xyz, cb0[2].xyzx, cb0[2].wwww
    r2.xyz = ((source[2].xyzx)*(source[2].wwww)).xyz;
    // 49: mul r1.xyw, r1.xyxw, r2.xyxz
    r1.xyw = ((r1.xyxw)*(r2.xyxz)).xyw;
    // 50: mad r1.xyw, r1.xyxw, v3.xyxz, cb0[1].xyxz
    r1.xyw = ((r1.xyxw)*(v3.xyxz)+(source[1].xyxz)).xyw;
    // 51: mul r1.xyw, r1.xyxw, v5.wwww
    r1.xyw = ((r1.xyxw)*(v5.wwww)).xyw;
    // 52: dp2 r2.x, cb0[3].xyxx, r0.xyxx
    r2.x = (dot((source[3].xyxx).xy,(r0.xyxx).xy).xxxx).x;
    // 53: dp2 r2.y, cb0[4].xyxx, r0.xyxx
    r2.y = (dot((source[4].xyxx).xy,(r0.xyxx).xy).xxxx).y;
    // 54: mad r0.xy, cb0[11].zzzz, r2.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
    r0.xy = ((source[11].zzzz)*(r2.xyxx)+(float4(0.500000,0.500000,0.000000,0.000000))).xy;
    // 55: sample_b_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t0.xyzw, s2, l(0.000000)
    r0.x = (ArtistNativeSample1((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).x;
    // 56: mad r0.y, -r1.z, cb0[7].w, l(1.000000)
    r0.y = ((-(r1.zzzz))*(source[7].wwww)+(float4(1.000000,1.000000,1.000000,1.000000))).y;
    // 57: mad r0.z, -r1.z, cb0[9].z, l(1.000000)
    r0.z = ((-(r1.zzzz))*(source[9].zzzz)+(float4(1.000000,1.000000,1.000000,1.000000))).z;
    // 58: mul_sat r0.z, r0.z, cb0[10].z
    r0.z = (saturate((r0.zzzz)*(source[10].zzzz))).z;
    // 59: mul_sat r0.y, r0.y, cb0[8].w
    r0.y = (saturate((r0.yyyy)*(source[8].wwww))).y;
    // 60: add r0.y, -r0.y, l(1.000000)
    r0.y = ((-(r0.yyyy))+(float4(1.000000,1.000000,1.000000,1.000000))).y;
    // 61: mul r0.y, r0.z, r0.y
    r0.y = ((r0.zzzz)*(r0.yyyy)).y;
    // 62: lt r0.z, r0.y, l(0.000001)
    r0.z = (asfloat((uint4)((r0.yyyy)<(float4(0.000001,0.000001,0.000001,0.000001))) * 0xffffffffu)).z;
    // 63: log r0.y, r0.y
    r0.y = (log2(r0.yyyy)).y;
    // 64: mul r0.y, r0.y, cb0[10].w
    ...
    // 72: exp r0.x, r0.x
    r0.x = (exp2(r0.xxxx)).x;
    // 73: div r0.zw, v7.xxxy, v7.wwww
    r0.zw = ((v7.xxxy)/(v7.wwww)).zw;
    // 74: mad r0.zw, r0.zzzw, cb2[0].xxxy, cb2[0].wwwz
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_m_pa_flowergarden_01_204_ts_dt_ad: 769d50cc54bd4e46b7dae36b27b358bb; selected map 6d128a5bf3c65db1689e2f86345cf367c3c925cb5369c131ab522c9d34ca1c00.
float4 ArtistNative882(ARTIST_NATIVE_INPUT input)
{
    float4 source[13]; [unroll] for (uint i=0u; i<13u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_m_pa_flowergarden_shine_02_02_dt_ad: 4c438a911de13a409f43aa84d58dd35c; selected map 1887c9428010069253d5938b52a44e701c298f0fb85c992be272fbc054d8c42c.
float4 ArtistNative883(ARTIST_NATIVE_INPUT input)
{
    float4 source[5]; [unroll] for (uint i=0u; i<5u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    // 62: mul_sat r0.x, r0.x, v3.w
    r0.x = (saturate((r0.xxxx)*(v3.wwww))).x;
    // 63: mad r1.x, cb0[3].y, v2.x, cb0[3].z
    r1.x = ((source[3].yyyy)*(v2.xxxx)+(source[3].zzzz)).x;
    // 64: mad r1.y, cb0[3].w, v2.y, cb0[4].x
    r1.y = ((source[3].wwww)*(v2.yyyy)+(source[4].xxxx)).y;
    // 65: sample_b_indexable(texture2d)(float,float,float,float) r0.y, r1.xyxx, t2.yxzw, s2, l(0.000000)
    r0.y = (ArtistNativeSample1((r1.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yxzw).y;
    ...
    r0.x = ((asuint(r0.xxxx) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.yyyy)).x;
    // 73: add r0.yzw, v3.xxyz, cb0[1].xxyz
    r0.yzw = ((v3.xxyz)+(source[1].xxyz)).yzw;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_x_pa_splitline_01_01_tr: e04ea2bffd830143bd3e8e4986fac611; selected map a4ea3a4eee34794c4643e3de3e4dd9f416dba5b37672f46c4787160ad075a1c2.
float4 ArtistNative884(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    r0.x = ((abs(r0.xxxx))*(source[2].yyyy)).x;
    // 3: log r0.y, |r0.x|
    r0.y = (log2(abs(r0.xxxx))).y;
    ...
    r0.x = ((asuint(r0.xxxx) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.yyyy)).x;
    // 8: mul r0.y, |v2.y|, |v2.y|
    r0.y = ((abs(v2.yyyy))*(abs(v2.yyyy))).y;
    // 9: mul r0.y, r0.y, |v2.y|
    r0.y = ((r0.yyyy)*(abs(v2.yyyy))).y;
    // 10: lt r0.z, |v2.y|, l(0.000001)
    ...
    r0.x = ((r0.xxxx)*(r0.yyyy)).x;
    // 13: log r0.y, |v2.y|
    r0.y = (log2(abs(v2.yyyy))).y;
    // 14: mul r0.y, r0.y, cb0[2].x
    r0.y = ((r0.yyyy)*(source[2].xxxx)).y;
    // 15: exp r0.y, r0.y
    r0.y = (exp2(r0.yyyy)).y;
    // 16: movc r0.y, r0.z, l(0), r0.y
    r0.y = ((asuint(r0.zzzz) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.yyyy)).y;
    // 17: mad r0.x, r0.x, l(0.350000), r0.y
    r0.x = ((r0.xxxx)*(float4(0.350000,0.350000,0.350000,0.350000))+(r0.yyyy)).x;
    // 18: mul r0.y, r0.x, v3.w
    r0.y = ((r0.xxxx)*(v3.wwww)).y;
    // 19: mad r0.xzw, v3.xxyz, r0.xxxx, cb0[1].xxyz
    r0.xzw = ((v3.xxyz)*(r0.xxxx)+(source[1].xxyz)).xzw;
    // 20: mad o0.xyz, r0.xzwx, v5.wwww, v5.xyzx
    output.xyz = ((r0.xzwx)*(v5.wwww)+(v5.xyzx)).xyz;
    // 21: mul o0.w, r0.y, cb0[0].x
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_m_me_flowergraden_2_ad: 4f28fc374f4fd94f8a32a1632fa2af10; selected map f552533451a95325eae54ca0431baed9b9472108d15bd484495b376d7ca99cea.
float4 ArtistNative885(ARTIST_NATIVE_INPUT input)
{
    float4 source[14]; [unroll] for (uint i=0u; i<14u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_d_pa_master_01_205_ts_dt5_ad: 6a14a7327072ab44bc23695f746c32c6; selected map b9323035f71da28d4aec74aaad63fd29d7669ae036ce95ddeaab49b8cca5fba7.
float4 ArtistNative886(ARTIST_NATIVE_INPUT input)
{
    float4 source[10]; [unroll] for (uint i=0u; i<10u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    source[4].x = (g_ArtistSourceMaterialParameters[5u].yyyy).x;
    source[4].y = (g_ArtistSourceMaterialTime.xxxx).x;
    source[4].z = (g_ArtistSourceMaterialParameters[1u].wwww).x;
    source[4].w = (g_ArtistSourceMaterialParameters[0u].wwww).x;
    source[5].x = (g_ArtistSourceMaterialParameters[1u].yyyy).x;
    ...
    source[6].w = (g_ArtistSourceMaterialParameters[5u].xxxx).x;
    source[7].x = (g_ArtistSourceMaterialParameters[1u].xxxx).x;
    source[7].y = (g_ArtistSourceMaterialParameters[0u].yyyy).x;
    ...
    // 1: mul r0.x, v2.x, cb0[4].w
    r0.x = ((v2.xxxx)*(source[4].wwww)).x;
    // 2: mul r0.y, cb0[4].x, cb0[4].y
    r0.y = ((source[4].xxxx)*(source[4].yyyy)).y;
    // 3: mad r1.x, r0.y, cb0[4].z, r0.x
    r1.x = ((r0.yyyy)*(source[4].zzzz)+(r0.xxxx)).x;
    // 4: mul r0.xz, v2.yyxy, cb0[5].xxwx
    r0.xz = ((v2.yyxy)*(source[5].xxwx)).xz;
    // 5: mad r1.yz, r0.yyyy, cb0[5].yyzy, r0.xxzx
    r1.yz = ((r0.yyyy)*(source[5].yyzy)+(r0.xxzx)).yz;
    // 6: sample_b_indexable(texture2d)(float,float,float,float) r0.xzw, r1.xyxx, t3.xwyz, s1, l(0.000000)
    r0.xzw = (ArtistNativeSample0((r1.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xwyz).xzw;
    // 7: mul r1.x, v2.y, cb0[6].x
    r1.x = ((v2.yyyy)*(source[6].xxxx)).x;
    // 8: mad r1.w, r0.y, cb0[6].y, r1.x
    r1.w = ((r0.yyyy)*(source[6].yyyy)+(r1.xxxx)).w;
    // 9: sample_b_indexable(texture2d)(float,float,float,float) r1.xyz, r1.zwzz, t4.xyzw, s2, l(0.000000)
    ...
    // 13: mad r0.xzw, cb0[6].zzzz, r1.xxyz, r0.xxzw
    r0.xzw = ((source[6].zzzz)*(r1.xxyz)+(r0.xxzw)).xzw;
    ...
    // 16: mul r0.xzw, r0.xxzw, cb0[6].wwww
    r0.xzw = ((r0.xxzw)*(source[6].wwww)).xzw;
    ...
    // 22: mul r1.xy, v2.xyxx, cb0[7].yzyy
    r1.xy = ((v2.xyxx)*(source[7].yzyy)).xy;
    // 23: mad r1.xy, r0.yyyy, cb0[7].xwxx, r1.xyxx
    r1.xy = ((r0.yyyy)*(source[7].xwxx)+(r1.xyxx)).xy;
    ...
    // 25: add r1.x, v4.y, l(-1.000000)
    r1.x = ((v4.yyyy)+(float4(-1.000000,-1.000000,-1.000000,-1.000000))).x;
    // 26: mad r1.y, cb0[4].y, cb0[8].y, cb0[8].z
    r1.y = ((source[4].yyyy)*(source[8].yyyy)+(source[8].zzzz)).y;
    // 27: sincos r2.x, r3.x, r1.y
    r2.x = (sin(r1.yyyy)).x; r3.x = (cos(r1.yyyy)).x;
    // 28: mov r4.x, -r2.x
    r4.x = (-(r2.xxxx)).x;
    // 29: add r1.yz, v2.xxyx, l(0.000000, -0.500000, -0.500000, 0.000000)
    ...
    // 34: mad r1.x, r1.y, cb0[3].x, r1.x
    r1.x = ((r1.yyyy)*(source[3].xxxx)+(r1.xxxx)).x;
    // 35: mul r1.z, r1.w, cb0[3].y
    r1.z = ((r1.wwww)*(source[3].yyyy)).z;
    // 36: add r1.xy, r1.xzxx, l(0.500000, 0.500000, 0.000000, 0.000000)
    r1.xy = ((r1.xzxx)+(float4(0.500000,0.500000,0.000000,0.000000))).xy;
    // 37: sample_b_indexable(texture2d)(float,float,float,float) r1.x, r1.xyxx, t1.xyzw, s4, l(0.000000)
    r1.x = (ArtistNativeSample3((r1.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).x;
    // 38: add r1.y, -v4.x, l(1.000000)
    r1.y = ((-(v4.xxxx))+(float4(1.000000,1.000000,1.000000,1.000000))).y;
    // 39: mad r0.y, r0.y, r1.x, -r1.y
    r0.y = ((r0.yyyy)*(r1.xxxx)+(-(r1.yyyy))).y;
    // 40: mul_sat r0.y, r0.y, cb0[9].y
    r0.y = (saturate((r0.yyyy)*(source[9].yyyy))).y;
    // 41: log r1.x, r0.y
    r1.x = (log2(r0.yyyy)).x;
    // 42: lt r0.y, r0.y, l(0.000001)
    r0.y = (asfloat((uint4)((r0.yyyy)<(float4(0.000001,0.000001,0.000001,0.000001))) * 0xffffffffu)).y;
    // 43: mul r1.x, r1.x, cb0[9].z
    r1.x = ((r1.xxxx)*(source[9].zzzz)).x;
    // 44: exp r1.x, r1.x
    r1.x = (exp2(r1.xxxx)).x;
    // 45: div r1.yz, v7.xxyx, v7.wwww
    r1.yz = ((v7.xxyx)/(v7.wwww)).yz;
    // 46: mad r1.yz, r1.yyzy, cb2[0].xxyx, cb2[0].wwzw
    ...
    r1.y = r1.y;
    // 53: add r1.y, r1.y, -v7.w
    r1.y = ((r1.yyyy)+(-(v7.wwww))).y;
    // 54: add r1.z, -cb0[9].w, l(1.000000)
    r1.z = ((-(source[9].wwww))+(float4(1.000000,1.000000,1.000000,1.000000))).z;
    // 55: max r1.z, -r1.z, l(0.001000)
    r1.z = (max(-(r1.zzzz),float4(0.001000,0.001000,0.001000,0.001000))).z;
    // 56: div_sat r1.y, r1.y, r1.z
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_m_pa_worldoffset_02_26_tr: a0f7f5723e826143b3970e44f6a045f2; selected map 556a53205748259b14772cac15cc51ca4b99fc29a3e8ad2940bdffdafc2ff11e.
float4 ArtistNative887(ARTIST_NATIVE_INPUT input)
{
    float4 source[18]; [unroll] for (uint i=0u; i<18u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_m_flowergarden_test_01_tr_inst: 224ce98a3bcf8a418e51c622d7e6427f; selected map bb2cd3c25e0c625682703246a1a815b0596873f6cb616db6311515b145e5cba3.
float4 ArtistNative888(ARTIST_NATIVE_INPUT input)
{
    ...
    source[4].y = (g_ArtistSourceMaterialParameters[11u].yyyy).x;
    source[4].z = (g_ArtistSourceMaterialParameters[5u].wwww).x;
    source[4].w = (g_ArtistSourceMaterialParameters[6u].zzzz).x;
    source[5].x = (g_ArtistSourceMaterialTime.xxxx).x;
    source[5].y = ((g_ArtistSourceMaterialTime.xxxx*g_ArtistSourceMaterialParameters[6u].zzzz)).x;
    source[5].z = (g_ArtistSourceMaterialParameters[7u].zzzz).x;
    source[5].w = (g_ArtistSourceMaterialParameters[6u].yyyy).x;
    source[6].x = (g_ArtistSourceMaterialParameters[10u].xxxx).x;
    source[6].y = (g_ArtistSourceMaterialParameters[4u].yyyy).x;
    source[6].z = (g_ArtistSourceMaterialParameters[1u].xxxx).x;
    source[6].w = ((g_ArtistSourceMaterialParameters[6u].yyyy*g_ArtistSourceMaterialTime.xxxx)).x;
    source[7].x = (g_ArtistSourceMaterialParameters[8u].wwww).x;
    source[7].y = (g_ArtistSourceMaterialParameters[3u].xxxx).x;
    source[7].z = (g_ArtistSourceMaterialParameters[11u].zzzz).x;
    source[7].w = (g_ArtistSourceMaterialParameters[6u].xxxx).x;
    source[8].x = (g_ArtistSourceMaterialParameters[7u].wwww).x;
    source[8].y = (g_ArtistSourceMaterialParameters[10u].yyyy).x;
    source[8].z = (g_ArtistSourceMaterialParameters[4u].zzzz).x;
    source[8].w = (g_ArtistSourceMaterialParameters[1u].yyyy).x;
    source[9].x = (g_ArtistSourceMaterialParameters[9u].xxxx).x;
    source[9].y = (g_ArtistSourceMaterialParameters[13u].xxxx).x;
    source[9].z = (g_ArtistSourceMaterialParameters[12u].zzzz).x;
    source[9].w = (g_ArtistSourceMaterialParameters[12u].wwww).x;
    ...
    source[11].x = (g_ArtistSourceMaterialParameters[10u].zzzz).x;
    source[11].y = (g_ArtistSourceMaterialParameters[5u].xxxx).x;
    source[11].z = (g_ArtistSourceMaterialParameters[6u].wwww).x;
    source[11].w = (g_ArtistSourceMaterialParameters[9u].yyyy).x;
    source[12].x = (g_ArtistSourceMaterialParameters[3u].yyyy).x;
    source[12].y = (g_ArtistSourceMaterialParameters[0u].xxxx).x;
    source[12].z = (g_ArtistSourceMaterialParameters[8u].xxxx).x;
    source[12].w = (g_ArtistSourceMaterialParameters[11u].wwww).x;
    source[13].x = (g_ArtistSourceMaterialParameters[13u].yyyy).x;
    source[13].y = (g_ArtistSourceMaterialParameters[1u].wwww).x;
    source[13].z = (g_ArtistSourceMaterialParameters[10u].wwww).x;
    ...
    source[14].z = (g_ArtistSourceMaterialParameters[3u].zzzz).x;
    source[14].w = (g_ArtistSourceMaterialParameters[0u].yyyy).x;
    source[15].x = (g_ArtistSourceMaterialParameters[8u].yyyy).x;
    source[15].y = (g_ArtistSourceMaterialParameters[12u].xxxx).x;
    source[15].z = (g_ArtistSourceMaterialParameters[13u].zzzz).x;
    source[15].w = (g_ArtistSourceMaterialParameters[2u].xxxx).x;
    source[16].x = (g_ArtistSourceMaterialParameters[11u].xxxx).x;
    source[16].y = (g_ArtistSourceMaterialParameters[5u].zzzz).x;
    source[16].z = (g_ArtistSourceMaterialParameters[7u].yyyy).x;
    source[16].w = (g_ArtistSourceMaterialParameters[9u].wwww).x;
    source[17].x = (g_ArtistSourceMaterialParameters[3u].wwww).x;
    source[17].y = (g_ArtistSourceMaterialParameters[0u].zzzz).x;
    source[17].z = (g_ArtistSourceMaterialParameters[8u].zzzz).x;
    source[17].w = (g_ArtistSourceMaterialParameters[12u].yyyy).x;
    source[18].x = (g_ArtistSourceMaterialParameters[4u].xxxx).x;
    source[18].y = (g_ArtistSourceMaterialParameters[4u].wwww).x;
    float4 passValues[4]={float4(.5f,-.5f,.5f,.5f),float4(0.f,0.f,0.f,0.f),float4(0.f,0.f,0.f,0.f),float4(0.f,0.f,0.f,0.f)};
    float4 v0 = float4(input.sourceBasisX,0.f); // native texcoord10
    float4 v1 = float4(input.sourceBasisZ,input.handedness); // native texcoord11
    float4 v2 = input.vertexColor; // native color0
    ...
    r0.z = ((r0.wwww)*(r0.zzzz)).z;
    // 29: mad r0.w, cb0[3].x, cb0[16].x, cb0[16].y
    r0.w = ((source[3].xxxx)*(source[16].xxxx)+(source[16].yyyy)).w;
    // 30: mad r0.w, v4.y, cb0[15].w, r0.w
    r0.w = ((v4.yyyy)*(source[15].wwww)+(r0.wwww)).w;
    // 31: mad r1.x, cb0[3].x, cb0[16].w, cb0[17].x
    r1.x = ((source[3].xxxx)*(source[16].wwww)+(source[17].xxxx)).x;
    // 32: mad r1.x, cb0[17].y, v4.x, r1.x
    r1.x = ((source[17].yyyy)*(v4.xxxx)+(r1.xxxx)).x;
    // 33: mad r2.x, cb0[16].z, r0.w, r1.x
    r2.x = ((source[16].zzzz)*(r0.wwww)+(r1.xxxx)).x;
    // 34: mad r2.y, r1.x, cb0[17].z, r0.w
    r2.y = ((r1.xxxx)*(source[17].zzzz)+(r0.wwww)).y;
    // 35: mad r1.xy, cb0[17].wwww, r0.xyxx, r2.xyxx
    r1.xy = ((source[17].wwww)*(r0.xyxx)+(r2.xyxx)).xy;
    // 36: sample_b_indexable(texture2d)(float,float,float,float) r0.w, r1.xyxx, t3.yzwx, s4, l(0.000000)
    r0.w = (ArtistNativeSample4((r1.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yzwx).w;
    // 37: mul r0.z, r0.w, r0.z
    r0.z = ((r0.wwww)*(r0.zzzz)).z;
    // 38: max r0.z, |r0.z|, l(0.000001)
    r0.z = (max(abs(r0.zzzz),float4(0.000001,0.000001,0.000001,0.000001))).z;
    // 39: log r0.z, r0.z
    r0.z = (log2(r0.zzzz)).z;
    // 40: mul r0.w, cb0[3].w, cb0[18].x
    r0.w = ((source[3].wwww)*(source[18].xxxx)).w;
    // 41: mul r0.z, r0.z, r0.w
    r0.z = ((r0.zzzz)*(r0.wwww)).z;
    // 42: exp r0.z, r0.z
    r0.z = (exp2(r0.zzzz)).z;
    // 43: mul_sat r0.z, r0.z, cb0[18].y
    r0.z = (saturate((r0.zzzz)*(source[18].yyyy))).z;
    // 44: mul_sat r0.z, r0.z, cb0[1].w
    r0.z = (saturate((r0.zzzz)*(source[1].wwww))).z;
    // 45: mul o0.w, r0.z, cb0[0].x
    output.w = ((r0.zzzz)*(source[0].xxxx)).w;
    // 46: mad r0.z, cb0[3].x, cb0[4].y, cb0[4].z
    r0.z = ((source[3].xxxx)*(source[4].yyyy)+(source[4].zzzz)).z;
    // 47: mad r0.z, v4.y, cb0[4].x, r0.z
    r0.z = ((v4.yyyy)*(source[4].xxxx)+(r0.zzzz)).z;
    // 48: add r0.z, r0.z, cb0[5].y
    r0.z = ((r0.zzzz)+(source[5].yyyy)).z;
    // 49: mad r0.w, cb0[3].x, cb0[6].x, cb0[6].y
    r0.w = ((source[3].xxxx)*(source[6].xxxx)+(source[6].yyyy)).w;
    // 50: mad r0.w, cb0[6].z, v4.x, r0.w
    r0.w = ((source[6].zzzz)*(v4.xxxx)+(r0.wwww)).w;
    // 51: add r0.w, r0.w, cb0[6].w
    r0.w = ((r0.wwww)+(source[6].wwww)).w;
    // 52: mad r1.x, cb0[5].z, r0.z, r0.w
    r1.x = ((source[5].zzzz)*(r0.zzzz)+(r0.wwww)).x;
    // 53: mad r1.y, r0.w, cb0[7].x, r0.z
    r1.y = ((r0.wwww)*(source[7].xxxx)+(r0.zzzz)).y;
    // 54: mad r0.xy, cb0[9].zzzz, r0.xyxx, r1.xyxx
    r0.xy = ((source[9].zzzz)*(r0.xyxx)+(r1.xyxx)).xy;
    // 55: sample_b_indexable(texture2d)(float,float,float,float) r0.xyz, r0.xyxx, t4.xyzw, s1, l(0.000000)
    r0.xyz = (ArtistNativeSample1((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 56: dp3 r0.w, r0.xyzx, l(0.300000, 0.590000, 0.110000, 0.000000)
    r0.w = (dot((r0.xyzx).xyz,(float4(0.300000,0.590000,0.110000,0.000000)).xyz).xxxx).w;
    // 57: add r1.xyz, -r0.xyzx, r0.wwww
    r1.xyz = ((-(r0.xyzx))+(r0.wwww)).xyz;
    // 58: mad r0.xyz, cb0[9].wwww, r1.xyzx, r0.xyzx
    r0.xyz = ((source[9].wwww)*(r1.xyzx)+(r0.xyzx)).xyz;
    // 59: max r0.xyz, |r0.xyzx|, l(0.000001, 0.000001, 0.000001, 0.000000)
    r0.xyz = (max(abs(r0.xyzx),float4(0.000001,0.000001,0.000001,0.000000))).xyz;
    // 60: log r0.xyz, r0.xyzx
    r0.xyz = (log2(r0.xyzx)).xyz;
    // 61: mul r0.xyz, r0.xyzx, cb0[10].xxxx
    r0.xyz = ((r0.xyzx)*(source[10].xxxx)).xyz;
    // 62: exp r0.xyz, r0.xyzx
    r0.xyz = (exp2(r0.xyzx)).xyz;
    // 63: mad r0.xyz, cb0[10].yyyy, r0.xyzx, cb0[10].zzzz
...
float4 ArtistNative889(ARTIST_NATIVE_INPUT input)
{
    float4 source[6]; [unroll] for (uint i=0u; i<6u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    r1.xyz = (ArtistNativeSample0((r2.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, true).xyzw).xyz;
...
float4 ArtistNative890(ARTIST_NATIVE_INPUT input)
{
    float4 source[2]; [unroll] for (uint i=0u; i<2u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_m_pa_shine_02_01_ad: dc1f0c23c50f944f90c2b61310c3a529; selected map f043093e1ccced8ac3926f3339da3f84ef1355a649d73c76d972dc74d97c9e23.
float4 ArtistNative891(ARTIST_NATIVE_INPUT input)
{
    float4 source[10]; [unroll] for (uint i=0u; i<10u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    // 42: movc r0.x, r0.y, l(0), r0.x
    r0.x = ((asuint(r0.yyyy) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.xxxx)).x;
    // 43: mad_sat r0.x, r0.x, r0.w, r0.w
    r0.x = (saturate((r0.xxxx)*(r0.wwww)+(r0.wwww))).x;
    // 44: log r0.y, r0.z
    r0.y = (log2(r0.zzzz)).y;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_m_me_flowergarden_sky_01: 38a74c088c723a4094ea288f0a1b4014; selected map 4bd09fe79b27410630f15a48876afaff90a0e467d3bdfe9cad80cc58c6dd2f58.
float4 ArtistNative892(ARTIST_NATIVE_INPUT input)
{
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_k_pa_makeflow_03_03_tr: b7fba3d7f5a5dd4bac4b55216b447962; selected map cc98d515357c137c204955f6aab619bb64a9b46b3720cfe06ed57a959156e3d6.
float4 ArtistNative893(ARTIST_NATIVE_INPUT input)
{
    float4 source[13]; [unroll] for (uint i=0u; i<13u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    source[8] = ArtistNativeAppend(g_ArtistSourceMaterialParameters[4u].yyyy,g_ArtistSourceMaterialParameters[4u].zzzz,1u);
    ...
    source[10].x = ((g_ArtistSourceMaterialTime.xxxx*g_ArtistSourceMaterialParameters[1u].yyyy)).x;
    source[10].y = ((g_ArtistSourceMaterialTime.xxxx*g_ArtistSourceMaterialParameters[1u].xxxx)).x;
    ...
    // 30: sample_b_indexable(texture2d)(float,float,float,float) r1.x, r0.zwzz, t0.xyzw, s0, l(0.000000)
    r1.x = (ArtistNativeSample0((r0.zwzz).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).x;
    // 31: mov r2.w, cb0[9].z
    r2.w = (source[9].zzzz).w;
    // 32: mov r2.yz, l(0,0,0,0)
    r2.yz = (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))).yz;
    // 33: add r3.xyzw, r0.zwzw, r2.wzzw
    r3.xyzw = ((r0.zwzw)+(r2.wzzw)).xyzw;
    // 34: sample_b_indexable(texture2d)(float,float,float,float) r0.z, r3.xyxx, t0.yzxw, s0, l(0.000000)
    r0.z = (ArtistNativeSample0((r3.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yzxw).z;
    // 35: sample_b_indexable(texture2d)(float,float,float,float) r0.w, r3.zwzz, t0.yzwx, s0, l(0.000000)
    r0.w = (ArtistNativeSample0((r3.zwzz).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yzwx).w;
    // 36: add r3.xy, -r1.xxxx, r0.zwzz
    r3.xy = ((-(r1.xxxx))+(r0.zwzz)).xy;
    // 37: mul r1.xy, r3.xyxx, l(8.000000, 8.000000, 0.000000, 0.000000)
    ...
    r3.x = (v4.wwww).x;
    // 47: mov r3.y, l(0)
    r3.y = (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))).y;
    // 48: add r1.xy, r1.xyxx, r3.xyxx
    r1.xy = ((r1.xyxx)+(r3.xyxx)).xy;
    // 49: add r1.xy, r1.xyxx, cb0[5].xyxx
    r1.xy = ((r1.xyxx)+(source[5].xyxx)).xy;
    // 50: sample_b_indexable(texture2d)(float,float,float,float) r1.xyz, r1.xyxx, t2.xyzw, s1, l(0.000000)
    r1.xyz = (ArtistNativeSample1((r1.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 51: mad r2.zw, r0.xxxy, cb0[6].xxxy, r0.zzzw
    r2.zw = ((r0.xxxy)*(source[6].xxxy)+(r0.zzzw)).zw;
    // 52: add r2.zw, r2.zzzw, cb0[7].xxxy
    r2.zw = ((r2.zzzw)+(source[7].xxxy)).zw;
    // 53: sample_b_indexable(texture2d)(float,float,float,float) r3.xyz, r2.zwzz, t3.xyzw, s2, l(0.000000)
    ...
    // 56: mad r1.xyz, -r1.xyzx, r3.xyzx, r1.wwww
    r1.xyz = ((-(r1.xyzx))*(r3.xyzx)+(r1.wwww)).xyz;
    // 57: mad r1.xyz, cb0[10].zzzz, r1.xyzx, r4.xyzx
    r1.xyz = ((source[10].zzzz)*(r1.xyzx)+(r4.xyzx)).xyz;
    // 58: max r1.xyz, |r1.xyzx|, l(0.000001, 0.000001, 0.000001, 0.000000)
    r1.xyz = (max(abs(r1.xyzx),float4(0.000001,0.000001,0.000001,0.000000))).xyz;
    // 59: log r1.xyz, r1.xyzx
    r1.xyz = (log2(r1.xyzx)).xyz;
    // 60: mul r1.xyz, r1.xyzx, cb0[10].wwww
    r1.xyz = ((r1.xyzx)*(source[10].wwww)).xyz;
    // 61: exp r1.xyz, r1.xyzx
    r1.xyz = (exp2(r1.xyzx)).xyz;
    // 62: mul r1.xyz, r1.xyzx, cb0[11].xxxx
    ...
    // 65: mov r2.x, v4.y
    r2.x = (v4.yyyy).x;
    // 66: mad r1.xy, r0.xyxx, cb0[8].xyxx, r2.xyxx
    r1.xy = ((r0.xyxx)*(source[8].xyxx)+(r2.xyxx)).xy;
    // 67: mad r0.yz, cb0[11].wwww, r0.zzwz, r1.xxyx
    r0.yz = ((source[11].wwww)*(r0.zzwz)+(r1.xxyx)).yz;
    // 68: sample_b_indexable(texture2d)(float,float,float,float) r0.y, r0.yzyy, t1.yxzw, s3, l(0.000000)
    r0.y = (ArtistNativeSample3((r0.yzyy).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yxzw).y;
    // 69: max r0.y, |r0.y|, l(0.000001)
    r0.y = (max(abs(r0.yyyy),float4(0.000001,0.000001,0.000001,0.000001))).y;
    // 70: log r0.y, r0.y
    r0.y = (log2(r0.yyyy)).y;
    // 71: mul r0.y, r0.y, cb0[12].x
    r0.y = ((r0.yyyy)*(source[12].xxxx)).y;
    // 72: exp r0.y, r0.y
    r0.y = (exp2(r0.yyyy)).y;
    // 73: add r0.z, -|r0.x|, l(1.000000)
    r0.z = ((-(abs(r0.xxxx)))+(float4(1.000000,1.000000,1.000000,1.000000))).z;
    // 74: mul r0.x, r0.z, |r0.x|
    r0.x = ((r0.zzzz)*(abs(r0.xxxx))).x;
    // 75: lt r0.z, |r0.x|, l(0.000001)
    r0.z = (asfloat((uint4)((abs(r0.xxxx))<(float4(0.000001,0.000001,0.000001,0.000001))) * 0xffffffffu)).z;
    // 76: log r0.x, |r0.x|
    r0.x = (log2(abs(r0.xxxx))).x;
    // 77: mul r0.xy, r0.xyxx, cb0[12].zyzz
    r0.xy = ((r0.xyxx)*(source[12].zyzz)).xy;
    // 78: exp r0.x, r0.x
    r0.x = (exp2(r0.xxxx)).x;
    // 79: movc r0.x, r0.z, l(0), r0.x
    r0.x = ((asuint(r0.zzzz) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.xxxx)).x;
    // 80: mul_sat r0.x, r0.y, r0.x
    r0.x = (saturate((r0.yyyy)*(r0.xxxx))).x;
    // 81: mul r0.x, r0.x, v3.w
    r0.x = ((r0.xxxx)*(v3.wwww)).x;
    // 82: mul o0.w, r0.x, cb0[0].x
    output.w = ((r0.xxxx)*(source[0].xxxx)).w;
    return output;
}
#endif
...
float4 ArtistNative894(ARTIST_NATIVE_INPUT input)
{
