// Original Kouku material programs 3712..3775; native IDs and expressions are unchanged.
...
float4 ArtistNative3712(ARTIST_NATIVE_INPUT input)
{
...
float4 ArtistNative3713(ARTIST_NATIVE_INPUT input)
{
...
float4 ArtistNative3714(ARTIST_NATIVE_INPUT input)
{
...
float4 ArtistNative3714Distortion(ARTIST_NATIVE_INPUT input)
{
...
float4 ArtistNative3715(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative3716(ARTIST_NATIVE_INPUT input)
{
...
float4 ArtistNative3717(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_d_pa_master_01_060_tr: 276bb89ef84f0c4ab375048a3a166d50; selected map 45b0e17bd603902cfda17dd14cabcf9f3acdff2be74eb951eefa6ff065045cbe.
float4 ArtistNative3718(ARTIST_NATIVE_INPUT input)
{
    ...
    source[6].w = (g_ArtistSourceMaterialParameters[4u].wwww).x;
    ...
    source[8].z = ((float4(-0.523599029, 0.0, 0.0, 0.0)*g_ArtistSourceMaterialParameters[3u].zzzz)).x;
    ...
    // 22: mul r0.xz, v2.xxyx, cb0[7].yyzy
    r0.xz = ((v2.xxyx)*(source[7].yyzy)).xz;
    // 23: mad r0.xy, r0.yyyy, cb0[7].xwxx, r0.xzxx
    r0.xy = ((r0.yyyy)*(source[7].xwxx)+(r0.xzxx)).xy;
    // 24: sample_b_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t0.xyzw, s2, l(0.000000)
    r0.x = (ArtistNativeSample2((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).x;
    // 25: mad r0.y, cb0[4].y, cb0[8].y, cb0[8].z
    r0.y = ((source[4].yyyy)*(source[8].yyyy)+(source[8].zzzz)).y;
    // 26: sincos r1.x, r2.x, r0.y
    r1.x = (sin(r0.yyyy)).x; r2.x = (cos(r0.yyyy)).x;
    // 27: mov r3.x, -r1.x
    r3.x = (-(r1.xxxx)).x;
    ...
    // 30: mov r3.z, r1.x
    r3.z = (r1.xxxx).z;
    // 31: dp2 r1.y, r3.zyzz, r0.yzyy
    r1.y = (dot((r3.zyzz).xy,(r0.yzyy).xy).xxxx).y;
    // 32: dp2 r1.x, r3.yxyy, r0.yzyy
    r1.x = (dot((r3.yxyy).xy,(r0.yzyy).xy).xxxx).x;
    // 33: mad r0.yz, r1.xxyx, cb0[3].xxyx, l(0.000000, 0.500000, 0.500000, 0.000000)
    r0.yz = ((r1.xxyx)*(source[3].xxyx)+(float4(0.000000,0.500000,0.500000,0.000000))).yz;
    // 34: sample_b_indexable(texture2d)(float,float,float,float) r0.y, r0.yzyy, t1.yxzw, s3, l(0.000000)
    r0.y = (ArtistNativeSample3((r0.yzyy).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yxzw).y;
    // 35: mul r0.x, r0.y, r0.x
    r0.x = ((r0.yyyy)*(r0.xxxx)).x;
    // 36: mul_sat r0.x, r0.x, cb0[9].y
    r0.x = (saturate((r0.xxxx)*(source[9].yyyy))).x;
    // 37: log r0.y, r0.x
    r0.y = (log2(r0.xxxx)).y;
    // 38: lt r0.x, r0.x, l(0.000001)
    r0.x = (asfloat((uint4)((r0.xxxx)<(float4(0.000001,0.000001,0.000001,0.000001))) * 0xffffffffu)).x;
    // 39: mul r0.y, r0.y, cb0[9].z
    r0.y = ((r0.yyyy)*(source[9].zzzz)).y;
    // 40: exp r0.y, r0.y
    r0.y = (exp2(r0.yyyy)).y;
    // 41: mul_sat r0.y, r0.y, v3.w
    r0.y = (saturate((r0.yyyy)*(v3.wwww))).y;
    // 42: mul r0.y, r0.y, cb0[0].x
    r0.y = ((r0.yyyy)*(source[0].xxxx)).y;
    // 43: movc o0.w, r0.x, l(0), r0.y
    output.w = ((asuint(r0.xxxx) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.yyyy)).w;
    return output;
}
#endif
...
float4 ArtistNative3718Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_PARTICLE_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_k_pa_waterribbon_01_11_tr: 60489df85025ee4ba6b810db5e142f9a; selected map 81d674443d6cdbfbf3ac4bbc2bffabd834c314ebbba584dd43fb398eca9cb191.
float4 ArtistNative3719(ARTIST_NATIVE_INPUT input)
{
    ...
    // 3: mad r0.xyzw, v2.zwzw, cb0[3].xyxy, r0.yxxy
    r0.xyzw = ((v2.zwzw)*(source[3].xyxy)+(r0.yxxy)).xyzw;
    ...
    // 6: mul r0.zw, v2.zzzw, cb0[3].xxxy
    r0.zw = ((v2.zzzw)*(source[3].xxxy)).zw;
    ...
    // 16: add r0.zw, v2.zzzw, cb0[8].xxxy
    r0.zw = ((v2.zzzw)+(source[8].xxxy)).zw;
    // 17: mad r0.zw, r0.xxxy, l(0.000000, 0.000000, 1.000000, 0.200000), r0.zzzw
    r0.zw = ((r0.xxxy)*(float4(0.000000,0.000000,1.000000,0.200000))+(r0.zzzw)).zw;
    // 18: mul r0.xy, r0.xyxx, l(1.000000, 0.200000, 0.000000, 0.000000)
    r0.xy = ((r0.xyxx)*(float4(1.000000,0.200000,0.000000,0.000000))).xy;
    // 19: add r0.zw, r0.zzzw, cb0[9].xxxy
    r0.zw = ((r0.zzzw)+(source[9].xxxy)).zw;
    // 20: sample_b_indexable(texture2d)(float,float,float,float) r0.z, r0.zwzz, t1.yzxw, s3, l(0.000000)
    r0.z = (ArtistNativeSample3((r0.zwzz).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yzxw).z;
    // 21: max r0.z, |r0.z|, l(0.000001)
    r0.z = (max(abs(r0.zzzz),float4(0.000001,0.000001,0.000001,0.000001))).z;
    // 22: log r0.z, r0.z
    r0.z = (log2(r0.zzzz)).z;
    // 23: mul r0.z, r0.z, cb0[13].z
    r0.z = ((r0.zzzz)*(source[13].zzzz)).z;
    // 24: exp r0.z, r0.z
    r0.z = (exp2(r0.zzzz)).z;
    // 25: mad r1.xy, v2.zwzz, cb0[7].xyxx, r0.xyxx
    r1.xy = ((v2.zwzz)*(source[7].xyxx)+(r0.xyxx)).xy;
    // 26: mad r0.xy, v2.zwzz, cb0[2].xyxx, r0.xyxx
    r0.xy = ((v2.zwzz)*(source[2].xyxx)+(r0.xyxx)).xy;
    // 27: add r0.xy, r0.xyxx, cb0[4].xyxx
    ...
    // 33: mul r1.xyz, r1.xyzx, cb0[12].yyyy
    r1.xyz = ((r1.xyzx)*(source[12].yyyy)).xyz;
    // 34: exp r1.xyz, r1.xyzx
    r1.xyz = (exp2(r1.xyzx)).xyz;
    // 35: mad r1.xyz, -cb0[12].zzzz, r1.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
    ...
    // 59: add r2.xyz, -r0.xywx, r0.zzzz
    r2.xyz = ((-(r0.xywx))+(r0.zzzz)).xyz;
    // 60: mad r0.xyz, cb0[11].xxxx, r2.xyzx, r0.xywx
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_PARTICLE_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative3719Distortion(ARTIST_NATIVE_INPUT input)
{
    ...
    // 2: mov r0.x, l(0)
    r0.x = (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))).x;
    // 3: mad r0.xyzw, v1.zwzw, cb0[0].xyxy, r0.yxxy
    r0.xyzw = ((v1.zwzw)*(source[0].xyxy)+(r0.yxxy)).xyzw;
    ...
    r0.y = (ArtistNativeSample0((r0.zwzz).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yxzw).y;
    // 6: mul r0.zw, v1.zzzw, cb0[0].xxxy
    r0.zw = ((v1.zzzw)*(source[0].xxxy)).zw;
    ...
    // 15: mad r0.xy, r0.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000), l(0.500000, 0.500000, 0.000000, 0.000000)
    r0.xy = ((r0.xyxx)*(float4(0.500000,0.500000,0.000000,0.000000))+(float4(0.500000,0.500000,0.000000,0.000000))).xy;
    // 16: mul r0.zw, r0.xxxy, l(0.000000, 0.000000, 1.000000, 0.200000)
    r0.zw = ((r0.xxxy)*(float4(0.000000,0.000000,1.000000,0.200000))).zw;
    // 17: mad r0.zw, v1.zzzw, cb0[1].xxxy, r0.zzzw
    ...
    // 19: add r1.xyzw, r0.zwzw, cb0[5].wwww
    r1.xyzw = ((r0.zwzw)+(source[5].wwww)).xyzw;
    // 20: mul r1.xyzw, r1.xyzw, cb0[6].xxxx
    r1.xyzw = ((r1.xyzw)*(source[6].xxxx)).xyzw;
    // 21: mul r1.xyzw, r1.xyzw, l(6.283185, 6.283185, 6.283185, 6.283185)
    r1.xyzw = ((r1.xyzw)*(float4(6.283185,6.283185,6.283185,6.283185))).xyzw;
    // 22: sincos r1.xyzw, null, r1.xyzw
    r1.xyzw = (sin(r1.xyzw)).xyzw;
    // 23: max r1.xyzw, |r1.xyzw|, l(0.000001, 0.000001, 0.000001, 0.000001)
    r1.xyzw = (max(abs(r1.xyzw),float4(0.000001,0.000001,0.000001,0.000001))).xyzw;
    // 24: log r1.xyzw, r1.xyzw
    r1.xyzw = (log2(r1.xyzw)).xyzw;
    // 25: mul r1.xyzw, r1.xyzw, cb0[6].yyyy
    r1.xyzw = ((r1.xyzw)*(source[6].yyyy)).xyzw;
    // 26: exp r1.xyzw, r1.xyzw
    r1.xyzw = (exp2(r1.xyzw)).xyzw;
    // 27: mul_sat r1.xyzw, r1.xyzw, cb0[6].zzzz
    r1.xyzw = (saturate((r1.xyzw)*(source[6].zzzz))).xyzw;
    // 28: add r0.zw, v1.zzzw, cb0[2].xxxy
    r0.zw = ((v1.zzzw)+(source[2].xxxy)).zw;
    // 29: mad r0.xy, r0.xyxx, l(1.000000, 0.200000, 0.000000, 0.000000), r0.zwzz
    r0.xy = ((r0.xyxx)*(float4(1.000000,0.200000,0.000000,0.000000))+(r0.zwzz)).xy;
    // 30: add r0.xy, r0.xyxx, cb0[3].xyxx
    r0.xy = ((r0.xyxx)+(source[3].xyxx)).xy;
    // 31: sample_b_indexable(texture2d)(float,float,float,float) r0.xy, r0.xyxx, t1.xyzw, s3, l(0.000000)
    r0.xy = (ArtistNativeSample3((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xy;
    // 32: max r0.xyzw, |r0.xyxy|, l(0.000001, 0.000001, 0.000001, 0.000001)
    r0.xyzw = (max(abs(r0.xyxy),float4(0.000001,0.000001,0.000001,0.000001))).xyzw;
    // 33: log r0.xyzw, r0.xyzw
    r0.xyzw = (log2(r0.xyzw)).xyzw;
    // 34: mul r0.xyzw, r0.xyzw, cb0[5].zzzz
    r0.xyzw = ((r0.xyzw)*(source[5].zzzz)).xyzw;
    // 35: exp r0.xyzw, r0.xyzw
    r0.xyzw = (exp2(r0.xyzw)).xyzw;
    // 36: mul r0.xyzw, r1.xyzw, r0.xyzw
    r0.xyzw = ((r1.xyzw)*(r0.xyzw)).xyzw;
    // 37: mul r0.xyzw, r0.xyzw, cb0[6].wwww
    r0.xyzw = ((r0.xyzw)*(source[6].wwww)).xyzw;
    // 38: mad r1.x, v1.z, l(2.000000), l(-1.000000)
    r1.x = ((v1.zzzz)*(float4(2.000000,2.000000,2.000000,2.000000))+(float4(-1.000000,-1.000000,-1.000000,-1.000000))).x;
    // 39: add r1.x, -|r1.x|, l(1.000000)
    r1.x = ((-(abs(r1.xxxx)))+(float4(1.000000,1.000000,1.000000,1.000000))).x;
    // 40: log r1.y, |r1.x|
    r1.y = (log2(abs(r1.xxxx))).y;
    // 41: lt r1.x, |r1.x|, l(0.000001)
    r1.x = (asfloat((uint4)((abs(r1.xxxx))<(float4(0.000001,0.000001,0.000001,0.000001))) * 0xffffffffu)).x;
    // 42: mul r1.y, r1.y, cb0[7].x
    r1.y = ((r1.yyyy)*(source[7].xxxx)).y;
    // 43: exp r1.y, r1.y
    r1.y = (exp2(r1.yyyy)).y;
    // 44: mul r1.y, r1.y, l(3.000000)
    r1.y = ((r1.yyyy)*(float4(3.000000,3.000000,3.000000,3.000000))).y;
    // 45: min r1.y, r1.y, l(1.000000)
    r1.y = (min(r1.yyyy,float4(1.000000,1.000000,1.000000,1.000000))).y;
    // 46: movc r1.x, r1.x, l(0), r1.y
    r1.x = ((asuint(r1.xxxx) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r1.yyyy)).x;
    // 47: mul_sat r0.xyzw, r0.xyzw, r1.xxxx
    r0.xyzw = (saturate((r0.xyzw)*(r1.xxxx))).xyzw;
    // 48: mul r0.xyzw, r0.xyzw, v2.wwww
    r0.xyzw = ((r0.xyzw)*(v2.wwww)).xyzw;
    // 49: mul r0.xyzw, r0.xyzw, cb0[7].yyyy
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_k_me_floorstrm_10_ad: 5e2600088c9e3d4daf1817717375d476; selected map 93031c22f403159ea47b7db47f70cd8a9fef5b8140bc2342058923bccf6d95fe.
float4 ArtistNative3720(ARTIST_NATIVE_INPUT input)
{
    float4 source[10]; [unroll] for (uint i=0u; i<10u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    // 24: mul r0.y, v4.x, cb0[6].w
    r0.y = ((v4.xxxx)*(source[6].wwww)).y;
    // 25: mul r0.z, cb0[6].x, cb0[6].y
    r0.z = ((source[6].xxxx)*(source[6].yyyy)).z;
    // 26: mad r1.x, r0.z, cb0[6].z, r0.y
    r1.x = ((r0.zzzz)*(source[6].zzzz)+(r0.yyyy)).x;
    // 27: mul r0.y, v4.y, cb0[7].x
    r0.y = ((v4.yyyy)*(source[7].xxxx)).y;
    // 28: mad r1.y, r0.z, cb0[7].y, r0.y
    r1.y = ((r0.zzzz)*(source[7].yyyy)+(r0.yyyy)).y;
    // 29: sample_b_indexable(texture2d)(float,float,float,float) r0.yzw, r1.xyxx, t1.wxyz, s0, l(0.000000)
    ...
    // 32: mad r0.yzw, cb0[7].zzzz, r1.xxyz, r0.yyzw
...
float4 ArtistNative3720Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative3721(ARTIST_NATIVE_INPUT input)
{
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative3721Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_k_speedline_01_ad: 92df3678b2681f47a53ecce9a3ee0739; selected map aa1b265d6b86ba392eb6fb5f09a05a07ca94fe89c48b913da082cf8bd9b3786d.
float4 ArtistNative3722(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    source[1] = g_ArtistSourceMaterialParameters[0u];
    source[2] = ArtistNativeAppend(ArtistNativePeriodic(((g_ArtistSourceMaterialTime.xxxx*float4(1.0, 0.0, 0.0, 0.0))*float4(3.0, 0.0, 0.0, 0.0))),ArtistNativePeriodic(((g_ArtistSourceMaterialTime.xxxx*float4(1.0, 0.0, 0.0, 0.0))*float4(0.0, 0.0, 0.0, 0.0))),1u);
    float4 passValues[4]; [unroll] for(uint passIndex=0u;passIndex<4u;++passIndex) passValues[passIndex]=0.f;
    passValues[0]=float4(.5f,-.5f,.5f,.5f);
    float4 v0 = float4(input.sourceBasisX,0.f); // native texcoord10
    float4 v1 = float4(input.sourceBasisZ,input.handedness); // native texcoord11
    ...
    float4 v8 = asfloat(uint4(input.frontFace ? 0xffffffffu : 0u,0u,0u,0u)); // native sv_isfrontface0
    float4 r0=0.f, r1=0.f;
    // 1: mad r0.x, -v2.x, l(0.500000), l(1.000000)
    r0.x = ((-(v2.xxxx))*(float4(0.500000,0.500000,0.500000,0.500000))+(float4(1.000000,1.000000,1.000000,1.000000))).x;
    ...
    r0.x = ((asuint(r0.yyyy) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.xxxx)).x;
    // 5: add r0.x, r0.x, cb0[2].x
    r0.x = ((r0.xxxx)+(source[2].xxxx)).x;
    // 6: mad r0.y, v2.y, l(1.000000), cb0[2].y
    r0.y = ((v2.yyyy)*(float4(1.000000,1.000000,1.000000,1.000000))+(source[2].yyyy)).y;
    // 7: add r0.xy, r0.xyxx, l(-0.500000, 0.500000, 0.000000, 0.000000)
    r0.xy = ((r0.xyxx)+(float4(-0.500000,0.500000,0.000000,0.000000))).xy;
    // 8: dp2 r1.x, l(-0.999999, -0.001593, 0.000000, 0.000000), r0.xyxx
    r1.x = (dot((float4(-0.999999,-0.001593,0.000000,0.000000)).xy,(r0.xyxx).xy).xxxx).x;
    // 9: dp2 r1.y, l(0.001593, -0.999999, 0.000000, 0.000000), r0.xyxx
    r1.y = (dot((float4(0.001593,-0.999999,0.000000,0.000000)).xy,(r0.xyxx).xy).xxxx).y;
    // 10: add r0.xy, r1.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
    r0.xy = ((r1.xyxx)+(float4(0.500000,0.500000,0.000000,0.000000))).xy;
    // 11: sample_b_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t0.xyzw, s0, l(0.000000)
    r0.x = (ArtistNativeSample0((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).x;
    // 12: mad r0.xyz, r0.xxxx, v3.xyzx, cb0[1].xyzx
    r0.xyz = ((r0.xxxx)*(v3.xyzx)+(source[1].xyzx)).xyz;
    // 13: mul r0.xyz, r0.xyzx, v5.wwww
    r0.xyz = ((r0.xyzx)*(v5.wwww)).xyz;
    // 14: add r0.w, -v2.x, l(1.000000)
    r0.w = ((-(v2.xxxx))+(float4(1.000000,1.000000,1.000000,1.000000))).w;
    // 15: mul r0.w, |r0.w|, v3.w
    r0.w = ((abs(r0.wwww))*(v3.wwww)).w;
    // 16: mul r0.w, r0.w, cb0[0].x
    r0.w = ((r0.wwww)*(source[0].xxxx)).w;
    // 17: mul o0.xyz, r0.wwww, r0.xyzx
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_h_pa_line_01_01_ad: 37064a89e24fce4ba106e08265284174; selected map 135e1c070afa78fbaa175cec8f12ba5badb3b0f66724ce4fad31dcac0ace7e9e.
float4 ArtistNative3723(ARTIST_NATIVE_INPUT input)
{
    float4 source[8]; [unroll] for (uint i=0u; i<8u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative3723Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative3724(ARTIST_NATIVE_INPUT input)
{
...
float4 ArtistNative3725(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative3725Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_PARTICLE_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_j_me_hexashield_ad: 6fbd72acb5e71b45b89d1019f674ba95; selected map fbccdd3d597d3ebb4997163ce05e24a5823c31fb66e877f575a152d303dd3129.
float4 ArtistNative3726(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    // 5: mov r1.x, v4.x
    r1.x = (v4.xxxx).x;
    // 6: add r1.y, v4.y, cb0[3].x
    r1.y = ((v4.yyyy)+(source[3].xxxx)).y;
    // 7: sample_b_indexable(texture2d)(float,float,float,float) r0.y, r1.xyxx, t0.yxzw, s0, l(0.000000)
    r0.y = (ArtistNativeSample0((r1.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yxzw).y;
    // 8: mul r0.x, r0.x, r0.y
    r0.x = ((r0.xxxx)*(r0.yyyy)).x;
    // 9: mad r0.xyz, r0.xxxx, cb0[1].xyzx, cb0[2].xyzx
    r0.xyz = ((r0.xxxx)*(source[1].xyzx)+(source[2].xyzx)).xyz;
    // 10: mul r0.xyz, r0.xyzx, v5.wwww
    r0.xyz = ((r0.xyzx)*(v5.wwww)).xyz;
    // 11: mul r0.w, cb0[0].x, cb0[1].w
...
float4 ArtistNative3727(ARTIST_NATIVE_INPUT input)
{
    float4 source[6]; [unroll] for (uint i=0u; i<6u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative3728(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative3729(ARTIST_NATIVE_INPUT input)
{
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative3729Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative3730(ARTIST_NATIVE_INPUT input)
{
    float4 source[8]; [unroll] for (uint i=0u; i<8u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative3730Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative3731(ARTIST_NATIVE_INPUT input)
{
    float4 source[5]; [unroll] for (uint i=0u; i<5u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative3731Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative3732(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative3732Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative3733(ARTIST_NATIVE_INPUT input)
{
    float4 source[6]; [unroll] for (uint i=0u; i<6u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_PARTICLE_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_l_me_master_01_1_ts_ad: 96da793c4ee15348b51c8ee39728846c; selected map cef2e6969f09d926827eb6d54c6abaf8d717997086e52664d49dc0b1db9866f4.
float4 ArtistNative3734(ARTIST_NATIVE_INPUT input)
{
    ...
    source[13].x = ((float4(-0.523599029, 0.0, 0.0, 0.0)*g_ArtistSourceMaterialParameters[4u].wwww)).x;
    ...
    r0.x = (asfloat((uint4)((abs(r0.xxxx))<(float4(0.000001,0.000001,0.000001,0.000001))) * 0xffffffffu)).x;
    // 6: mul r0.y, r0.y, cb0[14].y
    r0.y = ((r0.yyyy)*(source[14].yyyy)).y;
    // 7: exp r0.y, r0.y
    r0.y = (exp2(r0.yyyy)).y;
    // 8: mul_sat r0.y, r0.y, cb0[14].z
    r0.y = (saturate((r0.yyyy)*(source[14].zzzz))).y;
    // 9: movc r0.x, r0.x, l(0), r0.y
    r0.x = ((asuint(r0.xxxx) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.yyyy)).x;
    // 10: add r0.y, cb0[5].y, l(-1.000000)
    r0.y = ((source[5].yyyy)+(float4(-1.000000,-1.000000,-1.000000,-1.000000))).y;
    // 11: mad r0.z, cb0[7].y, cb0[12].w, cb0[13].x
    ...
    // 15: mov r3.z, r1.x
    r3.z = (r1.xxxx).z;
    // 16: mul r0.zw, v4.xxxy, cb0[8].zzzw
    r0.zw = ((v4.xxxy)*(source[8].zzzw)).zw;
    // 17: mul r1.x, cb0[7].x, cb0[7].y
    r1.x = ((source[7].xxxx)*(source[7].yyyy)).x;
    // 18: mad r2.x, r1.x, cb0[8].y, r0.z
    r2.x = ((r1.xxxx)*(source[8].yyyy)+(r0.zzzz)).x;
    // 19: mad r2.y, r1.x, cb0[9].x, r0.w
    ...
    // 21: mad r0.zw, cb0[9].zzzz, r0.zzzw, v4.xxxy
    ...
    // 25: mul r2.z, r1.y, cb0[6].y
    r2.z = ((r1.yyyy)*(source[6].yyyy)).z;
    // 26: mad r2.x, r1.w, cb0[6].x, r0.y
    ...
    // 28: sample_b_indexable(texture2d)(float,float,float,float) r0.y, r1.yzyy, t2.yxzw, s4, l(0.000000)
    r0.y = (ArtistNativeSample4((r1.yzyy).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yxzw).y;
    // 29: mul r1.y, r0.z, cb0[11].w
    r1.y = ((r0.zzzz)*(source[11].wwww)).y;
    // 30: mad r2.x, r1.x, cb0[11].z, r1.y
    r2.x = ((r1.xxxx)*(source[11].zzzz)+(r1.yyyy)).x;
    // 31: mul r1.y, r0.w, cb0[12].x
    r1.y = ((r0.wwww)*(source[12].xxxx)).y;
    // 32: mad r0.zw, v4.yyyx, cb0[3].xxxy, r0.zzzw
    r0.zw = ((v4.yyyx)*(source[3].xxxy)+(r0.zzzw)).zw;
    // 33: mad r2.y, r1.x, cb0[12].y, r1.y
    ...
    r0.x = ((asuint(r0.yyyy) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.xxxx)).x;
    // 46: mul r0.y, r0.z, cb0[7].w
    r0.y = ((r0.zzzz)*(source[7].wwww)).y;
    // 47: mad r2.x, r1.x, cb0[7].z, r0.y
    r2.x = ((r1.xxxx)*(source[7].zzzz)+(r0.yyyy)).x;
    // 48: mul r0.y, r1.x, cb0[9].w
    r0.y = ((r1.xxxx)*(source[9].wwww)).y;
    // 49: mad r2.y, cb0[8].x, r0.w, r0.y
    r2.y = ((source[8].xxxx)*(r0.wwww)+(r0.yyyy)).y;
    // 50: mul r0.yz, r0.zzwz, cb0[10].yyzy
    r0.yz = ((r0.zzwz)*(source[10].yyzy)).yz;
    // 51: mad r0.yz, r1.xxxx, cb0[10].xxwx, r0.yyzy
    r0.yz = ((r1.xxxx)*(source[10].xxwx)+(r0.yyzy)).yz;
    // 52: sample_b_indexable(texture2d)(float,float,float,float) r0.yzw, r0.yzyy, t4.wxyz, s2, l(0.000000)
    r0.yzw = (ArtistNativeSample2((r0.yzyy).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).wxyz).yzw;
    // 53: sample_b_indexable(texture2d)(float,float,float,float) r1.xyz, r2.xyxx, t3.xyzw, s1, l(0.000000)
    ...
    // 57: mad r0.yzw, cb0[11].xxxx, r0.yyzw, r2.xxyz
    ...
    r0.yzw = (log2(r0.yyzw)).yzw;
    // 60: mul r0.yzw, r0.yyzw, cb0[11].yyyy
    r0.yzw = ((r0.yyzw)*(source[11].yyyy)).yzw;
    // 61: exp r0.yzw, r0.yyzw
    r0.yzw = (exp2(r0.yyzw)).yzw;
    // 62: mul r1.xyz, cb0[4].xyzx, cb0[4].wwww
    r1.xyz = ((source[4].xyzx)*(source[4].wwww)).xyz;
    // 63: mul r0.yzw, r0.yyzw, r1.xxyz
    r0.yzw = ((r0.yyzw)*(r1.xxyz)).yzw;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_PARTICLE_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative3734Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative3735(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative3736(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative3736Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// bfx_d_pa_circ_01_01_dt_ad: f1ee928cd5135a43b5f7ecda979adc4e; selected map 78660aa0098523388cfb3e8846030823e481eab40c423d1a96f4a05c73bfd2e3.
float4 ArtistNative3737(ARTIST_NATIVE_INPUT input)
{
    float4 source[6]; [unroll] for (uint i=0u; i<6u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative3738(ARTIST_NATIVE_INPUT input)
{
    float4 source[6]; [unroll] for (uint i=0u; i<6u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative3739(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_k_pa_ht_01_ad_2s: b0d551a53864c9408d2c03215f9ef88f; selected map 1e2b28d0fbac6bf09259d428d37a1fe8ee89e98c8ea38c1079f1e46a344ab1d3.
float4 ArtistNative3740(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative3740Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_h_pa_space_01_2_tr: 7b96472eaa78a74892829dab56fd8981; selected map 7ee17f4a28972f189cd11ecaee482615285c2e89672dca0a8ebd152348ad93ec.
float4 ArtistNative3741(ARTIST_NATIVE_INPUT input)
{
    float4 source[6]; [unroll] for (uint i=0u; i<6u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    source[1] = g_ArtistSourceMaterialParameters[1u];
    source[2] = ArtistNativeAppend(ArtistNativePeriodic((g_ArtistSourceMaterialTime.xxxx*float4(0.0, 0.0, 0.0, 0.0))),ArtistNativePeriodic((g_ArtistSourceMaterialTime.xxxx*float4(0.0, 0.0, 0.0, 0.0))),1u);
    source[3] = ArtistNativeAppend(ArtistNativePeriodic((g_ArtistSourceMaterialTime.xxxx*float4(0.00999999978, 0.0, 0.0, 0.0))),ArtistNativePeriodic((g_ArtistSourceMaterialTime.xxxx*float4(0.0, 0.0, 0.0, 0.0))),1u);
    source[4] = ArtistNativeAppend(ArtistNativePeriodic((g_ArtistSourceMaterialTime.xxxx*float4(-0.00999999978, 0.0, 0.0, 0.0))),ArtistNativePeriodic((g_ArtistSourceMaterialTime.xxxx*float4(0.0, 0.0, 0.0, 0.0))),1u);
    source[5].x = (ArtistNativePeriodic((g_ArtistSourceMaterialTime.xxxx*float4(0.00999999978, 0.0, 0.0, 0.0)))).x;
    source[5].y = ((g_ArtistSourceMaterialTime.xxxx*float4(-0.00999999978, 0.0, 0.0, 0.0))).x;
    source[5].z = (ArtistNativePeriodic((g_ArtistSourceMaterialTime.xxxx*float4(-0.00999999978, 0.0, 0.0, 0.0)))).x;
    ...
    // 4: mul r1.xyzw, v2.xyxy, l(3.000000, 2.000000, 3.000000, 3.000000)
    r1.xyzw = ((v2.xyxy)*(float4(3.000000,2.000000,3.000000,3.000000))).xyzw;
    // 5: mad r0.zw, r0.xxxy, l(0.000000, 0.000000, 0.025000, 0.025000), r1.xxxy
    r0.zw = ((r0.xxxy)*(float4(0.000000,0.000000,0.025000,0.025000))+(r1.xxxy)).zw;
    // 6: mad r1.xy, r0.xyxx, l(-0.075000, -0.075000, 0.000000, 0.000000), r1.zwzz
    r1.xy = ((r0.xyxx)*(float4(-0.075000,-0.075000,0.000000,0.000000))+(r1.zwzz)).xy;
    // 7: mad r0.xy, r0.xyxx, l(-0.225000, -0.225000, 0.000000, 0.000000), v2.xyxx
    r0.xy = ((r0.xyxx)*(float4(-0.225000,-0.225000,0.000000,0.000000))+(v2.xyxx)).xy;
    // 8: sample_b_indexable(texture2d)(float,float,float,float) r2.xyz, r0.xyxx, t1.xyzw, s0, l(0.000000)
    r2.xyz = (ArtistNativeSample0((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 9: add r0.xy, r1.xyxx, cb0[4].xyxx
    ...
    // 11: add r0.xy, r0.zwzz, cb0[3].xyxx
    r0.xy = ((r0.zwzz)+(source[3].xyxx)).xy;
    // 12: sample_b_indexable(texture2d)(float,float,float,float) r0.xyz, r0.xyxx, t3.xyzw, s2, l(0.000000)
    r0.xyz = (ArtistNativeSample2((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 13: mul r0.xyz, r1.xyzx, r0.xyzx
    r0.xyz = ((r1.xyzx)*(r0.xyzx)).xyz;
    // 14: add r1.xy, v2.xyxx, cb0[2].xyxx
    r1.xy = ((v2.xyxx)+(source[2].xyxx)).xy;
    // 15: sample_b_indexable(texture2d)(float,float,float,float) r1.xyz, r1.xyxx, t2.xyzw, s1, l(0.000000)
    r1.xyz = (ArtistNativeSample1((r1.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 16: mul r1.xyz, r1.xyzx, l(0.400000, 0.400000, 0.400000, 0.000000)
    r1.xyz = ((r1.xyzx)*(float4(0.400000,0.400000,0.400000,0.000000))).xyz;
    // 17: mad r1.xyz, r2.xyzx, l(0.050000, 0.050000, 0.050000, 0.000000), r1.xyzx
    r1.xyz = ((r2.xyzx)*(float4(0.050000,0.050000,0.050000,0.000000))+(r1.xyzx)).xyz;
    // 18: mad r0.xyz, r0.xyzx, l(20.000000, 20.000000, 20.000000, 0.000000), r1.xyzx
    r0.xyz = ((r0.xyzx)*(float4(20.000000,20.000000,20.000000,0.000000))+(r1.xyzx)).xyz;
    // 19: mul r0.xyz, r0.xyzx, v3.xyzx
    r0.xyz = ((r0.xyzx)*(v3.xyzx)).xyz;
    // 20: mad r0.xyz, cb0[5].wwww, r0.xyzx, cb0[1].xyzx
    r0.xyz = ((source[5].wwww)*(r0.xyzx)+(source[1].xyzx)).xyz;
    // 21: mad o0.xyz, r0.xyzx, v5.wwww, v5.xyzx
    output.xyz = ((r0.xyzx)*(v5.wwww)+(v5.xyzx)).xyz;
    // 22: add r0.xy, v2.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)
    r0.xy = ((v2.xyxx)+(float4(-0.500000,-0.500000,0.000000,0.000000))).xy;
    // 23: mul r0.xy, r0.xyxx, l(2.100000, 2.100000, 0.000000, 0.000000)
    r0.xy = ((r0.xyxx)*(float4(2.100000,2.100000,0.000000,0.000000))).xy;
    ...
    // 28: lt r0.x, r0.x, l(0.000001)
    r0.x = (asfloat((uint4)((r0.xxxx)<(float4(0.000001,0.000001,0.000001,0.000001))) * 0xffffffffu)).x;
    // 29: div r0.y, l(1.000000, 1.000000, 1.000000, 1.000000), r0.y
    r0.y = ((float4(1.000000,1.000000,1.000000,1.000000))/(r0.yyyy)).y;
    // 30: movc r0.x, r0.x, l(0), r0.y
    r0.x = ((asuint(r0.xxxx) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.yyyy)).x;
    // 31: sample_b_indexable(texture2d)(float,float,float,float) r0.y, v2.xyxx, t0.yxzw, s3, l(0.000000)
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_r_pa_shine_11_01_ad: f308e6c8bf787a4fbb242a07ff277211; selected map 7300c3c9b40788b80b30a5d639bda8170624b700959cd1ce48b334633e0f6586.
float4 ArtistNative3742(ARTIST_NATIVE_INPUT input)
{
    float4 source[10]; [unroll] for (uint i=0u; i<10u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_d_pa_ringmaster_01_221_tr: 61bd66f9ec1c9742aea7752429f1793c; selected map 37ed37204133c9d1a5f729b3cb2d4d916cd0909e96b40e04d3e3776d022520a3.
float4 ArtistNative3743(ARTIST_NATIVE_INPUT input)
{
    float4 source[6]; [unroll] for (uint i=0u; i<6u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    source[3].x = (g_ArtistSourceMaterialParameters[0u].xxxx).x;
    source[3].y = (max(float4(9.99999975e-06, 0.0, 0.0, 0.0),g_ArtistSourceMaterialParameters[0u].xxxx)).x;
    source[3].z = ((float4(1.0, 0.0, 0.0, 0.0)/max(float4(9.99999975e-06, 0.0, 0.0, 0.0),g_ArtistSourceMaterialParameters[0u].xxxx))).x;
    source[3].w = (g_ArtistSourceMaterialParameters[0u].yyyy).x;
    source[4].x = ((float4(1.0, 0.0, 0.0, 0.0)-g_ArtistSourceMaterialParameters[0u].yyyy)).x;
    source[4].y = (max((float4(1.0, 0.0, 0.0, 0.0)-g_ArtistSourceMaterialParameters[0u].yyyy),float4(9.99999975e-06, 0.0, 0.0, 0.0))).x;
    source[4].z = ((float4(1.0, 0.0, 0.0, 0.0)/max((float4(1.0, 0.0, 0.0, 0.0)-g_ArtistSourceMaterialParameters[0u].yyyy),float4(9.99999975e-06, 0.0, 0.0, 0.0)))).x;
    source[4].w = (g_ArtistSourceMaterialParameters[0u].zzzz).x;
    ...
    // 13: lt r0.x, r0.x, l(0.000001)
    r0.x = (asfloat((uint4)((r0.xxxx)<(float4(0.000001,0.000001,0.000001,0.000001))) * 0xffffffffu)).x;
    // 14: mul r0.y, r0.y, cb0[5].y
    r0.y = ((r0.yyyy)*(source[5].yyyy)).y;
    // 15: exp r0.y, r0.y
    r0.y = (exp2(r0.yyyy)).y;
    // 16: mul_sat r0.y, r0.y, v3.w
    r0.y = (saturate((r0.yyyy)*(v3.wwww))).y;
    // 17: mul r0.y, r0.y, cb0[0].x
    r0.y = ((r0.yyyy)*(source[0].xxxx)).y;
    // 18: movc o0.w, r0.x, l(0), r0.y
    output.w = ((asuint(r0.xxxx) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.yyyy)).w;
    // 19: mul r0.xyz, cb0[2].xyzx, cb0[2].wwww
    r0.xyz = ((source[2].xyzx)*(source[2].wwww)).xyz;
    // 20: mad r0.xyz, r0.xyzx, v3.xyzx, cb0[1].xyzx
    r0.xyz = ((r0.xyzx)*(v3.xyzx)+(source[1].xyzx)).xyz;
    // 21: mad o0.xyz, r0.xyzx, v5.wwww, v5.xyzx
    output.xyz = ((r0.xyzx)*(v5.wwww)+(v5.xyzx)).xyz;
    return output;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative3743Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative3744(ARTIST_NATIVE_INPUT input)
{
    float4 source[5]; [unroll] for (uint i=0u; i<5u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_u_pa_symbol_01_38_tr: f48897bc0c925a49a8239d91aa63a48b; selected map 5887896cca9edad7e605d1308d1d9993738ce72577458dcfa12b0ecae197d97c.
float4 ArtistNative3745(ARTIST_NATIVE_INPUT input)
{
    float4 source[6]; [unroll] for (uint i=0u; i<6u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    // 13: dp3 r0.w, r1.yzwy, l(0.300000, 0.590000, 0.110000, 0.000000)
    r0.w = (dot((r1.yzwy).xyz,(float4(0.300000,0.590000,0.110000,0.000000)).xyz).xxxx).w;
    // 14: mul_sat r1.x, r1.x, v3.w
    r1.x = (saturate((r1.xxxx)*(v3.wwww))).x;
    // 15: mul o0.w, r1.x, cb0[0].x
    output.w = ((r1.xxxx)*(source[0].xxxx)).w;
    // 16: mul r1.xyz, r0.wwww, v3.xyzx
    r1.xyz = ((r0.wwww)*(v3.xyzx)).xyz;
    // 17: mad r0.xyz, r0.xyzx, r1.xyzx, r1.xyzx
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_l_pa_cloudsmoke_01_tr: 32f96e1af146b84aa458bb86bb878fe0; selected map 42cfbbc19d2a6dac43f93ad7935b54c338d019a73f00cb816a0c5c0db9f07233.
float4 ArtistNative3746(ARTIST_NATIVE_INPUT input)
{
    float4 source[6]; [unroll] for (uint i=0u; i<6u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    source[1] = g_ArtistSourceMaterialParameters[2u];
    source[2] = ArtistNativeAppend(ArtistNativePeriodic((g_ArtistSourceMaterialTime.xxxx*float4(0.0, 0.0, 0.0, 0.0))),ArtistNativePeriodic((g_ArtistSourceMaterialTime.xxxx*float4(0.0250000004, 0.0, 0.0, 0.0))),1u);
    ...
    source[5].z = ((g_ArtistSourceMaterialTime.xxxx*float4(0.0500000007, 0.0, 0.0, 0.0))).x;
    source[5].w = (ArtistNativePeriodic((g_ArtistSourceMaterialTime.xxxx*float4(0.0500000007, 0.0, 0.0, 0.0)))).x;
    float4 passValues[4]; [unroll] for(uint passIndex=0u;passIndex<4u;++passIndex) passValues[passIndex]=0.f;
    passValues[0]=float4(.5f,-.5f,.5f,.5f);
    float4 v0 = float4(input.sourceBasisX,0.f); // native texcoord10
    float4 v1 = float4(input.sourceBasisZ,input.handedness); // native texcoord11
    ...
    float4 v8 = asfloat(uint4(input.frontFace ? 0xffffffffu : 0u,0u,0u,0u)); // native sv_isfrontface0
    float4 r0=0.f, r1=0.f, r2=0.f;
    // 1: mul r0.x, v4.x, l(0.250000)
    r0.x = ((v4.xxxx)*(float4(0.250000,0.250000,0.250000,0.250000))).x;
    ...
    // 6: mov r2.z, r0.x
    r2.z = (r0.xxxx).z;
    // 7: dp2 r1.y, r2.zyzz, r0.yzyy
    r1.y = (dot((r2.zyzz).xy,(r0.yzyy).xy).xxxx).y;
    // 8: dp2 r1.x, r2.yxyy, r0.yzyy
    r1.x = (dot((r2.yxyy).xy,(r0.yzyy).xy).xxxx).x;
    // 9: add r0.xy, r1.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
    r0.xy = ((r1.xyxx)+(float4(0.500000,0.500000,0.000000,0.000000))).xy;
    // 10: mad r0.zw, v2.xxxy, l(0.000000, 0.000000, 0.500000, 0.500000), cb0[2].xxxy
    r0.zw = ((v2.xxxy)*(float4(0.000000,0.000000,0.500000,0.500000))+(source[2].xxxy)).zw;
    // 11: sample_b_indexable(texture2d)(float,float,float,float) r0.z, r0.zwzz, t0.yzxw, s1, l(0.000000)
    r0.z = (ArtistNativeSample0((r0.zwzz).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yzxw).z;
    // 12: mad r0.xy, r0.zzzz, cb0[4].yyyy, r0.xyxx
    r0.xy = ((r0.zzzz)*(source[4].yyyy)+(r0.xyxx)).xy;
    // 13: mul r0.z, r0.z, cb0[4].y
    r0.z = ((r0.zzzz)*(source[4].yyyy)).z;
    // 14: add r0.xy, r0.xyxx, l(-0.050000, -0.050000, 0.000000, 0.000000)
    r0.xy = ((r0.xyxx)+(float4(-0.050000,-0.050000,0.000000,0.000000))).xy;
    // 15: sample_b_indexable(texture2d)(float,float,float,float) r1.xyz, r0.xyxx, t3.xyzw, s3, l(0.000000)
    r1.xyz = (ArtistNativeSample2((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 16: sample_b_indexable(texture2d)(float,float,float,float) r0.xyw, r0.xyxx, t1.xywz, s2, l(0.000000)
    r0.xyw = (ArtistNativeSample1((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xywz).xyw;
    // 17: add_sat r1.xyz, r1.xyzx, cb0[5].yyyy
    r1.xyz = (saturate((r1.xyzx)+(source[5].yyyy))).xyz;
    // 18: mad r0.z, r0.x, cb0[4].z, r0.z
    r0.z = ((r0.xxxx)*(source[4].zzzz)+(r0.zzzz)).z;
    // 19: mov_sat r2.xyzw, r0.xxyw
    r2.xyzw = (saturate(r0.xxyw)).xyzw;
    // 20: add r0.x, r0.z, v2.y
    r0.x = ((r0.zzzz)+(v2.yyyy)).x;
    // 21: add r0.x, -r0.x, l(1.000000)
    r0.x = ((-(r0.xxxx))+(float4(1.000000,1.000000,1.000000,1.000000))).x;
    // 22: add r0.x, r0.x, -cb0[4].w
    r0.x = ((r0.xxxx)+(-(source[4].wwww))).x;
    // 23: mul_sat r0.x, r0.x, cb0[5].x
    r0.x = (saturate((r0.xxxx)*(source[5].xxxx))).x;
    // 24: add r0.yzw, r0.xxxx, r1.xxyz
    r0.yzw = ((r0.xxxx)+(r1.xxyz)).yzw;
    // 25: mad r0.yzw, r2.yyzw, cb0[3].xxyz, r0.yyzw
    r0.yzw = ((r2.yyzw)*(source[3].xxyz)+(r0.yyzw)).yzw;
    // 26: mad r0.xyz, r0.xxxx, r2.yzwy, r0.yzwy
    r0.xyz = ((r0.xxxx)*(r2.yzwy)+(r0.yzwy)).xyz;
    // 27: mul r0.w, r2.x, v3.w
    r0.w = ((r2.xxxx)*(v3.wwww)).w;
    // 28: mul r0.xyz, r0.xyzx, v3.xyzx
    r0.xyz = ((r0.xyzx)*(v3.xyzx)).xyz;
    // 29: mad r0.xyz, r0.xyzx, l(0.700000, 0.700000, 0.700000, 0.000000), cb0[1].xyzx
    r0.xyz = ((r0.xyzx)*(float4(0.700000,0.700000,0.700000,0.000000))+(source[1].xyzx)).xyz;
    // 30: mad o0.xyz, r0.xyzx, v5.wwww, v5.xyzx
    output.xyz = ((r0.xyzx)*(v5.wwww)+(v5.xyzx)).xyz;
    // 31: div r0.xy, v7.xyxx, v7.wwww
    r0.xy = ((v7.xyxx)/(v7.wwww)).xy;
    // 32: mad r0.xy, r0.xyxx, cb2[0].xyxx, cb2[0].wzww
    r0.xy = ((r0.xyxx)*(passValues[0].xyxx)+(passValues[0].wzww)).xy;
    // Native 33: source device depth mapped to centimetre view depth; reconstruction at 35.
    r0.x = g_EffectSceneDepthTexture.SampleLevel(EffectSliceDepthSampler, (r0.xyxx).xy, 0.f).y * 100000.f;
    // Native 35-38: reconstructed view depth is supplied by the runtime adapter.
    r0.x = r0.x;
    // 39: add r0.x, r0.x, -v7.w
    r0.x = ((r0.xxxx)+(-(v7.wwww))).x;
    // 40: mul_sat r0.x, r0.x, l(0.028571)
    r0.x = (saturate((r0.xxxx)*(float4(0.028571,0.028571,0.028571,0.028571)))).x;
    // 41: mul r0.x, r0.x, r0.w
    r0.x = ((r0.xxxx)*(r0.wwww)).x;
...
float4 ArtistNative3747(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative3748(ARTIST_NATIVE_INPUT input)
{
...
#if !defined(EFFECT_NATIVE_PARTICLE_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_d_me_shine_02_01_ad: db8fea89f30f11499c759eec670235bb; selected map 7a4e26d84c0ee0fa8931d03cf2e5aa533bdb53cd51b246dd37edf095ef2b01ae.
float4 ArtistNative3749(ARTIST_NATIVE_INPUT input)
{
    float4 source[10]; [unroll] for (uint i=0u; i<10u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative3750(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative3750Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative3751(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative3751Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_a_pa_db_01_1_ad: 1f6b66cb17f56f4d8ec7cb004d70bd5b; selected map 43e8b055b0a689ebacafd88e6eeacb8475f50eccafe6091ef4aba92e7bdf29c2.
float4 ArtistNative3752(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_i_pa_note_01_ad: 8a847d27d9c6564da0c04625c71b7f4f; selected map ce809eebf1a33abe2c9c95c03814890a5c66f8e8d46d10e8e3b22245fd4d6e28.
float4 ArtistNative3753(ARTIST_NATIVE_INPUT input)
{
    float4 source[5]; [unroll] for (uint i=0u; i<5u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative3754(ARTIST_NATIVE_INPUT input)
{
    float4 source[5]; [unroll] for (uint i=0u; i<5u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// bfx_g_pa_absorb_01_05_ad: c2eb7870a4129645bd414f670e6e1377; selected map c2383456817d4c06a84a265d1b9d37d1ef168e15404910241e6e603216b0286f.
float4 ArtistNative3755(ARTIST_NATIVE_INPUT input)
{
    float4 source[12]; [unroll] for (uint i=0u; i<12u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative3755Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[10]; [unroll] for (uint i=0u; i<10u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_d_pa_dirt_02_01_dt_tr: 7e66de1e2ac176408f112e22f5963139; selected map 3373ce8bed986c30200653807a72e19ebbd95eca1499423aeaabe3160f8e1c85.
float4 ArtistNative3756(ARTIST_NATIVE_INPUT input)
{
    float4 source[5]; [unroll] for (uint i=0u; i<5u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative3756Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative3757(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_f_pa_ri_01_7_ad: 22fe1d84b183a24ba061efbe70ff88fe; selected map dcb4af1b0c51e126ebfcd50d3245e9fb4ef45276b0b47937288bd666ab550511.
float4 ArtistNative3758(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_d_pa_atta_05_09_tr: 9b7d0436b976c84d8292abbeeb27f843; selected map 293d2a3997f15bd7c6b29400e6515afc4b53673272c9dd05a77b8590bafc05d7.
float4 ArtistNative3759(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_e_pa_ap_23_3_ad: 1f3e2fdc0f35504493c2d7fca9bd10b1; selected map 99fb0a09edfa19b9d94ab099ff0afebeefd112ee9e07786e44da96f7a5ba1180.
float4 ArtistNative3760(ARTIST_NATIVE_INPUT input)
{
    float4 source[8]; [unroll] for (uint i=0u; i<8u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// bfx_h_pa_projectile_01_02_ad: 009051ae79209b4c9b4504e9bcb82ee3; selected map 31aeb879268b9317a2be7d6eb4c07ac2df0a7cf55631ea559ec82d57efe05562.
float4 ArtistNative3761(ARTIST_NATIVE_INPUT input)
{
    float4 source[6]; [unroll] for (uint i=0u; i<6u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    source[3] = ArtistNativeAppend(ArtistNativePeriodic(((g_ArtistSourceMaterialTime.xxxx*float4(-0.0500000007, 0.0, 0.0, 0.0))*float4(0.0, 0.0, 0.0, 0.0))),ArtistNativePeriodic(((g_ArtistSourceMaterialTime.xxxx*float4(-0.0500000007, 0.0, 0.0, 0.0))*float4(1.0, 0.0, 0.0, 0.0))),1u);
    source[4].x = (g_ArtistSourceMaterialParameters[0u].xxxx).x;
    source[4].y = (g_ArtistSourceMaterialParameters[0u].wwww).x;
    source[4].z = (g_ArtistSourceMaterialParameters[1u].xxxx).x;
    source[4].w = ((g_ArtistSourceMaterialParameters[1u].xxxx*float4(1.57079601, 0.0, 0.0, 0.0))).x;
    source[5].x = (g_ArtistSourceMaterialParameters[0u].zzzz).x;
    source[5].y = ((float4(10.0, 0.0, 0.0, 0.0)/g_ArtistSourceMaterialParameters[0u].zzzz)).x;
    source[5].z = (g_ArtistSourceMaterialParameters[0u].yyyy).x;
    ...
    // 1: add r0.xy, v2.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)
    r0.xy = ((v2.xyxx)+(float4(-0.500000,-0.500000,0.000000,0.000000))).xy;
    // 2: mul r0.zw, r0.xxxy, cb0[4].yyyy
    r0.zw = ((r0.xxxy)*(source[4].yyyy)).zw;
    ...
    // 26: mul r0.z, r0.z, cb0[4].w
    r0.z = ((r0.zzzz)*(source[4].wwww)).z;
    // 27: mul r0.z, r0.z, l(0.318310)
    ...
    // 37: exp r0.w, r0.w
    r0.w = (exp2(r0.wwww)).w;
    // 38: mul_sat r0.w, r0.w, cb0[5].z
    r0.w = (saturate((r0.wwww)*(source[5].zzzz))).w;
    // 39: mul r0.z, r0.w, r0.z
    r0.z = ((r0.wwww)*(r0.zzzz)).z;
    // 40: movc r0.z, r1.x, l(0), r0.z
    r0.z = ((asuint(r1.xxxx) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.zzzz)).z;
    // 41: mad r1.x, v2.x, l(14.000000), cb0[2].x
    r1.x = ((v2.xxxx)*(float4(14.000000,14.000000,14.000000,14.000000))+(source[2].xxxx)).x;
    // 42: mad r1.y, v2.y, l(14.000000), cb0[3].y
    r1.y = ((v2.yyyy)*(float4(14.000000,14.000000,14.000000,14.000000))+(source[3].yyyy)).y;
    // 43: sample_b_indexable(texture2d)(float,float,float,float) r0.w, r1.xyxx, t1.yzwx, s3, l(0.000000)
    r0.w = (ArtistNativeSample2((r1.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yzwx).w;
    // 44: sample_b_indexable(texture2d)(float,float,float,float) r1.x, v2.xyxx, t0.xyzw, s2, l(0.000000)
    r1.x = (ArtistNativeSample1((v2.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).x;
    // 45: mul r0.w, r0.w, r1.x
    r0.w = ((r0.wwww)*(r1.xxxx)).w;
    // 46: mad r0.w, r0.w, l(50.000000), r0.z
    r0.w = ((r0.wwww)*(float4(50.000000,50.000000,50.000000,50.000000))+(r0.zzzz)).w;
    // 47: mul r0.z, r0.w, r0.z
    r0.z = ((r0.wwww)*(r0.zzzz)).z;
    // 48: mul r0.z, r0.z, v3.w
    r0.z = ((r0.zzzz)*(v3.wwww)).z;
    // 49: div r1.xy, v7.xyxx, v7.wwww
    r1.xy = ((v7.xyxx)/(v7.wwww)).xy;
    ...
    r0.w = r0.w;
    // 57: add r0.w, r0.w, -v7.w
    r0.w = ((r0.wwww)+(-(v7.wwww))).w;
    // 58: mul_sat r0.w, r0.w, l(0.019608)
    r0.w = (saturate((r0.wwww)*(float4(0.019608,0.019608,0.019608,0.019608)))).w;
    // 59: mul r0.z, r0.w, r0.z
    r0.z = ((r0.wwww)*(r0.zzzz)).z;
    // 60: mul r0.z, r0.z, cb0[0].x
    r0.z = ((r0.zzzz)*(source[0].xxxx)).z;
    // 61: mad r1.xy, |r0.xyxx|, l(-0.018729, -0.018729, 0.000000, 0.000000), l(0.074261, 0.074261, 0.000000, 0.000000)
    r1.xy = ((abs(r0.xyxx))*(float4(-0.018729,-0.018729,0.000000,0.000000))+(float4(0.074261,0.074261,0.000000,0.000000))).xy;
    // 62: mad r1.xy, r1.xyxx, |r0.xyxx|, l(-0.212114, -0.212114, 0.000000, 0.000000)
    r1.xy = ((r1.xyxx)*(abs(r0.xyxx))+(float4(-0.212114,-0.212114,0.000000,0.000000))).xy;
    // 63: mad r1.xy, r1.xyxx, |r0.xyxx|, l(1.570729, 1.570729, 0.000000, 0.000000)
    r1.xy = ((r1.xyxx)*(abs(r0.xyxx))+(float4(1.570729,1.570729,0.000000,0.000000))).xy;
    // 64: add r1.zw, -|r0.xxxy|, l(0.000000, 0.000000, 1.000000, 1.000000)
    r1.zw = ((-(abs(r0.xxxy)))+(float4(0.000000,0.000000,1.000000,1.000000))).zw;
    // 65: lt r0.xy, r0.xyxx, -r0.xyxx
    r0.xy = (asfloat((uint4)((r0.xyxx)<(-(r0.xyxx))) * 0xffffffffu)).xy;
    // 66: sqrt r1.zw, r1.zzzw
    r1.zw = (sqrt(r1.zzzw)).zw;
    // 67: mul r2.xy, r1.zwzz, r1.xyxx
    r2.xy = ((r1.zwzz)*(r1.xyxx)).xy;
    // 68: mad r2.xy, r2.xyxx, l(-2.000000, -2.000000, 0.000000, 0.000000), l(3.141593, 3.141593, 0.000000, 0.000000)
    r2.xy = ((r2.xyxx)*(float4(-2.000000,-2.000000,0.000000,0.000000))+(float4(3.141593,3.141593,0.000000,0.000000))).xy;
    // 69: and r0.xy, r0.xyxx, r2.xyxx
    r0.xy = (asfloat(asuint(r0.xyxx) & asuint(r2.xyxx))).xy;
    // 70: mad r0.xy, r1.xyxx, r1.zwzz, r0.xyxx
    r0.xy = ((r1.xyxx)*(r1.zwzz)+(r0.xyxx)).xy;
    // 71: mul r1.z, r0.y, l(0.318310)
    r1.z = ((r0.yyyy)*(float4(0.318310,0.318310,0.318310,0.318310))).z;
    // 72: mad r1.x, r0.x, l(0.318310), v4.x
    r1.x = ((r0.xxxx)*(float4(0.318310,0.318310,0.318310,0.318310))+(v4.xxxx)).x;
    // 73: sample_l_indexable(texture2d)(float,float,float,float) r0.xyw, r1.xzxx, t3.xywz, s1, l(0.000000)
    r0.xyw = (ArtistNativeSample0((r1.xzxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, true).xywz).xyw;
    // 74: mul r0.xyw, r0.xyxw, cb0[4].xxxx
    r0.xyw = ((r0.xyxw)*(source[4].xxxx)).xyw;
    // 75: mad r0.xyw, r0.xyxw, v3.xyxz, cb0[1].xyxz
    r0.xyw = ((r0.xyxw)*(v3.xyxz)+(source[1].xyxz)).xyw;
    // 76: mul r0.xyw, r0.xyxw, v5.wwww
    r0.xyw = ((r0.xyxw)*(v5.wwww)).xyw;
    // 77: mul o0.xyz, r0.zzzz, r0.xywx
...
float4 ArtistNative3762(ARTIST_NATIVE_INPUT input)
{
    float4 source[8]; [unroll] for (uint i=0u; i<8u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative3763(ARTIST_NATIVE_INPUT input)
{
    float4 source[8]; [unroll] for (uint i=0u; i<8u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative3763Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative3764(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative3766(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative3766Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_d_pa_uiscreen_01_tr: 78d7681f191f6b4c897630d3a8c5b51d; selected map 9dbb44b70f2047bb0d7f06e558be4827968f2c7b8f2fb6176dcec1fc739298a9.
float4 ArtistNative3767(ARTIST_NATIVE_INPUT input)
{
    float4 source[10]; [unroll] for (uint i=0u; i<10u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    source[1] = g_ArtistSourceMaterialParameters[0u];
    source[2] = ArtistNativeAppend(cos((g_ArtistSourceMaterialTime.xxxx*float4(0.230000004, 0.0, 0.0, 0.0))),(float4(-1.0, 0.0, 0.0, 0.0)*sin((g_ArtistSourceMaterialTime.xxxx*float4(0.230000004, 0.0, 0.0, 0.0)))),1u);
    source[3] = ArtistNativeAppend(sin((g_ArtistSourceMaterialTime.xxxx*float4(0.230000004, 0.0, 0.0, 0.0))),cos((g_ArtistSourceMaterialTime.xxxx*float4(0.230000004, 0.0, 0.0, 0.0))),1u);
    source[4] = ArtistNativeAppend(cos((g_ArtistSourceMaterialTime.xxxx*float4(0.469999999, 0.0, 0.0, 0.0))),(float4(-1.0, 0.0, 0.0, 0.0)*sin((g_ArtistSourceMaterialTime.xxxx*float4(0.469999999, 0.0, 0.0, 0.0)))),1u);
    source[5] = ArtistNativeAppend(sin((g_ArtistSourceMaterialTime.xxxx*float4(0.469999999, 0.0, 0.0, 0.0))),cos((g_ArtistSourceMaterialTime.xxxx*float4(0.469999999, 0.0, 0.0, 0.0))),1u);
    source[6] = ArtistNativeAppend(cos((g_ArtistSourceMaterialTime.xxxx*float4(0.409999996, 0.0, 0.0, 0.0))),(float4(-1.0, 0.0, 0.0, 0.0)*sin((g_ArtistSourceMaterialTime.xxxx*float4(0.409999996, 0.0, 0.0, 0.0)))),1u);
    source[7] = ArtistNativeAppend(sin((g_ArtistSourceMaterialTime.xxxx*float4(0.409999996, 0.0, 0.0, 0.0))),cos((g_ArtistSourceMaterialTime.xxxx*float4(0.409999996, 0.0, 0.0, 0.0))),1u);
    source[8] = ArtistNativeAppend(cos((g_ArtistSourceMaterialTime.xxxx*float4(0.670000017, 0.0, 0.0, 0.0))),(float4(-1.0, 0.0, 0.0, 0.0)*sin((g_ArtistSourceMaterialTime.xxxx*float4(0.670000017, 0.0, 0.0, 0.0)))),1u);
    source[9] = ArtistNativeAppend(sin((g_ArtistSourceMaterialTime.xxxx*float4(0.670000017, 0.0, 0.0, 0.0))),cos((g_ArtistSourceMaterialTime.xxxx*float4(0.670000017, 0.0, 0.0, 0.0))),1u);
    float4 passValues[4]; [unroll] for(uint passIndex=0u;passIndex<4u;++passIndex) passValues[passIndex]=0.f;
    passValues[0]=float4(.5f,-.5f,.5f,.5f);
    float4 v0 = float4(input.sourceBasisX,0.f); // native texcoord10
    float4 v1 = float4(input.sourceBasisZ,input.handedness); // native texcoord11
    ...
    // 1: add r0.xy, v2.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)
    r0.xy = ((v2.xyxx)+(float4(-0.500000,-0.500000,0.000000,0.000000))).xy;
    // 2: dp2 r1.x, cb0[6].xyxx, r0.xyxx
    r1.x = (dot((source[6].xyxx).xy,(r0.xyxx).xy).xxxx).x;
    // 3: dp2 r1.y, cb0[7].xyxx, r0.xyxx
    ...
    // 5: sample_b_indexable(texture2d)(float,float,float,float) r0.z, r0.zwzz, t0.xzyw, s0, l(0.000000)
    r0.z = (ArtistNativeSample0((r0.zwzz).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xzyw).z;
    // 6: dp2 r1.x, cb0[8].xyxx, r0.xyxx
    r1.x = (dot((source[8].xyxx).xy,(r0.xyxx).xy).xxxx).x;
    // 7: dp2 r1.y, cb0[9].xyxx, r0.xyxx
    r1.y = (dot((source[9].xyxx).xy,(r0.xyxx).xy).xxxx).y;
    // 8: add r1.xy, r1.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
    r1.xy = ((r1.xyxx)+(float4(0.500000,0.500000,0.000000,0.000000))).xy;
    // 9: sample_b_indexable(texture2d)(float,float,float,float) r0.w, r1.xyxx, t0.xywz, s0, l(0.000000)
    r0.w = (ArtistNativeSample0((r1.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xywz).w;
    // 10: mul r0.z, r0.w, r0.z
    r0.z = ((r0.wwww)*(r0.zzzz)).z;
    // 11: dp2 r1.x, cb0[2].xyxx, r0.xyxx
    r1.x = (dot((source[2].xyxx).xy,(r0.xyxx).xy).xxxx).x;
    // 12: dp2 r1.y, cb0[3].xyxx, r0.xyxx
    r1.y = (dot((source[3].xyxx).xy,(r0.xyxx).xy).xxxx).y;
    // 13: add r1.xy, r1.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
    r1.xy = ((r1.xyxx)+(float4(0.500000,0.500000,0.000000,0.000000))).xy;
    // 14: sample_b_indexable(texture2d)(float,float,float,float) r0.w, r1.xyxx, t0.yzwx, s0, l(0.000000)
    ...
    r0.xy = ((r1.xyxx)+(float4(0.500000,0.500000,0.000000,0.000000))).xy;
    // 18: sample_b_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t0.yxzw, s0, l(0.000000)
    r0.x = (ArtistNativeSample0((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yxzw).x;
    // 19: mad r0.y, r0.w, r0.x, r0.z
    r0.y = ((r0.wwww)*(r0.xxxx)+(r0.zzzz)).y;
    // 20: mul r0.x, r0.x, r0.w
    r0.x = ((r0.xxxx)*(r0.wwww)).x;
    // 21: mul r0.x, r0.z, r0.x
    r0.x = ((r0.zzzz)*(r0.xxxx)).x;
    // 22: mul r0.xzw, r0.xxxx, v3.xxyz
    r0.xzw = ((r0.xxxx)*(v3.xxyz)).xzw;
    // 23: mul r0.xzw, r0.xxzw, l(0.800000, 0.000000, 0.800000, 0.800000)
    r0.xzw = ((r0.xxzw)*(float4(0.800000,0.000000,0.800000,0.800000))).xzw;
    // 24: mad r0.xzw, v3.xxyz, l(0.200000, 0.000000, 0.200000, 0.200000), r0.xxzw
    r0.xzw = ((v3.xxyz)*(float4(0.200000,0.000000,0.200000,0.200000))+(r0.xxzw)).xzw;
    // 25: add r0.xzw, r0.xxzw, cb0[1].xxyz
    r0.xzw = ((r0.xxzw)+(source[1].xxyz)).xzw;
    // 26: mad o0.xyz, r0.xzwx, v5.wwww, v5.xyzx
    output.xyz = ((r0.xzwx)*(v5.wwww)+(v5.xyzx)).xyz;
    // 27: sample_b_indexable(texture2d)(float,float,float,float) r0.x, v2.xyxx, t0.wxyz, s0, l(0.000000)
    r0.x = (ArtistNativeSample0((v2.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).wxyz).x;
    // 28: mul r0.x, r0.x, r0.y
    r0.x = ((r0.xxxx)*(r0.yyyy)).x;
    // 29: mul r0.yz, v2.xxyx, l(0.000000, 0.000000, 11.000000, 0.000000)
    r0.yz = ((v2.xxyx)*(float4(0.000000,0.000000,11.000000,0.000000))).yz;
    // 30: sample_b_indexable(texture2d)(float,float,float,float) r0.y, r0.yzyy, t1.yxzw, s1, l(0.000000)
    r0.y = (ArtistNativeSample1((r0.yzyy).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yxzw).y;
...
float4 ArtistNative3768(ARTIST_NATIVE_INPUT input)
{
    float4 source[8]; [unroll] for (uint i=0u; i<8u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative3768Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative3769(ARTIST_NATIVE_INPUT input)
{
    float4 source[8]; [unroll] for (uint i=0u; i<8u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative3769Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative3770(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_d_post3ch_02_02_tr: fb40a3e513b3e641ad510f3842232d5b; selected map a52f871ef3633e9a1866afab43034a61c4e0f18421e8764b60ef75c4f3ebb484.
float4 ArtistNative3771(ARTIST_NATIVE_INPUT input)
{
    ...
    source[5].z = (max((float4(1.0, 0.0, 0.0, 0.0)-g_ArtistSourceMaterialParameters[0u].xxxx),float4(9.99999975e-06, 0.0, 0.0, 0.0))).x;
    source[5].w = ((float4(1.0, 0.0, 0.0, 0.0)/max((float4(1.0, 0.0, 0.0, 0.0)-g_ArtistSourceMaterialParameters[0u].xxxx),float4(9.99999975e-06, 0.0, 0.0, 0.0)))).x;
    source[6].x = (g_ArtistSourceMaterialParameters[0u].yyyy).x;
    float4 passValues[4]; [unroll] for(uint passIndex=0u;passIndex<4u;++passIndex) passValues[passIndex]=0.f;
    passValues[0]=float4(.5f,-.5f,.5f,.5f);
    float4 v0 = float4(input.sourceBasisX,0.f); // native texcoord10
    ...
    // 4: sample_indexable(texture2d)(float,float,float,float) r1.x, r0.zwzz, t1.xyzw, s1 (project resolved HDR SceneColor snapshot adapter)
    ...
    // 6: sample_indexable(texture2d)(float,float,float,float) r1.y, r0.zwzz, t1.xyzw, s1 (project resolved HDR SceneColor snapshot adapter)
    r1.y = (Read_EffectSceneColor(LinearClampUVSampler, (r0.zwzz).xy).xyzw).y;
    // 7: mad r0.zw, v4.yyyy, cb0[4].xxxy, r0.xxxy
    r0.zw = ((v4.yyyy)*(source[4].xxxy)+(r0.xxxy)).zw;
    // Native 8: source device depth mapped to centimetre view depth; reconstruction at 13.
    r0.x = g_EffectSceneDepthTexture.SampleLevel(EffectSliceDepthSampler, (r0.xyxx).xy, 0.f).y * 100000.f;
    // 10: sample_indexable(texture2d)(float,float,float,float) r1.z, r0.zwzz, t1.xyzw, s1 (project resolved HDR SceneColor snapshot adapter)
    r1.z = (Read_EffectSceneColor(LinearClampUVSampler, (r0.zwzz).xy).xyzw).z;
    // 11: mad r0.yzw, r1.xxyz, v3.xxyz, cb0[1].xxyz
    r0.yzw = ((r1.xxyz)*(v3.xxyz)+(source[1].xxyz)).yzw;
    // 12: mad o0.xyz, r0.yzwy, v5.wwww, v5.xyzx
    output.xyz = ((r0.yzwy)*(v5.wwww)+(v5.xyzx)).xyz;
    // Native 13-16: reconstructed view depth is supplied by the runtime adapter.
    r0.x = r0.x;
    // 17: add r0.x, r0.x, -v7.w
    r0.x = ((r0.xxxx)+(-(v7.wwww))).x;
    // 18: add r0.y, -cb0[6].x, l(1.000000)
    r0.y = ((-(source[6].xxxx))+(float4(1.000000,1.000000,1.000000,1.000000))).y;
    // 19: max r0.y, -r0.y, l(0.001000)
    r0.y = (max(-(r0.yyyy),float4(0.001000,0.001000,0.001000,0.001000))).y;
    // 20: div_sat r0.x, r0.x, r0.y
    r0.x = (saturate((r0.xxxx)/(r0.yyyy))).x;
    // 21: add r0.yz, v2.xxyx, l(0.000000, -0.500000, -0.500000, 0.000000)
    r0.yz = ((v2.xxyx)+(float4(0.000000,-0.500000,-0.500000,0.000000))).yz;
    // 22: dp2 r0.y, r0.yzyy, r0.yzyy
    r0.y = (dot((r0.yzyy).xy,(r0.yzyy).xy).xxxx).y;
    // 23: sqrt r0.y, r0.y
    r0.y = (sqrt(r0.yyyy)).y;
    // 24: mad r0.y, -r0.y, l(2.000000), l(1.000000)
    r0.y = ((-(r0.yyyy))*(float4(2.000000,2.000000,2.000000,2.000000))+(float4(1.000000,1.000000,1.000000,1.000000))).y;
    // 25: mul_sat r0.y, r0.y, cb0[5].w
    r0.y = (saturate((r0.yyyy)*(source[5].wwww))).y;
    // 26: mul r0.x, r0.x, r0.y
    r0.x = ((r0.xxxx)*(r0.yyyy)).x;
    // 27: mul r0.x, r0.x, v3.w
    r0.x = ((r0.xxxx)*(v3.wwww)).x;
...
float4 ArtistNative3772(ARTIST_NATIVE_INPUT input)
{
    float4 source[5]; [unroll] for (uint i=0u; i<5u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_e_pa_gl_02_2_ad: c058e92770ba0b488812c453984a6c6c; selected map 3bfdf33f4814032d8490d912e6851095862f6b1a880a141b9d66c4d2c795070e.
float4 ArtistNative3773(ARTIST_NATIVE_INPUT input)
{
    float4 source[8]; [unroll] for (uint i=0u; i<8u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative3774(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative3775(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
