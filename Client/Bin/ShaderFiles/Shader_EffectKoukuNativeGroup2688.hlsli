// Original Kouku material programs 2688..2751; native IDs and expressions are unchanged.
...
float4 ArtistNative2688(ARTIST_NATIVE_INPUT input)
{
    ...
    source[9].x = ((float4(-0.523599029, 0.0, 0.0, 0.0)*g_ArtistSourceMaterialParameters[3u].xxxx)).x;
    ...
    r2.xyz = (ArtistNativeSample1((r2.zwzz).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
...
#if !defined(EFFECT_NATIVE_PARTICLE_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// bfx_k_me_master_01_01_ad: ea428b8025219a49b393d3d68ad6edab; selected map fa85d0d8190dc9d1319fa0363e04465860c6b4dc7bbdb1dc1d4a1aa217a88bf9.
float4 ArtistNative2689(ARTIST_NATIVE_INPUT input)
{
    ...
    r0.w = (ArtistNativeSample2((r1.yzyy).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yzwx).w;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// bfx_k_pa_colorshine_03_ad: 62e298f6ffe06446b89f901590d7a3e5; selected map deb09af08121226063926c8562f73f77b35f944fb840f929467f453f84684610.
float4 ArtistNative2690(ARTIST_NATIVE_INPUT input)
{
    float4 source[10]; [unroll] for (uint i=0u; i<10u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    source[2].w = ((g_ArtistSourceMaterialParameters[4u].yyyy*g_ArtistSourceMaterialTime.xxxx)).x;
    source[3].x = (g_ArtistSourceMaterialParameters[4u].zzzz).x;
    source[3].y = (g_ArtistSourceMaterialParameters[4u].wwww).x;
    source[3].z = (g_ArtistSourceMaterialParameters[5u].xxxx).x;
    source[3].w = ((g_ArtistSourceMaterialTime.xxxx*g_ArtistSourceMaterialParameters[5u].xxxx)).x;
    ...
    source[8].y = ((float4(100.0, 0.0, 0.0, 0.0)-g_ArtistSourceMaterialParameters[5u].yyyy)).x;
    source[8].z = ((float4(0.00999999978, 0.0, 0.0, 0.0)*(float4(100.0, 0.0, 0.0, 0.0)-g_ArtistSourceMaterialParameters[5u].yyyy))).x;
    ...
    // 1: mul r0.x, v2.x, cb0[5].w
    r0.x = ((v2.xxxx)*(source[5].wwww)).x;
    // 2: mad r0.x, cb0[2].x, cb0[5].z, r0.x
    r0.x = ((source[2].xxxx)*(source[5].zzzz)+(r0.xxxx)).x;
    // 3: mul r1.xy, v2.yxyy, cb0[6].xwxx
    r1.xy = ((v2.yxyy)*(source[6].xwxx)).xy;
    // 4: mad r0.yz, cb0[2].xxxx, cb0[6].yyzy, r1.xxyx
    r0.yz = ((source[2].xxxx)*(source[6].yyzy)+(r1.xxyx)).yz;
    // 5: sample_b_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t0.xyzw, s2, l(0.000000)
    r0.x = (ArtistNativeSample1((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).x;
    // 6: mul r0.y, v2.y, cb0[7].x
    r0.y = ((v2.yyyy)*(source[7].xxxx)).y;
    // 7: mad r0.w, cb0[2].x, cb0[7].y, r0.y
    r0.w = ((source[2].xxxx)*(source[7].yyyy)+(r0.yyyy)).w;
    // 8: sample_b_indexable(texture2d)(float,float,float,float) r0.y, r0.zwzz, t1.yxzw, s3, l(0.000000)
    ...
    // 12: mul r0.y, r0.y, cb0[7].z
    r0.y = ((r0.yyyy)*(source[7].zzzz)).y;
    // 13: exp r0.y, r0.y
    r0.y = (exp2(r0.yyyy)).y;
    // 14: mul r0.y, r0.y, cb0[7].w
    ...
    r0.x = ((r0.xxxx)*(r0.yyyy)).x;
    // 30: mad_sat r0.x, r0.y, cb0[5].y, r0.x
    r0.x = (saturate((r0.yyyy)*(source[5].yyyy)+(r0.xxxx))).x;
    ...
    // 40: add r0.z, -cb0[8].z, l(1.000000)
    ...
    // 55: mul r0.y, v2.y, cb0[3].x
    r0.y = ((v2.yyyy)*(source[3].xxxx)).y;
    // 56: log r0.z, |r0.y|
    r0.z = (log2(abs(r0.yyyy))).z;
    // 57: lt r0.y, |r0.y|, l(0.000001)
    r0.y = (asfloat((uint4)((abs(r0.yyyy))<(float4(0.000001,0.000001,0.000001,0.000001))) * 0xffffffffu)).y;
    // 58: mul r0.z, r0.z, cb0[3].y
    r0.z = ((r0.zzzz)*(source[3].yyyy)).z;
    // 59: exp r0.z, r0.z
    r0.z = (exp2(r0.zzzz)).z;
    // 60: movc r0.y, r0.y, l(0), r0.z
    r0.y = ((asuint(r0.yyyy) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.zzzz)).y;
    // 61: add r1.y, r0.y, cb0[3].w
    r1.y = ((r0.yyyy)+(source[3].wwww)).y;
    // 62: mad r1.x, cb0[2].z, v2.x, cb0[2].w
    r1.x = ((source[2].zzzz)*(v2.xxxx)+(source[2].wwww)).x;
    // 63: sample_b_indexable(texture2d)(float,float,float,float) r0.yzw, r1.xyxx, t3.wxyz, s1, l(0.000000)
    ...
    r0.yzw = (log2(r0.yyzw)).yzw;
    // 66: mul r0.yzw, r0.yyzw, cb0[4].xxxx
    r0.yzw = ((r0.yyzw)*(source[4].xxxx)).yzw;
    // 67: exp r0.yzw, r0.yyzw
    r0.yzw = (exp2(r0.yyzw)).yzw;
    // 68: max r0.yzw, r0.yyzw, l(0.000000, 0.000001, 0.000001, 0.000001)
    r0.yzw = (max(r0.yyzw,float4(0.000000,0.000001,0.000001,0.000001))).yzw;
    // 69: log r0.yzw, r0.yyzw
    r0.yzw = (log2(r0.yyzw)).yzw;
    // 70: mul r0.yzw, r0.yyzw, cb0[4].yyyy
    r0.yzw = ((r0.yyzw)*(source[4].yyyy)).yzw;
    // 71: exp r0.yzw, r0.yyzw
    r0.yzw = (exp2(r0.yyzw)).yzw;
    // 72: mul r1.xyz, r0.yzwy, cb0[4].zzzz
    r1.xyz = ((r0.yzwy)*(source[4].zzzz)).xyz;
    // 73: dp3 r1.w, r1.xyzx, l(0.300000, 0.590000, 0.110000, 0.000000)
    r1.w = (dot((r1.xyzx).xyz,(float4(0.300000,0.590000,0.110000,0.000000)).xyz).xxxx).w;
    // 74: mad r0.yzw, -cb0[4].zzzz, r0.yyzw, r1.wwww
    r0.yzw = ((-(source[4].zzzz))*(r0.yyzw)+(r1.wwww)).yzw;
    // 75: mad r0.yzw, cb0[4].wwww, r0.yyzw, r1.xxyz
    r0.yzw = ((source[4].wwww)*(r0.yyzw)+(r1.xxyz)).yzw;
    // 76: mad r0.yzw, r0.yyzw, v3.xxyz, cb0[1].xxyz
...
float4 ArtistNative2692(ARTIST_NATIVE_INPUT input)
{
...
float4 ArtistNative2693(ARTIST_NATIVE_INPUT input)
{
    float4 source[6]; [unroll] for (uint i=0u; i<6u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_d_pa_atta_05_06_ad: f0aa4e3e7314dd4e9c13f71b608b7852; selected map 05b29fa49858053a667bb6066e164e45c67777aed8d16de4034a1f011b111555.
float4 ArtistNative2694(ARTIST_NATIVE_INPUT input)
{
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_k_pa_ht_01_01_ad: c058e92770ba0b488812c453984a6c6c; selected map 3bfdf33f4814032d8490d912e6851095862f6b1a880a141b9d66c4d2c795070e.
float4 ArtistNative2696(ARTIST_NATIVE_INPUT input)
{
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_j_pa_fakeribtrail_01_tr: 84391c6e4064434cb17505eead3178e8; selected map db530889d7a5d6febbd41913e187d27506bc6747f5ea7dd733d616765453a2de.
float4 ArtistNative2697(ARTIST_NATIVE_INPUT input)
{
    float4 source[13]; [unroll] for (uint i=0u; i<13u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    source[4] = g_ArtistSourceMaterialParameters[3u];
    source[5] = (float4(1.0, 1.0, 0.0, 0.0)*g_ArtistSourceMaterialParameters[1u].zzzz);
    source[6] = ArtistNativeAppend(ArtistNativePeriodic(((g_ArtistSourceMaterialTime.xxxx*g_ArtistSourceMaterialParameters[1u].xxxx)*float4(0.0, 0.0, 0.0, 0.0))),ArtistNativePeriodic(((g_ArtistSourceMaterialTime.xxxx*g_ArtistSourceMaterialParameters[1u].xxxx)*float4(1.0, 0.0, 0.0, 0.0))),1u);
    source[7] = ArtistNativeAppend(ArtistNativePeriodic(((g_ArtistSourceMaterialTime.xxxx*g_ArtistSourceMaterialParameters[0u].xxxx)*float4(0.0, 0.0, 0.0, 0.0))),ArtistNativePeriodic(((g_ArtistSourceMaterialTime.xxxx*g_ArtistSourceMaterialParameters[0u].xxxx)*float4(-2.0, 0.0, 0.0, 0.0))),1u);
    ...
    source[8].w = ((g_ArtistSourceMaterialTime.xxxx*g_ArtistSourceMaterialParameters[1u].xxxx)).x;
    source[9].x = (((g_ArtistSourceMaterialTime.xxxx*g_ArtistSourceMaterialParameters[1u].xxxx)*float4(0.0, 0.0, 0.0, 0.0))).x;
    source[9].y = (((g_ArtistSourceMaterialTime.xxxx*g_ArtistSourceMaterialParameters[1u].xxxx)*float4(1.0, 0.0, 0.0, 0.0))).x;
    source[9].z = (g_ArtistSourceMaterialParameters[2u].xxxx).x;
    source[9].w = (g_ArtistSourceMaterialParameters[1u].zzzz).x;
    source[10].x = (g_ArtistSourceMaterialParameters[0u].wwww).x;
    source[10].y = (ArtistNativePeriodic(((g_ArtistSourceMaterialTime.xxxx*g_ArtistSourceMaterialParameters[1u].xxxx)*float4(1.0, 0.0, 0.0, 0.0)))).x;
    source[10].z = (ArtistNativePeriodic(((g_ArtistSourceMaterialTime.xxxx*g_ArtistSourceMaterialParameters[1u].xxxx)*float4(0.0, 0.0, 0.0, 0.0)))).x;
    ...
    source[11].w = (((g_ArtistSourceMaterialTime.xxxx*g_ArtistSourceMaterialParameters[0u].xxxx)*float4(0.0, 0.0, 0.0, 0.0))).x;
    source[12].x = (((g_ArtistSourceMaterialTime.xxxx*g_ArtistSourceMaterialParameters[0u].xxxx)*float4(-2.0, 0.0, 0.0, 0.0))).x;
    source[12].y = (g_ArtistSourceMaterialParameters[0u].yyyy).x;
    source[12].z = (ArtistNativePeriodic(((g_ArtistSourceMaterialTime.xxxx*g_ArtistSourceMaterialParameters[0u].xxxx)*float4(-2.0, 0.0, 0.0, 0.0)))).x;
    source[12].w = (ArtistNativePeriodic(((g_ArtistSourceMaterialTime.xxxx*g_ArtistSourceMaterialParameters[0u].xxxx)*float4(0.0, 0.0, 0.0, 0.0)))).x;
    float4 passValues[4]; [unroll] for(uint passIndex=0u;passIndex<4u;++passIndex) passValues[passIndex]=0.f;
    passValues[0]=float4(.5f,-.5f,.5f,.5f);
    float4 v0 = float4(input.sourceBasisX,0.f); // native texcoord10
    float4 v1 = float4(input.sourceBasisZ,input.handedness); // native texcoord11
    ...
    // 2: mul r0.yw, r0.yyyy, cb0[2].xxxy
    r0.yw = ((r0.yyyy)*(source[2].xxxy)).yw;
    // 3: mad r0.xy, cb0[1].xyxx, r0.xxxx, r0.ywyy
    r0.xy = ((source[1].xyxx)*(r0.xxxx)+(r0.ywyy)).xy;
    // 4: mad r0.xy, cb0[3].xyxx, r0.zzzz, r0.xyxx
    r0.xy = ((source[3].xyxx)*(r0.zzzz)+(r0.xyxx)).xy;
    // 5: mad r0.xy, r0.xyxx, l(0.010000, 0.010000, 0.000000, 0.000000), l(1.000000, 1.000000, 0.000000, 0.000000)
    r0.xy = ((r0.xyxx)*(float4(0.010000,0.010000,0.000000,0.000000))+(float4(1.000000,1.000000,0.000000,0.000000))).xy;
    // 6: mul r0.z, r0.x, cb0[9].z
    r0.z = ((r0.xxxx)*(source[9].zzzz)).z;
    // 7: frc r0.z, r0.z
    r0.z = (frac(r0.zzzz)).z;
    // 8: mul r0.z, r0.z, l(6.283185)
    r0.z = ((r0.zzzz)*(float4(6.283185,6.283185,6.283185,6.283185))).z;
    // 9: sincos r0.z, null, r0.z
    r0.z = (sin(r0.zzzz)).z;
    // 10: mul r1.xy, r0.xyxx, cb0[5].xyxx
    r1.xy = ((r0.xyxx)*(source[5].xyxx)).xy;
    // 11: sample_b_indexable(texture2d)(float,float,float,float) r0.w, r1.xyxx, t0.yzwx, s0, l(0.000000)
    r0.w = (ArtistNativeSample0((r1.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yzwx).w;
    // 12: mul r0.z, r0.w, r0.z
    r0.z = ((r0.wwww)*(r0.zzzz)).z;
    // 13: mad_sat r0.w, -v2.x, l(2.000000), l(1.000000)
    r0.w = (saturate((-(v2.xxxx))*(float4(2.000000,2.000000,2.000000,2.000000))+(float4(1.000000,1.000000,1.000000,1.000000)))).w;
    // 14: log r1.x, r0.w
    r1.x = (log2(r0.wwww)).x;
    // 15: lt r0.w, r0.w, l(0.000001)
    r0.w = (asfloat((uint4)((r0.wwww)<(float4(0.000001,0.000001,0.000001,0.000001))) * 0xffffffffu)).w;
    // 16: mul r1.x, r1.x, cb0[8].x
    r1.x = ((r1.xxxx)*(source[8].xxxx)).x;
    // 17: exp r1.x, r1.x
    r1.x = (exp2(r1.xxxx)).x;
    // 18: movc r0.w, r0.w, l(0), r1.x
    r0.w = ((asuint(r0.wwww) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r1.xxxx)).w;
    // 19: add r1.x, -r0.w, l(1.000000)
    ...
    // 21: mad r1.y, v2.y, l(2.000000), l(-1.000000)
    r1.y = ((v2.yyyy)*(float4(2.000000,2.000000,2.000000,2.000000))+(float4(-1.000000,-1.000000,-1.000000,-1.000000))).y;
    // 22: div r1.y, r1.y, r1.x
    r1.y = ((r1.yyyy)/(r1.xxxx)).y;
    // 23: mad r0.z, r0.z, v2.x, r1.y
    r0.z = ((r0.zzzz)*(v2.xxxx)+(r1.yyyy)).z;
    // 24: add r1.y, r0.z, cb0[6].x
    r1.y = ((r0.zzzz)+(source[6].xxxx)).y;
    // 25: mul r2.x, r0.z, cb0[11].x
    r2.x = ((r0.zzzz)*(source[11].xxxx)).x;
    // 26: add r3.x, r1.y, l(0.500000)
    r3.x = ((r1.yyyy)+(float4(0.500000,0.500000,0.500000,0.500000))).x;
    // 27: mad r3.y, r0.x, cb0[10].x, cb0[6].y
    r3.y = ((r0.xxxx)*(source[10].xxxx)+(source[6].yyyy)).y;
    // 28: mul r0.xy, r0.xyxx, l(1.000000, 1.300000, 0.000000, 0.000000)
    r0.xy = ((r0.xyxx)*(float4(1.000000,1.300000,0.000000,0.000000))).xy;
    // 29: sample_b_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t0.xyzw, s0, l(0.000000)
    r0.x = (ArtistNativeSample0((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).x;
    // 30: add r0.x, r0.x, l(1.000000)
    r0.x = ((r0.xxxx)+(float4(1.000000,1.000000,1.000000,1.000000))).x;
    // 31: sample_b_indexable(texture2d)(float,float,float,float) r0.y, r3.xyxx, t1.yxzw, s1, l(0.000000)
    r0.y = (ArtistNativeSample1((r3.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yxzw).y;
    // 32: mul r0.y, r0.y, cb0[10].w
    r0.y = ((r0.yyyy)*(source[10].wwww)).y;
    // 33: mul r1.yz, v2.xxxx, l(0.000000, 1.000000, -0.500000, 0.000000)
    r1.yz = ((v2.xxxx)*(float4(0.000000,1.000000,-0.500000,0.000000))).yz;
    // 34: mad r2.y, r1.y, cb0[12].y, cb0[7].y
    r2.y = ((r1.yyyy)*(source[12].yyyy)+(source[7].yyyy)).y;
    // 35: add r1.yw, r2.xxxy, l(0.000000, 0.500000, 0.000000, 0.000000)
    r1.yw = ((r2.xxxy)+(float4(0.000000,0.500000,0.000000,0.000000))).yw;
    // 36: sample_b_indexable(texture2d)(float,float,float,float) r0.z, r1.ywyy, t2.yzxw, s2, l(0.000000)
    r0.z = (ArtistNativeSample2((r1.ywyy).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yzxw).z;
    // 37: mul r0.y, r0.z, r0.y
    r0.y = ((r0.zzzz)*(r0.yyyy)).y;
    // 38: mul r0.y, r0.y, l(4.000000)
    r0.y = ((r0.yyyy)*(float4(4.000000,4.000000,4.000000,4.000000))).y;
    // 39: mul r0.z, r0.y, r0.w
    r0.z = ((r0.yyyy)*(r0.wwww)).z;
    // 40: mul r0.y, r0.y, v2.x
    r0.y = ((r0.yyyy)*(v2.xxxx)).y;
    // 41: mul r2.xyz, r0.yyyy, v3.xyzx
    r2.xyz = ((r0.yyyy)*(v3.xyzx)).xyz;
    // 42: mul r2.xyz, r2.xyzx, l(0.300000, 0.300000, 0.300000, 0.000000)
    r2.xyz = ((r2.xyzx)*(float4(0.300000,0.300000,0.300000,0.000000))).xyz;
    // 43: mad r0.yzw, r0.zzzz, v3.xxyz, r2.xxyz
    r0.yzw = ((r0.zzzz)*(v3.xxyz)+(r2.xxyz)).yzw;
    // 44: add r1.y, -v2.x, l(1.000000)
    r1.y = ((-(v2.xxxx))+(float4(1.000000,1.000000,1.000000,1.000000))).y;
    // 45: mul_sat r0.x, r0.x, r1.y
    r0.x = (saturate((r0.xxxx)*(r1.yyyy))).x;
    // 46: mul r0.xyz, r0.yzwy, r0.xxxx
    r0.xyz = ((r0.yzwy)*(r0.xxxx)).xyz;
    // 47: mul r0.xyz, r0.xyzx, r1.yyyy
    r0.xyz = ((r0.xyzx)*(r1.yyyy)).xyz;
    // 48: mul r2.xyz, r0.xyzx, l(1.500000, 1.500000, 1.500000, 0.000000)
    r2.xyz = ((r0.xyzx)*(float4(1.500000,1.500000,1.500000,0.000000))).xyz;
    // 49: dp3 r0.w, r2.xyzx, l(0.300000, 0.590000, 0.110000, 0.000000)
    r0.w = (dot((r2.xyzx).xyz,(float4(0.300000,0.590000,0.110000,0.000000)).xyz).xxxx).w;
    // 50: mad r0.xyz, -r0.xyzx, l(1.500000, 1.500000, 1.500000, 0.000000), r0.wwww
    r0.xyz = ((-(r0.xyzx))*(float4(1.500000,1.500000,1.500000,0.000000))+(r0.wwww)).xyz;
    // 51: mad r0.xyz, r1.zzzz, r0.xyzx, r2.xyzx
    r0.xyz = ((r1.zzzz)*(r0.xyzx)+(r2.xyzx)).xyz;
    // 52: add r0.xyz, r0.xyzx, cb0[4].xyzx
    r0.xyz = ((r0.xyzx)+(source[4].xyzx)).xyz;
    // 53: mul r0.xyz, r0.xyzx, v5.wwww
    r0.xyz = ((r0.xyzx)*(v5.wwww)).xyz;
    // 54: mad r0.w, v2.y, l(2.000000), l(-1.000000)
    r0.w = ((v2.yyyy)*(float4(2.000000,2.000000,2.000000,2.000000))+(float4(-1.000000,-1.000000,-1.000000,-1.000000))).w;
    // 55: div r0.w, r0.w, r1.x
    r0.w = ((r0.wwww)/(r1.xxxx)).w;
    // 56: add r0.w, -|r0.w|, l(1.000000)
    r0.w = ((-(abs(r0.wwww)))+(float4(1.000000,1.000000,1.000000,1.000000))).w;
    // 57: max r0.w, r0.w, l(0.000000)
    r0.w = (max(r0.wwww,float4(0.000000,0.000000,0.000000,0.000000))).w;
    // 58: mul r0.w, r0.w, v3.w
    r0.w = ((r0.wwww)*(v3.wwww)).w;
    // 59: mul r0.w, r0.w, cb0[0].w
    r0.w = ((r0.wwww)*(source[0].wwww)).w;
    // 60: mul o0.xyz, r0.wwww, r0.xyzx
    output.xyz = ((r0.wwww)*(r0.xyzx)).xyz;
    // 61: mov o0.w, l(0)
    output.w = (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))).w;
    return output;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_m_pa_noise_01_1_tr: d85ae778ef56c442bc72ba1d756793a6; selected map 174eade347c09efc07fe84aee42662fedb5eb0bc4cf7912eb2eca349f64065f5.
float4 ArtistNative2698(ARTIST_NATIVE_INPUT input)
{
    ...
    r0.w = (ArtistNativeSample2((r1.xzxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yzwx).w;
...
float4 ArtistNative2699(ARTIST_NATIVE_INPUT input)
{
    float4 source[6]; [unroll] for (uint i=0u; i<6u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative2700(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_d_pa_fire_18_02_tr: b907311020f1bc488c0712cb83550f86; selected map 2ec3e916b008bf0ff43ede033e99db3867fc1484193381d5b664187d7234b6db.
float4 ArtistNative2701(ARTIST_NATIVE_INPUT input)
{
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_f_pa_wing_01_tr: b2f743be332ba647ac29d80173f1a102; selected map 44f12bab9a7e86d5d5a3a963b6307086c17088c6e745dbab5e0ea798fff05687.
float4 ArtistNative2703(ARTIST_NATIVE_INPUT input)
{
    ...
    source[3] = ArtistNativeAppend(ArtistNativePeriodic((g_ArtistSourceMaterialTime.xxxx*float4(0.0500000007, 0.0, 0.0, 0.0))),ArtistNativePeriodic((g_ArtistSourceMaterialTime.xxxx*float4(0.0700000003, 0.0, 0.0, 0.0))),1u);
    float4 passValues[4]; [unroll] for(uint passIndex=0u;passIndex<4u;++passIndex) passValues[passIndex]=0.f;
    passValues[0]=float4(.5f,-.5f,.5f,.5f);
    float4 v0 = float4(input.sourceBasisX,input.subUVBlend); // native texcoord10
    float4 v1 = float4(input.sourceBasisZ,input.handedness); // native texcoord11
    ...
    float4 v8 = asfloat(uint4(input.frontFace ? 0xffffffffu : 0u,0u,0u,0u)); // native sv_isfrontface0
    float4 r0=0.f, r1=0.f;
    // 1: mad r0.xy, v2.xyxx, l(0.200000, 0.200000, 0.000000, 0.000000), cb0[3].xyxx
    r0.xy = ((v2.xyxx)*(float4(0.200000,0.200000,0.000000,0.000000))+(source[3].xyxx)).xy;
    // 2: sample_b_indexable(texture2d)(float,float,float,float) r0.xyz, r0.xyxx, t1.xyzw, s0, l(0.000000)
    r0.xyz = (ArtistNativeSample0((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 3: mul r1.xyz, cb0[2].xyzx, cb0[2].wwww
    r1.xyz = ((source[2].xyzx)*(source[2].wwww)).xyz;
    // 4: mul r0.xyz, r0.xyzx, r1.xyzx
    r0.xyz = ((r0.xyzx)*(r1.xyzx)).xyz;
    // 5: max r0.xyz, |r0.xyzx|, l(0.000001, 0.000001, 0.000001, 0.000000)
    r0.xyz = (max(abs(r0.xyzx),float4(0.000001,0.000001,0.000001,0.000000))).xyz;
    // 6: log r0.xyz, r0.xyzx
    r0.xyz = (log2(r0.xyzx)).xyz;
    // 7: mul r0.xyz, r0.xyzx, l(0.700000, 0.700000, 0.700000, 0.000000)
    r0.xyz = ((r0.xyzx)*(float4(0.700000,0.700000,0.700000,0.000000))).xyz;
    // 8: exp r0.xyz, r0.xyzx
    r0.xyz = (exp2(r0.xyzx)).xyz;
    ...
    // 10: mul_sat r1.yzw, r1.xxyz, l(0.000000, 3.000000, 3.000000, 3.000000)
    r1.yzw = (saturate((r1.xxyz)*(float4(0.000000,3.000000,3.000000,3.000000)))).yzw;
    // 11: mul r0.w, r1.x, v3.w
    r0.w = ((r1.xxxx)*(v3.wwww)).w;
    // 12: mul r0.w, r0.w, cb0[0].x
    r0.w = ((r0.wwww)*(source[0].xxxx)).w;
    // 13: mul r0.xyz, r0.xyzx, r1.yzwy
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_lf_m_006: 511de8e5b0112246b359c438fa245eff; selected map 12170a936eaa55f9138edcf851d179bbf5702324f576242d191d1154f1e0603b.
float4 ArtistNative2704(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    source[2].y = (g_ArtistSourceMaterialTime.xxxx).x;
    source[2].z = ((g_ArtistSourceMaterialTime.xxxx*float4(3.14159274, 0.0, 0.0, 0.0))).x;
    source[2].w = (sin((g_ArtistSourceMaterialTime.xxxx*float4(3.14159274, 0.0, 0.0, 0.0)))).x;
    source[3].x = ((float4(0.200000003, 0.0, 0.0, 0.0)*sin((g_ArtistSourceMaterialTime.xxxx*float4(3.14159274, 0.0, 0.0, 0.0))))).x;
    source[3].y = ((float4(0.200000003, 0.0, 0.0, 0.0)+(float4(0.200000003, 0.0, 0.0, 0.0)*sin((g_ArtistSourceMaterialTime.xxxx*float4(3.14159274, 0.0, 0.0, 0.0)))))).x;
    source[3].z = ((float4(0.5, 0.0, 0.0, 0.0)+(float4(0.200000003, 0.0, 0.0, 0.0)+(float4(0.200000003, 0.0, 0.0, 0.0)*sin((g_ArtistSourceMaterialTime.xxxx*float4(3.14159274, 0.0, 0.0, 0.0))))))).x;
    float4 passValues[4]; [unroll] for(uint passIndex=0u;passIndex<4u;++passIndex) passValues[passIndex]=0.f;
    passValues[0]=float4(.5f,-.5f,.5f,.5f);
    float4 v0 = float4(input.sourceBasisX,0.f); // native texcoord10
    float4 v1 = float4(input.sourceBasisZ,input.handedness); // native texcoord11
    ...
    // 12: mul r0.x, r0.x, cb0[2].x
    r0.x = ((r0.xxxx)*(source[2].xxxx)).x;
    // 13: mul r0.x, r0.x, cb0[0].x
    r0.x = ((r0.xxxx)*(source[0].xxxx)).x;
    // 14: mul r0.xyz, r0.xxxx, v3.xyzx
    r0.xyz = ((r0.xxxx)*(v3.xyzx)).xyz;
    // 15: mad r0.xyz, cb0[3].zzzz, r0.xyzx, cb0[1].xyzx
    r0.xyz = ((source[3].zzzz)*(r0.xyzx)+(source[1].xyzx)).xyz;
    ...
    r0.w = ((r0.wwww)+(-(v7.wwww))).w;
    // 26: mul_sat r0.w, r0.w, l(0.033333)
    r0.w = (saturate((r0.wwww)*(float4(0.033333,0.033333,0.033333,0.033333)))).w;
    // 27: mul r0.w, r0.w, v3.w
    r0.w = ((r0.wwww)*(v3.wwww)).w;
    // 28: mul r0.w, r0.w, cb0[0].y
    r0.w = ((r0.wwww)*(source[0].yyyy)).w;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_d_pa_atta_12_04_ad: 5ea6abf36654c94eae8b523062def76d; selected map ddfa6780fd232822c32a57bef702012872510d7c744aec89366ef16885fdc498.
float4 ArtistNative2705(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_e_pa_gl_01_2_tr: 1166c98a352b934594aa881b9923e0f3; selected map c2d8d01196bc1ad3c52eed22b3401991f762707ca1c0e1467fc60f3a974cf0b1.
float4 ArtistNative2706(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_e_pa_fd_11_1_tr: e0227a19f9844c4b8ca2075d090c029a; selected map 6488081d2137d5e0b70f7a9cac4494536d6914791c0322030786e060ea225729.
float4 ArtistNative2707(ARTIST_NATIVE_INPUT input)
{
    float4 source[7]; [unroll] for (uint i=0u; i<7u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    // 45: mad r0.x, cb0[4].x, r0.y, r0.x
    r0.x = ((source[4].xxxx)*(r0.yyyy)+(r0.xxxx)).x;
    // 46: mul r0.x, r0.x, cb0[4].y
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_e_pa_fd_15_4_tr: 4c97b0b4101fdd419d81d18b73d76cfa; selected map 429c8ca050b540e68fc6aafaf935744624046c6d5575d8040ab6b3e570e8dacd.
float4 ArtistNative2708(ARTIST_NATIVE_INPUT input)
{
    float4 source[5]; [unroll] for (uint i=0u; i<5u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    source[1] = g_ArtistSourceMaterialParameters[1u];
    source[2] = ArtistNativeAppend(ArtistNativePeriodic((g_ArtistSourceMaterialTime.xxxx*float4(-0.125, 0.0, 0.0, 0.0))),ArtistNativePeriodic((g_ArtistSourceMaterialTime.xxxx*float4(0.0, 0.0, 0.0, 0.0))),1u);
    source[3] = ArtistNativeAppend(ArtistNativePeriodic((g_ArtistSourceMaterialTime.xxxx*float4(-0.25, 0.0, 0.0, 0.0))),ArtistNativePeriodic((g_ArtistSourceMaterialTime.xxxx*float4(0.0, 0.0, 0.0, 0.0))),1u);
    source[4].x = (ArtistNativePeriodic((g_ArtistSourceMaterialTime.xxxx*float4(-0.125, 0.0, 0.0, 0.0)))).x;
    source[4].y = ((g_ArtistSourceMaterialTime.xxxx*float4(-0.25, 0.0, 0.0, 0.0))).x;
    source[4].z = (ArtistNativePeriodic((g_ArtistSourceMaterialTime.xxxx*float4(-0.25, 0.0, 0.0, 0.0)))).x;
    ...
    // 1: add r0.xy, v2.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)
    r0.xy = ((v2.xyxx)+(float4(-0.500000,-0.500000,0.000000,0.000000))).xy;
    // 2: dp2 r1.x, l(-0.999999, -0.001593, 0.000000, 0.000000), r0.xyxx
    r1.x = (dot((float4(-0.999999,-0.001593,0.000000,0.000000)).xy,(r0.xyxx).xy).xxxx).x;
    // 3: dp2 r1.y, l(0.001593, -0.999999, 0.000000, 0.000000), r0.xyxx
    r1.y = (dot((float4(0.001593,-0.999999,0.000000,0.000000)).xy,(r0.xyxx).xy).xxxx).y;
    // 4: mul r0.xy, r1.xyxx, l(1.500000, 1.500000, 0.000000, 0.000000)
    r0.xy = ((r1.xyxx)*(float4(1.500000,1.500000,0.000000,0.000000))).xy;
    // 5: max r0.z, |r0.y|, |r0.x|
    r0.z = (max(abs(r0.yyyy),abs(r0.xxxx))).z;
    // 6: div r0.z, l(1.000000, 1.000000, 1.000000, 1.000000), r0.z
    r0.z = ((float4(1.000000,1.000000,1.000000,1.000000))/(r0.zzzz)).z;
    // 7: min r0.w, |r0.y|, |r0.x|
    r0.w = (min(abs(r0.yyyy),abs(r0.xxxx))).w;
    // 8: mul r0.z, r0.z, r0.w
    r0.z = ((r0.zzzz)*(r0.wwww)).z;
    // 9: mul r0.w, r0.z, r0.z
    r0.w = ((r0.zzzz)*(r0.zzzz)).w;
    // 10: mad r1.x, r0.w, l(0.020835), l(-0.085133)
    r1.x = ((r0.wwww)*(float4(0.020835,0.020835,0.020835,0.020835))+(float4(-0.085133,-0.085133,-0.085133,-0.085133))).x;
    // 11: mad r1.x, r0.w, r1.x, l(0.180141)
    r1.x = ((r0.wwww)*(r1.xxxx)+(float4(0.180141,0.180141,0.180141,0.180141))).x;
    // 12: mad r1.x, r0.w, r1.x, l(-0.330299)
    r1.x = ((r0.wwww)*(r1.xxxx)+(float4(-0.330299,-0.330299,-0.330299,-0.330299))).x;
    // 13: mad r0.w, r0.w, r1.x, l(0.999866)
    r0.w = ((r0.wwww)*(r1.xxxx)+(float4(0.999866,0.999866,0.999866,0.999866))).w;
    // 14: mul r1.x, r0.w, r0.z
    r1.x = ((r0.wwww)*(r0.zzzz)).x;
    // 15: mad r1.x, r1.x, l(-2.000000), l(1.570796)
    r1.x = ((r1.xxxx)*(float4(-2.000000,-2.000000,-2.000000,-2.000000))+(float4(1.570796,1.570796,1.570796,1.570796))).x;
    // 16: lt r1.y, |r0.y|, |r0.x|
    r1.y = (asfloat((uint4)((abs(r0.yyyy))<(abs(r0.xxxx))) * 0xffffffffu)).y;
    // 17: and r1.x, r1.y, r1.x
    r1.x = (asfloat(asuint(r1.yyyy) & asuint(r1.xxxx))).x;
    // 18: mad r0.z, r0.z, r0.w, r1.x
    r0.z = ((r0.zzzz)*(r0.wwww)+(r1.xxxx)).z;
    // 19: lt r0.w, r0.y, -r0.y
    r0.w = (asfloat((uint4)((r0.yyyy)<(-(r0.yyyy))) * 0xffffffffu)).w;
    // 20: and r0.w, r0.w, l(0xc0490fdb)
    r0.w = (asfloat(asuint(r0.wwww) & uint4(0xc0490fdbu,0xc0490fdbu,0xc0490fdbu,0xc0490fdbu))).w;
    // 21: add r0.z, r0.w, r0.z
    r0.z = ((r0.wwww)+(r0.zzzz)).z;
    // 22: min r0.w, r0.y, r0.x
    r0.w = (min(r0.yyyy,r0.xxxx)).w;
    // 23: lt r0.w, r0.w, -r0.w
    r0.w = (asfloat((uint4)((r0.wwww)<(-(r0.wwww))) * 0xffffffffu)).w;
    // 24: max r1.x, r0.y, r0.x
    r1.x = (max(r0.yyyy,r0.xxxx)).x;
    // 25: dp2 r0.x, r0.xyxx, r0.xyxx
    r0.x = (dot((r0.xyxx).xy,(r0.xyxx).xy).xxxx).x;
    // 26: sqrt r0.x, r0.x
    r0.x = (sqrt(r0.xxxx)).x;
    ...
    // 30: mad r0.z, r0.z, l(0.318310), l(1.000000)
    r0.z = ((r0.zzzz)*(float4(0.318310,0.318310,0.318310,0.318310))+(float4(1.000000,1.000000,1.000000,1.000000))).z;
    // 31: mad r0.w, r0.z, l(0.500000), cb0[2].y
    r0.w = ((r0.zzzz)*(float4(0.500000,0.500000,0.500000,0.500000))+(source[2].yyyy)).w;
    // 32: mul r0.y, r0.z, l(0.500000)
    r0.y = ((r0.zzzz)*(float4(0.500000,0.500000,0.500000,0.500000))).y;
    // 33: add r0.yz, r0.xxyx, cb0[3].xxyx
    r0.yz = ((r0.xxyx)+(source[3].xxyx)).yz;
    // 34: add r1.x, r0.x, cb0[2].x
    r1.x = ((r0.xxxx)+(source[2].xxxx)).x;
    // 35: sample_b_indexable(texture2d)(float,float,float,float) r0.x, r0.yzyy, t1.xyzw, s1, l(0.000000)
    r0.x = (ArtistNativeSample1((r0.yzyy).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).x;
    // 36: add r1.y, r0.w, l(0.500000)
    r1.y = ((r0.wwww)+(float4(0.500000,0.500000,0.500000,0.500000))).y;
    // 37: sample_b_indexable(texture2d)(float,float,float,float) r0.y, r1.xyxx, t1.yxzw, s1, l(0.000000)
    r0.y = (ArtistNativeSample1((r1.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yxzw).y;
    // 38: mul r0.z, |r0.y|, |r0.y|
    r0.z = ((abs(r0.yyyy))*(abs(r0.yyyy))).z;
    // 39: lt r0.y, |r0.y|, l(0.000001)
    r0.y = (asfloat((uint4)((abs(r0.yyyy))<(float4(0.000001,0.000001,0.000001,0.000001))) * 0xffffffffu)).y;
    // 40: mul r0.z, r0.z, l(10.000000)
    r0.z = ((r0.zzzz)*(float4(10.000000,10.000000,10.000000,10.000000))).z;
    // 41: movc r0.y, r0.y, l(0), r0.z
    r0.y = ((asuint(r0.yyyy) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.zzzz)).y;
    // 42: mul r0.z, |r0.x|, |r0.x|
    r0.z = ((abs(r0.xxxx))*(abs(r0.xxxx))).z;
    // 43: lt r0.x, |r0.x|, l(0.000001)
    r0.x = (asfloat((uint4)((abs(r0.xxxx))<(float4(0.000001,0.000001,0.000001,0.000001))) * 0xffffffffu)).x;
    // 44: mul r0.z, r0.z, l(20.000000)
    r0.z = ((r0.zzzz)*(float4(20.000000,20.000000,20.000000,20.000000))).z;
    // 45: movc r0.x, r0.x, l(0), r0.z
    r0.x = ((asuint(r0.xxxx) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.zzzz)).x;
    // 46: add r0.x, r0.x, r0.y
    r0.x = ((r0.xxxx)+(r0.yyyy)).x;
    // 47: mul r0.x, r0.x, cb0[4].w
    r0.x = ((r0.xxxx)*(source[4].wwww)).x;
    // 48: sample_b_indexable(texture2d)(float,float,float,float) r0.y, v2.xyxx, t2.yxzw, s2, l(0.000000)
    r0.y = (ArtistNativeSample2((v2.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yxzw).y;
    // 49: mul r0.x, r0.x, r0.y
    r0.x = ((r0.xxxx)*(r0.yyyy)).x;
    // 50: mul r0.x, r0.x, v3.w
    r0.x = ((r0.xxxx)*(v3.wwww)).x;
    // 51: mul r0.x, r0.x, l(1.500000)
    r0.x = ((r0.xxxx)*(float4(1.500000,1.500000,1.500000,1.500000))).x;
    // 52: mov_sat r0.y, r0.x
    r0.y = (saturate(r0.xxxx)).y;
    // 53: mad r0.xzw, r0.xxxx, v3.xxyz, cb0[1].xxyz
    r0.xzw = ((r0.xxxx)*(v3.xxyz)+(source[1].xxyz)).xzw;
    // 54: mad o0.xyz, r0.xzwx, v5.wwww, v5.xyzx
    output.xyz = ((r0.xzwx)*(v5.wwww)+(v5.xyzx)).xyz;
    // 55: mul o0.w, r0.y, cb0[0].x
...
float4 ArtistNative2709(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative2710(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_f_pa_gl_01_1_ad: 096d7ee0efa1eb4bb2e91b406fe61913; selected map d3ae7817e320de17bcfcd6b6dde23265c1c47d93ae32f74e18619b11001ac907.
float4 ArtistNative2713(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative2714(ARTIST_NATIVE_INPUT input)
{
    float4 source[6]; [unroll] for (uint i=0u; i<6u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_k_pa_fluid_01_01_ad: 199ef9122f95194b964b9aca7983a4bc; selected map 49e1b76b928fa7bddf58cd7a4469bb377cd0904b9c410a6562a7c9f9e93a8eb9.
float4 ArtistNative2715(ARTIST_NATIVE_INPUT input)
{
    float4 source[7]; [unroll] for (uint i=0u; i<7u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    // 61: mad r0.xyz, v3.xyzx, r0.xyzx, cb0[1].xyzx
    r0.xyz = ((v3.xyzx)*(r0.xyzx)+(source[1].xyzx)).xyz;
    // 62: mul r0.xyz, r0.xyzx, v5.wwww
    r0.xyz = ((r0.xyzx)*(v5.wwww)).xyz;
    // 63: log r1.x, |r0.w|
    r1.x = (log2(abs(r0.wwww))).x;
    // 64: lt r0.w, |r0.w|, l(0.000001)
    r0.w = (asfloat((uint4)((abs(r0.wwww))<(float4(0.000001,0.000001,0.000001,0.000001))) * 0xffffffffu)).w;
    // 65: mul r1.x, r1.x, v4.y
    r1.x = ((r1.xxxx)*(v4.yyyy)).x;
    // 66: exp r1.x, r1.x
    r1.x = (exp2(r1.xxxx)).x;
    // 67: mul_sat r1.x, r1.x, v3.w
    r1.x = (saturate((r1.xxxx)*(v3.wwww))).x;
    // 68: mul r1.x, r1.x, cb0[0].x
    r1.x = ((r1.xxxx)*(source[0].xxxx)).x;
    // 69: movc r0.w, r0.w, l(0), r1.x
    r0.w = ((asuint(r0.wwww) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r1.xxxx)).w;
    // 70: mul o0.xyz, r0.wwww, r0.xyzx
    output.xyz = ((r0.wwww)*(r0.xyzx)).xyz;
    // 71: mov o0.w, l(0)
    output.w = (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))).w;
    return output;
...
float4 ArtistNative2716(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative2717(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative2719(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_PARTICLE_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_d_pa_trail_07_01_tr: 0ea942cf918084488ca30542d8faaccf; selected map c0016be8aebb75074f1902a3ed7cbc95f7ede556f5251ea3497c45c09a6ab039.
float4 ArtistNative2720(ARTIST_NATIVE_INPUT input)
{
    float4 source[11]; [unroll] for (uint i=0u; i<11u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_PARTICLE_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_d_pa_ribflow_01_09_ad: ea567ece7b55b04ab3ba2adae1720d6f; selected map dea711b5d3f939b16c19807b4c0b73a00b9fe74613ec4e4162ea26da128dfcba.
float4 ArtistNative2721(ARTIST_NATIVE_INPUT input)
{
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_b_pa_sy_02_1_tr: 991ecc5522859c49bb034318a827af71; selected map fd85ade76eaa888dbc097dfdfc3900cacd64ae68812cae449a674d712986917f.
float4 ArtistNative2722(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_c_pa_ring_08_1_ad: f0aa4e3e7314dd4e9c13f71b608b7852; selected map 05b29fa49858053a667bb6066e164e45c67777aed8d16de4034a1f011b111555.
float4 ArtistNative2723(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_b_pa_atypical_02_tr: 9237b9bef4cb5242afd37de7123b2851; selected map ca24450169584810fa6ecc19c1195c69441b396bebc602fbb3cb48756d0157e8.
float4 ArtistNative2724(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    // 2: mul r0.y, v4.x, l(0.200000)
    r0.y = ((v4.xxxx)*(float4(0.200000,0.200000,0.200000,0.200000))).y;
    // 3: mad r0.xyzw, v2.xyxy, l(2.000000, 1.000000, 1.200000, 0.600000), r0.xyxy
    r0.xyzw = ((v2.xyxy)*(float4(2.000000,1.000000,1.200000,0.600000))+(r0.xyxy)).xyzw;
    // 4: sample_b_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t0.xyzw, s1, l(0.000000)
    r0.x = (ArtistNativeSample0((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).x;
    // 5: sample_b_indexable(texture2d)(float,float,float,float) r0.y, r0.zwzz, t0.xyzw, s1, l(0.000000)
    r0.y = (ArtistNativeSample0((r0.zwzz).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).y;
    ...
    // 8: mad r0.yz, r0.yyzy, cb0[2].xxyx, l(0.000000, 0.500000, 0.500000, 0.000000)
    r0.yz = ((r0.yyzy)*(source[2].xxyx)+(float4(0.000000,0.500000,0.500000,0.000000))).yz;
    // 9: mad r0.xy, r0.xxxx, l(0.140000, 0.140000, 0.000000, 0.000000), r0.yzyy
    r0.xy = ((r0.xxxx)*(float4(0.140000,0.140000,0.000000,0.000000))+(r0.yzyy)).xy;
    // 10: sample_b_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t1.xyzw, s2, l(0.000000)
    r0.x = (ArtistNativeSample1((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).x;
    // 11: mul_sat r0.x, r0.x, l(1.500000)
    ...
    r0.y = ((r0.yyyy)+(-(v7.wwww))).y;
    // 22: mul_sat r0.y, r0.y, l(0.133333)
    r0.y = (saturate((r0.yyyy)*(float4(0.133333,0.133333,0.133333,0.133333)))).y;
    // 23: mul r0.x, r0.y, r0.x
    r0.x = ((r0.yyyy)*(r0.xxxx)).x;
    // 24: mul o0.w, r0.x, cb0[0].x
    output.w = ((r0.xxxx)*(source[0].xxxx)).w;
    // 25: add r0.xyz, v3.xyzx, cb0[1].xyzx
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_b_pa_aura_03_tr: 729f8c6ebcf42d4ba4799fd75d94afb8; selected map e9e62177dabb0e10101486cdfe5c033c1ba07ecd533e3f71f8f17b0c1705e631.
float4 ArtistNative2725(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    float4 v8 = asfloat(uint4(input.frontFace ? 0xffffffffu : 0u,0u,0u,0u)); // native sv_isfrontface0
    float4 r0=0.f, r1=0.f;
    // 1: mul r0.xyzw, v2.xyxy, l(0.500000, 0.500000, 0.750000, 0.750000)
    r0.xyzw = ((v2.xyxy)*(float4(0.500000,0.500000,0.750000,0.750000))).xyzw;
    // 2: mad r0.xyzw, v4.xxyy, l(0.100000, 0.050000, -0.100000, 0.080000), r0.xyzw
    r0.xyzw = ((v4.xxyy)*(float4(0.100000,0.050000,-0.100000,0.080000))+(r0.xyzw)).xyzw;
    ...
    // 4: sample_b_indexable(texture2d)(float,float,float,float) r0.y, r0.zwzz, t3.yxzw, s5, l(0.000000)
    r0.y = (ArtistNativeSample4((r0.zwzz).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yxzw).y;
    // 5: add r0.x, r0.y, r0.x
    r0.x = ((r0.yyyy)+(r0.xxxx)).x;
    // 6: sample_b_indexable(texture2d)(float,float,float,float) r0.x, r0.xxxx, t4.xyzw, s6, l(0.000000)
    r0.x = (ArtistNativeSample5((r0.xxxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).x;
    // 7: sample_b_indexable(texture2d)(float,float,float,float) r0.y, v2.xyxx, t1.yxzw, s3, l(0.000000)
    r0.y = (ArtistNativeSample2((v2.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yxzw).y;
    ...
    r0.x = ((asuint(r0.xxxx) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.yyyy)).x;
    // 15: sample_b_indexable(texture2d)(float,float,float,float) r0.y, v2.xyxx, t0.yxzw, s2, l(0.000000)
    r0.y = (ArtistNativeSample1((v2.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yxzw).y;
    // 16: mul r0.x, r0.x, r0.y
    r0.x = ((r0.xxxx)*(r0.yyyy)).x;
    // 17: mul_sat r0.x, r0.x, v3.w
    r0.x = (saturate((r0.xxxx)*(v3.wwww))).x;
    ...
    r0.y = ((r0.yyyy)+(-(v7.wwww))).y;
    // 27: mul_sat r0.y, r0.y, l(0.066667)
    r0.y = (saturate((r0.yyyy)*(float4(0.066667,0.066667,0.066667,0.066667)))).y;
    // 28: mul r0.x, r0.y, r0.x
    r0.x = ((r0.yyyy)*(r0.xxxx)).x;
    // 29: mul o0.w, r0.x, cb0[0].x
    output.w = ((r0.xxxx)*(source[0].xxxx)).w;
    // 30: sample_b_indexable(texture2d)(float,float,float,float) r0.xyz, v2.xyxx, t6.xyzw, s1, l(0.000000)
    r0.xyz = (ArtistNativeSample0((v2.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 31: mul r0.xyz, r0.xyzx, v3.xyzx
    r0.xyz = ((r0.xyzx)*(v3.xyzx)).xyz;
    // 32: mad r0.xyz, r0.xyzx, l(0.200000, 0.200000, 0.200000, 0.000000), cb0[1].xyzx
    r0.xyz = ((r0.xyzx)*(float4(0.200000,0.200000,0.200000,0.000000))+(source[1].xyzx)).xyz;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_b_pa_skullblur_01_tr: 54f4887006f9464482e997b6aec2a087; selected map 5a694f8a7ed0e1159a199a88a6c35d2c89ef9af28694e2f4f37078dbd5208a95.
float4 ArtistNative2726(ARTIST_NATIVE_INPUT input)
{
    ...
    source[5] = ArtistNativeAppend(ArtistNativePeriodic((g_ArtistSourceMaterialTime.xxxx*float4(0.100000001, 0.0, 0.0, 0.0))),ArtistNativePeriodic((g_ArtistSourceMaterialTime.xxxx*float4(0.0500000007, 0.0, 0.0, 0.0))),1u);
    ...
    // 1: add r0.xy, v2.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)
    r0.xy = ((v2.xyxx)+(float4(-0.500000,-0.500000,0.000000,0.000000))).xy;
    // 2: dp2 r0.x, l(0.587785, 0.809017, 0.000000, 0.000000), r0.xyxx
    r0.x = (dot((float4(0.587785,0.809017,0.000000,0.000000)).xy,(r0.xyxx).xy).xxxx).x;
    // 3: add r0.x, r0.x, l(1.500000)
    r0.x = ((r0.xxxx)+(float4(1.500000,1.500000,1.500000,1.500000))).x;
    // 4: add r0.yz, v4.xxxx, cb0[11].zzxz
    r0.yz = ((v4.xxxx)+(source[11].zzxz)).yz;
    // 5: add r0.yz, -r0.yyzy, r0.xxxx
    r0.yz = ((-(r0.yyzy))+(r0.xxxx)).yz;
    // 6: add r0.x, r0.x, -v4.x
    r0.x = ((r0.xxxx)+(-(v4.xxxx))).x;
    // 7: add_sat r0.xyz, r0.xyzx, r0.xyzx
    r0.xyz = (saturate((r0.xyzx)+(r0.xyzx))).xyz;
    // 8: mad r1.xy, v2.xyxx, l(2.000000, 1.000000, 0.000000, 0.000000), cb0[5].xyxx
    r1.xy = ((v2.xyxx)*(float4(2.000000,1.000000,0.000000,0.000000))+(source[5].xyxx)).xy;
    // 9: sample_b_indexable(texture2d)(float,float,float,float) r1.xyz, r1.xyxx, t4.xyzw, s4, l(0.000000)
    r1.xyz = (ArtistNativeSample4((r1.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 10: mad r2.xyz, r0.zzzz, r1.xyzx, r0.zzzz
    r2.xyz = ((r0.zzzz)*(r1.xyzx)+(r0.zzzz)).xyz;
    // 11: mad r0.yzw, r0.yyyy, r1.xxyz, r0.yyyy
    r0.yzw = ((r0.yyyy)*(r1.xxyz)+(r0.yyyy)).yzw;
    // 12: mad r1.xyz, r0.xxxx, r1.xyzx, r0.xxxx
    r1.xyz = ((r0.xxxx)*(r1.xyzx)+(r0.xxxx)).xyz;
    // 13: max r1.xyz, |r1.xyzx|, l(0.000001, 0.000001, 0.000001, 0.000000)
    r1.xyz = (max(abs(r1.xyzx),float4(0.000001,0.000001,0.000001,0.000000))).xyz;
    // 14: max r0.xyz, |r0.yzwy|, l(0.000001, 0.000001, 0.000001, 0.000000)
    r0.xyz = (max(abs(r0.yzwy),float4(0.000001,0.000001,0.000001,0.000000))).xyz;
    // 15: max r2.xyz, |r2.xyzx|, l(0.000001, 0.000001, 0.000001, 0.000000)
    r2.xyz = (max(abs(r2.xyzx),float4(0.000001,0.000001,0.000001,0.000000))).xyz;
    // 16: mul r3.xyz, r2.xyzx, r2.xyzx
    r3.xyz = ((r2.xyzx)*(r2.xyzx)).xyz;
    // 17: mul r3.xyz, r3.xyzx, r3.xyzx
    r3.xyz = ((r3.xyzx)*(r3.xyzx)).xyz;
    // 18: mul r2.xyz, r2.xyzx, r3.xyzx
    r2.xyz = ((r2.xyzx)*(r3.xyzx)).xyz;
    // 19: min r2.xyz, r2.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
    r2.xyz = (min(r2.xyzx,float4(1.000000,1.000000,1.000000,0.000000))).xyz;
    // 20: mul r3.xyz, r1.xyzx, r1.xyzx
    r3.xyz = ((r1.xyzx)*(r1.xyzx)).xyz;
    // 21: mul r3.xyz, r3.xyzx, r3.xyzx
    r3.xyz = ((r3.xyzx)*(r3.xyzx)).xyz;
    // 22: mul r1.xyz, r1.xyzx, r3.xyzx
    r1.xyz = ((r1.xyzx)*(r3.xyzx)).xyz;
    // 23: min r1.xyz, r1.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
    r1.xyz = (min(r1.xyzx,float4(1.000000,1.000000,1.000000,0.000000))).xyz;
    // 24: add r2.xyz, -r1.xyzx, r2.xyzx
    r2.xyz = ((-(r1.xyzx))+(r2.xyzx)).xyz;
    // 25: max r2.xyz, |r2.xyzx|, l(0.000001, 0.000001, 0.000001, 0.000000)
    r2.xyz = (max(abs(r2.xyzx),float4(0.000001,0.000001,0.000001,0.000000))).xyz;
    // 26: mul r3.xyz, r2.xyzx, r2.xyzx
    r3.xyz = ((r2.xyzx)*(r2.xyzx)).xyz;
    // 27: mul r3.xyz, r3.xyzx, r3.xyzx
    r3.xyz = ((r3.xyzx)*(r3.xyzx)).xyz;
    // 28: mul r2.xyz, r2.xyzx, r3.xyzx
    r2.xyz = ((r2.xyzx)*(r3.xyzx)).xyz;
    // 29: mul r0.w, v2.y, cb0[9].w
    r0.w = ((v2.yyyy)*(source[9].wwww)).w;
    // 30: mul r0.w, r0.w, l(0.700000)
    r0.w = ((r0.wwww)*(float4(0.700000,0.700000,0.700000,0.700000))).w;
    // 31: mad r3.y, cb0[8].x, cb0[10].x, r0.w
    r3.y = ((source[8].xxxx)*(source[10].xxxx)+(r0.wwww)).y;
    // 32: mov r4.xyz, v2.yxxy
    r4.xyz = (v2.yxxy).xyz;
    // 33: mul r0.w, r4.y, cb0[9].z
    r0.w = ((r4.yyyy)*(source[9].zzzz)).w;
    // 34: mad r3.x, cb0[8].x, cb0[9].y, r0.w
    r3.x = ((source[8].xxxx)*(source[9].yyyy)+(r0.wwww)).x;
    // 35: sample_b_indexable(texture2d)(float,float,float,float) r3.xy, r3.xyxx, t1.xyzw, s1, l(0.000000)
    r3.xy = (ArtistNativeSample1((r3.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xy;
    ...
    // 37: mul r3.xy, r3.xyxx, cb0[10].yyyy
    r3.xy = ((r3.xyxx)*(source[10].yyyy)).xy;
    // 38: mul r0.w, v2.x, cb0[8].y
    r0.w = ((v2.xxxx)*(source[8].yyyy)).w;
    // 39: mul r0.w, r0.w, l(1.500000)
    r0.w = ((r0.wwww)*(float4(1.500000,1.500000,1.500000,1.500000))).w;
    // 40: mad r5.x, cb0[8].x, cb0[7].w, r0.w
    r5.x = ((source[8].xxxx)*(source[7].wwww)+(r0.wwww)).x;
    // 41: mul r0.w, r4.x, cb0[8].z
    r0.w = ((r4.xxxx)*(source[8].zzzz)).w;
    // 42: mad r5.y, cb0[8].x, cb0[8].w, r0.w
    r5.y = ((source[8].xxxx)*(source[8].wwww)+(r0.wwww)).y;
    // 43: sample_b_indexable(texture2d)(float,float,float,float) r3.zw, r5.xyxx, t0.zwxy, s0, l(0.000000)
    r3.zw = (ArtistNativeSample0((r5.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).zwxy).zw;
    // 44: mad r3.zw, r3.zzzw, l(0.000000, 0.000000, 2.000000, 2.000000), l(0.000000, 0.000000, -1.000000, -1.000000)
    r3.zw = ((r3.zzzw)*(float4(0.000000,0.000000,2.000000,2.000000))+(float4(0.000000,0.000000,-1.000000,-1.000000))).zw;
    // 45: mad r3.xy, cb0[9].xxxx, r3.zwzz, r3.xyxx
    r3.xy = ((source[9].xxxx)*(r3.zwzz)+(r3.xyxx)).xy;
    // 46: mul r0.w, v4.x, cb0[7].y
    r0.w = ((v4.xxxx)*(source[7].yyyy)).w;
    // 47: mad r1.w, -cb0[7].y, v4.x, v2.y
    r1.w = ((-(source[7].yyyy))*(v4.xxxx)+(v2.yyyy)).w;
    // 48: mad r0.w, cb0[7].z, r1.w, r0.w
    r0.w = ((source[7].zzzz)*(r1.wwww)+(r0.wwww)).w;
    // 49: round_pi r1.w, r1.w
    r1.w = (ceil(r1.wwww)).w;
    // 50: add r2.w, -r0.w, v2.y
    r2.w = ((-(r0.wwww))+(v2.yyyy)).w;
    // 51: mad r4.w, r1.w, r2.w, r0.w
    r4.w = ((r1.wwww)*(r2.wwww)+(r0.wwww)).w;
    // 52: mad r3.xy, cb0[10].zzzz, r3.xyxx, r4.zwzz
    r3.xy = ((source[10].zzzz)*(r3.xyxx)+(r4.zwzz)).xy;
    // 53: add r3.xy, r3.xyxx, cb0[2].xyxx
    r3.xy = ((r3.xyxx)+(source[2].xyxx)).xy;
    // 54: mad r3.zw, v2.xxxy, l(0.000000, 0.000000, -0.300000, 0.050000), l(0.000000, 0.000000, 1.300000, 1.000000)
    r3.zw = ((v2.xxxy)*(float4(0.000000,0.000000,-0.300000,0.050000))+(float4(0.000000,0.000000,1.300000,1.000000))).zw;
    // 55: mul r3.xy, r3.xyxx, r3.zwzz
    r3.xy = ((r3.xyxx)*(r3.zwzz)).xy;
    // 56: sample_b_indexable(texture2d)(float,float,float,float) r3.xyz, r3.xyxx, t2.xyzw, s2, l(0.000000)
    r3.xyz = (ArtistNativeSample2((r3.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 57: mul r4.xyz, r3.xyzx, cb0[3].xyzx
    r4.xyz = ((r3.xyzx)*(source[3].xyzx)).xyz;
    // 58: sample_b_indexable(texture2d)(float,float,float,float) r5.xyzw, v2.xyxx, t3.xyzw, s3, l(0.000000)
    r5.xyzw = (ArtistNativeSample3((v2.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyzw;
    // 59: mad r5.xyz, cb0[4].xyzx, r5.xyzx, -r4.xyzx
    r5.xyz = ((source[4].xyzx)*(r5.xyzx)+(-(r4.xyzx))).xyz;
    // 60: mad r3.xyz, -r3.xyzx, cb0[3].xyzx, r5.wwww
    r3.xyz = ((-(r3.xyzx))*(source[3].xyzx)+(r5.wwww)).xyz;
    // 61: mad r3.xyz, r1.xyzx, r3.xyzx, r4.xyzx
    r3.xyz = ((r1.xyzx)*(r3.xyzx)+(r4.xyzx)).xyz;
    // 62: mad r1.xyz, r1.xyzx, r5.xyzx, r4.xyzx
    r1.xyz = ((r1.xyzx)*(r5.xyzx)+(r4.xyzx)).xyz;
    // 63: mul r2.xyz, r2.xyzx, r1.xyzx
    r2.xyz = ((r2.xyzx)*(r1.xyzx)).xyz;
    // 64: mad r1.xyz, r2.xyzx, cb0[6].xyzx, r1.xyzx
    r1.xyz = ((r2.xyzx)*(source[6].xyzx)+(r1.xyzx)).xyz;
    // 65: mul r2.xyz, r0.xyzx, r0.xyzx
    r2.xyz = ((r0.xyzx)*(r0.xyzx)).xyz;
    // 66: mul r2.xyz, r2.xyzx, r2.xyzx
    r2.xyz = ((r2.xyzx)*(r2.xyzx)).xyz;
    // 67: mul r0.xyz, r0.xyzx, r2.xyzx
    r0.xyz = ((r0.xyzx)*(r2.xyzx)).xyz;
    // 68: min r0.xyz, r0.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
    r0.xyz = (min(r0.xyzx,float4(1.000000,1.000000,1.000000,0.000000))).xyz;
    // 69: mul r1.xyz, r0.xyzx, r1.xyzx
    r1.xyz = ((r0.xyzx)*(r1.xyzx)).xyz;
    // 70: mul r0.xyz, r0.xyzx, r3.xyzx
    r0.xyz = ((r0.xyzx)*(r3.xyzx)).xyz;
    // 71: dp3_sat r0.x, r0.xyzx, l(0.300000, 0.590000, 0.110000, 0.000000)
    ...
    output.w = ((r0.xxxx)*(source[0].xxxx)).w;
    // 74: mad r0.xyz, v3.xyzx, r1.xyzx, cb0[1].xyzx
    r0.xyz = ((v3.xyzx)*(r1.xyzx)+(source[1].xyzx)).xyz;
...
float4 ArtistNative2727(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_c_pa_ring_02_ad: 1893c738ce6a8d4c8ca6b0a4bf849cc5; selected map a32259b11b7ec77bcf6459237da4469c8cf6db50c772a661a91eccf63370ebc0.
float4 ArtistNative2728(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_e_pa_gl_01_1_ad: 8b4801a9801c444caa83855e137d58f2; selected map e64bca26a0a0a114e5dd244138934787a3b094473f191007bd4e4f09add57baf.
float4 ArtistNative2729(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_c_pa_dist_06_ad: 0fc154ee4cdbcc408e07e6b3989115cd; selected map fc665cfba28d644a71f804e3bda422371b49a30fda7761241f1d8ec15baf121b.
float4 ArtistNative2730(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_c_pa_mark_01_1_dt: 5d016e3a03a0bd47bdcbdf53e041895a; selected map 281d5181b7dc07c41e88e4cea1e3e9ea53e8787479276f468d885b78aff29c60.
float4 ArtistNative2731(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative2732(ARTIST_NATIVE_INPUT input)
{
    float4 source[5]; [unroll] for (uint i=0u; i<5u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_PARTICLE_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_d_me_glass_01_03_ts_tr: 4191a53dcb9e5b46b873e6dfc11c3999; selected map 9938308eac5e3955c403d4cfc77e4ab532843ce77f3496e6c45fee8acc92b35d.
float4 ArtistNative2733(ARTIST_NATIVE_INPUT input)
{
    float4 source[10]; [unroll] for (uint i=0u; i<10u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    float4 v8 = asfloat(uint4(input.frontFace ? 0xffffffffu : 0u,0u,0u,0u)); // native sv_isfrontface0
    float4 r0=0.f, r1=0.f, r2=0.f;
    // 1: mad r0.xy, v4.xyxx, cb0[5].xyxx, cb0[4].xyxx
    r0.xy = ((v4.xyxx)*(source[5].xyxx)+(source[4].xyxx)).xy;
    // 2: sample_b_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t0.xyzw, s0, l(0.000000)
    r0.x = (ArtistNativeSample0((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).x;
    // 3: mul r0.y, r0.x, cb0[7].z
    r0.y = ((r0.xxxx)*(source[7].zzzz)).y;
    // 4: mad r0.y, r0.y, l(0.050000), l(-0.025000)
    r0.y = ((r0.yyyy)*(float4(0.050000,0.050000,0.050000,0.050000))+(float4(-0.025000,-0.025000,-0.025000,-0.025000))).y;
    // 5: dp3 r0.z, v6.xyzx, v6.xyzx
    r0.z = (dot((v6.xyzx).xyz,(v6.xyzx).xyz).xxxx).z;
    // 6: rsq r0.z, r0.z
    r0.z = (rsqrt(r0.zzzz)).z;
    // 7: mul r1.xyz, r0.zzzz, v6.xyzx
    r1.xyz = ((r0.zzzz)*(v6.xyzx)).xyz;
    // 8: mad r0.yz, r0.yyyy, r1.xxyx, v4.xxyx
    r0.yz = ((r0.yyyy)*(r1.xxyx)+(v4.xxyx)).yz;
    // 9: mad r0.yz, r0.yyzy, cb0[5].xxyx, cb0[4].xxyx
    r0.yz = ((r0.yyzy)*(source[5].xxyx)+(source[4].xxyx)).yz;
    // 10: sample_b_indexable(texture2d)(float,float,float,float) r0.yz, r0.yzyy, t0.zxyw, s0, l(0.000000)
    r0.yz = (ArtistNativeSample0((r0.yzyy).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).zxyw).yz;
    // 11: mul r0.zw, r0.yyyz, cb0[7].zzzz
    r0.zw = ((r0.yyyz)*(source[7].zzzz)).zw;
    // 12: mad r0.zw, -r1.xxxy, cb0[3].xxxy, r0.zzzw
    r0.zw = ((-(r1.xxxy))*(source[3].xxxy)+(r0.zzzw)).zw;
    // 13: add r1.x, -|r1.z|, l(1.000000)
    r1.x = ((-(abs(r1.zzzz)))+(float4(1.000000,1.000000,1.000000,1.000000))).x;
    // 14: sample_b_indexable(texture2d)(float,float,float,float) r1.yzw, r0.zwzz, t1.wxyz, s1, l(0.000000)
    r1.yzw = (ArtistNativeSample1((r0.zwzz).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).wxyz).yzw;
    // 15: add r0.z, -r0.y, l(1.000000)
    r0.z = ((-(r0.yyyy))+(float4(1.000000,1.000000,1.000000,1.000000))).z;
    // 16: mul r2.xyz, r0.zzzz, l(0.000000, 0.020000, 0.010000, 0.000000)
    r2.xyz = ((r0.zzzz)*(float4(0.000000,0.020000,0.010000,0.000000))).xyz;
    // 17: mad r1.yzw, r0.yyyy, r1.yyzw, r2.xxyz
    r1.yzw = ((r0.yyyy)*(r1.yyzw)+(r2.xxyz)).yzw;
    // 18: log r0.z, |r1.x|
    ...
    // 20: mul r0.z, r0.z, cb0[7].w
    r0.z = ((r0.zzzz)*(source[7].wwww)).z;
    // 21: exp r0.z, r0.z
    r0.z = (exp2(r0.zzzz)).z;
    // 22: mul_sat r0.z, r0.z, cb0[8].x
    r0.z = (saturate((r0.zzzz)*(source[8].xxxx))).z;
    // 23: movc r0.z, r0.w, l(0), r0.z
    r0.z = ((asuint(r0.wwww) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.zzzz)).z;
    // 24: mul r2.xyz, r1.yzwy, r0.zzzz
    r2.xyz = ((r1.yzwy)*(r0.zzzz)).xyz;
    // 25: dp3 r0.w, r2.xyzx, l(0.300000, 0.590000, 0.110000, 0.000000)
    r0.w = (dot((r2.xyzx).xyz,(float4(0.300000,0.590000,0.110000,0.000000)).xyz).xxxx).w;
    // 26: mad r1.xyz, -r0.zzzz, r1.yzwy, r0.wwww
    r1.xyz = ((-(r0.zzzz))*(r1.yzwy)+(r0.wwww)).xyz;
    // 27: mad r1.xyz, cb0[8].yyyy, r1.xyzx, r2.xyzx
    r1.xyz = ((source[8].yyyy)*(r1.xyzx)+(r2.xyzx)).xyz;
    // 28: max r1.xyz, |r1.xyzx|, l(0.000001, 0.000001, 0.000001, 0.000000)
    r1.xyz = (max(abs(r1.xyzx),float4(0.000001,0.000001,0.000001,0.000000))).xyz;
    // 29: log r1.xyz, r1.xyzx
    r1.xyz = (log2(r1.xyzx)).xyz;
    // 30: mul r1.xyz, r1.xyzx, cb0[8].zzzz
    ...
    r1.xyz = ((r1.xyzx)*(r2.xyzx)).xyz;
    // 34: mad r1.xyz, r1.xyzx, cb0[1].xyzx, cb0[2].xyzx
    ...
    // 36: add r0.x, -r0.x, r0.y
    r0.x = ((-(r0.xxxx))+(r0.yyyy)).x;
    // 37: mad r0.x, r0.z, r0.y, r0.x
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_d_pa_smoke_ulit_01_03_dt_tr: c09ef819991e34448b72ea36ee9d1242; selected map 0fa557db3ddb45f15aabefc9953ec128db20431b08a8a53f2bf6c1c3e973117b.
float4 ArtistNative2735(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_PARTICLE_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_d_me_master_01_016_ad: 658321f9f5460c47ad52cac4cb1c0ce2; selected map 3141e453c5d51b27f01af45e3f89569065c1786dd92d7d0f1f2feb9eb157d33d.
float4 ArtistNative2736(ARTIST_NATIVE_INPUT input)
{
    float4 source[13]; [unroll] for (uint i=0u; i<13u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    // 19: mad r1.xyz, cb0[10].xxxx, r1.xyzx, r3.xyzx
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_f_pa_shine_01_4_tr: a14d57c96465f346be3437ad63c9ad10; selected map 0716202d132c7fa3cb9c994bb5370a1db2710298fb3e58040e580c23ad3e1c1b.
float4 ArtistNative2737(ARTIST_NATIVE_INPUT input)
{
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_d_pa_ring_07_38_tr: 49b20ef3e36f5d489296969b93121e8a; selected map f75dbcf90a506f1f7f5dc721416bed80268ad58099bde66257a119e42e54e17d.
float4 ArtistNative2738(ARTIST_NATIVE_INPUT input)
{
    float4 source[10]; [unroll] for (uint i=0u; i<10u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_PARTICLE_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_e_me_fd_04_1_tr: 930f22572ba64f4d9346c46c91237a35; selected map e75b47be0de0f8f378a990a6aae1d31c0701cda86cb27119262601270609a8a8.
float4 ArtistNative2739(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    // 12: dp3 r0.w, v6.xyzx, v6.xyzx
    r0.w = (dot((v6.xyzx).xyz,(v6.xyzx).xyz).xxxx).w;
    // 13: rsq r0.w, r0.w
    r0.w = (rsqrt(r0.wwww)).w;
    // 14: mul r1.xyz, r0.wwww, v6.xyzx
    r1.xyz = ((r0.wwww)*(v6.xyzx)).xyz;
    // 15: dp3 r0.w, r0.xyzx, r1.xyzx
    r0.w = (dot((r0.xyzx).xyz,(r1.xyzx).xyz).xxxx).w;
    // 16: mul r2.xyz, r0.wwww, r0.xyzx
    r2.xyz = ((r0.wwww)*(r0.xyzx)).xyz;
    // 17: mad r1.xyw, r2.xyxz, l(2.000000, 2.000000, 0.000000, 2.000000), -r1.xyxz
    r1.xyw = ((r2.xyxz)*(float4(2.000000,2.000000,0.000000,2.000000))+(-(r1.xyxz))).xyw;
    // 18: max r0.w, r1.z, l(0.000000)
    r0.w = (max(r1.zzzz,float4(0.000000,0.000000,0.000000,0.000000))).w;
    // 19: add r0.w, -r0.w, l(1.000000)
    r0.w = ((-(r0.wwww))+(float4(1.000000,1.000000,1.000000,1.000000))).w;
    // 20: dp3 r1.z, v1.xyzx, v1.xyzx
    r1.z = (dot((v1.xyzx).xyz,(v1.xyzx).xyz).xxxx).z;
    // 21: rsq r1.z, r1.z
    r1.z = (rsqrt(r1.zzzz)).z;
    // 22: mul r2.xyz, r1.zzzz, v1.xyzx
    r2.xyz = ((r1.zzzz)*(v1.xyzx)).xyz;
    // 23: dp3 r3.z, r2.xyzx, r1.xywx
    r3.z = (dot((r2.xyzx).xyz,(r1.xywx).xyz).xxxx).z;
    // 24: dp3 r1.z, v0.xyzx, v0.xyzx
    r1.z = (dot((v0.xyzx).xyz,(v0.xyzx).xyz).xxxx).z;
    // 25: rsq r1.z, r1.z
    r1.z = (rsqrt(r1.zzzz)).z;
    // 26: mul r4.xyz, r1.zzzz, v0.xyzx
    r4.xyz = ((r1.zzzz)*(v0.xyzx)).xyz;
    // 27: dp3 r3.x, r4.xyzx, r1.xywx
    r3.x = (dot((r4.xyzx).xyz,(r1.xywx).xyz).xxxx).x;
    // 28: mul r5.xyz, r2.zxyz, r4.yzxy
    r5.xyz = ((r2.zxyz)*(r4.yzxy)).xyz;
    // 29: mad r5.xyz, r2.yzxy, r4.zxyz, -r5.xyzx
    r5.xyz = ((r2.yzxy)*(r4.zxyz)+(-(r5.xyzx))).xyz;
    // 30: mul r5.xyz, r5.xyzx, v1.wwww
    r5.xyz = ((r5.xyzx)*(v1.wwww)).xyz;
    // 31: dp3 r3.y, r5.xyzx, r1.xywx
    r3.y = (dot((r5.xyzx).xyz,(r1.xywx).xyz).xxxx).y;
    // 32: mov r1.y, -r5.z
    r1.y = (-(r5.zzzz)).y;
    // 33: dp3 r5.y, r5.xyzx, r0.xyzx
    r5.y = (dot((r5.xyzx).xyz,(r0.xyzx).xyz).xxxx).y;
    // 34: mov r1.x, -r4.z
    r1.x = (-(r4.zzzz)).x;
    // 35: dp3 r5.x, r4.xyzx, r0.xyzx
    r5.x = (dot((r4.xyzx).xyz,(r0.xyzx).xyz).xxxx).x;
    // 36: dp3 r5.z, r2.xyzx, r0.xyzx
    r5.z = (dot((r2.xyzx).xyz,(r0.xyzx).xyz).xxxx).z;
    // 37: mov r1.z, -r2.z
    r1.z = (-(r2.zzzz)).z;
    // 38: div_sat r0.xyz, r3.xyzx, r1.xyzx
    r0.xyz = (saturate((r3.xyzx)/(r1.xyzx))).xyz;
    // 39: sample_b_indexable(texture2d)(float,float,float,float) r1.xyz, r3.xyxx, t1.xyzw, s1, l(0.000000)
    r1.xyz = (ArtistNativeSample1((r3.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).xyz;
    // 40: dp3 r0.x, r0.xyzx, l(0.300000, 0.590000, 0.110000, 0.000000)
    r0.x = (dot((r0.xyzx).xyz,(float4(0.300000,0.590000,0.110000,0.000000)).xyz).xxxx).x;
    // 41: log r0.y, r0.x
    r0.y = (log2(r0.xxxx)).y;
    // 42: lt r0.x, r0.x, l(0.000001)
    r0.x = (asfloat((uint4)((r0.xxxx)<(float4(0.000001,0.000001,0.000001,0.000001))) * 0xffffffffu)).x;
    // 43: mul r0.y, r0.y, cb0[3].x
    r0.y = ((r0.yyyy)*(source[3].xxxx)).y;
    // 44: exp r0.y, r0.y
    r0.y = (exp2(r0.yyyy)).y;
    // 45: mul r0.y, r0.y, cb0[3].y
    r0.y = ((r0.yyyy)*(source[3].yyyy)).y;
    // 46: movc r0.x, r0.x, l(0), r0.y
    r0.x = ((asuint(r0.xxxx) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.yyyy)).x;
    // 47: dp3 r0.y, r1.xyzx, l(0.300000, 0.590000, 0.110000, 0.000000)
    r0.y = (dot((r1.xyzx).xyz,(float4(0.300000,0.590000,0.110000,0.000000)).xyz).xxxx).y;
    // 48: add r2.xyz, -r1.xyzx, r0.yyyy
    r2.xyz = ((-(r1.xyzx))+(r0.yyyy)).xyz;
    // 49: mad r1.xyz, r2.xyzx, l(0.900000, 0.900000, 0.900000, 0.000000), r1.xyzx
    r1.xyz = ((r2.xyzx)*(float4(0.900000,0.900000,0.900000,0.000000))+(r1.xyzx)).xyz;
    // 50: add r0.xyz, r0.xxxx, r1.xyzx
    r0.xyz = ((r0.xxxx)+(r1.xyzx)).xyz;
    // 51: mad r0.xyz, r0.xyzx, cb0[1].xyzx, cb0[2].xyzx
    r0.xyz = ((r0.xyzx)*(source[1].xyzx)+(source[2].xyzx)).xyz;
    // 52: mad o0.xyz, r0.xyzx, v5.wwww, v5.xyzx
    output.xyz = ((r0.xyzx)*(v5.wwww)+(v5.xyzx)).xyz;
    // 53: mul r0.x, |r0.w|, |r0.w|
    r0.x = ((abs(r0.wwww))*(abs(r0.wwww))).x;
    // 54: mad r0.x, |r0.w|, r0.x, l(-0.500000)
    r0.x = ((abs(r0.wwww))*(r0.xxxx)+(float4(-0.500000,-0.500000,-0.500000,-0.500000))).x;
    // 55: lt r0.y, |r0.w|, l(0.000001)
    r0.y = (asfloat((uint4)((abs(r0.wwww))<(float4(0.000001,0.000001,0.000001,0.000001))) * 0xffffffffu)).y;
    // 56: mad r0.x, r0.x, l(0.500000), l(0.500000)
    r0.x = ((r0.xxxx)*(float4(0.500000,0.500000,0.500000,0.500000))+(float4(0.500000,0.500000,0.500000,0.500000))).x;
    // 57: movc r0.x, r0.y, l(0.250000), r0.x
    r0.x = ((asuint(r0.yyyy) != 0u) ? (float4(0.250000,0.250000,0.250000,0.250000)) : (r0.xxxx)).x;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_b_pa_linedistort_01_ad: f17d45a712317244a38d0a6c0edc0e30; selected map 9cbe02e53cc350117429a434e2cbae582cfd617c7445ac5d50d50c323c028290.
float4 ArtistNative2740(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    // 2: mul r0.yw, v4.zzzz, l(0.000000, -0.370000, 0.000000, -0.100000)
    r0.yw = ((v4.zzzz)*(float4(0.000000,-0.370000,0.000000,-0.100000))).yw;
    // 3: mad r0.xyzw, v2.xyxy, l(1.000000, 1.500000, 0.500000, 1.000000), r0.xyzw
    r0.xyzw = ((v2.xyxy)*(float4(1.000000,1.500000,0.500000,1.000000))+(r0.xyzw)).xyzw;
    // 4: sample_b_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t0.xyzw, s1, l(0.000000)
    r0.x = (ArtistNativeSample1((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).x;
    ...
    // 6: add r0.x, r0.y, r0.x
    r0.x = ((r0.yyyy)+(r0.xxxx)).x;
    // 7: mad r0.xy, r0.xxxx, v4.xxxx, v2.xyxx
    r0.xy = ((r0.xxxx)*(v4.xxxx)+(v2.xyxx)).xy;
    // 8: sample_b_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t1.xyzw, s2, l(0.000000)
    r0.x = (ArtistNativeSample2((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).x;
    // 9: mul r0.x, r0.x, v3.w
    r0.x = ((r0.xxxx)*(v3.wwww)).x;
    // 10: mul r0.x, r0.x, cb0[0].x
    r0.x = ((r0.xxxx)*(source[0].xxxx)).x;
    // 11: sample_b_indexable(texture2d)(float,float,float,float) r0.yzw, v2.xyxx, t2.wxyz, s0, l(0.000000)
    r0.yzw = (ArtistNativeSample0((v2.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).wxyz).yzw;
    // 12: mad r0.yzw, r0.yyzw, v3.xxyz, cb0[1].xxyz
    r0.yzw = ((r0.yyzw)*(v3.xxyz)+(source[1].xxyz)).yzw;
    // 13: mul r0.yzw, r0.yyzw, v5.wwww
    r0.yzw = ((r0.yyzw)*(v5.wwww)).yzw;
    // 14: mul o0.xyz, r0.xxxx, r0.yzwy
    output.xyz = ((r0.xxxx)*(r0.yzwy)).xyz;
    // 15: mov o0.w, l(0)
    output.w = (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))).w;
    return output;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_d_pa_turbulence_01_16_tr: f2ecc1c1e40aa34d879ceeabe82dfc21; selected map c345cefde3ac6ecbf5923057310970d247e2eee9b09817d3af90d16e36f482f6.
float4 ArtistNative2741(ARTIST_NATIVE_INPUT input)
{
    float4 source[6]; [unroll] for (uint i=0u; i<6u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
#ifndef ARTIST_NATIVE_MODEL_ONLY
// fx_d_pa_sqc_01_03_ad: 3d7695c13c2945419ae8aab70102f5b7; selected map 0bb1b55ace85bbe3195592b11c282ab1f30c6781463c6f2f337c051c8f4d3a9c.
float4 ArtistNative2743(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    // 4: mad r0.xyzw, v0.wwww, r0.xyzw, r1.wxyz
    r0.xyzw = ((v0.wwww)*(r0.xyzw)+(r1.wxyz)).xyzw;
    // 5: dp3 r1.x, r0.yzwy, l(0.300000, 0.590000, 0.110000, 0.000000)
    r1.x = (dot((r0.yzwy).xyz,(float4(0.300000,0.590000,0.110000,0.000000)).xyz).xxxx).x;
    // 6: add r1.xyz, -r0.yzwy, r1.xxxx
    r1.xyz = ((-(r0.yzwy))+(r1.xxxx)).xyz;
    // 7: mad r0.yzw, cb0[2].xxxx, r1.xxyz, r0.yyzw
    r0.yzw = ((source[2].xxxx)*(r1.xxyz)+(r0.yyzw)).yzw;
    // 8: mad r0.yzw, v3.xxyz, r0.yyzw, cb0[1].xxyz
    r0.yzw = ((v3.xxyz)*(r0.yyzw)+(source[1].xxyz)).yzw;
    // 9: mul r0.yzw, r0.yyzw, v5.wwww
    r0.yzw = ((r0.yyzw)*(v5.wwww)).yzw;
    // 10: mov_sat r1.x, v4.y
    r1.x = (saturate(v4.yyyy)).x;
    // 11: add r1.x, -r1.x, l(1.000000)
    r1.x = ((-(r1.xxxx))+(float4(1.000000,1.000000,1.000000,1.000000))).x;
    // 12: add_sat r0.x, r0.x, -r1.x
    r0.x = (saturate((r0.xxxx)+(-(r1.xxxx)))).x;
...
float4 ArtistNative2751(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative2688Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_PARTICLE_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative2689Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[5]; [unroll] for (uint i=0u; i<5u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    source[1].z = (g_ArtistSourceMaterialParameters[2u].xxxx).x;
    ...
    float4 v5 = asfloat(uint4(input.frontFace ? 0xffffffffu : 0u,0u,0u,0u)); // native sv_isfrontface0
    float4 r0=0.f, r1=0.f;
    // 1: mul r0.xy, v2.xyxx, cb0[2].yzyy
    r0.xy = ((v2.xyxx)*(source[2].yzyy)).xy;
    // 2: mul r0.z, cb0[1].x, cb0[1].y
    r0.z = ((source[1].xxxx)*(source[1].yyyy)).z;
    // 3: mad r0.xy, r0.zzzz, cb0[2].xwxx, r0.xyxx
    r0.xy = ((r0.zzzz)*(source[2].xwxx)+(r0.xyxx)).xy;
    // 4: sample_b_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t0.xyzw, s1, l(0.000000)
    r0.x = (ArtistNativeSample1((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).x;
    // 5: mul r0.yw, v2.xxxy, cb0[3].yyyz
    r0.yw = ((v2.xxxy)*(source[3].yyyz)).yw;
    // 6: mad r0.yz, r0.zzzz, cb0[3].xxwx, r0.yywy
    r0.yz = ((r0.zzzz)*(source[3].xxwx)+(r0.yywy)).yz;
    // 7: sample_b_indexable(texture2d)(float,float,float,float) r0.y, r0.yzyy, t1.yxzw, s2, l(0.000000)
    r0.y = (ArtistNativeSample2((r0.yzyy).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yxzw).y;
    // 8: mul r0.x, r0.y, r0.x
    r0.x = ((r0.yyyy)*(r0.xxxx)).x;
    // 9: mul r0.x, r0.x, cb0[4].w
    r0.x = ((r0.xxxx)*(source[4].wwww)).x;
    // 10: mul r0.x, r0.x, cb0[0].w
    r0.x = ((r0.xxxx)*(source[0].wwww)).x;
    // 11: mad r0.xyzw, r0.xxxx, l(2.000000, -2.000000, 2.000000, -2.000000), l(-1.000000, 1.000000, -1.000000, 1.000000)
...
float4 ArtistNative2697Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative2705Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative2707Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative2710Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative2713Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative2714Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative2715Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative2717Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative2719Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_PARTICLE_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative2720Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_PARTICLE_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative2721Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative2722Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative2727Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative2729Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    // 17: movc r0.yw, r0.xxxx, l(0,0,0,0), r0.yyyy
    r0.yw = ((asuint(r0.xxxx) != 0u) ? (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))) : (r0.yyyy)).yw;
    // 18: mov r0.xz, cb0[1].xxxx
    r0.xz = (source[1].xxxx).xz;
    // 19: mad r0.xyzw, r0.xyzw, l(0.000000, -2.000000, 0.000000, -2.000000), l(-1.000000, 1.000000, -1.000000, 1.000000)
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative2730Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    // 5: mad r0.x, -r0.x, l(2.000000), l(1.000000)
    r0.x = ((-(r0.xxxx))*(float4(2.000000,2.000000,2.000000,2.000000))+(float4(1.000000,1.000000,1.000000,1.000000))).x;
    // 6: add_sat r0.x, r0.x, r0.x
    r0.x = (saturate((r0.xxxx)+(r0.xxxx))).x;
    // 7: max r0.y, r0.y, l(0.000000)
    r0.y = (max(r0.yyyy,float4(0.000000,0.000000,0.000000,0.000000))).y;
    // 8: mul r0.y, r0.y, r0.y
    r0.y = ((r0.yyyy)*(r0.yyyy)).y;
    // 9: mul r0.y, r0.y, v3.z
    r0.y = ((r0.yyyy)*(v3.zzzz)).y;
    // 10: mad r1.xyzw, v1.xyxy, l(-2.000000, 2.000000, -2.000000, 2.000000), l(1.000000, -1.000000, 1.000000, -1.000000)
    r1.xyzw = ((v1.xyxy)*(float4(-2.000000,2.000000,-2.000000,2.000000))+(float4(1.000000,-1.000000,1.000000,-1.000000))).xyzw;
    // 11: mul r1.xyzw, r0.yyyy, r1.xyzw
    r1.xyzw = ((r0.yyyy)*(r1.xyzw)).xyzw;
    // 12: mul r0.xyzw, r0.xxxx, r1.xyzw
    r0.xyzw = ((r0.xxxx)*(r1.xyzw)).xyzw;
    // 13: div r1.x, l(1536.000000), v4.z
    r1.x = ((float4(1536.000000,1536.000000,1536.000000,1536.000000))/(v4.zzzz)).x;
    // 14: mul r0.xyzw, r0.xyzw, r1.xxxx
    r0.xyzw = ((r0.xyzw)*(r1.xxxx)).xyzw;
    // 15: mad r0.xyzw, r0.xyzw, l(2.000000, -2.000000, 2.000000, -2.000000), l(-1.000000, 1.000000, -1.000000, 1.000000)
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative2732Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_PARTICLE_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative2736Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative2738Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative2740Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
    ...
    // 1: mov r0.xz, l(0,0,0,0)
    r0.xz = (float4(asfloat(0u),asfloat(0u),asfloat(0u),asfloat(0u))).xz;
    // 2: mul r0.yw, v3.zzzz, l(0.000000, -0.370000, 0.000000, -0.100000)
    r0.yw = ((v3.zzzz)*(float4(0.000000,-0.370000,0.000000,-0.100000))).yw;
    // 3: mad r0.xyzw, v1.xyxy, l(1.000000, 1.500000, 0.500000, 1.000000), r0.xyzw
    r0.xyzw = ((v1.xyxy)*(float4(1.000000,1.500000,0.500000,1.000000))+(r0.xyzw)).xyzw;
    // 4: sample_b_indexable(texture2d)(float,float,float,float) r0.x, r0.xyxx, t0.xyzw, s1, l(0.000000)
    r0.x = (ArtistNativeSample1((r0.xyxx).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).xyzw).x;
    // 5: sample_b_indexable(texture2d)(float,float,float,float) r0.y, r0.zwzz, t0.yxzw, s1, l(0.000000)
    r0.y = (ArtistNativeSample1((r0.zwzz).xy, (float4(0.000000,0.000000,0.000000,0.000000)).x, false).yxzw).y;
    // 6: add r0.x, r0.y, r0.x
    r0.x = ((r0.yyyy)+(r0.xxxx)).x;
    // 7: mad r0.xy, r0.xxxx, v3.xxxx, v1.xyxx
    r0.xy = ((r0.xxxx)*(v3.xxxx)+(v1.xyxx)).xy;
    ...
    // 9: mul r0.xyzw, r0.xyxy, v3.wwww
    r0.xyzw = ((r0.xyxy)*(v3.wwww)).xyzw;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative2743Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
float4 ArtistNative2742(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// Installed source-identical native reuse
float4 ArtistNative2712(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// Installed source-identical native reuse
float4 ArtistNative2711(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative2711Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// Installed source-identical native reuse
float4 ArtistNative2691(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// Installed source-identical native reuse
float4 ArtistNative2695(ARTIST_NATIVE_INPUT input)
{
    float4 source[4]; [unroll] for (uint i=0u; i<4u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative2695Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// Installed source-identical native reuse
float4 ArtistNative2749(ARTIST_NATIVE_INPUT input)
{
    float4 source[6]; [unroll] for (uint i=0u; i<6u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// Installed source-identical native reuse
float4 ArtistNative2734(ARTIST_NATIVE_INPUT input)
{
    float4 source[5]; [unroll] for (uint i=0u; i<5u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// Installed source-identical native reuse
float4 ArtistNative2748(ARTIST_NATIVE_INPUT input)
{
    float4 source[12]; [unroll] for (uint i=0u; i<12u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative2748Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// Installed source-identical native reuse
float4 ArtistNative2718(ARTIST_NATIVE_INPUT input)
{
    float4 source[6]; [unroll] for (uint i=0u; i<6u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// Installed source-identical native reuse
float4 ArtistNative2744(ARTIST_NATIVE_INPUT input)
{
    float4 source[8]; [unroll] for (uint i=0u; i<8u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// Installed source-identical native reuse
float4 ArtistNative2746(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative2746Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// Installed source-identical native reuse
float4 ArtistNative2745(ARTIST_NATIVE_INPUT input)
{
    float4 source[5]; [unroll] for (uint i=0u; i<5u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative2745Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// Installed source-identical native reuse
float4 ArtistNative2747(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_MESH_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative2747Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// Installed source-identical native reuse
float4 ArtistNative2750(ARTIST_NATIVE_INPUT input)
{
    float4 source[14]; [unroll] for (uint i=0u; i<14u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#if !defined(ARTIST_NATIVE_MODEL_ONLY) && !defined(EFFECT_NATIVE_PARTICLE_CARRIER) && !defined(EFFECT_NATIVE_DECAL_CARRIER) && !defined(EFFECT_NATIVE_TRAIL_CARRIER) && !defined(EFFECT_NATIVE_SCREEN_POST_CARRIER)
float4 ArtistNative2750Distortion(ARTIST_NATIVE_INPUT input)
{
    float4 source[3]; [unroll] for (uint i=0u; i<3u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
...
#ifndef ARTIST_NATIVE_MODEL_ONLY
// Installed source-identical native reuse
float4 ArtistNative2702(ARTIST_NATIVE_INPUT input)
{
    float4 source[11]; [unroll] for (uint i=0u; i<11u; ++i) source[i]=0.f;
    source[0].x=1.f; // Project engine opacity multiplier.
    float4 output=0.f;
