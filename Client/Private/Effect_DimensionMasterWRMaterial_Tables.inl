constexpr std::array<std::string_view,2> DIMENSIONMASTER_WR_TEXTURES_208 = {{"flow_texture","alpha_texture"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,17> DIMENSIONMASTER_WR_PARAMETERS_208 = {{
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,2> DIMENSIONMASTER_WR_SWITCHES_208 = {{
    {"use_alphapan", false},
    {"use_sinetime", true},
}};

constexpr std::array<std::string_view,0> DIMENSIONMASTER_WR_TEXTURES_209 = {{}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,1> DIMENSIONMASTER_WR_PARAMETERS_209 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,0> DIMENSIONMASTER_WR_SWITCHES_209 = {{
}};

constexpr std::array<std::string_view,3> DIMENSIONMASTER_WR_TEXTURES_210 = {{"04.map_anew","06.map","00.map_b"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,14> DIMENSIONMASTER_WR_PARAMETERS_210 = {{
    {"selectioncolor", 4u, 0u, true},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,18> DIMENSIONMASTER_WR_SWITCHES_210 = {{
...
constexpr std::array<std::string_view,0> DIMENSIONMASTER_WR_TEXTURES_211 = {{}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,6> DIMENSIONMASTER_WR_PARAMETERS_211 = {{
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,5> DIMENSIONMASTER_WR_SWITCHES_211 = {{
...
constexpr std::array<std::string_view,0> DIMENSIONMASTER_WR_TEXTURES_212 = {{}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,6> DIMENSIONMASTER_WR_PARAMETERS_212 = {{
    {"selectioncolor", 2u, 0u, true},
    {"01.radius", 0u, 0u, false},
    {"02.hardness", 0u, 1u, false},
    {"03.spherepower", 0u, 2u, false},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,4> DIMENSIONMASTER_WR_SWITCHES_212 = {{
    {"01.checkisvertexcolor", true},
    {"02.usedynamicparam", false},
    {"30.usefresnal", false},
    {"checkisdepthbiasalpha", true},
...
constexpr std::array<std::string_view,1> DIMENSIONMASTER_WR_TEXTURES_213 = {{"slice_flow_texture"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,11> DIMENSIONMASTER_WR_PARAMETERS_213 = {{
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,0> DIMENSIONMASTER_WR_SWITCHES_213 = {{
}};

constexpr std::array<std::string_view,3> DIMENSIONMASTER_WR_TEXTURES_214 = {{"normal_tex","refle_tex","native_texture_2"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,17> DIMENSIONMASTER_WR_PARAMETERS_214 = {{
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,2> DIMENSIONMASTER_WR_SWITCHES_214 = {{
    {"use_depth", false},
    {"use_dissolve", false},
}};

constexpr std::array<std::string_view,6> DIMENSIONMASTER_WR_TEXTURES_215 = {{"mask_noisemap","mask_tex_l","mask_tex_r","01.map_e","06.map","06.map_f"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,38> DIMENSIONMASTER_WR_PARAMETERS_215 = {{
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,17> DIMENSIONMASTER_WR_SWITCHES_215 = {{
    {"00.use_texmap", false},
    {"03.addphase", false},
    {"10.usebump", false},
...
constexpr std::array<std::string_view,7> DIMENSIONMASTER_WR_TEXTURES_216 = {{"cracknormal_tex","native_texture_1","in_hole_texture","aura_texture","native_texture_4","native_texture_5","native_texture_6"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,32> DIMENSIONMASTER_WR_PARAMETERS_216 = {{
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,6> DIMENSIONMASTER_WR_SWITCHES_216 = {{
...
constexpr std::array<std::string_view,5> DIMENSIONMASTER_WR_TEXTURES_217 = {{"flow_1_tex","flow_2_tex","diff_tex","opacity_tex","mask_tex"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,35> DIMENSIONMASTER_WR_PARAMETERS_217 = {{
    {"selectioncolor", 10u, 0u, true},
    {"color_1", 8u, 0u, true},
    {"color_2", 9u, 0u, true},
    {"diff_u", 1u, 0u, false},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,3> DIMENSIONMASTER_WR_SWITCHES_217 = {{
    {"use_mesh", false},
    {"depthalpha_use", true},
    {"noise_compose", false},
}};

constexpr std::array<std::string_view,2> DIMENSIONMASTER_WR_TEXTURES_218 = {{"01.map_a","06.map_b"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,19> DIMENSIONMASTER_WR_PARAMETERS_218 = {{
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,12> DIMENSIONMASTER_WR_SWITCHES_218 = {{
...
constexpr std::array<std::string_view,3> DIMENSIONMASTER_WR_TEXTURES_220 = {{"14.map_d","01.map_a","06.map_b"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,19> DIMENSIONMASTER_WR_PARAMETERS_220 = {{
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,6> DIMENSIONMASTER_WR_SWITCHES_220 = {{
    {"checkisdepthbiasalpha", true},
...
constexpr std::array<std::string_view,1> DIMENSIONMASTER_WR_TEXTURES_221 = {{"main_tex"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,5> DIMENSIONMASTER_WR_PARAMETERS_221 = {{
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,4> DIMENSIONMASTER_WR_SWITCHES_221 = {{
    {"use_5waysplit", false},
    {"use_alphach", false},
...
constexpr std::array<std::string_view,1> DIMENSIONMASTER_WR_TEXTURES_222 = {{"native_texture_0"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,7> DIMENSIONMASTER_WR_PARAMETERS_222 = {{
    {"selectioncolor", 2u, 0u, true},
    {"u_scale", 0u, 2u, false},
    {"v_scale", 0u, 3u, false},
    {"wave_uv", 1u, 1u, false},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,2> DIMENSIONMASTER_WR_SWITCHES_222 = {{
    {"use_turns", true},
    {"mask_up/down", true},
}};

constexpr std::array<std::string_view,1> DIMENSIONMASTER_WR_TEXTURES_223 = {{"emissive_tex"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,7> DIMENSIONMASTER_WR_PARAMETERS_223 = {{
    {"selectioncolor", 2u, 0u, true},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,17> DIMENSIONMASTER_WR_SWITCHES_223 = {{
...
constexpr std::array<std::string_view,2> DIMENSIONMASTER_WR_TEXTURES_224 = {{"uv_noise_tex","emissive_tex"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,10> DIMENSIONMASTER_WR_PARAMETERS_224 = {{
    {"selectioncolor", 3u, 0u, true},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,5> DIMENSIONMASTER_WR_SWITCHES_224 = {{
    {"use_meshtype", false},
    {"use_subuv_tex", false},
...
constexpr std::array<std::string_view,0> DIMENSIONMASTER_WR_TEXTURES_225 = {{}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,6> DIMENSIONMASTER_WR_PARAMETERS_225 = {{
    {"selectioncolor", 2u, 0u, true},
    {"01.color", 1u, 0u, true},
    {"01.radius", 0u, 0u, false},
    {"02.hardness", 0u, 1u, false},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,4> DIMENSIONMASTER_WR_SWITCHES_225 = {{
    {"00.usenoise", false},
    {"01.usemesh", false},
    {"00.checkisdepthbiasalpha", false},
...
constexpr std::array<std::string_view,1> DIMENSIONMASTER_WR_TEXTURES_226 = {{"lensflaretexture"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,4> DIMENSIONMASTER_WR_PARAMETERS_226 = {{
    {"selectioncolor", 1u, 0u, true},
    {"select texture(0 or 0.5)", 0u, 2u, false},
    {"desaturation", 0u, 1u, false},
    {"depthbaisalpha", 0u, 0u, false},
}};
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,0> DIMENSIONMASTER_WR_SWITCHES_226 = {{
}};

constexpr std::array<std::string_view,1> DIMENSIONMASTER_WR_TEXTURES_229 = {{"emissive_tex"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,1> DIMENSIONMASTER_WR_PARAMETERS_229 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,3> DIMENSIONMASTER_WR_SWITCHES_229 = {{
    {"use_meshtype", false},
    {"use_subuv_tex", false},
    {"use_nonalpha_chanel", false},
}};

constexpr std::array<std::string_view,5> DIMENSIONMASTER_WR_TEXTURES_230 = {{"maintex","uv_noise_tex","emissivetex02","noisedissolve_tex","dissolve_tex_01"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,44> DIMENSIONMASTER_WR_PARAMETERS_230 = {{
    {"selectioncolor", 12u, 0u, true},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,20> DIMENSIONMASTER_WR_SWITCHES_230 = {{
    {"use_dissolve", true},
    {"use_meshtype", false},
    {"use_uvnoise", true},
...
constexpr std::array<std::string_view,5> DIMENSIONMASTER_WR_TEXTURES_231 = {{"maintex","uv_noise_tex","emissivetex02","noisedissolve_tex","dissolve_tex_01"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,41> DIMENSIONMASTER_WR_PARAMETERS_231 = {{
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,20> DIMENSIONMASTER_WR_SWITCHES_231 = {{
    {"use_dissolve", true},
    {"use_meshtype", false},
    {"use_uvnoise", true},
    {"achannel_use_uvnoisedynamicpan", true},
...
constexpr std::array<std::string_view,1> DIMENSIONMASTER_WR_TEXTURES_232 = {{"emissive_tex"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,1> DIMENSIONMASTER_WR_PARAMETERS_232 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,3> DIMENSIONMASTER_WR_SWITCHES_232 = {{
    {"use_meshtype", false},
    {"use_subuv_tex", false},
    {"use_nonalpha_chanel", true},
}};

constexpr std::array<std::string_view,3> DIMENSIONMASTER_WR_TEXTURES_233 = {{"diff_tex","diff_noise_tex","a_mask_tex"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,26> DIMENSIONMASTER_WR_PARAMETERS_233 = {{
    {"selectioncolor", 7u, 0u, true},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,13> DIMENSIONMASTER_WR_SWITCHES_233 = {{
...
constexpr std::array<std::string_view,3> DIMENSIONMASTER_WR_TEXTURES_234 = {{"maintex","uv_noise_tex","dissolve_tex_01"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,34> DIMENSIONMASTER_WR_PARAMETERS_234 = {{
    {"selectioncolor", 10u, 0u, true},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,19> DIMENSIONMASTER_WR_SWITCHES_234 = {{
    {"use_alpha_fresnel", true},
    {"use_meshtype", true},
...
constexpr std::array<std::string_view,6> DIMENSIONMASTER_WR_TEXTURES_235 = {{"crackcore_tex","crackcore_normal","native_texture_2","native_texture_3","crack_linetexture","crack_uvtexture"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,17> DIMENSIONMASTER_WR_PARAMETERS_235 = {{
    {"selectioncolor", 6u, 0u, true},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,4> DIMENSIONMASTER_WR_SWITCHES_235 = {{
...
constexpr std::array<std::string_view,3> DIMENSIONMASTER_WR_TEXTURES_238 = {{"normal_tex","refle_tex","native_texture_2"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,17> DIMENSIONMASTER_WR_PARAMETERS_238 = {{
    {"selectioncolor", 7u, 0u, true},
    {"refle_panspeed", 1u, 3u, false},
    {"refle_color", 6u, 0u, true},
    {"meshemitterdynamicparameter", 4u, 0u, true},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,2> DIMENSIONMASTER_WR_SWITCHES_238 = {{
    {"use_depth", false},
    {"use_dissolve", false},
}};

constexpr std::array<std::string_view,1> DIMENSIONMASTER_WR_TEXTURES_239 = {{"emissive_tex"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,6> DIMENSIONMASTER_WR_PARAMETERS_239 = {{
    {"selectioncolor", 2u, 0u, true},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,17> DIMENSIONMASTER_WR_SWITCHES_239 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", true},
    {"use_distortion", false},
    {"use_meshtype", false},
...
constexpr std::array<std::string_view,1> DIMENSIONMASTER_WR_TEXTURES_240 = {{"lensflaretexture"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,4> DIMENSIONMASTER_WR_PARAMETERS_240 = {{
    {"selectioncolor", 1u, 0u, true},
    {"select texture(0 or 0.5)", 0u, 2u, false},
    {"desaturation", 0u, 1u, false},
    {"depthbaisalpha", 0u, 0u, false},
}};
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,0> DIMENSIONMASTER_WR_SWITCHES_240 = {{
}};

constexpr std::array<std::string_view,0> DIMENSIONMASTER_WR_TEXTURES_241 = {{}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,6> DIMENSIONMASTER_WR_PARAMETERS_241 = {{
    {"selectioncolor", 2u, 0u, true},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,4> DIMENSIONMASTER_WR_SWITCHES_241 = {{
    {"use_distortion", false},
    {"use_centerglow", true},
...
constexpr std::array<std::string_view,7> DIMENSIONMASTER_WR_TEXTURES_242 = {{"cracknormal_tex","native_texture_1","in_hole_texture","aura_texture","native_texture_4","native_texture_5","native_texture_6"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,32> DIMENSIONMASTER_WR_PARAMETERS_242 = {{
    {"selectioncolor", 10u, 0u, true},
    {"in_hole_panx", 4u, 0u, false},
    {"in_hole_pany", 4u, 1u, false},
    {"alpha_tile_x", 0u, 2u, false},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,6> DIMENSIONMASTER_WR_SWITCHES_242 = {{
    {"use_dynamic_vcoord", true},
    {"uvnoise_v_pannertime", true},
    {"main_v_pannertime", false},
    {"main_u_pannertime", false},
...
constexpr std::array<std::string_view,2> DIMENSIONMASTER_WR_TEXTURES_243 = {{"01.map_a","21.map_c"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,15> DIMENSIONMASTER_WR_PARAMETERS_243 = {{
    {"selectioncolor", 5u, 0u, true},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,26> DIMENSIONMASTER_WR_SWITCHES_243 = {{
    {"00.usedistortion", false},
    {"01.usemesh", true},
    {"31.mapch.r", true},
    {"32.mapch.g", true},
...
constexpr std::array<std::string_view,3> DIMENSIONMASTER_WR_TEXTURES_244 = {{"12.map_f","06.map","02.map_e"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,29> DIMENSIONMASTER_WR_PARAMETERS_244 = {{
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,27> DIMENSIONMASTER_WR_SWITCHES_244 = {{
    {"00.usespecullar", false},
    {"11.mape+mapf", true},
    {"10.use_mapb", true},
...
constexpr std::array<std::string_view,2> DIMENSIONMASTER_WR_TEXTURES_245 = {{"01.map_a","06.map_b"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,19> DIMENSIONMASTER_WR_PARAMETERS_245 = {{
    {"selectioncolor", 6u, 0u, true},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,12> DIMENSIONMASTER_WR_SWITCHES_245 = {{
    {"00.checkisdepthbiasalpha", false},
    {"10.usefakedepthbiasalpha", true},
    {"01.useconeuv", false},
    {"30.usefresnal", true},
...
constexpr std::array<std::string_view,0> DIMENSIONMASTER_WR_TEXTURES_246 = {{}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,6> DIMENSIONMASTER_WR_PARAMETERS_246 = {{
    {"selectioncolor", 2u, 0u, true},
    {"centerglow_power", 0u, 0u, false},
    {"centerglow_str", 0u, 1u, false},
    {"glow_power", 0u, 2u, false},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,0> DIMENSIONMASTER_WR_SWITCHES_246 = {{
}};

constexpr std::array<std::string_view,3> DIMENSIONMASTER_WR_TEXTURES_247 = {{"14.map_d","01.map_a","06.map_b"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,19> DIMENSIONMASTER_WR_PARAMETERS_247 = {{
    {"selectioncolor", 5u, 0u, true},
    {"power", 4u, 0u, false},
    {"str", 4u, 1u, false},
    {"04.map_a_panning_x", 1u, 0u, false},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,5> DIMENSIONMASTER_WR_SWITCHES_247 = {{
...
constexpr std::array<std::string_view,4> DIMENSIONMASTER_WR_TEXTURES_248 = {{"diff_texture","dissolve_texture","flow_texture","alpha_texture"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,25> DIMENSIONMASTER_WR_PARAMETERS_248 = {{
    {"selectioncolor", 8u, 0u, true},
    {"diff_color", 6u, 0u, true},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,2> DIMENSIONMASTER_WR_SWITCHES_248 = {{
    {"use_mesh", false},
    {"use_steptexcoord_y", true},
}};

constexpr std::array<std::string_view,5> DIMENSIONMASTER_WR_TEXTURES_251 = {{"01.map_uv","01.map_e","native_texture_2","01.map_a","11.map_b"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,13> DIMENSIONMASTER_WR_PARAMETERS_251 = {{
    {"selectioncolor", 4u, 0u, true},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,8> DIMENSIONMASTER_WR_SWITCHES_251 = {{
    {"00.checkisdepthbiasalpha", false},
    {"01.usemesh", false},
    {"06.mapch.r", false},
    {"07.mapch.g", false},
...
constexpr std::array<std::string_view,2> DIMENSIONMASTER_WR_TEXTURES_252 = {{"01.map_e","06.map_f"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,22> DIMENSIONMASTER_WR_PARAMETERS_252 = {{
    {"selectioncolor", 6u, 0u, true},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,10> DIMENSIONMASTER_WR_SWITCHES_252 = {{
    {"00.usedistortion", false},
    {"01.usemesh", false},
    {"40.usefresnal", false},
    {"00.use_uvdistort", false},
...
constexpr std::array<std::string_view,3> DIMENSIONMASTER_WR_TEXTURES_253 = {{"14.map_d","01.map_a","06.map_b"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,19> DIMENSIONMASTER_WR_PARAMETERS_253 = {{
    {"selectioncolor", 6u, 0u, true},
    {"noisecolor", 5u, 0u, true},
    {"15.map_d_uvscale_r", 2u, 3u, false},
    {"16.map_d_uvscale_g", 3u, 0u, false},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,6> DIMENSIONMASTER_WR_SWITCHES_253 = {{
    {"checkisdepthbiasalpha", true},
    {"00.checkisnoiseon", true},
    {"12.uvnoise", true},
    {"11.uvmirroring", false},
...
constexpr std::array<std::string_view,3> DIMENSIONMASTER_WR_TEXTURES_254 = {{"14.map_d","01.map_a","06.map_b"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,24> DIMENSIONMASTER_WR_PARAMETERS_254 = {{
    {"selectioncolor", 6u, 0u, true},
    {"11.direct", 2u, 2u, false},
    {"04.map_a_panning_x", 1u, 0u, false},
    {"02.map_a_uvscale_r", 0u, 2u, false},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,12> DIMENSIONMASTER_WR_SWITCHES_254 = {{
    {"00.checkisdepthbiasalpha", false},
    {"10.usefakedepthbiasalpha", true},
    {"01.useconeuv", true},
    {"30.usefresnal", false},
...
constexpr std::array<std::string_view,3> DIMENSIONMASTER_WR_TEXTURES_255 = {{"01.map_e","01.map_a","21.map_m"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,17> DIMENSIONMASTER_WR_PARAMETERS_255 = {{
    {"selectioncolor", 5u, 0u, true},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,6> DIMENSIONMASTER_WR_SWITCHES_255 = {{
    {"01.usemesh", false},
    {"30.usefresnel", false},
...
constexpr std::array<std::string_view,5> DIMENSIONMASTER_WR_TEXTURES_256 = {{"maintex","uv_noise_tex_02","uv_noise_tex","noisedissolve_tex","dissolve_tex_01"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,45> DIMENSIONMASTER_WR_PARAMETERS_256 = {{
    {"selectioncolor", 12u, 0u, true},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,19> DIMENSIONMASTER_WR_SWITCHES_256 = {{
    {"use_alpha_fresnel", false},
    {"use_meshtype", false},
    {"use_dissolvetex_noise", true},
    {"use_dissolvetex_noise_type", true},
...
constexpr std::array<std::string_view,6> DIMENSIONMASTER_WR_TEXTURES_257 = {{"native_texture_0","native_texture_1","native_texture_2","sparkle_tex","edgedeco texture01","native_texture_5"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,4> DIMENSIONMASTER_WR_PARAMETERS_257 = {{
    {"selectioncolor", 1u, 0u, true},
    {"sparkle_paning", 0u, 1u, false},
    {"sparkle_tiling", 0u, 2u, false},
    {"sparkle_intensity", 0u, 0u, false},
}};
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,0> DIMENSIONMASTER_WR_SWITCHES_257 = {{
}};

constexpr std::array<std::string_view,7> DIMENSIONMASTER_WR_TEXTURES_258 = {{"06.map","02.map_e","12.map_f","01.map_a","11.map_b","21.map_c","01.specmap"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,43> DIMENSIONMASTER_WR_PARAMETERS_258 = {{
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,26> DIMENSIONMASTER_WR_SWITCHES_258 = {{
    {"00.usedistortion", false},
    {"01.usemesh", true},
    {"31.mapch.r", true},
    {"32.mapch.g", true},
...
constexpr std::array<std::string_view,4> DIMENSIONMASTER_WR_TEXTURES_259 = {{"06.map","02.map_e","12.map_f","21.map_c"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,25> DIMENSIONMASTER_WR_PARAMETERS_259 = {{
    {"selectioncolor", 7u, 0u, true},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,26> DIMENSIONMASTER_WR_SWITCHES_259 = {{
    {"00.usedistortion", false},
    {"01.usemesh", false},
    {"31.mapch.r", true},
    {"32.mapch.g", true},
...
constexpr std::array<std::string_view,4> DIMENSIONMASTER_WR_TEXTURES_260 = {{"maintex","uv_noise_tex","noisedissolve_tex","dissolve_tex_01"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,40> DIMENSIONMASTER_WR_PARAMETERS_260 = {{
    {"selectioncolor", 12u, 0u, true},
...
// native-material-public-constant: DIMENSIONMASTER_WR_260_CPU_ROTATION_ROW
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,20> DIMENSIONMASTER_WR_SWITCHES_260 = {{
    {"use_dissolve", true},
    {"use_meshtype", true},
    {"use_uvnoise", true},
    {"achannel_use_uvnoisedynamicpan", false},
...
constexpr std::array<std::string_view,1> DIMENSIONMASTER_WR_TEXTURES_262 = {{"subuv_tex"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,4> DIMENSIONMASTER_WR_PARAMETERS_262 = {{
    {"selectioncolor", 2u, 0u, true},
    {"emissive_color&intensity", 1u, 0u, true},
    {"dynamic_parameter_explanation", 0u, 0u, false},
    {"emissive_tex_desturation", 0u, 1u, false},
}};
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,5> DIMENSIONMASTER_WR_SWITCHES_262 = {{
    {"use_meshtype", false},
    {"use_subuv_tex", true},
    {"use_nonalpha_tex", false},
    {"use_emissive_vertcolor", false},
...
constexpr std::array<std::string_view,3> DIMENSIONMASTER_WR_TEXTURES_263 = {{"normal_tex","refle_tex","native_texture_2"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,17> DIMENSIONMASTER_WR_PARAMETERS_263 = {{
    {"selectioncolor", 7u, 0u, true},
    {"refle_panspeed", 1u, 3u, false},
    {"refle_color", 6u, 0u, true},
    {"meshemitterdynamicparameter", 4u, 0u, true},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,2> DIMENSIONMASTER_WR_SWITCHES_263 = {{
    {"use_depth", false},
    {"use_dissolve", false},
}};


constexpr std::array<std::string_view,4> DIMENSIONMASTER_WR_TEXTURES_277 = {{"flowtex","diff_tex1","diff_tex2","opacity_tex"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,27> DIMENSIONMASTER_WR_PARAMETERS_277 = {{
    {"selectioncolor", 8u, 0u, true},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,5> DIMENSIONMASTER_WR_SWITCHES_277 = {{
...
constexpr std::array<std::string_view,2> DIMENSIONMASTER_WR_TEXTURES_278 = {{"native_texture_0","native_texture_1"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,2> DIMENSIONMASTER_WR_PARAMETERS_278 = {{
    {"selectioncolor", 1u, 0u, true},
    {"meshemitterdynamicparameter", 0u, 0u, true},
}};
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,0> DIMENSIONMASTER_WR_SWITCHES_278 = {{
}};

constexpr std::array<std::string_view,6> DIMENSIONMASTER_WR_TEXTURES_279 = {{"diff_tex","a_mask_tex","a_noise_01_tex","b_mask_tex","b_noise_01_tex","dissolve_tex"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,56> DIMENSIONMASTER_WR_PARAMETERS_279 = {{
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,21> DIMENSIONMASTER_WR_SWITCHES_279 = {{
    {"meshtype_use", true},
...
constexpr std::array<std::string_view,4> DIMENSIONMASTER_WR_TEXTURES_280 = {{"flowtex","diff_tex1","diff_tex2","opacity_tex"}};
constexpr std::array<DIMENSIONMASTER_WR_PARAMETER_DESC,27> DIMENSIONMASTER_WR_PARAMETERS_280 = {{
    {"selectioncolor", 8u, 0u, true},
    {"diff_backcolor", 6u, 0u, true},
    {"flow_tile_u", 3u, 3u, false},
    {"flow_tile_v", 4u, 0u, false},
...
constexpr std::array<DIMENSIONMASTER_WR_SWITCH_DESC,5> DIMENSIONMASTER_WR_SWITCHES_280 = {{
    {"use_gra_r_channel", false},
    {"use_colormap", false},
    {"diff_pan_use_u", false},
    {"use_cam_vector", true},
...
constexpr std::array<DIMENSIONMASTER_WR_PROGRAM_DESC,56> DIMENSIONMASTER_WR_PROGRAM_STORAGE = {{
