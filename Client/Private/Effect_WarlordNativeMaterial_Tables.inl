constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_400 = {{"noise_tex","emissive_tex","dissolve_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,2> WARLORD_NATIVE_PARAMETERS_400 = {{
    {"selectioncolor", 1u, 0u, true},
    {"22", 0u, 0u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,1> WARLORD_NATIVE_SWITCHES_400 = {{
    {"use_noalpha", false},
}};

constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_401 = {{"native_texture_0","native_texture_1"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,1> WARLORD_NATIVE_PARAMETERS_401 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_401 = {{
}};

constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_402 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,5> WARLORD_NATIVE_PARAMETERS_402 = {{
    {"selectioncolor", 1u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,18> WARLORD_NATIVE_SWITCHES_402 = {{
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_403 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,8> WARLORD_NATIVE_PARAMETERS_403 = {{
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,18> WARLORD_NATIVE_SWITCHES_403 = {{
    {"use_mesh_world_normal", false},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_404 = {{"04.map_anew","00.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,8> WARLORD_NATIVE_PARAMETERS_404 = {{
    {"selectioncolor", 2u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,18> WARLORD_NATIVE_SWITCHES_404 = {{
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_405 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,6> WARLORD_NATIVE_PARAMETERS_405 = {{
    {"selectioncolor", 2u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,17> WARLORD_NATIVE_SWITCHES_405 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", true},
    {"use_distortion", false},
    {"use_meshtype", false},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_406 = {{"subuv_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,4> WARLORD_NATIVE_PARAMETERS_406 = {{
    {"selectioncolor", 2u, 0u, true},
    {"emissive_color&intensity", 1u, 0u, true},
    {"dynamic_parameter_explanation", 0u, 0u, false},
    {"emissive_tex_desturation", 0u, 1u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,5> WARLORD_NATIVE_SWITCHES_406 = {{
    {"use_meshtype", false},
    {"use_subuv_tex", true},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_407 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,8> WARLORD_NATIVE_PARAMETERS_407 = {{
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,18> WARLORD_NATIVE_SWITCHES_407 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", false},
    {"use_distortion", false},
    {"use_distortion_floor", false},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_408 = {{"14.map_d","01.map_a","06.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,19> WARLORD_NATIVE_PARAMETERS_408 = {{
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,6> WARLORD_NATIVE_SWITCHES_408 = {{
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_409 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,8> WARLORD_NATIVE_PARAMETERS_409 = {{
    {"selectioncolor", 3u, 0u, true},
    {"meshemitterdynamicparameter", 2u, 0u, true},
    {"uv_scale", 1u, 1u, false},
    {"dynamic_parameter_explanation", 0u, 0u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,18> WARLORD_NATIVE_SWITCHES_409 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", false},
    {"use_distortion", false},
    {"use_distortion_floor", false},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_410 = {{"dissolve_noise_tex","emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,12> WARLORD_NATIVE_PARAMETERS_410 = {{
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,14> WARLORD_NATIVE_SWITCHES_410 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", false},
    {"use_distortion", false},
    {"use_distortion_floor", false},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_411 = {{"rampshape_texture","uvnoise_texture","noise_texture"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,7> WARLORD_NATIVE_PARAMETERS_411 = {{
    {"selectioncolor", 3u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,9> WARLORD_NATIVE_SWITCHES_411 = {{
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_412 = {{"subuv_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,5> WARLORD_NATIVE_PARAMETERS_412 = {{
    {"selectioncolor", 1u, 0u, true},
    {"dynamic_parameter_explanation", 0u, 1u, false},
    {"emissive_desaturation", 0u, 2u, false},
    {"emissive_power", 0u, 3u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,17> WARLORD_NATIVE_SWITCHES_412 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", false},
    {"use_distortion", true},
    {"use_meshtype", false},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_413 = {{"subuv_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,4> WARLORD_NATIVE_PARAMETERS_413 = {{
    {"selectioncolor", 2u, 0u, true},
    {"emissive_color&intensity", 1u, 0u, true},
    {"dynamic_parameter_explanation", 0u, 0u, false},
    {"emissive_tex_desturation", 0u, 1u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,5> WARLORD_NATIVE_SWITCHES_413 = {{
    {"use_meshtype", false},
    {"use_subuv_tex", true},
    {"use_nonalpha_tex", false},
    {"use_emissive_vertcolor", false},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_414 = {{"native_texture_0","native_texture_1","native_texture_2"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,1> WARLORD_NATIVE_PARAMETERS_414 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_414 = {{
}};

constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_415 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,4> WARLORD_NATIVE_PARAMETERS_415 = {{
    {"selectioncolor", 1u, 0u, true},
    {"circle radius", 0u, 0u, false},
    {"circleedge hardness", 0u, 1u, false},
    {"opacity", 0u, 2u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,3> WARLORD_NATIVE_SWITCHES_415 = {{
    {"use_particle", true},
    {"use_invertedcirclealpha", false},
    {"use_circlealpha", true},
}};

constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_416 = {{"subuv_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,4> WARLORD_NATIVE_PARAMETERS_416 = {{
    {"selectioncolor", 2u, 0u, true},
    {"emissive_color&intensity", 1u, 0u, true},
    {"dynamic_parameter_explanation", 0u, 0u, false},
    {"emissive_tex_desturation", 0u, 1u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,5> WARLORD_NATIVE_SWITCHES_416 = {{
    {"use_meshtype", false},
    {"use_subuv_tex", true},
    {"use_nonalpha_tex", false},
    {"use_emissive_vertcolor", false},
...
constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_417 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,7> WARLORD_NATIVE_PARAMETERS_417 = {{
    {"selectioncolor", 2u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,2> WARLORD_NATIVE_SWITCHES_417 = {{
    {"00.use_distortion", false},
    {"00.use_depth_alpha", true},
}};

constexpr std::array<std::string_view,9> WARLORD_NATIVE_TEXTURES_418 = {{"native_texture_0","native_texture_1","native_texture_2","native_texture_3","native_texture_4","native_texture_5","native_texture_6","native_texture_7","native_texture_8"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,7> WARLORD_NATIVE_PARAMETERS_418 = {{
    {"selectioncolor", 5u, 0u, true},
    {"meshemitterdynamicparameter", 4u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_418 = {{
}};

constexpr std::array<std::string_view,5> WARLORD_NATIVE_TEXTURES_419 = {{"01.map.n","01.emismap","01.map.d","01.specmap","01.map_a"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,30> WARLORD_NATIVE_PARAMETERS_419 = {{
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,23> WARLORD_NATIVE_SWITCHES_419 = {{
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_420 = {{"detail texture","spread texture","center texture"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,4> WARLORD_NATIVE_PARAMETERS_420 = {{
    {"selectioncolor", 1u, 0u, true},
    {"scale", 0u, 2u, false},
    {"detail texture tiling", 0u, 0u, false},
    {"dynamic_parameter_explanation", 0u, 1u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,12> WARLORD_NATIVE_SWITCHES_420 = {{
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_421 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,6> WARLORD_NATIVE_PARAMETERS_421 = {{
    {"selectioncolor", 2u, 0u, true},
    {"uv_scale", 1u, 0u, false},
    {"dynamic_parameter_explanation", 0u, 1u, false},
    {"emissive_desaturation", 0u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,17> WARLORD_NATIVE_SWITCHES_421 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", true},
    {"use_distortion", false},
    {"use_meshtype", false},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_422 = {{"uv_noise_tex","emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,10> WARLORD_NATIVE_PARAMETERS_422 = {{
    {"selectioncolor", 3u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,5> WARLORD_NATIVE_SWITCHES_422 = {{
    {"use_meshtype", false},
    {"use_subuv_tex", false},
    {"use_nonalpha_tex", false},
    {"use_emissive_vertcolor", false},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_423 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,5> WARLORD_NATIVE_PARAMETERS_423 = {{
    {"selectioncolor", 1u, 0u, true},
    {"uv_scale", 0u, 3u, false},
    {"dynamic_parameter_explanation", 0u, 0u, false},
    {"emissive_desaturation", 0u, 1u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,17> WARLORD_NATIVE_SWITCHES_423 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", false},
    {"use_distortion", false},
    {"use_meshtype", false},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_424 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,1> WARLORD_NATIVE_PARAMETERS_424 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,3> WARLORD_NATIVE_SWITCHES_424 = {{
    {"use_meshtype", false},
    {"use_subuv_tex", false},
    {"use_nonalpha_chanel", false},
}};

constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_425 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,1> WARLORD_NATIVE_PARAMETERS_425 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,3> WARLORD_NATIVE_SWITCHES_425 = {{
    {"use_meshtype", false},
    {"use_subuv_tex", false},
    {"use_nonalpha_chanel", false},
}};

constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_426 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,1> WARLORD_NATIVE_PARAMETERS_426 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,3> WARLORD_NATIVE_SWITCHES_426 = {{
    {"use_meshtype", false},
    {"use_subuv_tex", false},
    {"use_nonalpha_chanel", false},
}};

constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_427 = {{"01.map"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,8> WARLORD_NATIVE_PARAMETERS_427 = {{
    {"selectioncolor", 2u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,1> WARLORD_NATIVE_SWITCHES_427 = {{
    {"00.checkisdepthbiasalpha", true},
}};

constexpr std::array<std::string_view,6> WARLORD_NATIVE_TEXTURES_428 = {{"native_texture_0","native_texture_1","native_texture_2","sparkle_tex","edgedeco texture01","native_texture_5"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,4> WARLORD_NATIVE_PARAMETERS_428 = {{
    {"selectioncolor", 1u, 0u, true},
    {"sparkle_paning", 0u, 1u, false},
    {"sparkle_tiling", 0u, 2u, false},
    {"sparkle_intensity", 0u, 0u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_428 = {{
}};

constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_429 = {{"map_a"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,1> WARLORD_NATIVE_PARAMETERS_429 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_429 = {{
}};

constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_430 = {{"native_texture_0","native_texture_1","native_texture_2","native_texture_3"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,6> WARLORD_NATIVE_PARAMETERS_430 = {{
    {"selectioncolor", 2u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,2> WARLORD_NATIVE_SWITCHES_430 = {{
    {"use_depthbiasedalpha", false},
    {"use_down_opacity", true},
}};

constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_431 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,6> WARLORD_NATIVE_PARAMETERS_431 = {{
    {"selectioncolor", 2u, 0u, true},
    {"uv_scale", 1u, 0u, false},
    {"dynamic_parameter_explanation", 0u, 1u, false},
    {"emissive_desaturation", 0u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,17> WARLORD_NATIVE_SWITCHES_431 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", true},
    {"use_distortion", false},
    {"use_meshtype", false},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_432 = {{"lensflaretexture"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,4> WARLORD_NATIVE_PARAMETERS_432 = {{
    {"selectioncolor", 1u, 0u, true},
    {"select texture(0 or 0.5)", 0u, 2u, false},
    {"desaturation", 0u, 1u, false},
    {"depthbaisalpha", 0u, 0u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_432 = {{
}};

constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_433 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,2> WARLORD_NATIVE_PARAMETERS_433 = {{
    {"selectioncolor", 1u, 0u, true},
    {"hardness", 0u, 0u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_433 = {{
}};

constexpr std::array<std::string_view,5> WARLORD_NATIVE_TEXTURES_434 = {{"01.diffmap_a","11.diffmap_b","21.maskmap","01.alphamaskmap","native_texture_4"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,10> WARLORD_NATIVE_PARAMETERS_434 = {{
    {"selectioncolor", 3u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,13> WARLORD_NATIVE_SWITCHES_434 = {{
    {"01.usemesh", false},
...
constexpr std::array<std::string_view,5> WARLORD_NATIVE_TEXTURES_435 = {{"01.heightmap","01.diffmap_a","06.normalmap","01.emismap","native_texture_4"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,14> WARLORD_NATIVE_PARAMETERS_435 = {{
    {"selectioncolor", 5u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,13> WARLORD_NATIVE_SWITCHES_435 = {{
    {"00.useinvertdepthbiasalpha", false},
    {"01.usemesh", false},
    {"30.usedissolve", true},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_436 = {{"04.map_anew","06.map","00_map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,14> WARLORD_NATIVE_PARAMETERS_436 = {{
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,17> WARLORD_NATIVE_SWITCHES_436 = {{
    {"00.usedistortion", false},
    {"20.use_centrehole", false},
    {"00.usedepthbiasalpha", false},
    {"30.usefresnal", false},
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_437 = {{"native_texture_0","native_texture_1","native_texture_2","native_texture_3"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,5> WARLORD_NATIVE_PARAMETERS_437 = {{
    {"selectioncolor", 1u, 0u, true},
    {"colormap_ucoord", 0u, 1u, false},
    {"colormap_vcoord", 0u, 2u, false},
    {"colormap_power", 0u, 0u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,2> WARLORD_NATIVE_SWITCHES_437 = {{
    {"use_depthbiasedalpha", true},
    {"use_down_opacity", false},
}};

constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_438 = {{"native_texture_0","native_texture_1"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,2> WARLORD_NATIVE_PARAMETERS_438 = {{
    {"selectioncolor", 1u, 0u, true},
    {"power", 0u, 0u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_438 = {{
}};

constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_439 = {{"uv_noise_tex","emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,10> WARLORD_NATIVE_PARAMETERS_439 = {{
    {"selectioncolor", 3u, 0u, true},
    {"emissive_color&intensity", 2u, 0u, true},
    {"uv_noise_panning_x", 0u, 3u, false},
    {"uv_noise_panning_y", 1u, 0u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,5> WARLORD_NATIVE_SWITCHES_439 = {{
    {"use_meshtype", false},
    {"use_subuv_tex", false},
    {"use_nonalpha_tex", false},
    {"use_emissive_vertcolor", false},
...
constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_440 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,5> WARLORD_NATIVE_PARAMETERS_440 = {{
    {"selectioncolor", 1u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,5> WARLORD_NATIVE_SWITCHES_440 = {{
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_441 = {{"emissive_tex","native_texture_1","alpha_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,3> WARLORD_NATIVE_PARAMETERS_441 = {{
    {"selectioncolor", 1u, 0u, true},
    {"alpha_power", 0u, 0u, false},
    {"alpha_strength", 0u, 1u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_441 = {{
}};

constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_442 = {{"texturesubuv"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,1> WARLORD_NATIVE_PARAMETERS_442 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_442 = {{
}};

constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_443 = {{"sub_texture","main_texture"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,7> WARLORD_NATIVE_PARAMETERS_443 = {{
    {"selectioncolor", 2u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_443 = {{
}};

constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_444 = {{"12.map_f","06.map","02.map_e"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,27> WARLORD_NATIVE_PARAMETERS_444 = {{
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,27> WARLORD_NATIVE_SWITCHES_444 = {{
    {"00.usespecullar", false},
    {"11.mape+mapf", false},
    {"10.use_mapb", true},
...
constexpr std::array<std::string_view,5> WARLORD_NATIVE_TEXTURES_445 = {{"uv_noise_texture","alpha_texture1_mask","alpha_texture2","emissive_tex_02","emissive_tex_01"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,31> WARLORD_NATIVE_PARAMETERS_445 = {{
    {"selectioncolor", 8u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,6> WARLORD_NATIVE_SWITCHES_445 = {{
    {"use_distortion", false},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_446 = {{"02.map_e","21.map_c"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,19> WARLORD_NATIVE_PARAMETERS_446 = {{
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,14> WARLORD_NATIVE_SWITCHES_446 = {{
...
constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_447 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,6> WARLORD_NATIVE_PARAMETERS_447 = {{
    {"selectioncolor", 2u, 0u, true},
    {"01.centerglow_power", 0u, 0u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,2> WARLORD_NATIVE_SWITCHES_447 = {{
    {"00.use_distortion", false},
    {"00.use_depth_alpha", false},
}};

constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_448 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,5> WARLORD_NATIVE_PARAMETERS_448 = {{
    {"selectioncolor", 1u, 0u, true},
    {"01.radius", 0u, 0u, false},
    {"02.hardness", 0u, 1u, false},
    {"03.spherepower", 0u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,4> WARLORD_NATIVE_SWITCHES_448 = {{
    {"checkisdepthbiasalpha", false},
    {"01.checkisvertexcolor", true},
    {"30.usefresnal", false},
    {"02.usedynamicparam", false},
...
constexpr std::array<std::string_view,5> WARLORD_NATIVE_TEXTURES_449 = {{"native_texture_0","native_texture_1","map_a","map_b","map_c"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,9> WARLORD_NATIVE_PARAMETERS_449 = {{
    {"selectioncolor", 2u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,2> WARLORD_NATIVE_SWITCHES_449 = {{
    {"checkistimedypa", true},
    {"use_fanshape", false},
}};

constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_450 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,1> WARLORD_NATIVE_PARAMETERS_450 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,3> WARLORD_NATIVE_SWITCHES_450 = {{
    {"use_meshtype", false},
    {"use_subuv_tex", false},
    {"use_nonalpha_chanel", false},
}};

constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_451 = {{"native_texture_0","01.map_uv","01.map_a","11.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,7> WARLORD_NATIVE_PARAMETERS_451 = {{
    {"selectioncolor", 2u, 0u, true},
    {"09.str", 0u, 1u, false},
    {"10.power", 0u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,8> WARLORD_NATIVE_SWITCHES_451 = {{
    {"00.checkisdepthbiasalpha", true},
    {"01.usemesh", false},
    {"06.mapch.r", true},
    {"07.mapch.g", true},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_672 = {{"native_texture_0","native_texture_1"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,13> WARLORD_NATIVE_PARAMETERS_672 = {{
    {"selectioncolor", 3u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,4> WARLORD_NATIVE_SWITCHES_672 = {{
    {"use_particle", true},
    {"use_circlealpha", true},
    {"use_invertedcirclealpha", false},
    {"use_noise", true},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_452 = {{"01.map"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,6> WARLORD_NATIVE_PARAMETERS_452 = {{
    {"selectioncolor", 2u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,4> WARLORD_NATIVE_SWITCHES_452 = {{
    {"checkisdepthbiasalpha", true},
    {"00.useradius", true},
    {"01.usemesh", false},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_453 = {{"uv_noise_01_tex","emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,12> WARLORD_NATIVE_PARAMETERS_453 = {{
    {"selectioncolor", 3u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,18> WARLORD_NATIVE_SWITCHES_453 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", false},
    {"use_distortion", false},
    {"use_distortion_floor", false},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_454 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,1> WARLORD_NATIVE_PARAMETERS_454 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,3> WARLORD_NATIVE_SWITCHES_454 = {{
    {"use_meshtype", false},
    {"use_subuv_tex", false},
    {"use_nonalpha_chanel", false},
}};

constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_455 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,1> WARLORD_NATIVE_PARAMETERS_455 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_455 = {{
}};

constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_456 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,5> WARLORD_NATIVE_PARAMETERS_456 = {{
    {"selectioncolor", 1u, 0u, true},
    {"uv_scale", 0u, 3u, false},
    {"dynamic_parameter_explanation", 0u, 0u, false},
    {"emissive_desaturation", 0u, 1u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,17> WARLORD_NATIVE_SWITCHES_456 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", false},
    {"use_distortion", false},
    {"use_meshtype", false},
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_457 = {{"31.map_e","06.map","04.map_anew","00.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,18> WARLORD_NATIVE_PARAMETERS_457 = {{
    {"selectioncolor", 5u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,18> WARLORD_NATIVE_SWITCHES_457 = {{
    {"00.usedistortion", false},
    {"20.use_centrehole", false},
    {"00.usedepthbiasalpha", false},
    {"30.usefresnal", false},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_458 = {{"lensflaretexture"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,6> WARLORD_NATIVE_PARAMETERS_458 = {{
    {"selectioncolor", 2u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_458 = {{
}};

constexpr std::array<std::string_view,5> WARLORD_NATIVE_TEXTURES_459 = {{"06.map","02.map_e","01.map_a","11.map_b","21.map_c"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,31> WARLORD_NATIVE_PARAMETERS_459 = {{
    {"selectioncolor", 9u, 0u, true},
    {"93.emissiion_color", 7u, 0u, true},
    {"meshemitterdynamicparameter", 8u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_459 = {{
    {"00.usedistortion", false},
    {"01.usemesh", true},
    {"31.mapch.r", false},
    {"32.mapch.g", false},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_660 = {{"subuv_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,4> WARLORD_NATIVE_PARAMETERS_660 = {{
    {"selectioncolor", 2u, 0u, true},
    {"emissive_color&intensity", 1u, 0u, true},
    {"dynamic_parameter_explanation", 0u, 0u, false},
    {"emissive_tex_desturation", 0u, 1u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,5> WARLORD_NATIVE_SWITCHES_660 = {{
    {"use_meshtype", false},
    {"use_subuv_tex", true},
    {"use_nonalpha_tex", false},
    {"use_emissive_vertcolor", false},
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_661 = {{"31.map_e","06.map","04.map_anew","00.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,19> WARLORD_NATIVE_PARAMETERS_661 = {{
    {"selectioncolor", 6u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,18> WARLORD_NATIVE_SWITCHES_661 = {{
    {"00.usedistortion", false},
    {"20.use_centrehole", false},
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_662 = {{"31.map_e","06.map","04.map_anew","00.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,19> WARLORD_NATIVE_PARAMETERS_662 = {{
    {"selectioncolor", 6u, 0u, true},
    {"39.map_a_panning_x", 3u, 2u, false},
    {"37.mape_color", 5u, 0u, true},
    {"09.map_a_panning_x", 1u, 3u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,18> WARLORD_NATIVE_SWITCHES_662 = {{
    {"00.usedistortion", false},
    {"20.use_centrehole", false},
    {"00.usedepthbiasalpha", true},
    {"30.usefresnal", false},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_663 = {{"06.map","01.map_a","21.map_c"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,21> WARLORD_NATIVE_PARAMETERS_663 = {{
    {"selectioncolor", 6u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_663 = {{
    {"00.usedistortion", false},
    {"01.usemesh", true},
    {"31.mapch.r", true},
    {"32.mapch.g", true},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_664 = {{"lensflaretexture"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,4> WARLORD_NATIVE_PARAMETERS_664 = {{
    {"selectioncolor", 1u, 0u, true},
    {"select texture(0 or 0.5)", 0u, 2u, false},
    {"desaturation", 0u, 1u, false},
    {"depthbaisalpha", 0u, 0u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_664 = {{
}};

constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_665 = {{"noisetexture","native_texture_1","wavetexture"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,7> WARLORD_NATIVE_PARAMETERS_665 = {{
    {"selectioncolor", 2u, 0u, true},
    {"x_coord", 0u, 3u, false},
    {"y_coord", 1u, 0u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,3> WARLORD_NATIVE_SWITCHES_665 = {{
    {"use_distortion", true},
    {"use_widefloor", true},
    {"usemesh", false},
}};

constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_666 = {{"02.map_e","12.map_f","01.map_a"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,22> WARLORD_NATIVE_PARAMETERS_666 = {{
    {"selectioncolor", 6u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_666 = {{
    {"00.usedistortion", false},
    {"01.usemesh", false},
    {"31.mapch.r", true},
    {"32.mapch.g", true},
...
constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_667 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,6> WARLORD_NATIVE_PARAMETERS_667 = {{
    {"selectioncolor", 2u, 0u, true},
    {"01.radius", 0u, 0u, false},
    {"02.hardness", 0u, 1u, false},
    {"03.spherepower", 0u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,4> WARLORD_NATIVE_SWITCHES_667 = {{
    {"01.checkisvertexcolor", true},
    {"02.usedynamicparam", false},
    {"30.usefresnal", false},
    {"checkisdepthbiasalpha", true},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_668 = {{"06.map","02.map_e","21.map_c"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,23> WARLORD_NATIVE_PARAMETERS_668 = {{
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_668 = {{
    {"00.usedistortion", false},
    {"01.usemesh", true},
    {"31.mapch.r", true},
    {"32.mapch.g", true},
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_669 = {{"native_texture_0","native_texture_1","native_texture_2","native_texture_3"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,5> WARLORD_NATIVE_PARAMETERS_669 = {{
    {"selectioncolor", 1u, 0u, true},
    {"colormap_ucoord", 0u, 1u, false},
    {"colormap_vcoord", 0u, 2u, false},
    {"colormap_power", 0u, 0u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,2> WARLORD_NATIVE_SWITCHES_669 = {{
    {"use_depthbiasedalpha", true},
    {"use_down_opacity", false},
}};

constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_670 = {{"01.map_a","21.map_c"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,15> WARLORD_NATIVE_PARAMETERS_670 = {{
    {"selectioncolor", 5u, 0u, true},
    {"meshemitterdynamicparameter", 4u, 0u, true},
    {"21.uvscale.x", 1u, 0u, false},
    {"22.uvscale.y", 1u, 1u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_670 = {{
    {"00.usedistortion", false},
    {"01.usemesh", true},
    {"31.mapch.r", false},
    {"32.mapch.g", false},
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_671 = {{"02.map_e","12.map_f","01.map_a","21.map_c"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,26> WARLORD_NATIVE_PARAMETERS_671 = {{
    {"selectioncolor", 8u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_671 = {{
    {"00.usedistortion", false},
    {"01.usemesh", true},
    {"31.mapch.r", true},
    {"32.mapch.g", true},
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1000 = {{"flowtex","diff_tex1","diff_tex2","opacity_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,27> WARLORD_NATIVE_PARAMETERS_1000 = {{
    {"selectioncolor", 8u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,5> WARLORD_NATIVE_SWITCHES_1000 = {{
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1001 = {{"dissolve_noise_tex","emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,10> WARLORD_NATIVE_PARAMETERS_1001 = {{
    {"selectioncolor", 3u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,14> WARLORD_NATIVE_SWITCHES_1001 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", true},
    {"use_distortion", false},
    {"use_distortion_floor", false},
...
constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_1002 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,5> WARLORD_NATIVE_PARAMETERS_1002 = {{
    {"selectioncolor", 1u, 0u, true},
    {"01.radius", 0u, 0u, false},
    {"02.hardness", 0u, 1u, false},
    {"03.spherepower", 0u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1002 = {{
}};

constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1003 = {{"14.map_d","01.map_a","06.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,19> WARLORD_NATIVE_PARAMETERS_1003 = {{
    {"selectioncolor", 6u, 0u, true},
    {"noisecolor", 5u, 0u, true},
    {"15.map_d_uvscale_r", 2u, 3u, false},
    {"16.map_d_uvscale_g", 3u, 0u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,6> WARLORD_NATIVE_SWITCHES_1003 = {{
    {"checkisdepthbiasalpha", true},
    {"00.checkisnoiseon", true},
    {"12.uvnoise", true},
    {"11.uvmirroring", false},
...
constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_1004 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,6> WARLORD_NATIVE_PARAMETERS_1004 = {{
    {"selectioncolor", 2u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1004 = {{
}};

constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1005 = {{"native_texture_0","texturesample","tex_01","opacity_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,6> WARLORD_NATIVE_PARAMETERS_1005 = {{
    {"selectioncolor", 2u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,2> WARLORD_NATIVE_SWITCHES_1005 = {{
    {"spheremask", true},
    {"01.useparticle", false},
}};

constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1006 = {{"flowtex","diff_tex1","diff_tex2","opacity_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,26> WARLORD_NATIVE_PARAMETERS_1006 = {{
    {"selectioncolor", 7u, 0u, true},
    {"flow_tile_u", 3u, 3u, false},
    {"flow_tile_v", 4u, 0u, false},
    {"flow_pan_u", 3u, 1u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,5> WARLORD_NATIVE_SWITCHES_1006 = {{
    {"use_gra_r_channel", false},
    {"use_colormap", false},
    {"diff_pan_use_u", false},
    {"use_cam_vector", true},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1007 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,6> WARLORD_NATIVE_PARAMETERS_1007 = {{
    {"selectioncolor", 2u, 0u, true},
    {"uv_scale", 1u, 0u, false},
    {"dynamic_parameter_explanation", 0u, 1u, false},
    {"emissive_desaturation", 0u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,17> WARLORD_NATIVE_SWITCHES_1007 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", true},
    {"use_distortion", false},
    {"use_meshtype", false},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1008 = {{"lensflaretexture"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,4> WARLORD_NATIVE_PARAMETERS_1008 = {{
    {"selectioncolor", 1u, 0u, true},
    {"select texture(0 or 0.5)", 0u, 2u, false},
    {"desaturation", 0u, 1u, false},
    {"depthbaisalpha", 0u, 0u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1008 = {{
}};

constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1009 = {{"lensflaretexture"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,4> WARLORD_NATIVE_PARAMETERS_1009 = {{
    {"selectioncolor", 1u, 0u, true},
    {"select texture(0 or 0.5)", 0u, 2u, false},
    {"desaturation", 0u, 1u, false},
    {"depthbaisalpha", 0u, 0u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1009 = {{
}};

constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1010 = {{"maintex","uv_noise_tex","noisedissolve_tex","dissolve_tex_01"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,39> WARLORD_NATIVE_PARAMETERS_1010 = {{
    {"selectioncolor", 11u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,20> WARLORD_NATIVE_SWITCHES_1010 = {{
    {"use_dissolve", true},
    {"use_meshtype", false},
    {"use_uvnoise", true},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1011 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,1> WARLORD_NATIVE_PARAMETERS_1011 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,3> WARLORD_NATIVE_SWITCHES_1011 = {{
    {"use_meshtype", false},
    {"use_subuv_tex", false},
    {"use_nonalpha_chanel", true},
}};

constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1012 = {{"01.map_e","native_texture_1","01.map_a"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,16> WARLORD_NATIVE_PARAMETERS_1012 = {{
    {"selectioncolor", 6u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,11> WARLORD_NATIVE_SWITCHES_1012 = {{
    {"00.usedistortion", false},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1013 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,6> WARLORD_NATIVE_PARAMETERS_1013 = {{
    {"selectioncolor", 2u, 0u, true},
    {"uv_scale", 1u, 0u, false},
    {"dynamic_parameter_explanation", 0u, 0u, false},
    {"emissive_desaturation", 0u, 1u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,13> WARLORD_NATIVE_SWITCHES_1013 = {{
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1015 = {{"map_a","map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,5> WARLORD_NATIVE_PARAMETERS_1015 = {{
    {"selectioncolor", 1u, 0u, true},
    {"readme", 0u, 3u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,7> WARLORD_NATIVE_SWITCHES_1015 = {{
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1017 = {{"uv_noise_tex_01","mainalpha_tex","dissolve_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,32> WARLORD_NATIVE_PARAMETERS_1017 = {{
    {"selectioncolor", 8u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,10> WARLORD_NATIVE_SWITCHES_1017 = {{
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1018 = {{"native_texture_0","native_texture_1","native_texture_2","native_texture_3"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,1> WARLORD_NATIVE_PARAMETERS_1018 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1018 = {{
}};

constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1020 = {{"add_emissive_tex","twinkle_tex","twinkle_tex_01","mask_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,8> WARLORD_NATIVE_PARAMETERS_1020 = {{
    {"selectioncolor", 3u, 0u, true},
    {"emissive_color&intensity", 2u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,3> WARLORD_NATIVE_SWITCHES_1020 = {{
    {"use_mask_r_chanel", false},
    {"use_emissive_r_chanel", false},
    {"use_meshtype", false},
}};

constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_1021 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,5> WARLORD_NATIVE_PARAMETERS_1021 = {{
    {"selectioncolor", 1u, 0u, true},
    {"01.radius", 0u, 0u, false},
    {"02.hardness", 0u, 1u, false},
    {"03.spherepower", 0u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,4> WARLORD_NATIVE_SWITCHES_1021 = {{
    {"checkisdepthbiasalpha", false},
    {"01.checkisvertexcolor", true},
    {"30.usefresnal", false},
    {"02.usedynamicparam", false},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1022 = {{"subuv_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,4> WARLORD_NATIVE_PARAMETERS_1022 = {{
    {"selectioncolor", 2u, 0u, true},
    {"emissive_color&intensity", 1u, 0u, true},
    {"dynamic_parameter_explanation", 0u, 0u, false},
    {"emissive_tex_desturation", 0u, 1u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,5> WARLORD_NATIVE_SWITCHES_1022 = {{
    {"use_meshtype", false},
    {"use_subuv_tex", true},
    {"use_nonalpha_tex", false},
    {"use_emissive_vertcolor", false},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1023 = {{"uv_noise_tex","alpha_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,26> WARLORD_NATIVE_PARAMETERS_1023 = {{
    {"selectioncolor", 7u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,4> WARLORD_NATIVE_SWITCHES_1023 = {{
    {"use_mesh", false},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1024 = {{"uv_noise_tex","alpha_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,26> WARLORD_NATIVE_PARAMETERS_1024 = {{
    {"selectioncolor", 7u, 0u, true},
    {"emissive_tex_core_positon_r", 3u, 3u, false},
    {"emissive_tex_core_positon_g", 3u, 2u, false},
    {"alpha_tex_rotator", 1u, 3u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,4> WARLORD_NATIVE_SWITCHES_1024 = {{
    {"use_mesh", false},
    {"use_dissolve_tex", false},
    {"use_fresnelalpha", false},
    {"dissolve_rampmap", true},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1025 = {{"01.map_a","06.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,15> WARLORD_NATIVE_PARAMETERS_1025 = {{
    {"selectioncolor", 4u, 0u, true},
    {"power", 3u, 0u, false},
    {"str", 3u, 1u, false},
    {"04.map_a_panning_x", 1u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,5> WARLORD_NATIVE_SWITCHES_1025 = {{
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1027 = {{"dissolve_noise_tex","uv_noise_01_tex","emissive_tex","alpha_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,16> WARLORD_NATIVE_PARAMETERS_1027 = {{
    {"selectioncolor", 5u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,14> WARLORD_NATIVE_SWITCHES_1027 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", false},
    {"use_distortion", false},
    {"use_distortion_floor", false},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1028 = {{"dissolve_noise_tex","emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,12> WARLORD_NATIVE_PARAMETERS_1028 = {{
    {"selectioncolor", 4u, 0u, true},
    {"dissolve_color&intensity", 3u, 0u, true},
    {"dissolve_noise_intensity", 0u, 1u, false},
    {"dissolve_noise_power", 0u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,14> WARLORD_NATIVE_SWITCHES_1028 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", true},
    {"use_distortion", false},
    {"use_distortion_floor", false},
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1029 = {{"native_texture_0","01.map_uv","01.map_a","11.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,6> WARLORD_NATIVE_PARAMETERS_1029 = {{
    {"selectioncolor", 2u, 0u, true},
    {"09.str", 0u, 0u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,8> WARLORD_NATIVE_SWITCHES_1029 = {{
    {"00.checkisdepthbiasalpha", false},
    {"01.usemesh", false},
    {"06.mapch.r", false},
    {"07.mapch.g", false},
...
constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_1030 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,2> WARLORD_NATIVE_PARAMETERS_1030 = {{
    {"selectioncolor", 1u, 0u, true},
    {"hardness", 0u, 0u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1030 = {{
}};

constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1031 = {{"native_texture_0","native_texture_1"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,2> WARLORD_NATIVE_PARAMETERS_1031 = {{
    {"selectioncolor", 1u, 0u, true},
    {"meshemitterdynamicparameter", 0u, 0u, true},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1031 = {{
}};

constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1032 = {{"tex_colormap","tex_diffmap","tex_maskmap"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,22> WARLORD_NATIVE_PARAMETERS_1032 = {{
    {"selectioncolor", 6u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,4> WARLORD_NATIVE_SWITCHES_1032 = {{
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1033 = {{"maintex","uv_noise_tex_02","uv_noise_tex","dissolve_tex_01"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,39> WARLORD_NATIVE_PARAMETERS_1033 = {{
    {"selectioncolor", 11u, 0u, true},
    {"uvnoise_move_x", 8u, 3u, false},
    {"uvnoise_move_y", 9u, 0u, false},
    {"maintex_move_x", 3u, 3u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,20> WARLORD_NATIVE_SWITCHES_1033 = {{
    {"use_dissolve", true},
    {"use_meshtype", false},
    {"use_uvnoise", true},
    {"achannel_use_uvnoisedynamicpan", false},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1034 = {{"dissolve_noise_tex","emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,10> WARLORD_NATIVE_PARAMETERS_1034 = {{
    {"selectioncolor", 3u, 0u, true},
    {"dissolve_color&intensity", 2u, 0u, true},
    {"dissolve_noise_intensity", 0u, 1u, false},
    {"dissolve_noise_power", 0u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,14> WARLORD_NATIVE_SWITCHES_1034 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", true},
    {"use_distortion", false},
    {"use_distortion_floor", false},
...
constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_1036 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,2> WARLORD_NATIVE_PARAMETERS_1036 = {{
    {"selectioncolor", 1u, 0u, true},
    {"dynamic_parameter_explanation", 0u, 0u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,12> WARLORD_NATIVE_SWITCHES_1036 = {{
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1037 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,1> WARLORD_NATIVE_PARAMETERS_1037 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,3> WARLORD_NATIVE_SWITCHES_1037 = {{
    {"use_meshtype", false},
    {"use_subuv_tex", false},
    {"use_nonalpha_chanel", false},
}};

constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1038 = {{"01.map_a","06.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,20> WARLORD_NATIVE_PARAMETERS_1038 = {{
    {"selectioncolor", 5u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,12> WARLORD_NATIVE_SWITCHES_1038 = {{
    {"00.checkisdepthbiasalpha", true},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1039 = {{"subuv_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,4> WARLORD_NATIVE_PARAMETERS_1039 = {{
    {"selectioncolor", 1u, 0u, true},
    {"dynamic_parameter_explanation", 0u, 0u, false},
    {"emissive_desaturation", 0u, 1u, false},
    {"emissive_power", 0u, 2u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,18> WARLORD_NATIVE_SWITCHES_1039 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", false},
    {"use_distortion", false},
    {"use_distortion_floor", false},
...
constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_1040 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,4> WARLORD_NATIVE_PARAMETERS_1040 = {{
    {"selectioncolor", 1u, 0u, true},
    {"10.radius", 0u, 2u, false},
    {"04.ringthickness", 0u, 0u, false},
    {"07.power", 0u, 1u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,7> WARLORD_NATIVE_SWITCHES_1040 = {{
    {"00.usedistortion", false},
    {"00.use_uvdistort", false},
    {"00.alphamap", false},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1041 = {{"native_texture_0","native_texture_1"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,1> WARLORD_NATIVE_PARAMETERS_1041 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1041 = {{
}};

constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1042 = {{"tex_uv_flow","tex_alpha_01","tex_alpha_02"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,11> WARLORD_NATIVE_PARAMETERS_1042 = {{
    {"selectioncolor", 3u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,2> WARLORD_NATIVE_SWITCHES_1042 = {{
    {"use_mesh", false},
    {"alpha_01_rotator_use", true},
}};

constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1043 = {{"native_texture_0","texturesample","tex_01","opacity_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,6> WARLORD_NATIVE_PARAMETERS_1043 = {{
    {"selectioncolor", 2u, 0u, true},
    {"meshemitterdynamicparameter", 1u, 0u, true},
    {"tex_alpha_02_r_tile", 0u, 3u, false},
    {"tex_alpha_02_g_tile", 0u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,2> WARLORD_NATIVE_SWITCHES_1043 = {{
    {"spheremask", true},
    {"01.useparticle", false},
}};

constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_1044 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,6> WARLORD_NATIVE_PARAMETERS_1044 = {{
    {"selectioncolor", 2u, 0u, true},
    {"centerglow_power", 0u, 0u, false},
    {"centerglow_str", 0u, 1u, false},
    {"glow_power", 0u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,4> WARLORD_NATIVE_SWITCHES_1044 = {{
    {"use_distortion", false},
    {"use_centerglow", true},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1045 = {{"native_texture_0","native_texture_1"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,2> WARLORD_NATIVE_PARAMETERS_1045 = {{
    {"selectioncolor", 1u, 0u, true},
    {"rotatevalue", 0u, 0u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,3> WARLORD_NATIVE_SWITCHES_1045 = {{
    {"meshvertexalpha", true},
    {"meshvertexemis", true},
    {"rotate", true},
}};

constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1046 = {{"uv_noise_01_tex","emissive_tex","alpha_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,11> WARLORD_NATIVE_PARAMETERS_1046 = {{
    {"selectioncolor", 3u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,18> WARLORD_NATIVE_SWITCHES_1046 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", true},
    {"use_distortion", false},
    {"use_distortion_floor", false},
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1047 = {{"colormap","native_texture_1","tex_main","native_texture_3"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,15> WARLORD_NATIVE_PARAMETERS_1047 = {{
    {"selectioncolor", 5u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1047 = {{
}};

constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1048 = {{"uv_noise_tex","native_texture_1","maintex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,33> WARLORD_NATIVE_PARAMETERS_1048 = {{
    {"selectioncolor", 9u, 0u, true},
    {"meshemitterdynamicparameter", 8u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,13> WARLORD_NATIVE_SWITCHES_1048 = {{
    {"usemesh", true},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1049 = {{"native_texture_0","native_texture_1"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,2> WARLORD_NATIVE_PARAMETERS_1049 = {{
    {"selectioncolor", 1u, 0u, true},
    {"depth_bias", 0u, 0u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,1> WARLORD_NATIVE_SWITCHES_1049 = {{
    {"use_depth", true},
}};

constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_1050 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,6> WARLORD_NATIVE_PARAMETERS_1050 = {{
    {"selectioncolor", 2u, 0u, true},
    {"01.color", 1u, 0u, true},
    {"01.radius", 0u, 0u, false},
    {"02.hardness", 0u, 1u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,4> WARLORD_NATIVE_SWITCHES_1050 = {{
    {"00.usenoise", false},
    {"01.usemesh", false},
    {"00.checkisdepthbiasalpha", false},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1051 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,1> WARLORD_NATIVE_PARAMETERS_1051 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,3> WARLORD_NATIVE_SWITCHES_1051 = {{
    {"use_meshtype", false},
    {"use_subuv_tex", false},
    {"use_nonalpha_chanel", false},
}};

constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1052 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,1> WARLORD_NATIVE_PARAMETERS_1052 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,3> WARLORD_NATIVE_SWITCHES_1052 = {{
    {"use_meshtype", false},
    {"use_subuv_tex", false},
    {"use_nonalpha_chanel", false},
}};

constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1053 = {{"01.map"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,6> WARLORD_NATIVE_PARAMETERS_1053 = {{
    {"selectioncolor", 2u, 0u, true},
    {"01.circlepower", 0u, 0u, false},
    {"02.circlestr", 0u, 2u, false},
    {"02.circlemaskpower", 0u, 1u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,4> WARLORD_NATIVE_SWITCHES_1053 = {{
    {"checkisdepthbiasalpha", true},
    {"00.useradius", true},
    {"01.usemesh", false},
    {"10.usetimebezire", true},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1054 = {{"02.map_e"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,12> WARLORD_NATIVE_PARAMETERS_1054 = {{
    {"selectioncolor", 4u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_1054 = {{
    {"00.usedistortion", false},
    {"01.usemesh", false},
    {"31.mapch.r", true},
    {"32.mapch.g", true},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1055 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,6> WARLORD_NATIVE_PARAMETERS_1055 = {{
    {"selectioncolor", 2u, 0u, true},
    {"uv_scale", 1u, 0u, false},
    {"dynamic_parameter_explanation", 0u, 1u, false},
    {"emissive_desaturation", 0u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,17> WARLORD_NATIVE_SWITCHES_1055 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", false},
    {"use_distortion", true},
    {"use_meshtype", false},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1056 = {{"02.map_e","22.map_a"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,22> WARLORD_NATIVE_PARAMETERS_1056 = {{
    {"selectioncolor", 7u, 0u, true},
    {"meshemitterdynamicparameter", 6u, 0u, true},
    {"93.emissiion_color", 5u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,27> WARLORD_NATIVE_SWITCHES_1056 = {{
    {"00.usespecullar", false},
    {"11.mape+mapf", false},
    {"10.use_mapb", false},
    {"01.use_emissionmap", true},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1057 = {{"01.map_a"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,8> WARLORD_NATIVE_PARAMETERS_1057 = {{
    {"selectioncolor", 4u, 0u, true},
    {"16.color", 2u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,11> WARLORD_NATIVE_SWITCHES_1057 = {{
    {"00.usedistortion", false},
    {"50.use_fresnal", false},
    {"06.mapch.r", true},
    {"07.mapch.g", true},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1058 = {{"01.map_e","01.map_a"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,19> WARLORD_NATIVE_PARAMETERS_1058 = {{
    {"selectioncolor", 6u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,8> WARLORD_NATIVE_SWITCHES_1058 = {{
    {"06.mapch.r", false},
    {"07.mapch.g", true},
    {"08.mapch.b", true},
    {"00.use_uvdistort", false},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1059 = {{"02.map_e","06.map","22.map_a"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,25> WARLORD_NATIVE_PARAMETERS_1059 = {{
    {"selectioncolor", 7u, 0u, true},
    {"93.emissiion_color", 6u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,27> WARLORD_NATIVE_SWITCHES_1059 = {{
    {"00.usedistortion", false},
    {"30.usefresnal", false},
    {"31.fresnal.invert", false},
    {"00.checkisdepthbiasalpha", true},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1060 = {{"map_a","map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,5> WARLORD_NATIVE_PARAMETERS_1060 = {{
    {"selectioncolor", 1u, 0u, true},
    {"readme", 0u, 3u, false},
    {"map_a_uvscale", 0u, 0u, false},
    {"map_b_uvscale", 0u, 1u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,7> WARLORD_NATIVE_SWITCHES_1060 = {{
    {"00.uselightshift", false},
    {"01.use_depthbiasalpha", false},
    {"btimebezier", true},
    {"00.userainbow", false},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1061 = {{"01.map_a","21.map_c"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,16> WARLORD_NATIVE_PARAMETERS_1061 = {{
    {"selectioncolor", 5u, 0u, true},
    {"meshemitterdynamicparameter", 4u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_1061 = {{
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1062 = {{"06.map","01.map_a","21.map_c"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,17> WARLORD_NATIVE_PARAMETERS_1062 = {{
    {"selectioncolor", 4u, 0u, true},
    {"21.uvscale.x", 2u, 1u, false},
    {"22.uvscale.y", 2u, 2u, false},
    {"time", 3u, 3u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_1062 = {{
    {"00.usedistortion", false},
    {"01.usemesh", false},
    {"31.mapch.r", true},
    {"32.mapch.g", true},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1063 = {{"uv_noise_01_tex","emissive_tex","alpha_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,13> WARLORD_NATIVE_PARAMETERS_1063 = {{
    {"selectioncolor", 3u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,18> WARLORD_NATIVE_SWITCHES_1063 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", true},
    {"use_distortion", false},
    {"use_distortion_floor", false},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1064 = {{"uv_noise_tex","native_texture_1","maintex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,31> WARLORD_NATIVE_PARAMETERS_1064 = {{
    {"selectioncolor", 9u, 0u, true},
    {"meshemitterdynamicparameter", 8u, 0u, true},
    {"maintex_rotator", 4u, 3u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,13> WARLORD_NATIVE_SWITCHES_1064 = {{
    {"usemesh", true},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1065 = {{"native_texture_0"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,1> WARLORD_NATIVE_PARAMETERS_1065 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1065 = {{
}};

constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1066 = {{"06.map_anew","06.map","00.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,13> WARLORD_NATIVE_PARAMETERS_1066 = {{
    {"selectioncolor", 3u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,15> WARLORD_NATIVE_SWITCHES_1066 = {{
    {"00.usedistortion", false},
    {"20.use_centrehole", false},
    {"00.usedepthbiasalpha", false},
    {"30.usefresnal", false},
...
constexpr std::array<std::string_view,6> WARLORD_NATIVE_TEXTURES_1067 = {{"uv_noise_tex","emissive_tex01","alpha_tex02","alpha_tex","dissolve_tex02","uv_dissolve_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,47> WARLORD_NATIVE_PARAMETERS_1067 = {{
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,11> WARLORD_NATIVE_SWITCHES_1067 = {{
    {"use_mesh", false},
    {"use_fresnelalpha", false},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1068 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,8> WARLORD_NATIVE_PARAMETERS_1068 = {{
    {"selectioncolor", 3u, 0u, true},
    {"meshemitterdynamicparameter", 2u, 0u, true},
    {"uv_scale", 1u, 1u, false},
    {"dynamic_parameter_explanation", 0u, 0u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,18> WARLORD_NATIVE_SWITCHES_1068 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", false},
    {"use_distortion", false},
    {"use_distortion_floor", false},
...
constexpr std::array<std::string_view,7> WARLORD_NATIVE_TEXTURES_1069 = {{"diff_tex","a_mask_tex","a_noise_01_tex","a_noise_02_tex","b_mask_tex","b_noise_01_tex","b_noise_02_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,52> WARLORD_NATIVE_PARAMETERS_1069 = {{
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,23> WARLORD_NATIVE_SWITCHES_1069 = {{
    {"meshtype_use", false},
    {"depthalpha_use", true},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1070 = {{"native_texture_0","native_texture_1"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,1> WARLORD_NATIVE_PARAMETERS_1070 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1070 = {{
}};

constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1071 = {{"native_texture_0","native_texture_1"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,1> WARLORD_NATIVE_PARAMETERS_1071 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1071 = {{
}};

constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1072 = {{"subuv_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,4> WARLORD_NATIVE_PARAMETERS_1072 = {{
    {"selectioncolor", 1u, 0u, true},
    {"dynamic_parameter_explanation", 0u, 0u, false},
    {"emissive_desaturation", 0u, 1u, false},
    {"emissive_power", 0u, 2u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,18> WARLORD_NATIVE_SWITCHES_1072 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", false},
    {"use_distortion", false},
    {"use_distortion_floor", false},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1073 = {{"native_texture_0","native_texture_1","native_texture_2"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,1> WARLORD_NATIVE_PARAMETERS_1073 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1073 = {{
}};

constexpr std::array<std::string_view,5> WARLORD_NATIVE_TEXTURES_1074 = {{"06.map","02.map_e","12.map_f","01.map_a","21.map_c"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,33> WARLORD_NATIVE_PARAMETERS_1074 = {{
    {"selectioncolor", 11u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_1074 = {{
    {"00.usedistortion", false},
    {"01.usemesh", true},
    {"31.mapch.r", false},
    {"32.mapch.g", false},
...
constexpr std::array<std::string_view,5> WARLORD_NATIVE_TEXTURES_1075 = {{"06.map","02.map_e","12.map_f","01.map_a","21.map_c"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,33> WARLORD_NATIVE_PARAMETERS_1075 = {{
    {"selectioncolor", 11u, 0u, true},
    {"61.twist.xy", 8u, 0u, true},
    {"93.emissiion_color", 9u, 0u, true},
    {"meshemitterdynamicparameter", 10u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_1075 = {{
    {"00.usedistortion", false},
    {"01.usemesh", true},
    {"31.mapch.r", false},
    {"32.mapch.g", false},
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1076 = {{"flowtex","diff_tex1","diff_tex2","opacity_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,26> WARLORD_NATIVE_PARAMETERS_1076 = {{
    {"selectioncolor", 7u, 0u, true},
    {"flow_tile_u", 3u, 3u, false},
    {"flow_tile_v", 4u, 0u, false},
    {"flow_pan_u", 3u, 1u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,5> WARLORD_NATIVE_SWITCHES_1076 = {{
    {"use_gra_r_channel", false},
    {"use_colormap", false},
    {"diff_pan_use_u", false},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1077 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,5> WARLORD_NATIVE_PARAMETERS_1077 = {{
    {"selectioncolor", 1u, 0u, true},
    {"uv_scale", 0u, 3u, false},
    {"dynamic_parameter_explanation", 0u, 0u, false},
    {"emissive_desaturation", 0u, 1u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,17> WARLORD_NATIVE_SWITCHES_1077 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", false},
    {"use_distortion", false},
    {"use_meshtype", false},
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1078 = {{"noise_tex","diff_tex","native_texture_2","opacity_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,27> WARLORD_NATIVE_PARAMETERS_1078 = {{
    {"selectioncolor", 9u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,1> WARLORD_NATIVE_SWITCHES_1078 = {{
    {"use_cameravec", true},
}};

constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_1079 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,7> WARLORD_NATIVE_PARAMETERS_1079 = {{
    {"selectioncolor", 2u, 0u, true},
    {"01.radius", 0u, 0u, false},
    {"02.hardness", 0u, 1u, false},
    {"03.spherepower", 0u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,4> WARLORD_NATIVE_SWITCHES_1079 = {{
    {"01.checkisvertexcolor", true},
    {"02.usedynamicparam", false},
    {"30.usefresnal", true},
    {"checkisdepthbiasalpha", true},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1080 = {{"01.map_a"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,10> WARLORD_NATIVE_PARAMETERS_1080 = {{
    {"selectioncolor", 3u, 0u, true},
    {"time", 2u, 0u, false},
    {"04.map_a_panning_x", 0u, 2u, false},
    {"02.map_a_uvscale_r", 0u, 0u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_1080 = {{
    {"00.usedistortion", false},
    {"01.usemesh", false},
    {"31.mapch.r", true},
    {"32.mapch.g", true},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1081 = {{"02.map_e","42.map_c"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,16> WARLORD_NATIVE_PARAMETERS_1081 = {{
    {"selectioncolor", 5u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_1081 = {{
    {"00.usedistortion", false},
    {"01.usemesh", false},
    {"31.mapch.r", true},
    {"32.mapch.g", true},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1082 = {{"14.map_d","01.map_a","06.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,19> WARLORD_NATIVE_PARAMETERS_1082 = {{
    {"selectioncolor", 6u, 0u, true},
    {"noisecolor", 5u, 0u, true},
    {"15.map_d_uvscale_r", 2u, 3u, false},
    {"16.map_d_uvscale_g", 3u, 0u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,6> WARLORD_NATIVE_SWITCHES_1082 = {{
    {"checkisdepthbiasalpha", true},
    {"00.checkisnoiseon", true},
    {"12.uvnoise", true},
    {"11.uvmirroring", false},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1083 = {{"14.map_d","01.map_a","06.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,24> WARLORD_NATIVE_PARAMETERS_1083 = {{
    {"selectioncolor", 6u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,12> WARLORD_NATIVE_SWITCHES_1083 = {{
    {"00.checkisdepthbiasalpha", false},
    {"10.usefakedepthbiasalpha", true},
    {"01.useconeuv", true},
    {"30.usefresnal", false},
...
constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_1084 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,10> WARLORD_NATIVE_PARAMETERS_1084 = {{
    {"selectioncolor", 3u, 0u, true},
    {"powerx", 1u, 3u, false},
    {"rgb_str", 2u, 0u, false},
    {"ch_r", 0u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1084 = {{
}};

constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1085 = {{"lensflaretexture"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,4> WARLORD_NATIVE_PARAMETERS_1085 = {{
    {"selectioncolor", 1u, 0u, true},
    {"select texture(0 or 0.5)", 0u, 2u, false},
    {"desaturation", 0u, 1u, false},
    {"depthbaisalpha", 0u, 0u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1085 = {{
}};

constexpr std::array<std::string_view,5> WARLORD_NATIVE_TEXTURES_1086 = {{"maintex","uv_noise_tex_02","uv_noise_tex","noisedissolve_tex","dissolve_tex_01"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,45> WARLORD_NATIVE_PARAMETERS_1086 = {{
    {"selectioncolor", 12u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,19> WARLORD_NATIVE_SWITCHES_1086 = {{
    {"use_alpha_fresnel", false},
    {"use_meshtype", false},
    {"use_dissolvetex_noise", true},
    {"use_dissolvetex_noise_type", true},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1087 = {{"uv_noise_tex","emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,10> WARLORD_NATIVE_PARAMETERS_1087 = {{
    {"selectioncolor", 3u, 0u, true},
    {"emissive_color&intensity", 2u, 0u, true},
    {"uv_noise_panning_x", 0u, 3u, false},
    {"uv_noise_panning_y", 1u, 0u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,5> WARLORD_NATIVE_SWITCHES_1087 = {{
    {"use_meshtype", false},
    {"use_subuv_tex", false},
    {"use_nonalpha_tex", false},
    {"use_emissive_vertcolor", false},
...
constexpr std::array<std::string_view,5> WARLORD_NATIVE_TEXTURES_1088 = {{"diffuse_color","normal_color","native_texture_2","normal_tex","native_texture_4"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,6> WARLORD_NATIVE_PARAMETERS_1088 = {{
    {"selectioncolor", 2u, 0u, true},
    {"bright", 0u, 0u, false},
    {"desaturation", 0u, 1u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1088 = {{
}};

constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_1089 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,5> WARLORD_NATIVE_PARAMETERS_1089 = {{
    {"selectioncolor", 1u, 0u, true},
    {"01.radius", 0u, 0u, false},
    {"02.hardness", 0u, 1u, false},
    {"03.spherepower", 0u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,5> WARLORD_NATIVE_SWITCHES_1089 = {{
    {"checkisdepthbiasalpha", false},
    {"checkisvertexcolor", true},
    {"01.checkisvertexcolor", true},
    {"02.usedynamicparam", false},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1090 = {{"native_texture_0","native_texture_1"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,1> WARLORD_NATIVE_PARAMETERS_1090 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1090 = {{
}};

constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1091 = {{"06.map_anew","06.map","00.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,12> WARLORD_NATIVE_PARAMETERS_1091 = {{
    {"selectioncolor", 3u, 0u, true},
    {"09.map_a_panning_x", 1u, 2u, false},
    {"06.map_alod", 0u, 1u, false},
    {"07.map_a_uvscale_r", 0u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,15> WARLORD_NATIVE_SWITCHES_1091 = {{
    {"00.usedistortion", false},
    {"20.use_centrehole", false},
    {"00.usedepthbiasalpha", false},
    {"30.usefresnal", false},
...
constexpr std::array<std::string_view,6> WARLORD_NATIVE_TEXTURES_1092 = {{"noise_tex","native_texture_1","diff_tex","add_tex","edge_tex","opacity_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,18> WARLORD_NATIVE_PARAMETERS_1092 = {{
    {"selectioncolor", 5u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,2> WARLORD_NATIVE_SWITCHES_1092 = {{
    {"use_add_tex", true},
    {"use_depthalpha", true},
}};

constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_1093 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,6> WARLORD_NATIVE_PARAMETERS_1093 = {{
    {"selectioncolor", 2u, 0u, true},
    {"01.radius", 0u, 0u, false},
    {"02.hardness", 0u, 1u, false},
    {"03.spherepower", 0u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,4> WARLORD_NATIVE_SWITCHES_1093 = {{
    {"checkisdepthbiasalpha", true},
    {"01.checkisvertexcolor", true},
    {"30.usefresnal", false},
    {"02.usedynamicparam", false},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1094 = {{"01.map_e","01.map_a"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,20> WARLORD_NATIVE_PARAMETERS_1094 = {{
    {"selectioncolor", 6u, 0u, true},
    {"19.emissiion_color", 5u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,8> WARLORD_NATIVE_SWITCHES_1094 = {{
    {"06.mapch.r", false},
    {"07.mapch.g", true},
    {"08.mapch.b", true},
    {"00.use_uvdistort", false},
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1095 = {{"uv_noise_tex","emissive_tex01","alpha_tex","uv_dissolve_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,36> WARLORD_NATIVE_PARAMETERS_1095 = {{
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,11> WARLORD_NATIVE_SWITCHES_1095 = {{
    {"use_mesh", true},
    {"use_fresnelalpha", false},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1096 = {{"subuv_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,4> WARLORD_NATIVE_PARAMETERS_1096 = {{
    {"selectioncolor", 1u, 0u, true},
    {"dynamic_parameter_explanation", 0u, 0u, false},
    {"emissive_desaturation", 0u, 1u, false},
    {"emissive_power", 0u, 2u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,18> WARLORD_NATIVE_SWITCHES_1096 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", false},
    {"use_distortion", false},
    {"use_distortion_floor", false},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1097 = {{"maintex","uv_noise_tex","dissolve_tex_01"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,34> WARLORD_NATIVE_PARAMETERS_1097 = {{
    {"selectioncolor", 9u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,19> WARLORD_NATIVE_SWITCHES_1097 = {{
    {"use_alpha_fresnel", false},
    {"use_meshtype", false},
    {"use_dissolvetex_noise", false},
    {"use_dissolvetex_noise_type", true},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1098 = {{"dissolve_noise_tex","uv_noise_01_tex","emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,16> WARLORD_NATIVE_PARAMETERS_1098 = {{
    {"selectioncolor", 5u, 0u, true},
    {"dissolve_color&intensity", 4u, 0u, true},
    {"dissolve_noise_intensity", 0u, 0u, false},
    {"dissolve_noise_power", 0u, 1u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,14> WARLORD_NATIVE_SWITCHES_1098 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", false},
    {"use_distortion", false},
    {"use_distortion_floor", false},
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1099 = {{"31.map_e","06.map","04.map_anew","00.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,22> WARLORD_NATIVE_PARAMETERS_1099 = {{
    {"selectioncolor", 7u, 0u, true},
    {"meshemitterdynamicparameter", 6u, 0u, true},
    {"37.mape_color", 5u, 0u, true},
    {"05.map_alod", 0u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,18> WARLORD_NATIVE_SWITCHES_1099 = {{
    {"00.usedistortion", false},
    {"20.use_centrehole", false},
    {"00.usedepthbiasalpha", true},
    {"30.usefresnal", false},
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1100 = {{"native_texture_0","01.map_uv","01.map_a","11.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,6> WARLORD_NATIVE_PARAMETERS_1100 = {{
    {"selectioncolor", 2u, 0u, true},
    {"09.str", 0u, 0u, false},
    {"10.power", 0u, 1u, false},
    {"12.map_b_uvscale", 0u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,8> WARLORD_NATIVE_SWITCHES_1100 = {{
    {"00.checkisdepthbiasalpha", false},
    {"01.usemesh", false},
    {"06.mapch.r", false},
    {"07.mapch.g", true},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1101 = {{"02.map_e","22.map_a"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,18> WARLORD_NATIVE_PARAMETERS_1101 = {{
    {"selectioncolor", 5u, 0u, true},
    {"93.emissiion_color", 4u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,27> WARLORD_NATIVE_SWITCHES_1101 = {{
    {"00.usespecullar", false},
    {"11.mape+mapf", false},
    {"10.use_mapb", false},
    {"01.use_emissionmap", true},
...
constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_1102 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,2> WARLORD_NATIVE_PARAMETERS_1102 = {{
    {"selectioncolor", 1u, 0u, true},
    {"hardness", 0u, 0u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,1> WARLORD_NATIVE_SWITCHES_1102 = {{
    {"use_depthbias", false},
}};

constexpr std::array<std::string_view,5> WARLORD_NATIVE_TEXTURES_1103 = {{"uv_noise_texture","alpha_texture1_mask","alpha_texture2","emissive_tex_01","emissive_tex_02"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,31> WARLORD_NATIVE_PARAMETERS_1103 = {{
    {"selectioncolor", 8u, 0u, true},
    {"mainalpha_move_u", 5u, 0u, false},
    {"mainalpha_move_v", 5u, 1u, false},
    {"mainalpha_rotator", 5u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,6> WARLORD_NATIVE_SWITCHES_1103 = {{
    {"use_distortion", false},
    {"use_emissive_tex_02", true},
    {"emissive_tex_(01+02)/2", false},
    {"use_alphatex_type_pola", false},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1104 = {{"06.map","02.map_e","21.map_c"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,22> WARLORD_NATIVE_PARAMETERS_1104 = {{
    {"selectioncolor", 7u, 0u, true},
    {"93.emissiion_color", 5u, 0u, true},
    {"meshemitterdynamicparameter", 6u, 0u, true},
    {"21.uvscale.x", 2u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_1104 = {{
    {"00.usedistortion", false},
    {"01.usemesh", true},
    {"31.mapch.r", true},
    {"32.mapch.g", true},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1105 = {{"06.map","02.map_e","21.map_c"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,22> WARLORD_NATIVE_PARAMETERS_1105 = {{
    {"selectioncolor", 7u, 0u, true},
    {"93.emissiion_color", 5u, 0u, true},
    {"meshemitterdynamicparameter", 6u, 0u, true},
    {"21.uvscale.x", 2u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_1105 = {{
    {"00.usedistortion", false},
    {"01.usemesh", true},
    {"31.mapch.r", true},
    {"32.mapch.g", true},
...
constexpr std::array<std::string_view,5> WARLORD_NATIVE_TEXTURES_1106 = {{"distorta_tex","distortb_tex","emissive_tex","maska_tex","maskb_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,18> WARLORD_NATIVE_PARAMETERS_1106 = {{
    {"selectioncolor", 5u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,4> WARLORD_NATIVE_SWITCHES_1106 = {{
    {"use_depthbiasalpha", false},
    {"use_mesh", false},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1107 = {{"01.map_a"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,11> WARLORD_NATIVE_PARAMETERS_1107 = {{
    {"selectioncolor", 3u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,11> WARLORD_NATIVE_SWITCHES_1107 = {{
    {"00.usedistortion", false},
    {"00.use_uvdistort", false},
    {"01.usemesh", false},
...
constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_1108 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,6> WARLORD_NATIVE_PARAMETERS_1108 = {{
    {"selectioncolor", 2u, 0u, true},
    {"centerglow_power", 0u, 0u, false},
    {"centerglow_str", 0u, 1u, false},
    {"glow_power", 0u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,4> WARLORD_NATIVE_SWITCHES_1108 = {{
    {"use_distortion", false},
    {"use_centerglow", true},
    {"use_centermask", false},
    {"use_depth_alpha", true},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1109 = {{"lensflaretexture"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,4> WARLORD_NATIVE_PARAMETERS_1109 = {{
    {"selectioncolor", 1u, 0u, true},
    {"select texture(0 or 0.5)", 0u, 2u, false},
    {"desaturation", 0u, 1u, false},
    {"depthbaisalpha", 0u, 0u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1109 = {{
}};

constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1110 = {{"native_texture_0"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,1> WARLORD_NATIVE_PARAMETERS_1110 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1110 = {{
}};

constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1111 = {{"12.map_f","06.map","02.map_e","12.map_c"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,28> WARLORD_NATIVE_PARAMETERS_1111 = {{
    {"selectioncolor", 8u, 0u, true},
    {"93.emissiion_color", 7u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,27> WARLORD_NATIVE_SWITCHES_1111 = {{
    {"00.usespecullar", false},
    {"11.mape+mapf", false},
    {"10.use_mapb", true},
    {"01.use_emissionmap", true},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1112 = {{"tex_uv_flow","tex_alpha_01","tex_alpha_02"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,11> WARLORD_NATIVE_PARAMETERS_1112 = {{
    {"selectioncolor", 3u, 0u, true},
    {"tex_alpha_01_rotator", 1u, 1u, false},
    {"tex_alpha_01_r_tile", 1u, 0u, false},
    {"tex_alpha_01_g_tile", 0u, 3u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,2> WARLORD_NATIVE_SWITCHES_1112 = {{
    {"use_mesh", false},
    {"alpha_01_rotator_use", true},
}};

constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1114 = {{"31.map_e","06.map","04.map_anew","00.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,21> WARLORD_NATIVE_PARAMETERS_1114 = {{
    {"selectioncolor", 6u, 0u, true},
    {"37.mape_color", 5u, 0u, true},
    {"05.map_alod", 0u, 1u, false},
    {"39.map_a_panning_x", 3u, 3u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,18> WARLORD_NATIVE_SWITCHES_1114 = {{
    {"00.usedistortion", false},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1115 = {{"02.map_e","06.map","22.map_a"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,25> WARLORD_NATIVE_PARAMETERS_1115 = {{
    {"selectioncolor", 7u, 0u, true},
    {"93.emissiion_color", 6u, 0u, true},
    {"22.map_a_uvscale_r", 4u, 0u, false},
    {"23.map_a_uvscale_g", 4u, 1u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,27> WARLORD_NATIVE_SWITCHES_1115 = {{
    {"00.usedistortion", false},
    {"30.usefresnal", false},
    {"31.fresnal.invert", false},
    {"00.checkisdepthbiasalpha", true},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1116 = {{"02.map_e","01.map_a","11.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,22> WARLORD_NATIVE_PARAMETERS_1116 = {{
    {"selectioncolor", 7u, 0u, true},
    {"93.emissiion_color", 5u, 0u, true},
    {"meshemitterdynamicparameter", 6u, 0u, true},
    {"time", 4u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_1116 = {{
    {"00.usedistortion", true},
    {"01.usemesh", true},
    {"31.mapch.r", true},
    {"32.mapch.g", true},
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1117 = {{"01.map_a","11.map_b","21.map_c","01.specmap"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,27> WARLORD_NATIVE_PARAMETERS_1117 = {{
    {"selectioncolor", 9u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_1117 = {{
    {"00.usedistortion", false},
    {"01.usemesh", true},
    {"31.mapch.r", true},
    {"32.mapch.g", true},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1118 = {{"06.map","02.map_e","01.map_a"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,21> WARLORD_NATIVE_PARAMETERS_1118 = {{
    {"selectioncolor", 6u, 0u, true},
    {"93.emissiion_color", 5u, 0u, true},
    {"time", 4u, 2u, false},
    {"05.map_e_panning_x", 2u, 0u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_1118 = {{
    {"00.usedistortion", false},
    {"01.usemesh", false},
    {"31.mapch.r", false},
    {"32.mapch.g", false},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1119 = {{"01.map_a"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,12> WARLORD_NATIVE_PARAMETERS_1119 = {{
    {"selectioncolor", 3u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,5> WARLORD_NATIVE_SWITCHES_1119 = {{
    {"30.usefresnel", false},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1120 = {{"15.map_type"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,14> WARLORD_NATIVE_PARAMETERS_1120 = {{
    {"selectioncolor", 5u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,9> WARLORD_NATIVE_SWITCHES_1120 = {{
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1121 = {{"01.map_a","11.map_b","21.map_c"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,18> WARLORD_NATIVE_PARAMETERS_1121 = {{
    {"selectioncolor", 5u, 0u, true},
    {"meshemitterdynamicparameter", 4u, 0u, true},
    {"21.uvscale.x", 2u, 1u, false},
    {"22.uvscale.y", 2u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_1121 = {{
    {"00.usedistortion", false},
    {"01.usemesh", true},
    {"31.mapch.r", false},
    {"32.mapch.g", false},
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1124 = {{"01.map.n","01.emismap","01.map.d","01.specmap"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,24> WARLORD_NATIVE_PARAMETERS_1124 = {{
    {"selectioncolor", 9u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,22> WARLORD_NATIVE_SWITCHES_1124 = {{
    {"00.usenormalmap", true},
    {"00.usealphamap", false},
    {"31.mapch.r", true},
    {"32.mapch.g", true},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1125 = {{"uv_noise_01_tex","emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,11> WARLORD_NATIVE_PARAMETERS_1125 = {{
    {"selectioncolor", 3u, 0u, true},
    {"uv_noise_01_panning_x", 1u, 1u, false},
    {"uv_noise_01_tiling_x", 1u, 3u, false},
    {"uv_noise_01_tiling_y", 2u, 0u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,18> WARLORD_NATIVE_SWITCHES_1125 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", true},
    {"use_distortion", false},
    {"use_distortion_floor", false},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1126 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,1> WARLORD_NATIVE_PARAMETERS_1126 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,3> WARLORD_NATIVE_SWITCHES_1126 = {{
    {"use_meshtype", false},
    {"use_subuv_tex", false},
    {"use_nonalpha_chanel", false},
}};

constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1127 = {{"tex_uv_flow","tex_alpha_01","tex_alpha_02"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,11> WARLORD_NATIVE_PARAMETERS_1127 = {{
    {"selectioncolor", 3u, 0u, true},
    {"tex_alpha_01_rotator", 1u, 1u, false},
    {"tex_alpha_01_r_tile", 1u, 0u, false},
    {"tex_alpha_01_g_tile", 0u, 3u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,2> WARLORD_NATIVE_SWITCHES_1127 = {{
    {"use_mesh", false},
    {"alpha_01_rotator_use", true},
}};

constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1128 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,6> WARLORD_NATIVE_PARAMETERS_1128 = {{
    {"selectioncolor", 2u, 0u, true},
    {"uv_scale", 1u, 0u, false},
    {"dynamic_parameter_explanation", 0u, 1u, false},
    {"emissive_desaturation", 0u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,17> WARLORD_NATIVE_SWITCHES_1128 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", true},
    {"use_distortion", false},
    {"use_meshtype", false},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1129 = {{"uv_noise_01_tex","emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,12> WARLORD_NATIVE_PARAMETERS_1129 = {{
    {"selectioncolor", 3u, 0u, true},
    {"uv_noise_01_panning_x", 1u, 2u, false},
    {"uv_noise_01_tiling_x", 2u, 0u, false},
    {"uv_noise_01_tiling_y", 2u, 1u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,17> WARLORD_NATIVE_SWITCHES_1129 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", false},
    {"use_distortion", false},
    {"use_meshtype", false},
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1130 = {{"noise_tex","diff_tex","native_texture_2","opacity_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,26> WARLORD_NATIVE_PARAMETERS_1130 = {{
    {"selectioncolor", 9u, 0u, true},
    {"diff_high_color", 6u, 0u, true},
    {"diff_low_color", 7u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1130 = {{
}};

constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_1131 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,1> WARLORD_NATIVE_PARAMETERS_1131 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1131 = {{
}};

constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1132 = {{"06.map","01.map_a","21.map_c"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,18> WARLORD_NATIVE_PARAMETERS_1132 = {{
    {"selectioncolor", 5u, 0u, true},
    {"21.uvscale.x", 2u, 2u, false},
    {"22.uvscale.y", 2u, 3u, false},
    {"time", 4u, 0u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_1132 = {{
    {"00.usedistortion", false},
    {"01.usemesh", false},
    {"31.mapch.r", true},
    {"32.mapch.g", true},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1134 = {{"02.map_e","22.map_a"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,23> WARLORD_NATIVE_PARAMETERS_1134 = {{
    {"selectioncolor", 7u, 0u, true},
    {"93.emissiion_color", 6u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,27> WARLORD_NATIVE_SWITCHES_1134 = {{
    {"00.usespecullar", false},
    {"11.mape+mapf", false},
    {"10.use_mapb", false},
    {"01.use_emissionmap", true},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1135 = {{"01.map_a","21.map_c"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,15> WARLORD_NATIVE_PARAMETERS_1135 = {{
    {"selectioncolor", 5u, 0u, true},
    {"meshemitterdynamicparameter", 4u, 0u, true},
    {"21.uvscale.x", 1u, 0u, false},
    {"22.uvscale.y", 1u, 1u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_1135 = {{
    {"00.usedistortion", false},
    {"01.usemesh", true},
    {"31.mapch.r", true},
    {"32.mapch.g", true},
...
constexpr std::array<std::string_view,5> WARLORD_NATIVE_TEXTURES_1136 = {{"addmap1_tex","uvnoise_tex","colormap2_tex","colormap_tex","main_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,39> WARLORD_NATIVE_PARAMETERS_1136 = {{
    {"selectioncolor", 11u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,18> WARLORD_NATIVE_SWITCHES_1136 = {{
    {"use_distortion", false},
    {"use_halfmoon", false},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1137 = {{"22.map_a","06.map"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,19> WARLORD_NATIVE_PARAMETERS_1137 = {{
    {"selectioncolor", 6u, 0u, true},
    {"93.emissiion_color", 5u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,27> WARLORD_NATIVE_SWITCHES_1137 = {{
    {"00.usespecullar", false},
    {"11.mape+mapf", false},
    {"10.use_mapb", false},
    {"01.use_emissionmap", false},
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1138 = {{"uv_noise_01_tex","emissive_tex","alpha_tex","mask_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,14> WARLORD_NATIVE_PARAMETERS_1138 = {{
    {"selectioncolor", 4u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,19> WARLORD_NATIVE_SWITCHES_1138 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", false},
    {"use_distortion", false},
    {"use_distortion_floor", false},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1139 = {{"14.map_d","01.map_a","06.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,23> WARLORD_NATIVE_PARAMETERS_1139 = {{
    {"selectioncolor", 6u, 0u, true},
    {"11.direct", 2u, 2u, false},
    {"04.map_a_panning_x", 1u, 0u, false},
    {"02.map_a_uvscale_r", 0u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,12> WARLORD_NATIVE_SWITCHES_1139 = {{
    {"00.checkisdepthbiasalpha", false},
    {"10.usefakedepthbiasalpha", true},
    {"01.useconeuv", false},
    {"30.usefresnal", false},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1140 = {{"01.diffmap_a","native_texture_1"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,7> WARLORD_NATIVE_PARAMETERS_1140 = {{
    {"selectioncolor", 3u, 0u, true},
    {"82.diffusecolor", 2u, 0u, true},
    {"02.diffmap_a.uvscale", 0u, 0u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,13> WARLORD_NATIVE_SWITCHES_1140 = {{
    {"00.useinvertdepthbiasalpha", false},
    {"01.usemesh", false},
    {"30.usedissolve", true},
    {"00.usealphamap", false},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1141 = {{"01.diffmap_a","01.emismap","native_texture_2"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,12> WARLORD_NATIVE_PARAMETERS_1141 = {{
    {"selectioncolor", 5u, 0u, true},
    {"82.diffusecolor", 4u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,13> WARLORD_NATIVE_SWITCHES_1141 = {{
    {"00.useinvertdepthbiasalpha", false},
    {"01.usemesh", false},
    {"30.usedissolve", true},
    {"00.usealphamap", false},
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1142 = {{"uv_noise_tex_02","emissivee_wave_texture","uv_noise_tex_01","worldoffset_emissive_tex_01"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,19> WARLORD_NATIVE_PARAMETERS_1142 = {{
    {"selectioncolor", 6u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1142 = {{
}};

constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1143 = {{"01.map.n","01.emismap","01.map.d"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,18> WARLORD_NATIVE_PARAMETERS_1143 = {{
    {"selectioncolor", 7u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,23> WARLORD_NATIVE_SWITCHES_1143 = {{
    {"00.usenormalmap", true},
    {"00.usealphamap", false},
    {"31.mapch.r", true},
    {"32.mapch.g", true},
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1144 = {{"06.map","02.map_e","01.map_a","21.map_c"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,25> WARLORD_NATIVE_PARAMETERS_1144 = {{
    {"selectioncolor", 7u, 0u, true},
    {"93.emissiion_color", 6u, 0u, true},
    {"21.uvscale.x", 3u, 2u, false},
    {"22.uvscale.y", 3u, 3u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_1144 = {{
    {"00.usedistortion", false},
    {"01.usemesh", false},
    {"31.mapch.r", false},
    {"32.mapch.g", false},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1145 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,6> WARLORD_NATIVE_PARAMETERS_1145 = {{
    {"selectioncolor", 2u, 0u, true},
    {"uv_scale", 1u, 0u, false},
    {"dynamic_parameter_explanation", 0u, 1u, false},
    {"emissive_desaturation", 0u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,18> WARLORD_NATIVE_SWITCHES_1145 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", true},
    {"use_distortion", false},
    {"use_distortion_floor", false},
...
constexpr std::array<std::string_view,6> WARLORD_NATIVE_TEXTURES_1146 = {{"native_texture_0","native_texture_1","native_texture_2","sparkle_tex","edgedeco texture01","native_texture_5"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,4> WARLORD_NATIVE_PARAMETERS_1146 = {{
    {"selectioncolor", 1u, 0u, true},
    {"sparkle_paning", 0u, 1u, false},
    {"sparkle_tiling", 0u, 2u, false},
    {"sparkle_intensity", 0u, 0u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1146 = {{
}};

constexpr std::array<std::string_view,5> WARLORD_NATIVE_TEXTURES_1147 = {{"01.heightmap","01.diffmap_a","01.emismap","01.alphamaskmap","native_texture_4"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,14> WARLORD_NATIVE_PARAMETERS_1147 = {{
    {"selectioncolor", 5u, 0u, true},
    {"82.diffusecolor", 4u, 0u, true},
    {"03.emap_uv.x.scale", 0u, 2u, false},
    {"04.emap_uv.y.scale", 1u, 0u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,13> WARLORD_NATIVE_SWITCHES_1147 = {{
    {"00.useinvertdepthbiasalpha", false},
    {"01.usemesh", false},
    {"30.usedissolve", true},
    {"00.usealphamap", true},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1148 = {{"uv_noise_tex","emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,10> WARLORD_NATIVE_PARAMETERS_1148 = {{
    {"selectioncolor", 3u, 0u, true},
    {"emissive_color&intensity", 2u, 0u, true},
    {"uv_noise_panning_x", 0u, 3u, false},
    {"uv_noise_panning_y", 1u, 0u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,5> WARLORD_NATIVE_SWITCHES_1148 = {{
    {"use_meshtype", false},
    {"use_subuv_tex", false},
    {"use_nonalpha_tex", false},
    {"use_emissive_vertcolor", false},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1149 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,5> WARLORD_NATIVE_PARAMETERS_1149 = {{
    {"selectioncolor", 1u, 0u, true},
    {"uv_scale", 0u, 3u, false},
    {"dynamic_parameter_explanation", 0u, 0u, false},
    {"emissive_desaturation", 0u, 1u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,17> WARLORD_NATIVE_SWITCHES_1149 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", false},
    {"use_distortion", false},
    {"use_meshtype", false},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1150 = {{"14.map_d","01.map_a","06.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,28> WARLORD_NATIVE_PARAMETERS_1150 = {{
    {"selectioncolor", 8u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,12> WARLORD_NATIVE_SWITCHES_1150 = {{
    {"00.checkisdepthbiasalpha", true},
    {"10.usefakedepthbiasalpha", true},
    {"01.useconeuv", false},
    {"30.usefresnal", false},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1151 = {{"12.map_f","06.map","02.map_e"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,29> WARLORD_NATIVE_PARAMETERS_1151 = {{
    {"selectioncolor", 8u, 0u, true},
    {"93.emissiion_color", 7u, 0u, true},
    {"time", 6u, 2u, false},
    {"15.map_e_panning_x", 4u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,27> WARLORD_NATIVE_SWITCHES_1151 = {{
    {"00.usespecullar", false},
    {"11.mape+mapf", true},
    {"10.use_mapb", true},
    {"01.use_emissionmap", true},
...
constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_1152 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,1> WARLORD_NATIVE_PARAMETERS_1152 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1152 = {{
}};

constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_1153 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,6> WARLORD_NATIVE_PARAMETERS_1153 = {{
    {"selectioncolor", 2u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,8> WARLORD_NATIVE_SWITCHES_1153 = {{
    {"00.alphamap", false},
    {"20.usehemisphere", false},
    {"00.useemissioncolor", false},
    {"00.checkisdepthbiasalpha", true},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1154 = {{"map_a","map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,6> WARLORD_NATIVE_PARAMETERS_1154 = {{
    {"selectioncolor", 2u, 0u, true},
    {"readme", 1u, 0u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,7> WARLORD_NATIVE_SWITCHES_1154 = {{
    {"00.uselightshift", false},
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1155 = {{"native_texture_0","native_texture_1","native_texture_2","native_texture_3"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,1> WARLORD_NATIVE_PARAMETERS_1155 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1155 = {{
}};

constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1156 = {{"02.map_e","06.map","22.map_a"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,28> WARLORD_NATIVE_PARAMETERS_1156 = {{
    {"selectioncolor", 8u, 0u, true},
    {"93.emissiion_color", 7u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,27> WARLORD_NATIVE_SWITCHES_1156 = {{
    {"00.usespecullar", false},
    {"11.mape+mapf", false},
    {"10.use_mapb", false},
    {"01.use_emissionmap", true},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1157 = {{"uv_noise_01_tex","emissive_tex","transition texture"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,17> WARLORD_NATIVE_PARAMETERS_1157 = {{
    {"selectioncolor", 5u, 0u, true},
    {"meshemitterdynamicparameter", 4u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,6> WARLORD_NATIVE_SWITCHES_1157 = {{
    {"non_alpha_chanel", true},
    {"use_distortion", false},
    {"use_fresnel_alpha", false},
    {"use_meshtype", true},
...
constexpr std::array<std::string_view,6> WARLORD_NATIVE_TEXTURES_1158 = {{"06.map","02.map_e","12.map_f","01.map_a","11.map_b","01.specmap"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,35> WARLORD_NATIVE_PARAMETERS_1158 = {{
    {"selectioncolor", 10u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_1158 = {{
    {"00.usedistortion", false},
    {"01.usemesh", false},
    {"31.mapch.r", true},
    {"32.mapch.g", true},
...
constexpr std::array<std::string_view,5> WARLORD_NATIVE_TEXTURES_1159 = {{"distorta_tex","distortb_tex","emissive_tex","maska_tex","maskb_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,18> WARLORD_NATIVE_PARAMETERS_1159 = {{
    {"selectioncolor", 5u, 0u, true},
    {"emissive_tileu", 3u, 1u, false},
    {"emissive_tilev", 3u, 2u, false},
    {"distorta_tileu", 0u, 3u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,4> WARLORD_NATIVE_SWITCHES_1159 = {{
    {"use_depthbiasalpha", false},
    {"use_mesh", false},
    {"use_dynamic_lerp", true},
    {"use_fanshape_alpha", false},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1160 = {{"native_texture_0","native_texture_1","native_texture_2"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,1> WARLORD_NATIVE_PARAMETERS_1160 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1160 = {{
}};

constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1161 = {{"02.map_e","01.map_a","21.map_c"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,24> WARLORD_NATIVE_PARAMETERS_1161 = {{
    {"selectioncolor", 8u, 0u, true},
    {"93.emissiion_color", 6u, 0u, true},
    {"meshemitterdynamicparameter", 7u, 0u, true},
    {"21.uvscale.x", 2u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_1161 = {{
    {"00.usedistortion", true},
    {"01.usemesh", true},
    {"31.mapch.r", true},
    {"32.mapch.g", true},
...
constexpr std::array<std::string_view,5> WARLORD_NATIVE_TEXTURES_1162 = {{"06.map","02.map_e","12.map_f","01.map_a","11.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,33> WARLORD_NATIVE_PARAMETERS_1162 = {{
    {"selectioncolor", 11u, 0u, true},
    {"61.twist.xy", 8u, 0u, true},
    {"93.emissiion_color", 9u, 0u, true},
    {"meshemitterdynamicparameter", 10u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_1162 = {{
    {"00.usedistortion", false},
    {"01.usemesh", true},
    {"31.mapch.r", true},
    {"32.mapch.g", true},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1163 = {{"uv_noise_01_tex","emissive_tex","transition texture"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,17> WARLORD_NATIVE_PARAMETERS_1163 = {{
    {"selectioncolor", 5u, 0u, true},
    {"meshemitterdynamicparameter", 4u, 0u, true},
    {"total_scale", 1u, 1u, false},
    {"uv_noise_01_panning_x", 3u, 0u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,6> WARLORD_NATIVE_SWITCHES_1163 = {{
    {"use_meshtype", true},
    {"use_polarcoordinate", true},
    {"non_alpha_chanel", false},
    {"use_uv_noise_02", false},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1164 = {{"02.map_e","12.map_f","21.map_c"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,22> WARLORD_NATIVE_PARAMETERS_1164 = {{
    {"selectioncolor", 7u, 0u, true},
    {"93.emissiion_color", 5u, 0u, true},
    {"meshemitterdynamicparameter", 6u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_1164 = {{
    {"00.usedistortion", false},
    {"01.usemesh", true},
    {"31.mapch.r", false},
    {"32.mapch.g", false},
...
constexpr std::array<std::string_view,5> WARLORD_NATIVE_TEXTURES_1165 = {{"06.map","02.map_e","12.map_f","01.map_a","21.map_c"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,29> WARLORD_NATIVE_PARAMETERS_1165 = {{
    {"selectioncolor", 8u, 0u, true},
    {"93.emissiion_color", 7u, 0u, true},
    {"21.uvscale.x", 4u, 2u, false},
    {"22.uvscale.y", 4u, 3u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_1165 = {{
    {"00.usedistortion", false},
    {"01.usemesh", false},
    {"31.mapch.r", true},
    {"32.mapch.g", true},
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1166 = {{"native_texture_0","native_texture_1","emissive_tex","emissive_tex_02"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,10> WARLORD_NATIVE_PARAMETERS_1166 = {{
    {"selectioncolor", 3u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,4> WARLORD_NATIVE_SWITCHES_1166 = {{
    {"non_alpha_chanel", true},
    {"use_meshtype", false},
    {"use_dissolve", false},
    {"use_fresnel_alpha", false},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1167 = {{"01.map_a","06.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,19> WARLORD_NATIVE_PARAMETERS_1167 = {{
    {"selectioncolor", 5u, 0u, true},
    {"11.direct", 2u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,12> WARLORD_NATIVE_SWITCHES_1167 = {{
    {"00.checkisdepthbiasalpha", false},
    {"10.usefakedepthbiasalpha", true},
    {"01.useconeuv", true},
    {"30.usefresnal", false},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1168 = {{"14.map_d","01.map_a","06.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,19> WARLORD_NATIVE_PARAMETERS_1168 = {{
    {"selectioncolor", 6u, 0u, true},
    {"noisecolor", 5u, 0u, true},
    {"15.map_d_uvscale_r", 2u, 3u, false},
    {"16.map_d_uvscale_g", 3u, 0u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,6> WARLORD_NATIVE_SWITCHES_1168 = {{
    {"checkisdepthbiasalpha", true},
    {"00.checkisnoiseon", true},
    {"11.uvmirroring", false},
    {"12.uvnoise", true},
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1169 = {{"06.map","02.map_e","01.map_a","21.map_c"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,25> WARLORD_NATIVE_PARAMETERS_1169 = {{
    {"selectioncolor", 7u, 0u, true},
    {"93.emissiion_color", 6u, 0u, true},
    {"21.uvscale.x", 3u, 2u, false},
    {"22.uvscale.y", 3u, 3u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_1169 = {{
    {"00.usedistortion", false},
    {"01.usemesh", false},
    {"31.mapch.r", false},
    {"32.mapch.g", false},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1170 = {{"14.map_d","01.map_a","06.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,18> WARLORD_NATIVE_PARAMETERS_1170 = {{
    {"selectioncolor", 5u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,6> WARLORD_NATIVE_SWITCHES_1170 = {{
    {"checkisdepthbiasalpha", false},
    {"00.checkisnoiseon", true},
    {"11.uvmirroring", false},
    {"12.uvnoise", true},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1171 = {{"14.map_d","01.map_a","06.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,21> WARLORD_NATIVE_PARAMETERS_1171 = {{
    {"selectioncolor", 5u, 0u, true},
    {"power", 4u, 2u, false},
    {"str", 4u, 3u, false},
    {"04.map_a_panning_x", 1u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,5> WARLORD_NATIVE_SWITCHES_1171 = {{
    {"--usefakedepthbiasalpha", true},
    {"checkisdepthbiasalpha", true},
    {"00.checkisnoiseon", true},
    {"12.uvnoise", true},
...
constexpr std::array<std::string_view,7> WARLORD_NATIVE_TEXTURES_1172 = {{"06.map","02.map_e","12.map_f","01.map_a","11.map_b","21.map_c","01.specmap"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,39> WARLORD_NATIVE_PARAMETERS_1172 = {{
    {"selectioncolor", 11u, 0u, true},
    {"05.specmap_uvscale.x", 2u, 2u, false},
    {"06.specmap_uvscale.y", 3u, 0u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_1172 = {{
    {"00.usedistortion", false},
    {"01.usemesh", false},
    {"31.mapch.r", true},
    {"32.mapch.g", true},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1173 = {{"01.map_a","06.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,19> WARLORD_NATIVE_PARAMETERS_1173 = {{
    {"selectioncolor", 6u, 0u, true},
    {"11.direct", 2u, 3u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,12> WARLORD_NATIVE_SWITCHES_1173 = {{
    {"00.checkisdepthbiasalpha", false},
    {"10.usefakedepthbiasalpha", true},
    {"01.useconeuv", false},
    {"30.usefresnal", true},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1174 = {{"01.map_a","06.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,18> WARLORD_NATIVE_PARAMETERS_1174 = {{
    {"selectioncolor", 5u, 0u, true},
    {"11.direct", 2u, 2u, false},
    {"11.width.power", 3u, 0u, false},
    {"12.width.strength", 3u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,12> WARLORD_NATIVE_SWITCHES_1174 = {{
    {"00.checkisdepthbiasalpha", false},
    {"10.usefakedepthbiasalpha", true},
    {"01.useconeuv", false},
    {"30.usefresnal", false},
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1175 = {{"31.map_e","06.map","04.map_anew","00.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,20> WARLORD_NATIVE_PARAMETERS_1175 = {{
    {"selectioncolor", 6u, 0u, true},
    {"37.mape_color", 5u, 0u, true},
    {"05.map_alod", 0u, 1u, false},
    {"39.map_a_panning_x", 3u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,18> WARLORD_NATIVE_SWITCHES_1175 = {{
    {"00.usedistortion", false},
    {"20.use_centrehole", false},
    {"00.usedepthbiasalpha", false},
    {"30.usefresnal", false},
...
constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_1176 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,9> WARLORD_NATIVE_PARAMETERS_1176 = {{
    {"selectioncolor", 2u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,12> WARLORD_NATIVE_SWITCHES_1176 = {{
    {"00.checkisdepthbiasalpha", true},
    {"10.usefakedepthbiasalpha", true},
    {"01.useconeuv", false},
    {"30.usefresnal", false},
...
constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_1177 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,6> WARLORD_NATIVE_PARAMETERS_1177 = {{
    {"selectioncolor", 2u, 0u, true},
    {"power", 0u, 3u, false},
    {"str", 1u, 0u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,6> WARLORD_NATIVE_SWITCHES_1177 = {{
    {"--usefakedepthbiasalpha", true},
    {"checkisdepthbiasalpha", true},
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1178 = {{"06.map","02.map_e","01.map_a","21.map_c"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,27> WARLORD_NATIVE_PARAMETERS_1178 = {{
    {"selectioncolor", 8u, 0u, true},
    {"93.emissiion_color", 6u, 0u, true},
    {"meshemitterdynamicparameter", 7u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_1178 = {{
    {"00.usedistortion", false},
    {"01.usemesh", true},
    {"31.mapch.r", true},
    {"32.mapch.g", true},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1179 = {{"04.map_anew","00.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,9> WARLORD_NATIVE_PARAMETERS_1179 = {{
    {"selectioncolor", 2u, 0u, true},
    {"05.map_alod", 0u, 0u, false},
    {"09.map_a_panning_x", 0u, 3u, false},
    {"07.map_a_uvscale_r", 0u, 1u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,18> WARLORD_NATIVE_SWITCHES_1179 = {{
    {"00.usedistortion", false},
    {"20.use_centrehole", false},
    {"00.usedepthbiasalpha", false},
    {"30.usefresnal", false},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1180 = {{"01.map_e","06.map","06.map_f"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,27> WARLORD_NATIVE_PARAMETERS_1180 = {{
    {"selectioncolor", 8u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,10> WARLORD_NATIVE_SWITCHES_1180 = {{
    {"00.usedistortion", false},
    {"01.usemesh", false},
    {"40.usefresnal", false},
    {"00.use_uvdistort", true},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1181 = {{"maintex","uv_noise_tex","dissolve_tex_01"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,34> WARLORD_NATIVE_PARAMETERS_1181 = {{
    {"selectioncolor", 9u, 0u, true},
    {"uvnoise_move_x", 7u, 2u, false},
    {"uvnoise_move_y", 7u, 3u, false},
    {"maintex_move_x", 3u, 3u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,20> WARLORD_NATIVE_SWITCHES_1181 = {{
    {"use_dissolve", true},
    {"use_meshtype", false},
    {"use_uvnoise", true},
    {"achannel_use_uvnoisedynamicpan", false},
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1182 = {{"noise_tex","diff_tex","native_texture_2","opacity_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,26> WARLORD_NATIVE_PARAMETERS_1182 = {{
    {"selectioncolor", 9u, 0u, true},
    {"diff_high_color", 6u, 0u, true},
    {"diff_low_color", 7u, 0u, true},
    {"diff_u_tile", 1u, 1u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,1> WARLORD_NATIVE_SWITCHES_1182 = {{
    {"use_cameravec", false},
}};

constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1183 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,6> WARLORD_NATIVE_PARAMETERS_1183 = {{
    {"selectioncolor", 2u, 0u, true},
    {"uv_scale", 1u, 0u, false},
    {"dynamic_parameter_explanation", 0u, 1u, false},
    {"emissive_desaturation", 0u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,14> WARLORD_NATIVE_SWITCHES_1183 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", true},
    {"use_distortion", false},
    {"use_distortion_floor", false},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1184 = {{"uv_noise_tex","native_texture_1","maintex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,30> WARLORD_NATIVE_PARAMETERS_1184 = {{
    {"selectioncolor", 8u, 0u, true},
    {"meshemitterdynamicparameter", 7u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,13> WARLORD_NATIVE_SWITCHES_1184 = {{
    {"usemesh", true},
    {"use_camera_vector_fresnel", false},
    {"use_distortion", false},
    {"use_outfalloff", false},
...
constexpr std::array<std::string_view,5> WARLORD_NATIVE_TEXTURES_1185 = {{"flowtex","diff_tex1","diff_tex2","mask_tex","opacity_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,25> WARLORD_NATIVE_PARAMETERS_1185 = {{
    {"selectioncolor", 7u, 0u, true},
    {"flow_tile_u", 3u, 3u, false},
    {"flow_tile_v", 4u, 0u, false},
    {"flow_pan_u", 3u, 1u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,3> WARLORD_NATIVE_SWITCHES_1185 = {{
    {"use_colormap", false},
    {"diff_pan_use_u", false},
    {"use_distortion", false},
}};

constexpr std::array<std::string_view,5> WARLORD_NATIVE_TEXTURES_1186 = {{"flowtex","diff_tex1","diff_tex2","mask_tex","opacity_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,24> WARLORD_NATIVE_PARAMETERS_1186 = {{
    {"selectioncolor", 7u, 0u, true},
    {"diff1_tile_u", 0u, 2u, false},
    {"diff1_tile_v", 0u, 3u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,3> WARLORD_NATIVE_SWITCHES_1186 = {{
    {"diff_pan_use_u", false},
    {"use_distortion", false},
    {"use_colormap", false},
}};

constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_1187 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,1> WARLORD_NATIVE_PARAMETERS_1187 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1187 = {{
}};

constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1188 = {{"flowtex","diff_tex1","diff_tex2","opacity_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,26> WARLORD_NATIVE_PARAMETERS_1188 = {{
    {"selectioncolor", 7u, 0u, true},
    {"flow_tile_u", 3u, 3u, false},
    {"flow_tile_v", 4u, 0u, false},
    {"flow_pan_u", 3u, 1u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,5> WARLORD_NATIVE_SWITCHES_1188 = {{
    {"use_gra_r_channel", false},
    {"use_colormap", false},
    {"diff_pan_use_u", false},
    {"use_cam_vector", true},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1189 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,5> WARLORD_NATIVE_PARAMETERS_1189 = {{
    {"selectioncolor", 1u, 0u, true},
    {"uv_scale", 0u, 3u, false},
    {"dynamic_parameter_explanation", 0u, 0u, false},
    {"emissive_desaturation", 0u, 1u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,17> WARLORD_NATIVE_SWITCHES_1189 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", false},
    {"use_distortion", false},
    {"use_meshtype", false},
...
constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1190 = {{"lensflaretexture"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,4> WARLORD_NATIVE_PARAMETERS_1190 = {{
    {"selectioncolor", 1u, 0u, true},
    {"select texture(0 or 0.5)", 0u, 2u, false},
    {"desaturation", 0u, 1u, false},
    {"depthbaisalpha", 0u, 0u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1190 = {{
}};

constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_1191 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,6> WARLORD_NATIVE_PARAMETERS_1191 = {{
    {"selectioncolor", 2u, 0u, true},
    {"centerglow_power", 0u, 0u, false},
    {"centerglow_str", 0u, 1u, false},
    {"glow_power", 0u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1191 = {{
}};

constexpr std::array<std::string_view,5> WARLORD_NATIVE_TEXTURES_1192 = {{"flowtex","diff_tex1","diff_tex2","mask_tex","opacity_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,24> WARLORD_NATIVE_PARAMETERS_1192 = {{
    {"selectioncolor", 7u, 0u, true},
    {"diff1_tile_u", 0u, 2u, false},
    {"diff1_tile_v", 0u, 3u, false},
    {"flow_tile_u", 3u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,3> WARLORD_NATIVE_SWITCHES_1192 = {{
    {"diff_pan_use_u", false},
    {"use_distortion", false},
    {"use_colormap", false},
}};

constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_1193 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,5> WARLORD_NATIVE_PARAMETERS_1193 = {{
    {"selectioncolor", 1u, 0u, true},
    {"power", 0u, 2u, false},
    {"str", 0u, 3u, false},
    {"01.range", 0u, 0u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,6> WARLORD_NATIVE_SWITCHES_1193 = {{
    {"checkisdepthbiasalpha", false},
    {"00.checkisnoiseon", false},
    {"11.uvmirroring", false},
    {"12.uvnoise", false},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_1194 = {{"native_texture_0","native_texture_1"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,20> WARLORD_NATIVE_PARAMETERS_1194 = {{
    {"selectioncolor", 5u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,1> WARLORD_NATIVE_SWITCHES_1194 = {{
    {"sw_opacity_stert_end", true},
}};

constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1195 = {{"lensflaretexture"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,4> WARLORD_NATIVE_PARAMETERS_1195 = {{
    {"selectioncolor", 1u, 0u, true},
    {"select texture(0 or 0.5)", 0u, 2u, false},
    {"desaturation", 0u, 1u, false},
    {"depthbaisalpha", 0u, 0u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_1195 = {{
}};

constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_1196 = {{"add_emissive_tex","twinkle_tex","twinkle_tex_01","mask_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,8> WARLORD_NATIVE_PARAMETERS_1196 = {{
    {"selectioncolor", 3u, 0u, true},
    {"emissive_color&intensity", 2u, 0u, true},
    {"emissive_paning", 0u, 1u, false},
    {"emissive_tiling", 0u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,3> WARLORD_NATIVE_SWITCHES_1196 = {{
    {"use_mask_r_chanel", false},
    {"use_emissive_r_chanel", false},
    {"use_meshtype", false},
}};

constexpr std::array<std::string_view,1> WARLORD_NATIVE_TEXTURES_1197 = {{"emissive_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,5> WARLORD_NATIVE_PARAMETERS_1197 = {{
    {"selectioncolor", 1u, 0u, true},
    {"uv_scale", 0u, 3u, false},
    {"dynamic_parameter_explanation", 0u, 0u, false},
    {"emissive_desaturation", 0u, 1u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,18> WARLORD_NATIVE_SWITCHES_1197 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", false},
    {"use_distortion", false},
    {"use_distortion_floor", false},
...
constexpr std::array<std::string_view,5> WARLORD_NATIVE_TEXTURES_1198 = {{"uv_noise_texture","alpha_texture1_mask","alpha_texture2","emissive_tex_01","emissive_tex_02"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,31> WARLORD_NATIVE_PARAMETERS_1198 = {{
    {"selectioncolor", 8u, 0u, true},
    {"mainalpha_move_u", 5u, 0u, false},
    {"mainalpha_move_v", 5u, 1u, false},
    {"mainalpha_rotator", 5u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,6> WARLORD_NATIVE_SWITCHES_1198 = {{
    {"use_distortion", false},
    {"use_emissive_tex_02", true},
    {"emissive_tex_(01+02)/2", false},
    {"use_alphatex_type_pola", false},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_1199 = {{"main_tex","uv_noise_texture","colormap_tex"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,22> WARLORD_NATIVE_PARAMETERS_1199 = {{
    {"selectioncolor", 6u, 0u, true},
    {"colormap_color", 5u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,4> WARLORD_NATIVE_SWITCHES_1199 = {{
    {"use_colormap", true},
    {"use_uvnoise", true},
    {"use_distortion", false},
    {"use_depth_alpha", false},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_2000 = {{"uvnoisemap","flowmap"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,5> WARLORD_NATIVE_PARAMETERS_2000 = {{
    {"selectioncolor", 1u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_2000 = {{
}};

constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_2001 = {{"06.map","02.map_e","21.map_c"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,24> WARLORD_NATIVE_PARAMETERS_2001 = {{
    {"selectioncolor", 8u, 0u, true},
    {"93.emissiion_color", 6u, 0u, true},
    {"meshemitterdynamicparameter", 7u, 0u, true},
    {"21.uvscale.x", 2u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_2001 = {{
    {"00.usedistortion", false},
    {"01.usemesh", true},
    {"31.mapch.r", true},
    {"32.mapch.g", true},
...
constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_2002 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,9> WARLORD_NATIVE_PARAMETERS_2002 = {{
    {"selectioncolor", 2u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,1> WARLORD_NATIVE_SWITCHES_2002 = {{
    {"use_inverse", false},
}};

constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_2003 = {{"06.map","02.map_e","21.map_c"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,24> WARLORD_NATIVE_PARAMETERS_2003 = {{
    {"selectioncolor", 8u, 0u, true},
    {"93.emissiion_color", 6u, 0u, true},
    {"meshemitterdynamicparameter", 7u, 0u, true},
    {"21.uvscale.x", 2u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,26> WARLORD_NATIVE_SWITCHES_2003 = {{
    {"00.usedistortion", true},
    {"01.usemesh", true},
    {"31.mapch.r", true},
    {"32.mapch.g", true},
...
constexpr std::array<std::string_view,0> WARLORD_NATIVE_TEXTURES_2004 = {{}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,2> WARLORD_NATIVE_PARAMETERS_2004 = {{
    {"selectioncolor", 1u, 0u, true},
    {"01.inactivealpha", 0u, 0u, false},
}};
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,0> WARLORD_NATIVE_SWITCHES_2004 = {{
}};


constexpr std::array<std::string_view,6> WARLORD_NATIVE_TEXTURES_1122 = {{"texture_normal","texture_basecolor","texture_orm","texture_color_fx_skin","texture_dead","native_texture_5"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,30> WARLORD_NATIVE_PARAMETERS_1122 = {{
    {"selectioncolor", 14u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,34> WARLORD_NATIVE_SWITCHES_1122 = {{
    {"1.use_dyeing", false},
...
constexpr std::array<std::string_view,8> WARLORD_NATIVE_TEXTURES_1123 = {{"texture_normal","texture_basecolor","texture_orm","texture_color_fx_skin","texture_emissive","texture_fx_panning","texture_dead","native_texture_7"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,35> WARLORD_NATIVE_PARAMETERS_1123 = {{
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,34> WARLORD_NATIVE_SWITCHES_1123 = {{
    {"1.use_dyeing", false},
    {"2.use_wp_dyeing", false},
    {"1.use_fx_dead_worldoffset", false},
    {"is_npc", false},
...
constexpr std::array<std::string_view,2> WARLORD_NATIVE_TEXTURES_2005 = {{"12.map_f","02.map_e"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,25> WARLORD_NATIVE_PARAMETERS_2005 = {{
    {"selectioncolor", 7u, 0u, true},
    {"93.emissiion_color", 6u, 0u, true},
    {"time", 5u, 2u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,27> WARLORD_NATIVE_SWITCHES_2005 = {{
    {"00.usespecullar", false},
    {"11.mape+mapf", false},
    {"10.use_mapb", true},
    {"01.use_emissionmap", true},
...
constexpr std::array<std::string_view,3> WARLORD_NATIVE_TEXTURES_2006 = {{"13.map_b","06.map","01.map_a"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,22> WARLORD_NATIVE_PARAMETERS_2006 = {{
    {"selectioncolor", 6u, 0u, true},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,11> WARLORD_NATIVE_SWITCHES_2006 = {{
    {"01.usemesh", false},
    {"00.alphamap", true},
...
constexpr std::array<std::string_view,4> WARLORD_NATIVE_TEXTURES_2007 = {{"native_texture_0","01.map_uv","01.map_a","11.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,7> WARLORD_NATIVE_PARAMETERS_2007 = {{
    {"selectioncolor", 2u, 0u, true},
    {"09.str", 0u, 1u, false},
    {"10.power", 0u, 2u, false},
    {"12.map_b_uvscale", 0u, 3u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,8> WARLORD_NATIVE_SWITCHES_2007 = {{
    {"00.checkisdepthbiasalpha", true},
    {"01.usemesh", false},
    {"06.mapch.r", true},
    {"07.mapch.g", true},
...
constexpr std::array<std::string_view,5> WARLORD_NATIVE_TEXTURES_2008 = {{"01.map_uv","01.map_e","native_texture_2","01.map_a","11.map_b"}};
constexpr std::array<WARLORD_NATIVE_PARAMETER_DESC,14> WARLORD_NATIVE_PARAMETERS_2008 = {{
    {"selectioncolor", 4u, 0u, true},
    {"19.emissiion_color", 3u, 0u, true},
    {"04.map_e_panning_x", 0u, 3u, false},
    {"02.map_e_uvscale_r", 0u, 1u, false},
...
constexpr std::array<WARLORD_NATIVE_SWITCH_DESC,8> WARLORD_NATIVE_SWITCHES_2008 = {{
    {"00.checkisdepthbiasalpha", true},
    {"01.usemesh", false},
    {"06.mapch.r", true},
    {"07.mapch.g", true},
