...
void Client::CEffect_Tool::Render_ProjectileDestinationControls()
{
    if (!m_ActiveDocument || m_ActiveDocument->strEffectAssetId !=
        "effect.kouku.gate3.backstep.electric.source.aim.preview") return;
    std::array<float3_t, 3> destinations{};
    std::string error;
    ...
    for (size_t branch = 0; branch < destinations.size(); ++branch)
    {
        ...
        { m_strElementStatus = error; break; }
        if (Try_CommitDocument(std::move(staged)))
        {
            Reset_DetailDraft();
            m_strElementStatus = m_strDocumentStatus = "";
        }
        break;
    }
    ImGui::EndDisabled();
    if (Has_UnappliedDetailDraft())
        ImGui::TextDisabled("\xeb\xa8\xbc\xec\xa0\x80\x20\xec\x97\xb4\xeb\xa6\xb0\x20\x44\x65\x74\x61\x69\x6c\x20\xed\x8e\xb8\xec\xa7\x91\xec\x9d\x84\x20\x41\x70\x70\x6c\x79\x20\xeb\x98\x90\xeb\x8a\x94\x20\x52\x65\x76\x65\x72\x74\x20\xed\x95\x98\xec\x84\xb8\xec\x9a\x94\x2e");
}
