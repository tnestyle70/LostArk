constexpr std::array<std::string_view,1> DIMENSIONMASTER_V_TEXTURES_52 = {{"lensflaretexture"}};
constexpr std::array<DIMENSIONMASTER_V_PARAMETER_DESC,6> DIMENSIONMASTER_V_PARAMETERS_52 = {{
...
constexpr std::array<DIMENSIONMASTER_V_SWITCH_DESC,0> DIMENSIONMASTER_V_SWITCHES_52 = {{
}};

constexpr std::array<std::string_view,0> DIMENSIONMASTER_V_TEXTURES_53 = {{}};
constexpr std::array<DIMENSIONMASTER_V_PARAMETER_DESC,6> DIMENSIONMASTER_V_PARAMETERS_53 = {{
    {"selectioncolor", 2u, 0u, true},
...
constexpr std::array<DIMENSIONMASTER_V_SWITCH_DESC,4> DIMENSIONMASTER_V_SWITCHES_53 = {{
...
constexpr std::array<std::string_view,1> DIMENSIONMASTER_V_TEXTURES_54 = {{"01.map"}};
constexpr std::array<DIMENSIONMASTER_V_PARAMETER_DESC,6> DIMENSIONMASTER_V_PARAMETERS_54 = {{
    {"selectioncolor", 2u, 0u, true},
...
constexpr std::array<DIMENSIONMASTER_V_SWITCH_DESC,4> DIMENSIONMASTER_V_SWITCHES_54 = {{
    {"checkisdepthbiasalpha", true},
    {"00.useradius", true},
    {"01.usemesh", false},
...
constexpr std::array<std::string_view,4> DIMENSIONMASTER_V_TEXTURES_55 = {{"31.map_e","06.map","04.map_anew","00.map_b"}};
constexpr std::array<DIMENSIONMASTER_V_PARAMETER_DESC,18> DIMENSIONMASTER_V_PARAMETERS_55 = {{
...
constexpr std::array<DIMENSIONMASTER_V_SWITCH_DESC,18> DIMENSIONMASTER_V_SWITCHES_55 = {{
...
constexpr std::array<std::string_view,2> DIMENSIONMASTER_V_TEXTURES_56 = {{"uv_noise_tex","emissive_tex"}};
constexpr std::array<DIMENSIONMASTER_V_PARAMETER_DESC,10> DIMENSIONMASTER_V_PARAMETERS_56 = {{
...
constexpr std::array<DIMENSIONMASTER_V_SWITCH_DESC,5> DIMENSIONMASTER_V_SWITCHES_56 = {{
    {"use_meshtype", false},
    {"use_subuv_tex", false},
...
constexpr std::array<std::string_view,1> DIMENSIONMASTER_V_TEXTURES_57 = {{"emissive_tex"}};
constexpr std::array<DIMENSIONMASTER_V_PARAMETER_DESC,1> DIMENSIONMASTER_V_PARAMETERS_57 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<DIMENSIONMASTER_V_SWITCH_DESC,3> DIMENSIONMASTER_V_SWITCHES_57 = {{
    {"use_meshtype", false},
    {"use_subuv_tex", false},
    {"use_nonalpha_chanel", false},
}};

constexpr std::array<std::string_view,1> DIMENSIONMASTER_V_TEXTURES_58 = {{"emissive_tex"}};
constexpr std::array<DIMENSIONMASTER_V_PARAMETER_DESC,5> DIMENSIONMASTER_V_PARAMETERS_58 = {{
...
constexpr std::array<DIMENSIONMASTER_V_SWITCH_DESC,17> DIMENSIONMASTER_V_SWITCHES_58 = {{
...
constexpr std::array<std::string_view,2> DIMENSIONMASTER_V_TEXTURES_59 = {{"uv_noise_01_tex","emissive_tex"}};
constexpr std::array<DIMENSIONMASTER_V_PARAMETER_DESC,12> DIMENSIONMASTER_V_PARAMETERS_59 = {{
    {"selectioncolor", 3u, 0u, true},
...
constexpr std::array<DIMENSIONMASTER_V_SWITCH_DESC,18> DIMENSIONMASTER_V_SWITCHES_59 = {{
    {"use_mesh_world_normal", false},
    {"use_depth_alpha", false},
    {"use_distortion", false},
    {"use_distortion_floor", false},
...
constexpr std::array<std::string_view,5> DIMENSIONMASTER_V_TEXTURES_60 = {{"06.map","02.map_e","01.map_a","11.map_b","21.map_c"}};
constexpr std::array<DIMENSIONMASTER_V_PARAMETER_DESC,31> DIMENSIONMASTER_V_PARAMETERS_60 = {{
...
constexpr std::array<DIMENSIONMASTER_V_SWITCH_DESC,26> DIMENSIONMASTER_V_SWITCHES_60 = {{
    {"00.usedistortion", false},
    {"01.usemesh", true},
    {"31.mapch.r", false},
    {"32.mapch.g", false},
...
constexpr std::array<std::string_view,1> DIMENSIONMASTER_V_TEXTURES_61 = {{"emissive_tex"}};
constexpr std::array<DIMENSIONMASTER_V_PARAMETER_DESC,1> DIMENSIONMASTER_V_PARAMETERS_61 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<DIMENSIONMASTER_V_SWITCH_DESC,3> DIMENSIONMASTER_V_SWITCHES_61 = {{
    {"use_meshtype", false},
    {"use_subuv_tex", false},
    {"use_nonalpha_chanel", false},
}};

constexpr std::array<std::string_view,0> DIMENSIONMASTER_V_TEXTURES_62 = {{}};
constexpr std::array<DIMENSIONMASTER_V_PARAMETER_DESC,1> DIMENSIONMASTER_V_PARAMETERS_62 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<DIMENSIONMASTER_V_SWITCH_DESC,0> DIMENSIONMASTER_V_SWITCHES_62 = {{
}};

constexpr std::array<std::string_view,3> DIMENSIONMASTER_V_TEXTURES_63 = {{"14.map_d","01.map_a","06.map_b"}};
constexpr std::array<DIMENSIONMASTER_V_PARAMETER_DESC,19> DIMENSIONMASTER_V_PARAMETERS_63 = {{
...
constexpr std::array<DIMENSIONMASTER_V_SWITCH_DESC,6> DIMENSIONMASTER_V_SWITCHES_63 = {{
    {"checkisdepthbiasalpha", true},
...
constexpr std::array<std::string_view,1> DIMENSIONMASTER_V_TEXTURES_64 = {{"main_tex"}};
constexpr std::array<DIMENSIONMASTER_V_PARAMETER_DESC,5> DIMENSIONMASTER_V_PARAMETERS_64 = {{
    {"selectioncolor", 1u, 0u, true},
...
constexpr std::array<DIMENSIONMASTER_V_SWITCH_DESC,4> DIMENSIONMASTER_V_SWITCHES_64 = {{
    {"use_5waysplit", false},
    {"use_alphach", false},
...
constexpr std::array<std::string_view,0> DIMENSIONMASTER_V_TEXTURES_65 = {{}};
constexpr std::array<DIMENSIONMASTER_V_PARAMETER_DESC,1> DIMENSIONMASTER_V_PARAMETERS_65 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<DIMENSIONMASTER_V_SWITCH_DESC,0> DIMENSIONMASTER_V_SWITCHES_65 = {{
}};

constexpr std::array<std::string_view,3> DIMENSIONMASTER_V_TEXTURES_66 = {{"normal_tex","refle_tex","native_texture_2"}};
constexpr std::array<DIMENSIONMASTER_V_PARAMETER_DESC,17> DIMENSIONMASTER_V_PARAMETERS_66 = {{
...
constexpr std::array<DIMENSIONMASTER_V_SWITCH_DESC,2> DIMENSIONMASTER_V_SWITCHES_66 = {{
    {"use_depth", false},
    {"use_dissolve", false},
}};

constexpr std::array<std::string_view,1> DIMENSIONMASTER_V_TEXTURES_67 = {{"slice_flow_texture"}};
constexpr std::array<DIMENSIONMASTER_V_PARAMETER_DESC,11> DIMENSIONMASTER_V_PARAMETERS_67 = {{
    {"selectioncolor", 3u, 0u, true},
...
constexpr std::array<DIMENSIONMASTER_V_SWITCH_DESC,0> DIMENSIONMASTER_V_SWITCHES_67 = {{
}};

constexpr std::array<std::string_view,0> DIMENSIONMASTER_V_TEXTURES_68 = {{}};
constexpr std::array<DIMENSIONMASTER_V_PARAMETER_DESC,10> DIMENSIONMASTER_V_PARAMETERS_68 = {{
    {"selectioncolor", 3u, 0u, true},
    {"powerx", 1u, 3u, false},
    {"rgb_str", 2u, 0u, false},
    {"ch_r", 0u, 2u, false},
...
constexpr std::array<DIMENSIONMASTER_V_SWITCH_DESC,0> DIMENSIONMASTER_V_SWITCHES_68 = {{
}};

constexpr std::array<std::string_view,1> DIMENSIONMASTER_V_TEXTURES_69 = {{"native_texture_0"}};
constexpr std::array<DIMENSIONMASTER_V_PARAMETER_DESC,1> DIMENSIONMASTER_V_PARAMETERS_69 = {{
    {"selectioncolor", 0u, 0u, true},
}};
constexpr std::array<DIMENSIONMASTER_V_SWITCH_DESC,0> DIMENSIONMASTER_V_SWITCHES_69 = {{
}};

constexpr std::array<std::string_view,5> DIMENSIONMASTER_V_TEXTURES_70 = {{"06.map","12.map_c","22.map_a","02.map_e","01.specmap"}};
constexpr std::array<DIMENSIONMASTER_V_PARAMETER_DESC,35> DIMENSIONMASTER_V_PARAMETERS_70 = {{
...
constexpr std::array<DIMENSIONMASTER_V_SWITCH_DESC,27> DIMENSIONMASTER_V_SWITCHES_70 = {{
...
constexpr std::array<std::string_view,3> DIMENSIONMASTER_V_TEXTURES_71 = {{"diff_tex","diff_noise_tex","a_mask_tex"}};
constexpr std::array<DIMENSIONMASTER_V_PARAMETER_DESC,26> DIMENSIONMASTER_V_PARAMETERS_71 = {{
    {"selectioncolor", 7u, 0u, true},
...
constexpr std::array<DIMENSIONMASTER_V_SWITCH_DESC,13> DIMENSIONMASTER_V_SWITCHES_71 = {{
...
constexpr std::array<std::string_view,1> DIMENSIONMASTER_V_TEXTURES_72 = {{"texture"}};
constexpr std::array<DIMENSIONMASTER_V_PARAMETER_DESC,3> DIMENSIONMASTER_V_PARAMETERS_72 = {{
    {"selectioncolor", 1u, 0u, true},
    {"tex_intensity", 0u, 1u, false},
    {"glimmer_opacity", 0u, 0u, false},
}};
constexpr std::array<DIMENSIONMASTER_V_SWITCH_DESC,0> DIMENSIONMASTER_V_SWITCHES_72 = {{
}};

constexpr std::array<std::string_view,2> DIMENSIONMASTER_V_TEXTURES_73 = {{"12.map_f","02.map_e"}};
constexpr std::array<DIMENSIONMASTER_V_PARAMETER_DESC,22> DIMENSIONMASTER_V_PARAMETERS_73 = {{
    {"selectioncolor", 6u, 0u, true},
...
constexpr std::array<DIMENSIONMASTER_V_SWITCH_DESC,27> DIMENSIONMASTER_V_SWITCHES_73 = {{
    {"00.usespecullar", false},
    {"11.mape+mapf", false},
    {"10.use_mapb", true},
    {"01.use_emissionmap", true},
...
constexpr std::array<std::string_view,2> DIMENSIONMASTER_V_TEXTURES_74 = {{"12.map_f","02.map_e"}};
constexpr std::array<DIMENSIONMASTER_V_PARAMETER_DESC,22> DIMENSIONMASTER_V_PARAMETERS_74 = {{
    {"selectioncolor", 6u, 0u, true},
    {"93.emissiion_color", 5u, 0u, true},
    {"time", 4u, 3u, false},
    {"15.map_e_panning_x", 3u, 1u, false},
...
constexpr std::array<DIMENSIONMASTER_V_SWITCH_DESC,27> DIMENSIONMASTER_V_SWITCHES_74 = {{
    {"00.usespecullar", false},
    {"11.mape+mapf", false},
    {"10.use_mapb", true},
    {"01.use_emissionmap", true},
...
constexpr std::array<std::string_view,1> DIMENSIONMASTER_V_TEXTURES_75 = {{"slice_flow_texture"}};
constexpr std::array<DIMENSIONMASTER_V_PARAMETER_DESC,11> DIMENSIONMASTER_V_PARAMETERS_75 = {{
    {"selectioncolor", 3u, 0u, true},
    {"slice_flow_rot", 1u, 2u, false},
    {"slice_rot", 2u, 1u, false},
    {"slice_flow_tileu", 1u, 3u, false},
...
constexpr std::array<DIMENSIONMASTER_V_SWITCH_DESC,0> DIMENSIONMASTER_V_SWITCHES_75 = {{
}};

constexpr std::array<std::string_view,0> DIMENSIONMASTER_V_TEXTURES_76 = {{}};
constexpr std::array<DIMENSIONMASTER_V_PARAMETER_DESC,4> DIMENSIONMASTER_V_PARAMETERS_76 = {{
    {"selectioncolor", 1u, 0u, true},
    {"circle radius", 0u, 0u, false},
    {"circleedge hardness", 0u, 1u, false},
    {"opacity", 0u, 2u, false},
}};
constexpr std::array<DIMENSIONMASTER_V_SWITCH_DESC,3> DIMENSIONMASTER_V_SWITCHES_76 = {{
    {"use_particle", true},
    {"use_invertedcirclealpha", false},
    {"use_circlealpha", true},
}};

constexpr std::array<DIMENSIONMASTER_V_PROGRAM_DESC,26> DIMENSIONMASTER_V_PROGRAM_STORAGE = {{
