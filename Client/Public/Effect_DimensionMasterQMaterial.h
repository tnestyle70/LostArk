...
inline constexpr std::array<std::string_view,5> DIMENSIONMASTER_Q_TEXTURES_44 = {{"diffuse_tex","flow_tex","mask_b_tex","mask_a_tex","dissolve_tex"}};
inline constexpr std::array<DIMENSIONMASTER_Q_PARAMETER_DESC,62> DIMENSIONMASTER_Q_PARAMETERS_44 = {{
...
inline constexpr std::array<DIMENSIONMASTER_Q_SWITCH_DESC,10> DIMENSIONMASTER_Q_SWITCHES_44 = {{
...
inline constexpr std::array<std::string_view,1> DIMENSIONMASTER_Q_TEXTURES_45 = {{"emissive_tex"}};
inline constexpr std::array<DIMENSIONMASTER_Q_PARAMETER_DESC,6> DIMENSIONMASTER_Q_PARAMETERS_45 = {{
...
inline constexpr std::array<DIMENSIONMASTER_Q_SWITCH_DESC,17> DIMENSIONMASTER_Q_SWITCHES_45 = {{
...
inline constexpr std::array<std::string_view,2> DIMENSIONMASTER_Q_TEXTURES_46 = {{"uv_noise_tex","alpha_tex"}};
inline constexpr std::array<DIMENSIONMASTER_Q_PARAMETER_DESC,26> DIMENSIONMASTER_Q_PARAMETERS_46 = {{
...
inline constexpr std::array<DIMENSIONMASTER_Q_SWITCH_DESC,4> DIMENSIONMASTER_Q_SWITCHES_46 = {{
...
inline constexpr std::array<std::string_view,0> DIMENSIONMASTER_Q_TEXTURES_47 = {{}};
inline constexpr std::array<DIMENSIONMASTER_Q_PARAMETER_DESC,6> DIMENSIONMASTER_Q_PARAMETERS_47 = {{
    {"selectioncolor", 2u, 0u, true},
...
inline constexpr std::array<DIMENSIONMASTER_Q_SWITCH_DESC,0> DIMENSIONMASTER_Q_SWITCHES_47 = {{
}};

inline constexpr std::array<std::string_view,7> DIMENSIONMASTER_Q_TEXTURES_48 = {{"02_diffnoise_tex","01_diff_tex","01_alphabase_tex","02_alphaflow_noise_tex","03_alphaflow_noise_tex","01_alphaflow_tex","native_texture_6"}};
inline constexpr std::array<DIMENSIONMASTER_Q_PARAMETER_DESC,32> DIMENSIONMASTER_Q_PARAMETERS_48 = {{
...
inline constexpr std::array<DIMENSIONMASTER_Q_SWITCH_DESC,7> DIMENSIONMASTER_Q_SWITCHES_48 = {{
...
inline constexpr std::array<std::string_view,2> DIMENSIONMASTER_Q_TEXTURES_49 = {{"uv_noise_tex","emissive_tex"}};
inline constexpr std::array<DIMENSIONMASTER_Q_PARAMETER_DESC,10> DIMENSIONMASTER_Q_PARAMETERS_49 = {{
...
inline constexpr std::array<DIMENSIONMASTER_Q_SWITCH_DESC,5> DIMENSIONMASTER_Q_SWITCHES_49 = {{
    {"use_meshtype", false},
    {"use_subuv_tex", false},
...
inline constexpr std::array<std::string_view,3> DIMENSIONMASTER_Q_TEXTURES_50 = {{"normal_tex","refle_tex","native_texture_2"}};
inline constexpr std::array<DIMENSIONMASTER_Q_PARAMETER_DESC,17> DIMENSIONMASTER_Q_PARAMETERS_50 = {{
    {"selectioncolor", 7u, 0u, true},
...
inline constexpr std::array<DIMENSIONMASTER_Q_SWITCH_DESC,2> DIMENSIONMASTER_Q_SWITCHES_50 = {{
    {"use_depth", false},
    {"use_dissolve", false},
}};

inline constexpr std::array<std::string_view,7> DIMENSIONMASTER_Q_TEXTURES_51 = {{"cracknormal_tex","native_texture_1","in_hole_texture","aura_texture","native_texture_4","native_texture_5","native_texture_6"}};
inline constexpr std::array<DIMENSIONMASTER_Q_PARAMETER_DESC,32> DIMENSIONMASTER_Q_PARAMETERS_51 = {{
...
inline constexpr std::array<DIMENSIONMASTER_Q_SWITCH_DESC,6> DIMENSIONMASTER_Q_SWITCHES_51 = {{
