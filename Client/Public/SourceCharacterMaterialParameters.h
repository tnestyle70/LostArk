    ...
    Engine::MODEL_SOURCE_CHARACTER_PARAMETERS& result)
{
    ...
    else if (family == "source.character.classic-parts-sp.v1")
    {
        [&]() {
        staged.program = 15u;
        staged.baseTextureMask = 127u;
    ...
    else if (family == "source.character.classic-armor-sp.v1")
    {
        [&]() {
        staged.program = 16u;
        staged.baseTextureMask = 127u;
    ...
    else if (family == "source.character.classic-brush.v1")
    {
        [&]() {
        staged.program = 17u;
        staged.baseTextureMask = 63u;
    ...
    else if (family == "source.character.hair-two-tone.v1")
    {
        [&]() {
        staged.program = 18u;
        staged.baseTextureMask = 7u;
    ...
    else if (family == "source.character.hair-masked.v1")
    {
        [&]() {
        staged.program = 19u;
        staged.baseTextureMask = 7u;
    ...
    else if (family == "source.character.hair-helmet.v1")
    {
        [&]() {
        staged.program = 20u;
        staged.baseTextureMask = 7u;
    ...
    else if (family == "source.character.monster-pbr-masked.v1")
    {
        [&]() {
        staged.program = 21u;
    ...
    else if (family == "source.character.monster-7493dcdfd412.v1")
    {
        [&]() {
        staged.program = 22u;
        staged.baseTextureMask = 7u;
    ...
    else if (family == "source.character.monster-d9d6c02905c3.v1")
    {
        [&]() {
        staged.program = 23u;
        staged.baseTextureMask = 255u;
    ...
    else if (family == "source.character.monster-d621a47e69ad.v1")
    {
        [&]() {
        staged.program = 24u;
        staged.baseTextureMask = 63u;
    ...
    else if (family == "source.character.monster-be5bc0ded311.v1")
    {
        [&]() {
        staged.program = 25u;
        staged.baseTextureMask = 127u;
    ...
    else if (family == "source.character.monster-6ff78ae19259.v1")
    {
        [&]() {
        staged.program = 26u;
        staged.baseTextureMask = 63u;
    ...
    else if (family == "source.character.monster-4184f1980abb.v1")
    {
        [&]() {
        staged.program = 27u;
        staged.baseTextureMask = 255u;
    ...
    else if (family == "source.character.monster-ce6425dcbdeb.v1")
    {
        [&]() {
        staged.program = 28u;
        staged.baseTextureMask = 255u;
    ...
    else if (family == "source.character.monster-63e86c4fac91.v1")
    {
        [&]() {
        staged.program = 29u;
        staged.baseTextureMask = 63u;
    ...
    else if (family == "source.character.monster-3b27d7fb1b53.v1")
    {
        [&]() {
        staged.program = 30u;
        staged.baseTextureMask = 63u;
    ...
    else if (family == "source.character.monster-d1e4d915a43a.v1")
    {
        [&]() {
        staged.program = 31u;
        staged.baseTextureMask = 63u;
    ...
    else if (family == "source.character.monster-411db5c836e7.v1")
    {
        [&]() {
        staged.program = 32u;
        staged.baseTextureMask = 127u;
    ...
    else if (family == "source.character.monster-862fa1000fe2.v1")
    {
        [&]() {
        staged.program = 80u;
    ...
    else if (family == "source.character.monster-3c300c108ac5.v1")
    {
        [&]() {
        staged.program = 81u;
        staged.baseTextureMask = 15u;
    ...
    else if (family == "source.character.monster-7373ec8df226.v1")
    {
        [&]() {
        staged.program = 82u;
        staged.baseTextureMask = 7u;
    ...
    else if (family == "source.character.monster-a2e0ec089348.v1")
    {
        [&]() {
        staged.program = 83u;
        staged.baseTextureMask = 31u;
    ...
    else if (family == "source.character.monster-8d18db0756e4.v1")
    {
        [&]() {
        staged.program = 84u;
        staged.baseTextureMask = 15u;
    ...
    else if (family == "source.vehicle.terpeion-body.v1")
    {
        [&]() {
        staged.program = 85u;
        staged.baseConstants[63] = vector(parameter("constantoutline_blink"));
    ...
    else if (family == "source.vehicle.starlight-body.v1")
    {
        [&]() {
        staged.program = 86u;
        staged.baseConstants[63] = vector(parameter("constantoutline_blink"));
    ...
    else if (family == "source.vehicle.mokoboard-vfx.v1")
    {
        [&]() {
        staged.program = 87u;
        staged.baseTextureMask = 127u;
    ...
    else if (family == "source.vehicle.starlight-shell-translucent.v1")
    {
        [&]() {
        staged.program = 88u;
        staged.baseTextureMask = 127u;
    ...
    else if (family == "source.vehicle.ancient-myth-realpbr.v1")
    {
        [&]() {
        staged.program = 89u;
        staged.baseConstants[63] = vector(parameter("constantoutline_blink"));
    ...
    else if (family == "source.character.monster-dead-16902fea865c.v1")
    {
        [&]() {
        staged.program = 92u;
        staged.baseConstants[63] = vector(parameter("constantoutline_blink"));
    ...
    else if (family == "source.character.monster-dead-e15390cf9645.v1")
    {
        [&]() {
        staged.program = 93u;
        staged.baseConstants[63] = vector(parameter("constantoutline_blink"));
    ...
    else if (family == "source.character.realpbr-avatar-ddk.v1")
    {
        [&]() {
        staged.program = 94u;
        staged.baseTextureMask = 63u;
    ...
    else if (family == "source.character.realpbr-avatar-ddk-plate.v1")
    {
        [&]() {
        staged.program = 95u;
        staged.baseTextureMask = 127u;
    ...
    else if (family == "source.character.realpbr-weapon-ddk.v1")
    {
        [&]() {
        staged.program = 96u;
        staged.baseTextureMask = 63u;
    ...
    else if (family == "source.character.realpbr-wing-ddk.v1")
    {
        [&]() {
        staged.program = 97u;
        staged.baseTextureMask = 127u;
    ...
    else if (family == "source.character.realpbr-wing-ddk-membrane.v1")
    {
        [&]() {
        staged.program = 98u;
        staged.baseTextureMask = 31u;
    ...
    else if (family == "source.character.hair-ddk.v1")
    {
        [&]() {
        staged.program = 99u;
        staged.baseTextureMask = 7u;
    ...
    else if (family == "source.vehicle.ancient-sea-realpbr.v1")
    {
        [&]() {
        staged.program = 100u;
        staged.baseConstants[63] = vector(parameter("constantoutline_blink"));
    ...
    else if (family == "source.character.guardianknight-sk-ddk-drg-00-body-mi-dead.v1")
    {
        [&]() {
        staged.program = 101u;
        staged.baseConstants[63] = vector(parameter("constantoutline_blink"));
    ...
    else if (family == "source.character.guardianknight-sk-ddk-drg-00-head-mi-dead.v1")
    {
        [&]() {
        staged.program = 102u;
        staged.baseConstants[63] = vector(parameter("constantoutline_blink"));
    ...
    else if (family == "source.character.guardianknight-sk-ddk-drg-00-neck-mi-dead.v1")
    {
        [&]() {
        staged.program = 103u;
        staged.baseConstants[63] = vector(parameter("constantoutline_blink"));
    ...
    else if (family == "source.character.guardianknight-sk-ddk-drg-00-wing1-mi-dead.v1")
    {
        [&]() {
        staged.program = 104u;
        staged.baseConstants[63] = vector(parameter("constantoutline_blink"));
    ...
    else if (family == "source.character.guardianknight-sk-ddk-drg-00-wing-mi-dead.v1")
    {
        [&]() {
        staged.program = 105u;
        staged.baseConstants[63] = vector(parameter("constantoutline_blink"));
    ...
    else if (family == "source.character.guardianknight-sk-ddk-drr-00-body-mi.v1")
    {
        [&]() {
        staged.program = 106u;
        staged.baseConstants[63] = vector(parameter("constantoutline_blink"));
    ...
    else if (family == "source.character.guardianknight-sk-ddk-drr-00-head-mi.v1")
    {
        [&]() {
        staged.program = 107u;
        staged.baseConstants[63] = vector(parameter("constantoutline_blink"));
    ...
    else if (family == "source.character.guardianknight-sk-ddk-drr-00-neck-mi.v1")
    {
        [&]() {
        staged.program = 108u;
        staged.baseConstants[63] = vector(parameter("constantoutline_blink"));
    ...
    else if (family == "source.character.guardianknight-sk-ddk-drr-01-head-st-mi-fx-dead.v1")
    {
        [&]() {
        staged.program = 110u;
        staged.baseConstants[63] = vector(parameter("constantoutline_blink"));
    ...
    else if (family == "source.character.guardianknight-sk-ddk-drr-01-neck-st-mi-fx-dead.v1")
    {
        [&]() {
        staged.program = 111u;
        staged.baseConstants[63] = vector(parameter("constantoutline_blink"));
