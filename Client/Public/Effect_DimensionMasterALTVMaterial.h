...
// native-material-tables: ../Private/Effect_DimensionMasterALTVMaterial_Tables.inl
extern const std::span<const DIMENSIONMASTER_ALTV_PROGRAM_DESC> DIMENSIONMASTER_ALTV_PROGRAMS;
