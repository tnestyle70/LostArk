    ...
    float3 normal,float4 clipPosition,float4 vertexColor,float4 extraUV,float2 lightmapUV,float3 cameraPosition)
{
    ...
    if (IsSourceMovieForward())
    {
        ...
        output = EvaluateSourceMovieBase(input);
        if (output.discarded) discard;
        if (g_SourceCharacterProgram>=1500u && g_SourceCharacterProgram<=1502u) output.targets[0].a=1.f;
        return output.targets[0];
    }
...
{
    if(!(g_SourceCharacterProgram==40u || g_SourceCharacterProgram==41u || g_SourceCharacterProgram==42u || g_SourceCharacterProgram==43u || g_SourceCharacterProgram==44u || g_SourceCharacterProgram==45u || g_SourceCharacterProgram==46u || g_SourceCharacterProgram==48u || g_SourceCharacterProgram==49u || g_SourceCharacterProgram==50u || g_SourceCharacterProgram==51u || g_SourceCharacterProgram==52u || g_SourceCharacterProgram==54u || g_SourceCharacterProgram==56u || g_SourceCharacterProgram==57u || g_SourceCharacterProgram==58u || g_SourceCharacterProgram==59u || g_SourceCharacterProgram==60u || g_SourceCharacterProgram==61u || g_SourceCharacterProgram==62u || g_SourceCharacterProgram==63u || g_SourceCharacterProgram==209u || g_SourceCharacterProgram==224u || g_SourceCharacterProgram==225u || g_SourceCharacterProgram==226u || g_SourceCharacterProgram==237u || IsSourceMovieLitForward()))return 0.f;
    const float3 t=SourceCharacterSafeUnit(tangent),b=SourceCharacterSafeUnit(binormal),n=SourceCharacterSafeUnit(normal);
    const float3 view=cameraPosition-worldPosition;
...
bool IsSourceMapForward() { return (g_SourceCharacterProgram>=33u && g_SourceCharacterProgram<=63u) || g_SourceCharacterProgram==65u || g_SourceCharacterProgram==209u || g_SourceCharacterProgram==224u || g_SourceCharacterProgram==225u || g_SourceCharacterProgram==226u || g_SourceCharacterProgram==237u || IsSourceMovieForward(); }
