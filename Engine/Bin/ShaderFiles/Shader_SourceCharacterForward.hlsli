    ...
    float3 cameraPosition, float3 lightDirection, float3 lightColor, bool frontFace)
{
    ...
    if (6u == g_SourceCharacterProgram || 212u == g_SourceCharacterProgram || 601u == g_SourceCharacterProgram)
    {
        light.values[2] = float4(input.vTexcoord, 0.f, 0.f);
        light.values[3] = light.values[5];
        light.values[5] = light.values[7];
    ...
    if (903u == g_SourceCharacterProgram) light.values[8] = input.vProjPos;
    ...
    {
        light.values[0] = 1.f; light.values[1] = 0.f;
        light.values[2] = float4(input.vTexcoord,0.f,0.f);
        light.values[3] = float4(dot(t,direction),dot(b,direction),dot(n,direction),1.f);
        light.values[4] = 0.f;
        light.values[5] = float4(dot(t,view),dot(b,view),dot(n,view),1.f);
        light.values[6] = input.vProjPos;
        light.values[7] = frontFace ? 1.f : 0.f;
    }
...
SCENE_COLOR_BLOOM_OUT PS_MAIN_SOURCE_CHARACTER_TRANSLUCENT(VS_OUT input, bool frontFace : SV_IsFrontFace)
{
    if (6u != g_SourceCharacterProgram && 7u != g_SourceCharacterProgram &&
        ...
        !(g_SourceCharacterProgram == 160u || g_SourceCharacterProgram == 166u || g_SourceCharacterProgram == 168u || g_SourceCharacterProgram == 169u || g_SourceCharacterProgram == 170u || g_SourceCharacterProgram == 171u || g_SourceCharacterProgram == 172u || g_SourceCharacterProgram == 174u || g_SourceCharacterProgram == 182u || g_SourceCharacterProgram == 187u || g_SourceCharacterProgram == 190u || g_SourceCharacterProgram == 192u || g_SourceCharacterProgram == 195u || g_SourceCharacterProgram == 212u || g_SourceCharacterProgram == 213u || g_SourceCharacterProgram == 903u || g_SourceCharacterProgram == 600u || g_SourceCharacterProgram == 601u || g_SourceCharacterProgram == 700u || g_SourceCharacterProgram == 701u || g_SourceCharacterProgram == 702u || g_SourceCharacterProgram == 801u)) discard;
