...
namespace Engine
{
	...
	enum class RENDERGROUP { PRIORITY, SHADOW, NONBLEND, DEFERRED_OVERLAY, NONLIGHT, BLEND, UI, SCENE_UI, PICKING, END };
	...
	enum class DEFERRED
	{
		...
		SPOT = 16,
		PRESENTATION_DISPLAY_OVERLAY = 17,
		SOURCE_LIGHT_MASK = 18,
