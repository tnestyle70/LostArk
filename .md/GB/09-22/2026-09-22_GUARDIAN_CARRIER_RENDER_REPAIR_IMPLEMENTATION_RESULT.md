...
수용하도록 carrier 및 installer 상한은4607이다.
...
주요 화염sprite에 원본 mask가 유지된다. 3979/3982의 early mesh samples alpha0은 별도 수명
확인 대상이고4000은 additive alpha0이므로 alpha만으로 비표시라고 판정하지 않는다.
...
| 붉은 LMB49001 | 실제3clip/bone,20개 원본GPU80건,3975/3988/3989 decal진입 | early3979/3982 및 최종 화염형태 확인 |
...
| ALT V49420 | 카메라/backdrop는 root 담당, projectile494200 복원 진행 | 화염/DragonDecal 구현 후 갱신 |
...
ALT V projectile의 원본화염/DragonDecal 설치 및 신규S shader 실제검증은 진행 중이다.
