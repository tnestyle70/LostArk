...
바디 단위이고, 소켓이 바디의 preTransform을 실어준다.

> **2026-08-02 정정:** 여기 적힌 "창술사 창만 x100"은 더 이상 사실이 아니다. 그 창이
> 옛 추출 경로에서 나와 2.3 단위였을 뿐이고, 다른 무기와 같은 방식으로 다시 뽑으니
> 233 유닛(바디 단위)이 됐다. 지금은 **모든 무기가 `XMMatrixIdentity`**다.
