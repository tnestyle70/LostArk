#!/usr/bin/env python3
"""Executable contracts for the fail-closed KoukuSaydon admission gate."""
...
from validate_kouku_saydon_world_admission import (  # noqa: E402
    AdmissionReport,
    AREA_ID,
    COLLECTION_NAME,
    Finding,
...
class Fixture:
    def __init__(self) -> None:
        self._temp = tempfile.TemporaryDirectory(
            prefix="lostark-kouku-saydon-admission-"
        )
...
class KoukuSaydonWorldAdmissionTests(unittest.TestCase):
    def setUp(self) -> None:
