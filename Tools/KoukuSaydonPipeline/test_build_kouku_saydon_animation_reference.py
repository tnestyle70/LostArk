#!/usr/bin/env python3
"""Focused contracts for KoukuSaydon reference-only animation authoring."""
...
from build_kouku_saydon_animation_reference import (  # noqa: E402
    AUTHORITY,
    AUTHORED_BASIS,
    BuildError,
    HOLDOUT,
...
class KoukuSaydonAnimationReferenceTests(unittest.TestCase):
    def setUp(self) -> None:
...
class CommittedKoukuSaydonAnimationReferenceTests(unittest.TestCase):
