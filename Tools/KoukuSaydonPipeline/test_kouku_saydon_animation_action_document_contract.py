...
HEADER = ROOT / "Client" / "Public" / "KoukuSaydonAnimationActionDocument.h"
SOURCE = ROOT / "Client" / "Private" / "KoukuSaydonAnimationActionDocument.cpp"
...
class KoukuSaydonAnimationActionDocumentContractTests(unittest.TestCase):
    ...
    def test_public_boundary_exposes_transactional_load_and_sparse_save(self):
        ...
        for token in (
            "KOUKU_SAYDON_ANIMATION_ACTION_REFERENCE_DOCUMENT",
            "KOUKU_SAYDON_ANIMATION_ACTION_AUTHORED_DOCUMENT",
        ...
        self.assertIn(
            "std::vector<KOUKU_SAYDON_ANIMATION_ACTION_BINDING> Bindings", header
        )
