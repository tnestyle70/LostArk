#!/usr/bin/env python3
"""Build KakulSaydon Server navigation, stable spawns and source-level waypoints.
...
from build_valtan_navgrid import apply_placement, placement_matrix  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    if stale:
        raise BuildError("generated Kakul authoring outputs are stale: " + ", ".join(stale))
...
if __name__ == "__main__":
    try:
        ...
        print(f"build_kakul_world_authoring: {error}", file=sys.stderr)
        raise SystemExit(1)
