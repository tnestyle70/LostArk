...
. (Join-Path $repoRoot 'Tools\KoukuSaydonPipeline\KoukuBootstrapRows.ps1')
...
# One canonical owner emits Kouku rows for publication and Debug draft play.
$koukuEncounterDocument = Read-JsonDocument `
    'Data/Encounters/KoukuSaydon/KoukuSaydonEncounter.json'
$koukuTargetBindings = $null
...
Add-KoukuBootstrapRows -Encounter $koukuEncounterDocument -Presentation $koukuTargetBindings -BossProfiles $bossDocument -Rows $patternRows
