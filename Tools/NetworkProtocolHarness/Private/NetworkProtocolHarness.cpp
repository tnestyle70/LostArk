...
namespace
{
		...
		TEST_RUNNER& testRunner)
	{
		...
		/* Human party capacity and replicated combat-actor capacity are separate.
		   A future four-human/four-server-bot raid must still round-trip eight
		   actor snapshots to every real Client without opening bot sockets. */
		{
